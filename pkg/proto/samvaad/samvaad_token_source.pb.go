...
// 	protoc        v4.23.4
// source: samvaad_token_source.proto
...
type TokenSourceRequest struct {
	...
	// More info: https://docs.samvaad.io/home/get-started/authentication/#room-configuration
...
func (x *TokenSourceRequest) Reset() {
	*x = TokenSourceRequest{}
	mi := &file_samvaad_token_source_proto_msgTypes[0]
...
func (*TokenSourceRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_token_source_proto_rawDescGZIP(), []int{0}
}
...
func (x *TokenSourceResponse) Reset() {
	*x = TokenSourceResponse{}
	mi := &file_samvaad_token_source_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TokenSourceResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_token_source_proto_rawDescGZIP(), []int{1}
}
...
var File_samvaad_token_source_proto protoreflect.FileDescriptor

const file_samvaad_token_source_proto_rawDesc = "" +
	"\n" +
	"\x1a\x6c\x69\x76\x65\x6b\x69\x74_token_source.proto\x12\a\x6c\x69\x76\x65\x6b\x69\x74\x1a\x12\x6c\x69\x76\x65\x6b\x69\x74_room.proto\"\xb6\x04\n" +
	...
	"\x16participant_attributes\x18\x05 \x03(\v26.\x6c\x69\x76\x65\x6b\x69\x74.TokenSourceRequest.ParticipantAttributesEntryR\x15participantAttributes\x12@\n" +
	"\vroom_config\x18\x06 \x01(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.RoomConfigurationH\x04R\n" +
	...
	"\x11participant_token\x18\x02 \x01(\tR\x10participantTokenBFZ#github.com/\x6c\x69\x76\x65\x6b\x69\x74/protocol/\x6c\x69\x76\x65\x6b\x69\x74\xaa\x02\r\x4c\x69\x76\x65\x4b\x69\x74.Proto\xea\x02\x0e\x4c\x69\x76\x65\x4b\x69\x74::Protob\x06proto3"

var (
	file_samvaad_token_source_proto_rawDescOnce sync.Once
	file_samvaad_token_source_proto_rawDescData []byte
)

func file_samvaad_token_source_proto_rawDescGZIP() []byte {
	file_samvaad_token_source_proto_rawDescOnce.Do(func() {
		file_samvaad_token_source_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_samvaad_token_source_proto_rawDesc), len(file_samvaad_token_source_proto_rawDesc)))
	})
	return file_samvaad_token_source_proto_rawDescData
}

var file_samvaad_token_source_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_samvaad_token_source_proto_goTypes = []any{
	(*TokenSourceRequest)(nil),  // 0: samvaad.TokenSourceRequest
	(*TokenSourceResponse)(nil), // 1: samvaad.TokenSourceResponse
	nil,                         // 2: samvaad.TokenSourceRequest.ParticipantAttributesEntry
	(*RoomConfiguration)(nil),   // 3: samvaad.RoomConfiguration
}
var file_samvaad_token_source_proto_depIdxs = []int32{
	2, // 0: samvaad.TokenSourceRequest.participant_attributes:type_name -> samvaad.TokenSourceRequest.ParticipantAttributesEntry
	3, // 1: samvaad.TokenSourceRequest.room_config:type_name -> samvaad.RoomConfiguration
...
func init() { file_samvaad_token_source_proto_init() }
func file_samvaad_token_source_proto_init() {
	if File_samvaad_token_source_proto != nil {
		return
	}
	file_samvaad_room_proto_init()
	file_samvaad_token_source_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_samvaad_token_source_proto_rawDesc), len(file_samvaad_token_source_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_samvaad_token_source_proto_goTypes,
		DependencyIndexes: file_samvaad_token_source_proto_depIdxs,
		MessageInfos:      file_samvaad_token_source_proto_msgTypes,
	}.Build()
	File_samvaad_token_source_proto = out.File
	file_samvaad_token_source_proto_goTypes = nil
	file_samvaad_token_source_proto_depIdxs = nil
}
