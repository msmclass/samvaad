...
func NewRoomServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) RoomService {
	...
	serviceURL += baseServicePath(pathPrefix, "samvaad", "RoomService")
	urls := [14]string{
...
const RoomServicePathPrefix = "/twirp/samvaad.RoomService/"
...
func (s *roomServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "samvaad.RoomService" {
...
func (s *roomServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "samvaad", "RoomService")
}

var twirpFileDescriptor4 = []byte{
	// 1590 bytes of a gzipped FileDescriptorProto
	,
}
