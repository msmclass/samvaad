...
func (SIPStatusCode) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_sip_proto_enumTypes[0].Descriptor()
}

func (SIPStatusCode) Type() protoreflect.EnumType {
	return &file_samvaad_sip_proto_enumTypes[0]
}
...
func (SIPStatusCode) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{0}
}
...
func (SIPTransport) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_sip_proto_enumTypes[1].Descriptor()
}

func (SIPTransport) Type() protoreflect.EnumType {
	return &file_samvaad_sip_proto_enumTypes[1]
}
...
func (SIPTransport) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{1}
}
...
func (SIPHeaderOptions) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_sip_proto_enumTypes[2].Descriptor()
}

func (SIPHeaderOptions) Type() protoreflect.EnumType {
	return &file_samvaad_sip_proto_enumTypes[2]
}
...
func (SIPHeaderOptions) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{2}
}
...
func (SIPMediaEncryption) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_sip_proto_enumTypes[3].Descriptor()
}

func (SIPMediaEncryption) Type() protoreflect.EnumType {
	return &file_samvaad_sip_proto_enumTypes[3]
}
...
func (SIPMediaEncryption) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{3}
}
...
func (ProviderType) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_sip_proto_enumTypes[4].Descriptor()
}

func (ProviderType) Type() protoreflect.EnumType {
	return &file_samvaad_sip_proto_enumTypes[4]
}
...
func (ProviderType) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{4}
}

type SIPCallStatus int32

const (
	SIPCallStatus_SCS_CALL_INCOMING      SIPCallStatus = 0 // Incoming call is being handled by the SIP service. The SIP participant hasn't joined a Samvaad room yet
	...
	SIPCallStatus_SCS_ACTIVE             SIPCallStatus = 2 // Call is ongoing. SIP participant is active in the Samvaad room
...
func (SIPCallStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_sip_proto_enumTypes[5].Descriptor()
}

func (SIPCallStatus) Type() protoreflect.EnumType {
	return &file_samvaad_sip_proto_enumTypes[5]
}
...
func (SIPCallStatus) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{5}
}
...
func (SIPTransferStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_sip_proto_enumTypes[6].Descriptor()
}

func (SIPTransferStatus) Type() protoreflect.EnumType {
	return &file_samvaad_sip_proto_enumTypes[6]
}
...
func (SIPTransferStatus) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{6}
}
...
func (SIPFeature) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_sip_proto_enumTypes[7].Descriptor()
}

func (SIPFeature) Type() protoreflect.EnumType {
	return &file_samvaad_sip_proto_enumTypes[7]
}
...
func (SIPFeature) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{7}
}
...
func (SIPCallDirection) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_sip_proto_enumTypes[8].Descriptor()
}

func (SIPCallDirection) Type() protoreflect.EnumType {
	return &file_samvaad_sip_proto_enumTypes[8]
}
...
func (SIPCallDirection) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{8}
}
...
func (SIPTrunkInfo_TrunkKind) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_sip_proto_enumTypes[9].Descriptor()
}

func (SIPTrunkInfo_TrunkKind) Type() protoreflect.EnumType {
	return &file_samvaad_sip_proto_enumTypes[9]
}
...
func (SIPTrunkInfo_TrunkKind) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{5, 0}
}

// SIPStatus is returned as an error detail in CreateSIPParticipant.
type SIPStatus struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Code          SIPStatusCode          `protobuf:"varint,1,opt,name=code,proto3,enum=samvaad.SIPStatusCode" json:"code,omitempty"`
...
func (x *SIPStatus) Reset() {
	*x = SIPStatus{}
	mi := &file_samvaad_sip_proto_msgTypes[0]
...
// Deprecated: Marked as deprecated in samvaad_sip.proto.
...
func (x *CreateSIPTrunkRequest) Reset() {
	*x = CreateSIPTrunkRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *SIPCodec) Reset() {
	*x = SIPCodec{}
	mi := &file_samvaad_sip_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
// Deprecated: Use SIPCodec.ProtoReflect.Descriptor instead.
func (*SIPCodec) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{2}
}
...
type SIPMediaConfig struct {
	...
	OnlyListedCodecs bool `protobuf:"varint,1,opt,name=only_listed_codecs,json=onlyListedCodecs,proto3" json:"only_listed_codecs,omitempty"`
	// List of allowed codecs. If only_listed_codecs is not set, this list is added to default codecs.
	Codecs     []*SIPCodec         `protobuf:"bytes,2,rep,name=codecs,proto3" json:"codecs,omitempty"`
	Encryption *SIPMediaEncryption `protobuf:"varint,3,opt,name=encryption,proto3,enum=samvaad.SIPMediaEncryption,oneof" json:"encryption,omitempty"`
	// Use specific media timeout. If zero or not specified, will use default timeout.
	MediaTimeout  *durationpb.Duration `protobuf:"bytes,4,opt,name=media_timeout,json=mediaTimeout,proto3,oneof" json:"media_timeout,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SIPMediaConfig) Reset() {
	*x = SIPMediaConfig{}
	mi := &file_samvaad_sip_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
// Deprecated: Use SIPMediaConfig.ProtoReflect.Descriptor instead.
func (*SIPMediaConfig) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{3}
}

func (x *SIPMediaConfig) GetOnlyListedCodecs() bool {
	if x != nil {
		return x.OnlyListedCodecs
	}
	return false
}
...
type ProviderInfo struct {
	...
	Type            ProviderType           `protobuf:"varint,3,opt,name=type,proto3,enum=samvaad.ProviderType" json:"type,omitempty"`
...
func (x *ProviderInfo) Reset() {
	*x = ProviderInfo{}
	mi := &file_samvaad_sip_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type SIPTrunkInfo struct {
	...
	Kind       SIPTrunkInfo_TrunkKind `protobuf:"varint,14,opt,name=kind,proto3,enum=samvaad.SIPTrunkInfo_TrunkKind" json:"kind,omitempty"`
	// CIDR or IPs that traffic is accepted from
	// An empty list means all inbound traffic is accepted.
	...
	Transport SIPTransport `protobuf:"varint,13,opt,name=transport,proto3,enum=samvaad.SIPTransport" json:"transport,omitempty"`
	// Deprecated: Marked as deprecated in samvaad_sip.proto.
...
func (x *SIPTrunkInfo) Reset() {
	*x = SIPTrunkInfo{}
	mi := &file_samvaad_sip_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *CreateSIPInboundTrunkRequest) Reset() {
	*x = CreateSIPInboundTrunkRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *UpdateSIPInboundTrunkRequest) Reset() {
	*x = UpdateSIPInboundTrunkRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type SIPInboundTrunkInfo struct {
	...
	// Numbers associated with Samvaad SIP. The Trunk will only accept calls made to these numbers.
	...
	// Map Samvaad attributes to SIP X-* headers when sending BYE or REFER requests.
	...
	IncludeHeaders SIPHeaderOptions `protobuf:"varint,15,opt,name=include_headers,json=includeHeaders,proto3,enum=samvaad.SIPHeaderOptions" json:"include_headers,omitempty"`
	...
	MediaEncryption SIPMediaEncryption     `protobuf:"varint,16,opt,name=media_encryption,json=mediaEncryption,proto3,enum=samvaad.SIPMediaEncryption" json:"media_encryption,omitempty"`
...
func (x *SIPInboundTrunkInfo) Reset() {
	*x = SIPInboundTrunkInfo{}
	mi := &file_samvaad_sip_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type SIPInboundTrunkUpdate struct {
	...
	MediaEncryption  *SIPMediaEncryption    `protobuf:"varint,8,opt,name=media_encryption,json=mediaEncryption,proto3,enum=samvaad.SIPMediaEncryption,oneof" json:"media_encryption,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *SIPInboundTrunkUpdate) Reset() {
	*x = SIPInboundTrunkUpdate{}
	mi := &file_samvaad_sip_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPInboundTrunkUpdate) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{9}
}
...
func (x *CreateSIPOutboundTrunkRequest) Reset() {
	*x = CreateSIPOutboundTrunkRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateSIPOutboundTrunkRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{10}
}
...
func (x *UpdateSIPOutboundTrunkRequest) Reset() {
	*x = UpdateSIPOutboundTrunkRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateSIPOutboundTrunkRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{11}
}
...
type SIPOutboundTrunkInfo struct {
	...
	// country where the call terminates as ISO 3166-1 alpha-2 (https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2). This will be used by the samvaad infrastructure to route calls.
	...
	Transport SIPTransport `protobuf:"varint,5,opt,name=transport,proto3,enum=samvaad.SIPTransport" json:"transport,omitempty"`
	...
	// These headers are sent as-is and may help identify this call as coming from Samvaad for the other SIP endpoint.
	Headers map[string]string `protobuf:"bytes,9,rep,name=headers,proto3" json:"headers,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	// lowercase header names should be used, for example: sip.h.x-custom-header.
	IncludeHeaders  SIPHeaderOptions   `protobuf:"varint,12,opt,name=include_headers,json=includeHeaders,proto3,enum=samvaad.SIPHeaderOptions" json:"include_headers,omitempty"`
	MediaEncryption SIPMediaEncryption `protobuf:"varint,13,opt,name=media_encryption,json=mediaEncryption,proto3,enum=samvaad.SIPMediaEncryption" json:"media_encryption,omitempty"`
...
func (x *SIPOutboundTrunkInfo) Reset() {
	*x = SIPOutboundTrunkInfo{}
	mi := &file_samvaad_sip_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPOutboundTrunkInfo) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{12}
}
...
type SIPOutboundTrunkUpdate struct {
	...
	Transport          *SIPTransport          `protobuf:"varint,2,opt,name=transport,proto3,enum=samvaad.SIPTransport,oneof" json:"transport,omitempty"`
...
func (x *SIPOutboundTrunkUpdate) Reset() {
	*x = SIPOutboundTrunkUpdate{}
	mi := &file_samvaad_sip_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPOutboundTrunkUpdate) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{13}
}
...
func (x *GetSIPInboundTrunkRequest) Reset() {
	*x = GetSIPInboundTrunkRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSIPInboundTrunkRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{14}
}
...
func (x *GetSIPInboundTrunkResponse) Reset() {
	*x = GetSIPInboundTrunkResponse{}
	mi := &file_samvaad_sip_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSIPInboundTrunkResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{15}
}
...
func (x *GetSIPOutboundTrunkRequest) Reset() {
	*x = GetSIPOutboundTrunkRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSIPOutboundTrunkRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{16}
}
...
func (x *GetSIPOutboundTrunkResponse) Reset() {
	*x = GetSIPOutboundTrunkResponse{}
	mi := &file_samvaad_sip_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSIPOutboundTrunkResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{17}
}
...
func (x *ListSIPTrunkRequest) Reset() {
	*x = ListSIPTrunkRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListSIPTrunkRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{18}
}
...
func (x *ListSIPTrunkResponse) Reset() {
	*x = ListSIPTrunkResponse{}
	mi := &file_samvaad_sip_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListSIPTrunkResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{19}
}
...
func (x *ListSIPInboundTrunkRequest) Reset() {
	*x = ListSIPInboundTrunkRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListSIPInboundTrunkRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{20}
}
...
func (x *ListSIPInboundTrunkResponse) Reset() {
	*x = ListSIPInboundTrunkResponse{}
	mi := &file_samvaad_sip_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListSIPInboundTrunkResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{21}
}
...
func (x *ListSIPOutboundTrunkRequest) Reset() {
	*x = ListSIPOutboundTrunkRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListSIPOutboundTrunkRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{22}
}
...
func (x *ListSIPOutboundTrunkResponse) Reset() {
	*x = ListSIPOutboundTrunkResponse{}
	mi := &file_samvaad_sip_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListSIPOutboundTrunkResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{23}
}
...
func (x *DeleteSIPTrunkRequest) Reset() {
	*x = DeleteSIPTrunkRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteSIPTrunkRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{24}
}
...
func (x *SIPDispatchRuleDirect) Reset() {
	*x = SIPDispatchRuleDirect{}
	mi := &file_samvaad_sip_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPDispatchRuleDirect) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{25}
}
...
func (x *SIPDispatchRuleIndividual) Reset() {
	*x = SIPDispatchRuleIndividual{}
	mi := &file_samvaad_sip_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPDispatchRuleIndividual) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{26}
}
...
func (x *SIPDispatchRuleCallee) Reset() {
	*x = SIPDispatchRuleCallee{}
	mi := &file_samvaad_sip_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPDispatchRuleCallee) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{27}
}
...
func (x *SIPDispatchRule) Reset() {
	*x = SIPDispatchRule{}
	mi := &file_samvaad_sip_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPDispatchRule) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{28}
}
...
func (x *CreateSIPDispatchRuleRequest) Reset() {
	*x = CreateSIPDispatchRuleRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateSIPDispatchRuleRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{29}
}
...
func (x *UpdateSIPDispatchRuleRequest) Reset() {
	*x = UpdateSIPDispatchRuleRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateSIPDispatchRuleRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{30}
}
...
type SIPDispatchRuleInfo struct {
	...
	Media        *SIPMediaConfig    `protobuf:"bytes,16,opt,name=media,proto3" json:"media,omitempty"`
	KrispEnabled bool               `protobuf:"varint,11,opt,name=krisp_enabled,json=krispEnabled,proto3" json:"krisp_enabled,omitempty"`
	// Deprecated: Marked as deprecated in samvaad_sip.proto.
	MediaEncryption SIPMediaEncryption     `protobuf:"varint,12,opt,name=media_encryption,json=mediaEncryption,proto3,enum=samvaad.SIPMediaEncryption" json:"media_encryption,omitempty"`
...
func (x *SIPDispatchRuleInfo) Reset() {
	*x = SIPDispatchRuleInfo{}
	mi := &file_samvaad_sip_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPDispatchRuleInfo) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{31}
}
...
type SIPDispatchRuleUpdate struct {
	...
	// Deprecated: Marked as deprecated in samvaad_sip.proto.
	MediaEncryption *SIPMediaEncryption `protobuf:"varint,6,opt,name=media_encryption,json=mediaEncryption,proto3,enum=samvaad.SIPMediaEncryption,oneof" json:"media_encryption,omitempty"`
	Media           *SIPMediaConfig     `protobuf:"bytes,7,opt,name=media,proto3" json:"media,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *SIPDispatchRuleUpdate) Reset() {
	*x = SIPDispatchRuleUpdate{}
	mi := &file_samvaad_sip_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPDispatchRuleUpdate) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{32}
}
...
func (x *ListSIPDispatchRuleRequest) Reset() {
	*x = ListSIPDispatchRuleRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListSIPDispatchRuleRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{33}
}
...
func (x *ListSIPDispatchRuleResponse) Reset() {
	*x = ListSIPDispatchRuleResponse{}
	mi := &file_samvaad_sip_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListSIPDispatchRuleResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{34}
}
...
func (x *DeleteSIPDispatchRuleRequest) Reset() {
	*x = DeleteSIPDispatchRuleRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteSIPDispatchRuleRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{35}
}
...
type SIPOutboundConfig struct {
	...
	// SIP Transport used for outbound call.
	Transport SIPTransport `protobuf:"varint,2,opt,name=transport,proto3,enum=samvaad.SIPTransport" json:"transport,omitempty"`
	// Username and password used to authenticate with SIP server.
	// May be empty to have no authentication.
...
func (x *SIPOutboundConfig) Reset() {
	*x = SIPOutboundConfig{}
	mi := &file_samvaad_sip_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPOutboundConfig) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{36}
}
...
// A SIP Participant is a singular SIP session connected to a Samvaad room via
...
type CreateSIPParticipantRequest struct {
	...
	// What Samvaad room should this participant be connected too
	RoomName string `protobuf:"bytes,3,opt,name=room_name,json=roomName,proto3" json:"room_name,omitempty"`
	// Optional identity of the participant in Samvaad room
	...
	// Optional name of the participant in Samvaad room
	...
	// When mapping 200 OK headers to follow-up request headers with attributes_to_headers map,
	// lowercase header names should be used, for example: sip.h.x-custom-header.
	IncludeHeaders SIPHeaderOptions `protobuf:"varint,17,opt,name=include_headers,json=includeHeaders,proto3,enum=samvaad.SIPHeaderOptions" json:"include_headers,omitempty"`
	...
	// Deprecated: Marked as deprecated in samvaad_sip.proto.
	MediaEncryption SIPMediaEncryption `protobuf:"varint,18,opt,name=media_encryption,json=mediaEncryption,proto3,enum=samvaad.SIPMediaEncryption" json:"media_encryption,omitempty"`
...
func (x *CreateSIPParticipantRequest) Reset() {
	*x = CreateSIPParticipantRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[37]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateSIPParticipantRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{37}
}
...
func (x *SIPParticipantInfo) Reset() {
	*x = SIPParticipantInfo{}
	mi := &file_samvaad_sip_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPParticipantInfo) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{38}
}
...
func (x *TransferSIPParticipantRequest) Reset() {
	*x = TransferSIPParticipantRequest{}
	mi := &file_samvaad_sip_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TransferSIPParticipantRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{39}
}
...
type SIPCallInfo struct {
	...
	EnabledFeatures  []SIPFeature     `protobuf:"varint,14,rep,packed,name=enabled_features,json=enabledFeatures,proto3,enum=samvaad.SIPFeature" json:"enabled_features,omitempty"`
	CallDirection    SIPCallDirection `protobuf:"varint,15,opt,name=call_direction,json=callDirection,proto3,enum=samvaad.SIPCallDirection" json:"call_direction,omitempty"`
	CallStatus       SIPCallStatus    `protobuf:"varint,8,opt,name=call_status,json=callStatus,proto3,enum=samvaad.SIPCallStatus" json:"call_status,omitempty"`
	...
	DisconnectReason DisconnectReason `protobuf:"varint,12,opt,name=disconnect_reason,json=disconnectReason,proto3,enum=samvaad.DisconnectReason" json:"disconnect_reason,omitempty"`
...
func (x *SIPCallInfo) Reset() {
	*x = SIPCallInfo{}
	mi := &file_samvaad_sip_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPCallInfo) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{40}
}
...
type SIPTransferInfo struct {
	...
	TransferStatus        SIPTransferStatus      `protobuf:"varint,6,opt,name=transfer_status,json=transferStatus,proto3,enum=samvaad.SIPTransferStatus" json:"transfer_status,omitempty"`
...
func (x *SIPTransferInfo) Reset() {
	*x = SIPTransferInfo{}
	mi := &file_samvaad_sip_proto_msgTypes[41]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPTransferInfo) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{41}
}
...
func (x *SIPUri) Reset() {
	*x = SIPUri{}
	mi := &file_samvaad_sip_proto_msgTypes[42]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SIPUri) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{42}
}
...
func (x *Destination) Reset() {
	*x = Destination{}
	mi := &file_samvaad_sip_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Destination) Descriptor() ([]byte, []int) {
	return file_samvaad_sip_proto_rawDescGZIP(), []int{43}
}
...
var File_samvaad_sip_proto protoreflect.FileDescriptor

const file_samvaad_sip_proto_rawDesc = "" +
	"\n" +
	"\x11\x6c\x69\x76\x65\x6b\x69\x74_sip.proto\x12\a\x6c\x69\x76\x65\x6b\x69\x74\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x14\x6c\x69\x76\x65\x6b\x69\x74_models.proto\x1a\x12\x6c\x69\x76\x65\x6b\x69\x74_room.proto\x1a\x14logger/options.proto\"O\n" +
	"\tSIPStatus\x12*\n" +
	"\x04code\x18\x01 \x01(\x0e2\x16.\x6c\x69\x76\x65\x6b\x69\x74.SIPStatusCodeR\x04code\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\"\x97\x04\n" +
	...
	"\x10inbound_username\x18\x05 \x01(\tB\x03\xa8P\x01R\x0finboundUsername\x12.\n" +
	"\x10inbound_password\x18\x06 \x01(\tB\x03\xa8P\x01R\x0finboundPassword\x120\n" +
	"\x11outbound_username\x18\a \x01(\tB\x03\xa8P\x01R\x10outboundUsername\x120\n" +
	"\x11outbound_password\x18\b \x01(\tB\x03\xa8P\x01R\x10outboundPassword\x12\x12\n" +
	"\x04name\x18\n" +
	" \x01(\tR\x04name\x12@\n" +
	"\bmetadata\x18\v \x01(\tB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\bmetadata:\x02\x18\x01\"2\n" +
	"\bSIPCodec\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04rate\x18\x02 \x01(\rR\x04rate\"\x91\x02\n" +
	"\x0eSIPMediaConfig\x12,\n" +
	"\x12only_listed_codecs\x18\x01 \x01(\bR\x10onlyListedCodecs\x12)\n" +
	"\x06codecs\x18\x02 \x03(\v2\x11.\x6c\x69\x76\x65\x6b\x69\x74.SIPCodecR\x06codecs\x12@\n" +
	"\n" +
	"encryption\x18\x03 \x01(\x0e2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SIPMediaEncryptionH\x00R\n" +
	"encryption\x88\x01\x01\x12C\n" +
	"\rmedia_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationH\x01R\fmediaTimeout\x88\x01\x01B\r\n" +
	"\v_encryptionB\x10\n" +
	"\x0e_media_timeout\"\x88\x01\n" +
	"\fProviderInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12)\n" +
	"\x04type\x18\x03 \x01(\x0e2\x15.\x6c\x69\x76\x65\x6b\x69\x74.ProviderTypeR\x04type\x12)\n" +
	"\x10prevent_transfer\x18\x04 \x01(\bR\x0fpreventTransfer\"\xef\x05\n" +
	"\fSIPTrunkInfo\x12/\n" +
	"\fsip_trunk_id\x18\x01 \x01(\tB\r\xbaP\n" +
	"sipTrunkIDR\n" +
	"sipTrunkId\x123\n" +
	"\x04kind\x18\x0e \x01(\x0e2\x1f.\x6c\x69\x76\x65\x6b\x69\x74.SIPTrunkInfo.TrunkKindR\x04kind\x12+\n" +
	...
	"\ttransport\x18\r \x01(\x0e2\x15.\x6c\x69\x76\x65\x6b\x69\x74.SIPTransportR\ttransport\x126\n" +
	...
	"\x10inbound_username\x18\x06 \x01(\tB\x03\xa8P\x01R\x0finboundUsername\x12.\n" +
	"\x10inbound_password\x18\a \x01(\tB\x03\xa8P\x01R\x0finboundPassword\x120\n" +
	"\x11outbound_username\x18\b \x01(\tB\x03\xa8P\x01R\x10outboundUsername\x120\n" +
	"\x11outbound_password\x18\t \x01(\tB\x03\xa8P\x01R\x10outboundPassword\x12\x12\n" +
	"\x04name\x18\v \x01(\tR\x04name\x12@\n" +
	"\bmetadata\x18\f \x01(\tB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\bmetadata\"D\n" +
	"\tTrunkKind\x12\x10\n" +
	...
	"\x05trunk\x18\x01 \x01(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.SIPInboundTrunkInfoR\x05trunk\"\xcd\x01\n" +
	"\x1cUpdateSIPInboundTrunkRequest\x12/\n" +
	"\fsip_trunk_id\x18\x01 \x01(\tB\r\xbaP\n" +
	"sipTrunkIDR\n" +
	"sipTrunkId\x128\n" +
	"\areplace\x18\x02 \x01(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.SIPInboundTrunkInfoH\x00R\areplace\x128\n" +
	"\x06update\x18\x03 \x01(\v2\x1e.\x6c\x69\x76\x65\x6b\x69\x74.SIPInboundTrunkUpdateH\x00R\x06updateB\b\n" +
	"\x06action\"\xbe\n" +
	"\n" +
	...
	"sipTrunkId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12@\n" +
	"\bmetadata\x18\x03 \x01(\tB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\bmetadata\x12\x18\n" +
	...
	"\aheaders\x18\t \x03(\v2).\x6c\x69\x76\x65\x6b\x69\x74.SIPInboundTrunkInfo.HeadersEntryB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\aheaders\x12i\n" +
	"\x15headers_to_attributes\x18\n" +
	" \x03(\v25.\x6c\x69\x76\x65\x6b\x69\x74.SIPInboundTrunkInfo.HeadersToAttributesEntryR\x13headersToAttributes\x12i\n" +
	"\x15attributes_to_headers\x18\x0e \x03(\v25.\x6c\x69\x76\x65\x6b\x69\x74.SIPInboundTrunkInfo.AttributesToHeadersEntryR\x13attributesToHeaders\x12B\n" +
	"\x0finclude_headers\x18\x0f \x01(\x0e2\x19.\x6c\x69\x76\x65\x6b\x69\x74.SIPHeaderOptionsR\x0eincludeHeaders\x12B\n" +
	...
	"\x10media_encryption\x18\x10 \x01(\x0e2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SIPMediaEncryptionR\x0fmediaEncryption\x129\n" +
	"\n" +
	...
	"\anumbers\x18\x01 \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.ListUpdateR\anumbers\x12@\n" +
	"\x11allowed_addresses\x18\x02 \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.ListUpdateR\x10allowedAddresses\x12<\n" +
	"\x0fallowed_numbers\x18\x03 \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.ListUpdateR\x0eallowedNumbers\x12-\n" +
	...
	"\x10media_encryption\x18\b \x01(\x0e2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SIPMediaEncryptionH\x05R\x0fmediaEncryption\x88\x01\x01B\x10\n" +
	...
	"\x05trunk\x18\x01 \x01(\v2\x1d.\x6c\x69\x76\x65\x6b\x69\x74.SIPOutboundTrunkInfoR\x05trunk\"\xd0\x01\n" +
	"\x1dUpdateSIPOutboundTrunkRequest\x12/\n" +
	"\fsip_trunk_id\x18\x01 \x01(\tB\r\xbaP\n" +
	"sipTrunkIDR\n" +
	"sipTrunkId\x129\n" +
	"\areplace\x18\x02 \x01(\v2\x1d.\x6c\x69\x76\x65\x6b\x69\x74.SIPOutboundTrunkInfoH\x00R\areplace\x129\n" +
	"\x06update\x18\x03 \x01(\v2\x1f.\x6c\x69\x76\x65\x6b\x69\x74.SIPOutboundTrunkUpdateH\x00R\x06updateB\b\n" +
	"\x06action\"\xba\t\n" +
	...
	"\ttransport\x18\x05 \x01(\x0e2\x15.\x6c\x69\x76\x65\x6b\x69\x74.SIPTransportR\ttransport\x12\x18\n" +
	"\anumbers\x18\x06 \x03(\tR\anumbers\x12(\n" +
	"\rauth_username\x18\a \x01(\tB\x03\xa8P\x01R\fauthUsername\x12(\n" +
	"\rauth_password\x18\b \x01(\tB\x03\xa8P\x01R\fauthPassword\x12j\n" +
	"\aheaders\x18\t \x03(\v2*.\x6c\x69\x76\x65\x6b\x69\x74.SIPOutboundTrunkInfo.HeadersEntryB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\aheaders\x12j\n" +
	"\x15headers_to_attributes\x18\n" +
	" \x03(\v26.\x6c\x69\x76\x65\x6b\x69\x74.SIPOutboundTrunkInfo.HeadersToAttributesEntryR\x13headersToAttributes\x12j\n" +
	"\x15attributes_to_headers\x18\v \x03(\v26.\x6c\x69\x76\x65\x6b\x69\x74.SIPOutboundTrunkInfo.AttributesToHeadersEntryR\x13attributesToHeaders\x12B\n" +
	"\x0finclude_headers\x18\f \x01(\x0e2\x19.\x6c\x69\x76\x65\x6b\x69\x74.SIPHeaderOptionsR\x0eincludeHeaders\x12F\n" +
	"\x10media_encryption\x18\r \x01(\x0e2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SIPMediaEncryptionR\x0fmediaEncryption\x12\x1b\n" +
	"\tfrom_host\x18\x0f \x01(\tR\bfromHost\x129\n" +
	"\n" +
	...
	"\ttransport\x18\x02 \x01(\x0e2\x15.\x6c\x69\x76\x65\x6b\x69\x74.SIPTransportH\x01R\ttransport\x88\x01\x01\x124\n" +
	"\x13destination_country\x18\t \x01(\tH\x02R\x12destinationCountry\x88\x01\x01\x12-\n" +
	"\anumbers\x18\x03 \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.ListUpdateR\anumbers\x12-\n" +
	"\rauth_username\x18\x04 \x01(\tB\x03\xa8P\x01H\x03R\fauthUsername\x88\x01\x01\x12-\n" +
	"\rauth_password\x18\x05 \x01(\tB\x03\xa8P\x01H\x04R\fauthPassword\x88\x01\x01\x12\x17\n" +
	"\x04name\x18\x06 \x01(\tH\x05R\x04name\x88\x01\x01\x12E\n" +
	"\bmetadata\x18\a \x01(\tB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>H\x06R\bmetadata\x88\x01\x01\x12K\n" +
	"\x10media_encryption\x18\b \x01(\x0e2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SIPMediaEncryptionH\aR\x0fmediaEncryption\x88\x01\x01\x12 \n" +
	"\tfrom_host\x18\n" +
	...
	"\x05trunk\x18\x01 \x01(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.SIPInboundTrunkInfoR\x05trunk\"M\n" +
	"\x1aGetSIPOutboundTrunkRequest\x12/\n" +
	"\fsip_trunk_id\x18\x01 \x01(\tB\r\xbaP\n" +
	"sipTrunkIDR\n" +
	"sipTrunkId\"R\n" +
	"\x1bGetSIPOutboundTrunkResponse\x123\n" +
	"\x05trunk\x18\x01 \x01(\v2\x1d.\x6c\x69\x76\x65\x6b\x69\x74.SIPOutboundTrunkInfoR\x05trunk\"B\n" +
	"\x13ListSIPTrunkRequest\x12'\n" +
	"\x04page\x18\x01 \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.PaginationR\x04page:\x02\x18\x01\"G\n" +
	"\x14ListSIPTrunkResponse\x12+\n" +
	"\x05items\x18\x01 \x03(\v2\x15.\x6c\x69\x76\x65\x6b\x69\x74.SIPTrunkInfoR\x05items:\x02\x18\x01\"|\n" +
	"\x1aListSIPInboundTrunkRequest\x12'\n" +
	"\x04page\x18\x03 \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.PaginationR\x04page\x12\x1b\n" +
	"\ttrunk_ids\x18\x01 \x03(\tR\btrunkIds\x12\x18\n" +
	"\anumbers\x18\x02 \x03(\tR\anumbers\"Q\n" +
	"\x1bListSIPInboundTrunkResponse\x122\n" +
	"\x05items\x18\x01 \x03(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.SIPInboundTrunkInfoR\x05items\"}\n" +
	"\x1bListSIPOutboundTrunkRequest\x12'\n" +
	"\x04page\x18\x03 \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.PaginationR\x04page\x12\x1b\n" +
	"\ttrunk_ids\x18\x01 \x03(\tR\btrunkIds\x12\x18\n" +
	"\anumbers\x18\x02 \x03(\tR\anumbers\"S\n" +
	"\x1cListSIPOutboundTrunkResponse\x123\n" +
	"\x05items\x18\x01 \x03(\v2\x1d.\x6c\x69\x76\x65\x6b\x69\x74.SIPOutboundTrunkInfoR\x05items\"H\n" +
	...
	"\x14dispatch_rule_direct\x18\x01 \x01(\v2\x1e.\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleDirectH\x00R\x12dispatchRuleDirect\x12^\n" +
	"\x18dispatch_rule_individual\x18\x02 \x01(\v2\".\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleIndividualH\x00R\x16dispatchRuleIndividual\x12R\n" +
	"\x14dispatch_rule_callee\x18\x03 \x01(\v2\x1e.\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleCalleeH\x00R\x12dispatchRuleCalleeB\x06\n" +
	"\x04rule\"\x91\x05\n" +
	"\x1cCreateSIPDispatchRuleRequest\x12A\n" +
	"\rdispatch_rule\x18\n" +
	" \x01(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleInfoR\fdispatchRule\x120\n" +
	"\x04rule\x18\x01 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleB\x02\x18\x01R\x04rule\x12\x1f\n" +
	...
	"\x04name\x18\x04 \x01(\tB\x02\x18\x01R\x04name\x12B\n" +
	"\bmetadata\x18\x05 \x01(\tB&\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>\x18\x01R\bmetadata\x12}\n" +
	"\n" +
	"attributes\x18\a \x03(\v25.\x6c\x69\x76\x65\x6b\x69\x74.CreateSIPDispatchRuleRequest.AttributesEntryB&\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>\x18\x01R\n" +
	"attributes\x12#\n" +
	"\vroom_preset\x18\b \x01(\tB\x02\x18\x01R\n" +
	"roomPreset\x12?\n" +
	"\vroom_config\x18\t \x01(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.RoomConfigurationB\x02\x18\x01R\n" +
	"roomConfig\x1a=\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xe3\x01\n" +
	"\x1cUpdateSIPDispatchRuleRequest\x12E\n" +
	"\x14sip_dispatch_rule_id\x18\x01 \x01(\tB\x14\xbaP\x11sipDispatchRuleIDR\x11sipDispatchRuleId\x128\n" +
	"\areplace\x18\x02 \x01(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleInfoH\x00R\areplace\x128\n" +
	"\x06update\x18\x03 \x01(\v2\x1e.\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleUpdateH\x00R\x06updateB\b\n" +
	"\x06action\"\x93\a\n" +
	"\x13SIPDispatchRuleInfo\x12E\n" +
	"\x14sip_dispatch_rule_id\x18\x01 \x01(\tB\x14\xbaP\x11sipDispatchRuleIDR\x11sipDispatchRuleId\x12,\n" +
	"\x04rule\x18\x02 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleR\x04rule\x12\x1b\n" +
	...
	"\bmetadata\x18\x06 \x01(\tB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\bmetadata\x12r\n" +
	"\n" +
	"attributes\x18\b \x03(\v2,.\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleInfo.AttributesEntryB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\n" +
	"attributes\x12\x1f\n" +
	"\vroom_preset\x18\t \x01(\tR\n" +
	"roomPreset\x12;\n" +
	"\vroom_config\x18\n" +
	" \x01(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.RoomConfigurationR\n" +
	"roomConfig\x12-\n" +
	"\x05media\x18\x10 \x01(\v2\x17.\x6c\x69\x76\x65\x6b\x69\x74.SIPMediaConfigR\x05media\x12#\n" +
	"\rkrisp_enabled\x18\v \x01(\bR\fkrispEnabled\x12J\n" +
	"\x10media_encryption\x18\f \x01(\x0e2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SIPMediaEncryptionB\x02\x18\x01R\x0fmediaEncryption\x129\n" +
	"\n" +
	...
	"\ttrunk_ids\x18\x01 \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.ListUpdateR\btrunkIds\x12,\n" +
	"\x04rule\x18\x02 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleR\x04rule\x12\x17\n" +
	"\x04name\x18\x03 \x01(\tH\x00R\x04name\x88\x01\x01\x12E\n" +
	"\bmetadata\x18\x04 \x01(\tB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>H\x01R\bmetadata\x88\x01\x01\x12t\n" +
	"\n" +
	"attributes\x18\x05 \x03(\v2..\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleUpdate.AttributesEntryB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\n" +
	"attributes\x12O\n" +
	"\x10media_encryption\x18\x06 \x01(\x0e2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SIPMediaEncryptionB\x02\x18\x01H\x02R\x0fmediaEncryption\x88\x01\x01\x12-\n" +
	"\x05media\x18\a \x01(\v2\x17.\x6c\x69\x76\x65\x6b\x69\x74.SIPMediaConfigR\x05media\x1a=\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x04page\x18\x03 \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.PaginationR\x04page\x12*\n" +
	...
	"\x05items\x18\x01 \x03(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleInfoR\x05items\"e\n" +
	"\x1cDeleteSIPDispatchRuleRequest\x12E\n" +
	"\x14sip_dispatch_rule_id\x18\x01 \x01(\tB\x14\xbaP\x11sipDispatchRuleIDR\x11sipDispatchRuleId\"\xe8\x04\n" +
	"\x11SIPOutboundConfig\x12\x1a\n" +
	"\bhostname\x18\x01 \x01(\tR\bhostname\x12/\n" +
	"\x13destination_country\x18\a \x01(\tR\x12destinationCountry\x123\n" +
	"\ttransport\x18\x02 \x01(\x0e2\x15.\x6c\x69\x76\x65\x6b\x69\x74.SIPTransportR\ttransport\x12(\n" +
	"\rauth_username\x18\x03 \x01(\tB\x03\xa8P\x01R\fauthUsername\x12(\n" +
	"\rauth_password\x18\x04 \x01(\tB\x03\xa8P\x01R\fauthPassword\x12g\n" +
	"\x15headers_to_attributes\x18\x05 \x03(\v23.\x6c\x69\x76\x65\x6b\x69\x74.SIPOutboundConfig.HeadersToAttributesEntryR\x13headersToAttributes\x12g\n" +
	"\x15attributes_to_headers\x18\x06 \x03(\v23.\x6c\x69\x76\x65\x6b\x69\x74.SIPOutboundConfig.AttributesToHeadersEntryR\x13attributesToHeaders\x12\x1b\n" +
	...
	"sipTrunkIDR\n" +
	"sipTrunkId\x120\n" +
	"\x05trunk\x18\x14 \x01(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.SIPOutboundConfigR\x05trunk\x12\x1e\n" +
	...
	"\x14participant_identity\x18\x04 \x01(\tR\x13participantIdentity\x12O\n" +
	"\x10participant_name\x18\a \x01(\tB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\x0fparticipantName\x12W\n" +
	"\x14participant_metadata\x18\b \x01(\tB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\x13participantMetadata\x12\x9c\x01\n" +
	"\x16participant_attributes\x18\t \x03(\v2?.\x6c\x69\x76\x65\x6b\x69\x74.CreateSIPParticipantRequest.ParticipantAttributesEntryB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\x15participantAttributes\x12\x12\n" +
	...
	" \x01(\bR\x0fhidePhoneNumber\x12q\n" +
	"\aheaders\x18\x10 \x03(\v21.\x6c\x69\x76\x65\x6b\x69\x74.CreateSIPParticipantRequest.HeadersEntryB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\aheaders\x12B\n" +
	"\x0finclude_headers\x18\x11 \x01(\x0e2\x19.\x6c\x69\x76\x65\x6b\x69\x74.SIPHeaderOptionsR\x0eincludeHeaders\x12B\n" +
	"\x0fringing_timeout\x18\v \x01(\v2\x19.google.protobuf.DurationR\x0eringingTimeout\x12E\n" +
	"\x11max_call_duration\x18\f \x01(\v2\x19.google.protobuf.DurationR\x0fmaxCallDuration\x12#\n" +
	"\rkrisp_enabled\x18\x0e \x01(\bR\fkrispEnabled\x12J\n" +
	"\x10media_encryption\x18\x12 \x01(\x0e2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SIPMediaEncryptionB\x02\x18\x01R\x0fmediaEncryption\x12-\n" +
	"\x05media\x18\x17 \x01(\v2\x17.\x6c\x69\x76\x65\x6b\x69\x74.SIPMediaConfigR\x05media\x12.\n" +
	"\x13wait_until_answered\x18\x13 \x01(\bR\x11waitUntilAnswered\x12L\n" +
	"\fdisplay_name\x18\x15 \x01(\tB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>H\x00R\vdisplayName\x88\x01\x01\x12;\n" +
	"\vdestination\x18\x16 \x01(\v2\x14.\x6c\x69\x76\x65\x6b\x69\x74.DestinationH\x01R\vdestination\x88\x01\x01\x1aH\n" +
	...
	"\r_display_nameB\x0e\n" +
	"\f_destination\"\xcb\x01\n" +
	"\x12SIPParticipantInfo\x127\n" +
	...
	"\vsip_call_id\x18\x04 \x01(\tB\f\xbaP\tsipCallIDR\tsipCallId\"\xaa\x03\n" +
	...
	"transferTo\x12#\n" +
	"\rplay_dialtone\x18\x04 \x01(\bR\fplayDialtone\x12s\n" +
	"\aheaders\x18\x05 \x03(\v23.\x6c\x69\x76\x65\x6b\x69\x74.TransferSIPParticipantRequest.HeadersEntryB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\aheaders\x12B\n" +
	"\x0fringing_timeout\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\x0eringingTimeout\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x87\v\n" +
	"\vSIPCallInfo\x12\"\n" +
	"\acall_id\x18\x01 \x01(\tB\t\xbaP\x06callIDR\x06callId\x12%\n" +
	"\btrunk_id\x18\x02 \x01(\tB\n" +
	"\xbaP\atrunkIDR\atrunkId\x12;\n" +
	"\x10dispatch_rule_id\x18\x10 \x01(\tB\x11\xbaP\x0edispatchRuleIDR\x0edispatchRuleId\x12\x16\n" +
	"\x06region\x18\x11 \x01(\tR\x06region\x12\x1b\n" +
	"\troom_name\x18\x03 \x01(\tR\broomName\x12\"\n" +
	"\aroom_id\x18\x04 \x01(\tB\t\xbaP\x06roomIDR\x06roomId\x121\n" +
	"\x14participant_identity\x18\x05 \x01(\tR\x13participantIdentity\x12\x8c\x01\n" +
	"\x16participant_attributes\x18\x12 \x03(\v2/.\x6c\x69\x76\x65\x6b\x69\x74.SIPCallInfo.ParticipantAttributesEntryB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\x15participantAttributes\x12*\n" +
	"\bfrom_uri\x18\x06 \x01(\v2\x0f.\x6c\x69\x76\x65\x6b\x69\x74.SIPUriR\afromUri\x12&\n" +
	"\x06to_uri\x18\a \x01(\v2\x0f.\x6c\x69\x76\x65\x6b\x69\x74.SIPUriR\x05toUri\x12!\n" +
	"\n" +
	...
	"\x10enabled_features\x18\x0e \x03(\x0e2\x13.\x6c\x69\x76\x65\x6b\x69\x74.SIPFeatureR\x0fenabledFeatures\x12@\n" +
	"\x0ecall_direction\x18\x0f \x01(\x0e2\x19.\x6c\x69\x76\x65\x6b\x69\x74.SIPCallDirectionR\rcallDirection\x127\n" +
	"\vcall_status\x18\b \x01(\x0e2\x16.\x6c\x69\x76\x65\x6b\x69\x74.SIPCallStatusR\n" +
	"callStatus\x12\"\n" +
	...
	"\x11disconnect_reason\x18\f \x01(\x0e2\x19.\x6c\x69\x76\x65\x6b\x69\x74.DisconnectReasonR\x10disconnectReason\x12\x14\n" +
	"\x05error\x18\r \x01(\tR\x05error\x12<\n" +
	"\x10call_status_code\x18\x13 \x01(\v2\x12.\x6c\x69\x76\x65\x6b\x69\x74.SIPStatusR\x0ecallStatusCode\x12\x1f\n" +
	...
	"\rprovider_info\x18\x1b \x01(\v2\x15.\x6c\x69\x76\x65\x6b\x69\x74.ProviderInfoR\fproviderInfo\x12,\n" +
	"\vsip_call_id\x18\x1c \x01(\tB\f\xbaP\tsipCallIDR\tsipCallId\x1aH\n" +
	"\x1aParticipantAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"transferIDR\n" +
	"transferId\x12\"\n" +
	"\acall_id\x18\x02 \x01(\tB\t\xbaP\x06callIDR\x06callId\x12\x1f\n" +
	"\vtransfer_to\x18\x03 \x01(\tR\n" +
	"transferTo\x127\n" +
	...
	"\x0ftransfer_status\x18\x06 \x01(\x0e2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.SIPTransferStatusR\x0etransferStatus\x12\x14\n" +
	"\x05error\x18\a \x01(\tR\x05error\x12D\n" +
	"\x14transfer_status_code\x18\b \x01(\v2\x12.\x6c\x69\x76\x65\x6b\x69\x74.SIPStatusR\x12transferStatusCode\"\x89\x01\n" +
	"\x06SIPUri\x12\x12\n" +
	"\x04user\x18\x01 \x01(\tR\x04user\x12\x12\n" +
	"\x04host\x18\x02 \x01(\tR\x04host\x12\x0e\n" +
	"\x02ip\x18\x03 \x01(\tR\x02ip\x12\x12\n" +
	"\x04port\x18\x04 \x01(\rR\x04port\x123\n" +
	"\ttransport\x18\x05 \x01(\x0e2\x15.\x6c\x69\x76\x65\x6b\x69\x74.SIPTransportR\ttransport\"S\n" +
	...
	"\x03SIP\x12P\n" +
	"\fListSIPTrunk\x12\x1c.\x6c\x69\x76\x65\x6b\x69\x74.ListSIPTrunkRequest\x1a\x1d.\x6c\x69\x76\x65\x6b\x69\x74.ListSIPTrunkResponse\"\x03\x88\x02\x01\x12\\\n" +
	"\x15CreateSIPInboundTrunk\x12%.\x6c\x69\x76\x65\x6b\x69\x74.CreateSIPInboundTrunkRequest\x1a\x1c.\x6c\x69\x76\x65\x6b\x69\x74.SIPInboundTrunkInfo\x12_\n" +
	"\x16CreateSIPOutboundTrunk\x12&.\x6c\x69\x76\x65\x6b\x69\x74.CreateSIPOutboundTrunkRequest\x1a\x1d.\x6c\x69\x76\x65\x6b\x69\x74.SIPOutboundTrunkInfo\x12\\\n" +
	"\x15UpdateSIPInboundTrunk\x12%.\x6c\x69\x76\x65\x6b\x69\x74.UpdateSIPInboundTrunkRequest\x1a\x1c.\x6c\x69\x76\x65\x6b\x69\x74.SIPInboundTrunkInfo\x12_\n" +
	"\x16UpdateSIPOutboundTrunk\x12&.\x6c\x69\x76\x65\x6b\x69\x74.UpdateSIPOutboundTrunkRequest\x1a\x1d.\x6c\x69\x76\x65\x6b\x69\x74.SIPOutboundTrunkInfo\x12]\n" +
	"\x12GetSIPInboundTrunk\x12\".\x6c\x69\x76\x65\x6b\x69\x74.GetSIPInboundTrunkRequest\x1a#.\x6c\x69\x76\x65\x6b\x69\x74.GetSIPInboundTrunkResponse\x12`\n" +
	"\x13GetSIPOutboundTrunk\x12#.\x6c\x69\x76\x65\x6b\x69\x74.GetSIPOutboundTrunkRequest\x1a$.\x6c\x69\x76\x65\x6b\x69\x74.GetSIPOutboundTrunkResponse\x12`\n" +
	"\x13ListSIPInboundTrunk\x12#.\x6c\x69\x76\x65\x6b\x69\x74.ListSIPInboundTrunkRequest\x1a$.\x6c\x69\x76\x65\x6b\x69\x74.ListSIPInboundTrunkResponse\x12c\n" +
	"\x14ListSIPOutboundTrunk\x12$.\x6c\x69\x76\x65\x6b\x69\x74.ListSIPOutboundTrunkRequest\x1a%.\x6c\x69\x76\x65\x6b\x69\x74.ListSIPOutboundTrunkResponse\x12G\n" +
	"\x0eDeleteSIPTrunk\x12\x1e.\x6c\x69\x76\x65\x6b\x69\x74.DeleteSIPTrunkRequest\x1a\x15.\x6c\x69\x76\x65\x6b\x69\x74.SIPTrunkInfo\x12\\\n" +
	"\x15CreateSIPDispatchRule\x12%.\x6c\x69\x76\x65\x6b\x69\x74.CreateSIPDispatchRuleRequest\x1a\x1c.\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleInfo\x12\\\n" +
	"\x15UpdateSIPDispatchRule\x12%.\x6c\x69\x76\x65\x6b\x69\x74.UpdateSIPDispatchRuleRequest\x1a\x1c.\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleInfo\x12`\n" +
	"\x13ListSIPDispatchRule\x12#.\x6c\x69\x76\x65\x6b\x69\x74.ListSIPDispatchRuleRequest\x1a$.\x6c\x69\x76\x65\x6b\x69\x74.ListSIPDispatchRuleResponse\x12\\\n" +
	"\x15DeleteSIPDispatchRule\x12%.\x6c\x69\x76\x65\x6b\x69\x74.DeleteSIPDispatchRuleRequest\x1a\x1c.\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleInfo\x12Y\n" +
	"\x14CreateSIPParticipant\x12$.\x6c\x69\x76\x65\x6b\x69\x74.CreateSIPParticipantRequest\x1a\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SIPParticipantInfo\x12X\n" +
	"\x16TransferSIPParticipant\x12&.\x6c\x69\x76\x65\x6b\x69\x74.TransferSIPParticipantRequest\x1a\x16.google.protobuf.EmptyBFZ#github.com/\x6c\x69\x76\x65\x6b\x69\x74/protocol/\x6c\x69\x76\x65\x6b\x69\x74\xaa\x02\r\x4c\x69\x76\x65\x4b\x69\x74.Proto\xea\x02\x0e\x4c\x69\x76\x65\x4b\x69\x74::Protob\x06proto3"

var (
	file_samvaad_sip_proto_rawDescOnce sync.Once
	file_samvaad_sip_proto_rawDescData []byte
)

func file_samvaad_sip_proto_rawDescGZIP() []byte {
	file_samvaad_sip_proto_rawDescOnce.Do(func() {
		file_samvaad_sip_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_samvaad_sip_proto_rawDesc), len(file_samvaad_sip_proto_rawDesc)))
	})
	return file_samvaad_sip_proto_rawDescData
}

var file_samvaad_sip_proto_enumTypes = make([]protoimpl.EnumInfo, 10)
var file_samvaad_sip_proto_msgTypes = make([]protoimpl.MessageInfo, 59)
var file_samvaad_sip_proto_goTypes = []any{
	(SIPStatusCode)(0),                    // 0: samvaad.SIPStatusCode
	(SIPTransport)(0),                     // 1: samvaad.SIPTransport
	(SIPHeaderOptions)(0),                 // 2: samvaad.SIPHeaderOptions
	(SIPMediaEncryption)(0),               // 3: samvaad.SIPMediaEncryption
	(ProviderType)(0),                     // 4: samvaad.ProviderType
	(SIPCallStatus)(0),                    // 5: samvaad.SIPCallStatus
	(SIPTransferStatus)(0),                // 6: samvaad.SIPTransferStatus
	(SIPFeature)(0),                       // 7: samvaad.SIPFeature
	(SIPCallDirection)(0),                 // 8: samvaad.SIPCallDirection
	(SIPTrunkInfo_TrunkKind)(0),           // 9: samvaad.SIPTrunkInfo.TrunkKind
	(*SIPStatus)(nil),                     // 10: samvaad.SIPStatus
	(*CreateSIPTrunkRequest)(nil),         // 11: samvaad.CreateSIPTrunkRequest
	(*SIPCodec)(nil),                      // 12: samvaad.SIPCodec
	(*SIPMediaConfig)(nil),                // 13: samvaad.SIPMediaConfig
	(*ProviderInfo)(nil),                  // 14: samvaad.ProviderInfo
	(*SIPTrunkInfo)(nil),                  // 15: samvaad.SIPTrunkInfo
	(*CreateSIPInboundTrunkRequest)(nil),  // 16: samvaad.CreateSIPInboundTrunkRequest
	(*UpdateSIPInboundTrunkRequest)(nil),  // 17: samvaad.UpdateSIPInboundTrunkRequest
	(*SIPInboundTrunkInfo)(nil),           // 18: samvaad.SIPInboundTrunkInfo
	(*SIPInboundTrunkUpdate)(nil),         // 19: samvaad.SIPInboundTrunkUpdate
	(*CreateSIPOutboundTrunkRequest)(nil), // 20: samvaad.CreateSIPOutboundTrunkRequest
	(*UpdateSIPOutboundTrunkRequest)(nil), // 21: samvaad.UpdateSIPOutboundTrunkRequest
	(*SIPOutboundTrunkInfo)(nil),          // 22: samvaad.SIPOutboundTrunkInfo
	(*SIPOutboundTrunkUpdate)(nil),        // 23: samvaad.SIPOutboundTrunkUpdate
	(*GetSIPInboundTrunkRequest)(nil),     // 24: samvaad.GetSIPInboundTrunkRequest
	(*GetSIPInboundTrunkResponse)(nil),    // 25: samvaad.GetSIPInboundTrunkResponse
	(*GetSIPOutboundTrunkRequest)(nil),    // 26: samvaad.GetSIPOutboundTrunkRequest
	(*GetSIPOutboundTrunkResponse)(nil),   // 27: samvaad.GetSIPOutboundTrunkResponse
	(*ListSIPTrunkRequest)(nil),           // 28: samvaad.ListSIPTrunkRequest
	(*ListSIPTrunkResponse)(nil),          // 29: samvaad.ListSIPTrunkResponse
	(*ListSIPInboundTrunkRequest)(nil),    // 30: samvaad.ListSIPInboundTrunkRequest
	(*ListSIPInboundTrunkResponse)(nil),   // 31: samvaad.ListSIPInboundTrunkResponse
	(*ListSIPOutboundTrunkRequest)(nil),   // 32: samvaad.ListSIPOutboundTrunkRequest
	(*ListSIPOutboundTrunkResponse)(nil),  // 33: samvaad.ListSIPOutboundTrunkResponse
	(*DeleteSIPTrunkRequest)(nil),         // 34: samvaad.DeleteSIPTrunkRequest
	(*SIPDispatchRuleDirect)(nil),         // 35: samvaad.SIPDispatchRuleDirect
	(*SIPDispatchRuleIndividual)(nil),     // 36: samvaad.SIPDispatchRuleIndividual
	(*SIPDispatchRuleCallee)(nil),         // 37: samvaad.SIPDispatchRuleCallee
	(*SIPDispatchRule)(nil),               // 38: samvaad.SIPDispatchRule
	(*CreateSIPDispatchRuleRequest)(nil),  // 39: samvaad.CreateSIPDispatchRuleRequest
	(*UpdateSIPDispatchRuleRequest)(nil),  // 40: samvaad.UpdateSIPDispatchRuleRequest
	(*SIPDispatchRuleInfo)(nil),           // 41: samvaad.SIPDispatchRuleInfo
	(*SIPDispatchRuleUpdate)(nil),         // 42: samvaad.SIPDispatchRuleUpdate
	(*ListSIPDispatchRuleRequest)(nil),    // 43: samvaad.ListSIPDispatchRuleRequest
	(*ListSIPDispatchRuleResponse)(nil),   // 44: samvaad.ListSIPDispatchRuleResponse
	(*DeleteSIPDispatchRuleRequest)(nil),  // 45: samvaad.DeleteSIPDispatchRuleRequest
	(*SIPOutboundConfig)(nil),             // 46: samvaad.SIPOutboundConfig
	(*CreateSIPParticipantRequest)(nil),   // 47: samvaad.CreateSIPParticipantRequest
	(*SIPParticipantInfo)(nil),            // 48: samvaad.SIPParticipantInfo
	(*TransferSIPParticipantRequest)(nil), // 49: samvaad.TransferSIPParticipantRequest
	(*SIPCallInfo)(nil),                   // 50: samvaad.SIPCallInfo
	(*SIPTransferInfo)(nil),               // 51: samvaad.SIPTransferInfo
	(*SIPUri)(nil),                        // 52: samvaad.SIPUri
	(*Destination)(nil),                   // 53: samvaad.Destination
	nil,                                   // 54: samvaad.SIPInboundTrunkInfo.HeadersEntry
	nil,                                   // 55: samvaad.SIPInboundTrunkInfo.HeadersToAttributesEntry
	nil,                                   // 56: samvaad.SIPInboundTrunkInfo.AttributesToHeadersEntry
	nil,                                   // 57: samvaad.SIPOutboundTrunkInfo.HeadersEntry
	nil,                                   // 58: samvaad.SIPOutboundTrunkInfo.HeadersToAttributesEntry
	nil,                                   // 59: samvaad.SIPOutboundTrunkInfo.AttributesToHeadersEntry
	nil,                                   // 60: samvaad.CreateSIPDispatchRuleRequest.AttributesEntry
	nil,                                   // 61: samvaad.SIPDispatchRuleInfo.AttributesEntry
	nil,                                   // 62: samvaad.SIPDispatchRuleUpdate.AttributesEntry
	nil,                                   // 63: samvaad.SIPOutboundConfig.HeadersToAttributesEntry
	nil,                                   // 64: samvaad.SIPOutboundConfig.AttributesToHeadersEntry
	nil,                                   // 65: samvaad.CreateSIPParticipantRequest.ParticipantAttributesEntry
	nil,                                   // 66: samvaad.CreateSIPParticipantRequest.HeadersEntry
	nil,                                   // 67: samvaad.TransferSIPParticipantRequest.HeadersEntry
	nil,                                   // 68: samvaad.SIPCallInfo.ParticipantAttributesEntry
	(*durationpb.Duration)(nil),           // 69: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),         // 70: google.protobuf.Timestamp
	(*ListUpdate)(nil),                    // 71: samvaad.ListUpdate
	(*Pagination)(nil),                    // 72: samvaad.Pagination
	(*RoomConfiguration)(nil),             // 73: samvaad.RoomConfiguration
	(DisconnectReason)(0),                 // 74: samvaad.DisconnectReason
	(*anypb.Any)(nil),                     // 75: google.protobuf.Any
	(*emptypb.Empty)(nil),                 // 76: google.protobuf.Empty
}
var file_samvaad_sip_proto_depIdxs = []int32{
	0,   // 0: samvaad.SIPStatus.code:type_name -> samvaad.SIPStatusCode
	12,  // 1: samvaad.SIPMediaConfig.codecs:type_name -> samvaad.SIPCodec
	3,   // 2: samvaad.SIPMediaConfig.encryption:type_name -> samvaad.SIPMediaEncryption
	69,  // 3: samvaad.SIPMediaConfig.media_timeout:type_name -> google.protobuf.Duration
	4,   // 4: samvaad.ProviderInfo.type:type_name -> samvaad.ProviderType
	9,   // 5: samvaad.SIPTrunkInfo.kind:type_name -> samvaad.SIPTrunkInfo.TrunkKind
	1,   // 6: samvaad.SIPTrunkInfo.transport:type_name -> samvaad.SIPTransport
	18,  // 7: samvaad.CreateSIPInboundTrunkRequest.trunk:type_name -> samvaad.SIPInboundTrunkInfo
	18,  // 8: samvaad.UpdateSIPInboundTrunkRequest.replace:type_name -> samvaad.SIPInboundTrunkInfo
	19,  // 9: samvaad.UpdateSIPInboundTrunkRequest.update:type_name -> samvaad.SIPInboundTrunkUpdate
	54,  // 10: samvaad.SIPInboundTrunkInfo.headers:type_name -> samvaad.SIPInboundTrunkInfo.HeadersEntry
	55,  // 11: samvaad.SIPInboundTrunkInfo.headers_to_attributes:type_name -> samvaad.SIPInboundTrunkInfo.HeadersToAttributesEntry
	56,  // 12: samvaad.SIPInboundTrunkInfo.attributes_to_headers:type_name -> samvaad.SIPInboundTrunkInfo.AttributesToHeadersEntry
	2,   // 13: samvaad.SIPInboundTrunkInfo.include_headers:type_name -> samvaad.SIPHeaderOptions
	69,  // 14: samvaad.SIPInboundTrunkInfo.ringing_timeout:type_name -> google.protobuf.Duration
	69,  // 15: samvaad.SIPInboundTrunkInfo.max_call_duration:type_name -> google.protobuf.Duration
	3,   // 16: samvaad.SIPInboundTrunkInfo.media_encryption:type_name -> samvaad.SIPMediaEncryption
	70,  // 17: samvaad.SIPInboundTrunkInfo.created_at:type_name -> google.protobuf.Timestamp
	70,  // 18: samvaad.SIPInboundTrunkInfo.updated_at:type_name -> google.protobuf.Timestamp
	71,  // 19: samvaad.SIPInboundTrunkUpdate.numbers:type_name -> samvaad.ListUpdate
	71,  // 20: samvaad.SIPInboundTrunkUpdate.allowed_addresses:type_name -> samvaad.ListUpdate
	71,  // 21: samvaad.SIPInboundTrunkUpdate.allowed_numbers:type_name -> samvaad.ListUpdate
	3,   // 22: samvaad.SIPInboundTrunkUpdate.media_encryption:type_name -> samvaad.SIPMediaEncryption
	22,  // 23: samvaad.CreateSIPOutboundTrunkRequest.trunk:type_name -> samvaad.SIPOutboundTrunkInfo
	22,  // 24: samvaad.UpdateSIPOutboundTrunkRequest.replace:type_name -> samvaad.SIPOutboundTrunkInfo
	23,  // 25: samvaad.UpdateSIPOutboundTrunkRequest.update:type_name -> samvaad.SIPOutboundTrunkUpdate
	1,   // 26: samvaad.SIPOutboundTrunkInfo.transport:type_name -> samvaad.SIPTransport
	57,  // 27: samvaad.SIPOutboundTrunkInfo.headers:type_name -> samvaad.SIPOutboundTrunkInfo.HeadersEntry
	58,  // 28: samvaad.SIPOutboundTrunkInfo.headers_to_attributes:type_name -> samvaad.SIPOutboundTrunkInfo.HeadersToAttributesEntry
	59,  // 29: samvaad.SIPOutboundTrunkInfo.attributes_to_headers:type_name -> samvaad.SIPOutboundTrunkInfo.AttributesToHeadersEntry
	2,   // 30: samvaad.SIPOutboundTrunkInfo.include_headers:type_name -> samvaad.SIPHeaderOptions
	3,   // 31: samvaad.SIPOutboundTrunkInfo.media_encryption:type_name -> samvaad.SIPMediaEncryption
	70,  // 32: samvaad.SIPOutboundTrunkInfo.created_at:type_name -> google.protobuf.Timestamp
	70,  // 33: samvaad.SIPOutboundTrunkInfo.updated_at:type_name -> google.protobuf.Timestamp
	1,   // 34: samvaad.SIPOutboundTrunkUpdate.transport:type_name -> samvaad.SIPTransport
	71,  // 35: samvaad.SIPOutboundTrunkUpdate.numbers:type_name -> samvaad.ListUpdate
	3,   // 36: samvaad.SIPOutboundTrunkUpdate.media_encryption:type_name -> samvaad.SIPMediaEncryption
	18,  // 37: samvaad.GetSIPInboundTrunkResponse.trunk:type_name -> samvaad.SIPInboundTrunkInfo
	22,  // 38: samvaad.GetSIPOutboundTrunkResponse.trunk:type_name -> samvaad.SIPOutboundTrunkInfo
	72,  // 39: samvaad.ListSIPTrunkRequest.page:type_name -> samvaad.Pagination
	15,  // 40: samvaad.ListSIPTrunkResponse.items:type_name -> samvaad.SIPTrunkInfo
	72,  // 41: samvaad.ListSIPInboundTrunkRequest.page:type_name -> samvaad.Pagination
	18,  // 42: samvaad.ListSIPInboundTrunkResponse.items:type_name -> samvaad.SIPInboundTrunkInfo
	72,  // 43: samvaad.ListSIPOutboundTrunkRequest.page:type_name -> samvaad.Pagination
	22,  // 44: samvaad.ListSIPOutboundTrunkResponse.items:type_name -> samvaad.SIPOutboundTrunkInfo
	35,  // 45: samvaad.SIPDispatchRule.dispatch_rule_direct:type_name -> samvaad.SIPDispatchRuleDirect
	36,  // 46: samvaad.SIPDispatchRule.dispatch_rule_individual:type_name -> samvaad.SIPDispatchRuleIndividual
	37,  // 47: samvaad.SIPDispatchRule.dispatch_rule_callee:type_name -> samvaad.SIPDispatchRuleCallee
	41,  // 48: samvaad.CreateSIPDispatchRuleRequest.dispatch_rule:type_name -> samvaad.SIPDispatchRuleInfo
	38,  // 49: samvaad.CreateSIPDispatchRuleRequest.rule:type_name -> samvaad.SIPDispatchRule
	60,  // 50: samvaad.CreateSIPDispatchRuleRequest.attributes:type_name -> samvaad.CreateSIPDispatchRuleRequest.AttributesEntry
	73,  // 51: samvaad.CreateSIPDispatchRuleRequest.room_config:type_name -> samvaad.RoomConfiguration
	41,  // 52: samvaad.UpdateSIPDispatchRuleRequest.replace:type_name -> samvaad.SIPDispatchRuleInfo
	42,  // 53: samvaad.UpdateSIPDispatchRuleRequest.update:type_name -> samvaad.SIPDispatchRuleUpdate
	38,  // 54: samvaad.SIPDispatchRuleInfo.rule:type_name -> samvaad.SIPDispatchRule
	61,  // 55: samvaad.SIPDispatchRuleInfo.attributes:type_name -> samvaad.SIPDispatchRuleInfo.AttributesEntry
	73,  // 56: samvaad.SIPDispatchRuleInfo.room_config:type_name -> samvaad.RoomConfiguration
	13,  // 57: samvaad.SIPDispatchRuleInfo.media:type_name -> samvaad.SIPMediaConfig
	3,   // 58: samvaad.SIPDispatchRuleInfo.media_encryption:type_name -> samvaad.SIPMediaEncryption
	70,  // 59: samvaad.SIPDispatchRuleInfo.created_at:type_name -> google.protobuf.Timestamp
	70,  // 60: samvaad.SIPDispatchRuleInfo.updated_at:type_name -> google.protobuf.Timestamp
	71,  // 61: samvaad.SIPDispatchRuleUpdate.trunk_ids:type_name -> samvaad.ListUpdate
	38,  // 62: samvaad.SIPDispatchRuleUpdate.rule:type_name -> samvaad.SIPDispatchRule
	62,  // 63: samvaad.SIPDispatchRuleUpdate.attributes:type_name -> samvaad.SIPDispatchRuleUpdate.AttributesEntry
	3,   // 64: samvaad.SIPDispatchRuleUpdate.media_encryption:type_name -> samvaad.SIPMediaEncryption
	13,  // 65: samvaad.SIPDispatchRuleUpdate.media:type_name -> samvaad.SIPMediaConfig
	72,  // 66: samvaad.ListSIPDispatchRuleRequest.page:type_name -> samvaad.Pagination
	41,  // 67: samvaad.ListSIPDispatchRuleResponse.items:type_name -> samvaad.SIPDispatchRuleInfo
	1,   // 68: samvaad.SIPOutboundConfig.transport:type_name -> samvaad.SIPTransport
	63,  // 69: samvaad.SIPOutboundConfig.headers_to_attributes:type_name -> samvaad.SIPOutboundConfig.HeadersToAttributesEntry
	64,  // 70: samvaad.SIPOutboundConfig.attributes_to_headers:type_name -> samvaad.SIPOutboundConfig.AttributesToHeadersEntry
	46,  // 71: samvaad.CreateSIPParticipantRequest.trunk:type_name -> samvaad.SIPOutboundConfig
	65,  // 72: samvaad.CreateSIPParticipantRequest.participant_attributes:type_name -> samvaad.CreateSIPParticipantRequest.ParticipantAttributesEntry
	66,  // 73: samvaad.CreateSIPParticipantRequest.headers:type_name -> samvaad.CreateSIPParticipantRequest.HeadersEntry
	2,   // 74: samvaad.CreateSIPParticipantRequest.include_headers:type_name -> samvaad.SIPHeaderOptions
	69,  // 75: samvaad.CreateSIPParticipantRequest.ringing_timeout:type_name -> google.protobuf.Duration
	69,  // 76: samvaad.CreateSIPParticipantRequest.max_call_duration:type_name -> google.protobuf.Duration
	3,   // 77: samvaad.CreateSIPParticipantRequest.media_encryption:type_name -> samvaad.SIPMediaEncryption
	13,  // 78: samvaad.CreateSIPParticipantRequest.media:type_name -> samvaad.SIPMediaConfig
	53,  // 79: samvaad.CreateSIPParticipantRequest.destination:type_name -> samvaad.Destination
	67,  // 80: samvaad.TransferSIPParticipantRequest.headers:type_name -> samvaad.TransferSIPParticipantRequest.HeadersEntry
	69,  // 81: samvaad.TransferSIPParticipantRequest.ringing_timeout:type_name -> google.protobuf.Duration
	68,  // 82: samvaad.SIPCallInfo.participant_attributes:type_name -> samvaad.SIPCallInfo.ParticipantAttributesEntry
	52,  // 83: samvaad.SIPCallInfo.from_uri:type_name -> samvaad.SIPUri
	52,  // 84: samvaad.SIPCallInfo.to_uri:type_name -> samvaad.SIPUri
	7,   // 85: samvaad.SIPCallInfo.enabled_features:type_name -> samvaad.SIPFeature
	8,   // 86: samvaad.SIPCallInfo.call_direction:type_name -> samvaad.SIPCallDirection
	5,   // 87: samvaad.SIPCallInfo.call_status:type_name -> samvaad.SIPCallStatus
	74,  // 88: samvaad.SIPCallInfo.disconnect_reason:type_name -> samvaad.DisconnectReason
	10,  // 89: samvaad.SIPCallInfo.call_status_code:type_name -> samvaad.SIPStatus
	75,  // 90: samvaad.SIPCallInfo.call_context:type_name -> google.protobuf.Any
	14,  // 91: samvaad.SIPCallInfo.provider_info:type_name -> samvaad.ProviderInfo
	6,   // 92: samvaad.SIPTransferInfo.transfer_status:type_name -> samvaad.SIPTransferStatus
	10,  // 93: samvaad.SIPTransferInfo.transfer_status_code:type_name -> samvaad.SIPStatus
	1,   // 94: samvaad.SIPUri.transport:type_name -> samvaad.SIPTransport
	28,  // 95: samvaad.SIP.ListSIPTrunk:input_type -> samvaad.ListSIPTrunkRequest
	16,  // 96: samvaad.SIP.CreateSIPInboundTrunk:input_type -> samvaad.CreateSIPInboundTrunkRequest
	20,  // 97: samvaad.SIP.CreateSIPOutboundTrunk:input_type -> samvaad.CreateSIPOutboundTrunkRequest
	17,  // 98: samvaad.SIP.UpdateSIPInboundTrunk:input_type -> samvaad.UpdateSIPInboundTrunkRequest
	21,  // 99: samvaad.SIP.UpdateSIPOutboundTrunk:input_type -> samvaad.UpdateSIPOutboundTrunkRequest
	24,  // 100: samvaad.SIP.GetSIPInboundTrunk:input_type -> samvaad.GetSIPInboundTrunkRequest
	26,  // 101: samvaad.SIP.GetSIPOutboundTrunk:input_type -> samvaad.GetSIPOutboundTrunkRequest
	30,  // 102: samvaad.SIP.ListSIPInboundTrunk:input_type -> samvaad.ListSIPInboundTrunkRequest
	32,  // 103: samvaad.SIP.ListSIPOutboundTrunk:input_type -> samvaad.ListSIPOutboundTrunkRequest
	34,  // 104: samvaad.SIP.DeleteSIPTrunk:input_type -> samvaad.DeleteSIPTrunkRequest
	39,  // 105: samvaad.SIP.CreateSIPDispatchRule:input_type -> samvaad.CreateSIPDispatchRuleRequest
	40,  // 106: samvaad.SIP.UpdateSIPDispatchRule:input_type -> samvaad.UpdateSIPDispatchRuleRequest
	43,  // 107: samvaad.SIP.ListSIPDispatchRule:input_type -> samvaad.ListSIPDispatchRuleRequest
	45,  // 108: samvaad.SIP.DeleteSIPDispatchRule:input_type -> samvaad.DeleteSIPDispatchRuleRequest
	47,  // 109: samvaad.SIP.CreateSIPParticipant:input_type -> samvaad.CreateSIPParticipantRequest
	49,  // 110: samvaad.SIP.TransferSIPParticipant:input_type -> samvaad.TransferSIPParticipantRequest
	29,  // 111: samvaad.SIP.ListSIPTrunk:output_type -> samvaad.ListSIPTrunkResponse
	18,  // 112: samvaad.SIP.CreateSIPInboundTrunk:output_type -> samvaad.SIPInboundTrunkInfo
	22,  // 113: samvaad.SIP.CreateSIPOutboundTrunk:output_type -> samvaad.SIPOutboundTrunkInfo
	18,  // 114: samvaad.SIP.UpdateSIPInboundTrunk:output_type -> samvaad.SIPInboundTrunkInfo
	22,  // 115: samvaad.SIP.UpdateSIPOutboundTrunk:output_type -> samvaad.SIPOutboundTrunkInfo
	25,  // 116: samvaad.SIP.GetSIPInboundTrunk:output_type -> samvaad.GetSIPInboundTrunkResponse
	27,  // 117: samvaad.SIP.GetSIPOutboundTrunk:output_type -> samvaad.GetSIPOutboundTrunkResponse
	31,  // 118: samvaad.SIP.ListSIPInboundTrunk:output_type -> samvaad.ListSIPInboundTrunkResponse
	33,  // 119: samvaad.SIP.ListSIPOutboundTrunk:output_type -> samvaad.ListSIPOutboundTrunkResponse
	15,  // 120: samvaad.SIP.DeleteSIPTrunk:output_type -> samvaad.SIPTrunkInfo
	41,  // 121: samvaad.SIP.CreateSIPDispatchRule:output_type -> samvaad.SIPDispatchRuleInfo
	41,  // 122: samvaad.SIP.UpdateSIPDispatchRule:output_type -> samvaad.SIPDispatchRuleInfo
	44,  // 123: samvaad.SIP.ListSIPDispatchRule:output_type -> samvaad.ListSIPDispatchRuleResponse
	41,  // 124: samvaad.SIP.DeleteSIPDispatchRule:output_type -> samvaad.SIPDispatchRuleInfo
	48,  // 125: samvaad.SIP.CreateSIPParticipant:output_type -> samvaad.SIPParticipantInfo
	76,  // 126: samvaad.SIP.TransferSIPParticipant:output_type -> google.protobuf.Empty
...
func init() { file_samvaad_sip_proto_init() }
func file_samvaad_sip_proto_init() {
	if File_samvaad_sip_proto != nil {
		return
	}
	file_samvaad_models_proto_init()
	file_samvaad_room_proto_init()
	file_samvaad_sip_proto_msgTypes[3].OneofWrappers = []any{}
	file_samvaad_sip_proto_msgTypes[7].OneofWrappers = []any{
		(*UpdateSIPInboundTrunkRequest_Replace)(nil),
		(*UpdateSIPInboundTrunkRequest_Update)(nil),
	}
	file_samvaad_sip_proto_msgTypes[9].OneofWrappers = []any{}
	file_samvaad_sip_proto_msgTypes[11].OneofWrappers = []any{
		(*UpdateSIPOutboundTrunkRequest_Replace)(nil),
		(*UpdateSIPOutboundTrunkRequest_Update)(nil),
	}
	file_samvaad_sip_proto_msgTypes[13].OneofWrappers = []any{}
	file_samvaad_sip_proto_msgTypes[28].OneofWrappers = []any{
		(*SIPDispatchRule_DispatchRuleDirect)(nil),
		(*SIPDispatchRule_DispatchRuleIndividual)(nil),
		(*SIPDispatchRule_DispatchRuleCallee)(nil),
	}
	file_samvaad_sip_proto_msgTypes[30].OneofWrappers = []any{
		(*UpdateSIPDispatchRuleRequest_Replace)(nil),
		(*UpdateSIPDispatchRuleRequest_Update)(nil),
	}
	file_samvaad_sip_proto_msgTypes[32].OneofWrappers = []any{}
	file_samvaad_sip_proto_msgTypes[37].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_samvaad_sip_proto_rawDesc), len(file_samvaad_sip_proto_rawDesc)),
			NumEnums:      10,
			NumMessages:   59,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_samvaad_sip_proto_goTypes,
		DependencyIndexes: file_samvaad_sip_proto_depIdxs,
		EnumInfos:         file_samvaad_sip_proto_enumTypes,
		MessageInfos:      file_samvaad_sip_proto_msgTypes,
	}.Build()
	File_samvaad_sip_proto = out.File
	file_samvaad_sip_proto_goTypes = nil
	file_samvaad_sip_proto_depIdxs = nil
}
