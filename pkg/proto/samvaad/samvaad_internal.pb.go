...
func (NodeType) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_internal_proto_enumTypes[0].Descriptor()
}

func (NodeType) Type() protoreflect.EnumType {
	return &file_samvaad_internal_proto_enumTypes[0]
}
...
func (NodeType) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_internal_proto_rawDescGZIP(), []int{0}
}
...
const (
	...
	NodeState_SUSPENDED     NodeState = 3
)
...
func (NodeState) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_internal_proto_enumTypes[1].Descriptor()
}

func (NodeState) Type() protoreflect.EnumType {
	return &file_samvaad_internal_proto_enumTypes[1]
}
...
func (NodeState) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_internal_proto_rawDescGZIP(), []int{1}
}
...
func (ICECandidateType) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_internal_proto_enumTypes[2].Descriptor()
}

func (ICECandidateType) Type() protoreflect.EnumType {
	return &file_samvaad_internal_proto_enumTypes[2]
}
...
func (ICECandidateType) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_internal_proto_rawDescGZIP(), []int{2}
}
...
type Node struct {
	...
	Type          NodeType               `protobuf:"varint,5,opt,name=type,proto3,enum=samvaad.NodeType" json:"type,omitempty"`
	State         NodeState              `protobuf:"varint,6,opt,name=state,proto3,enum=samvaad.NodeState" json:"state,omitempty"`
...
func (x *Node) Reset() {
	*x = Node{}
	mi := &file_samvaad_internal_proto_msgTypes[0]
...
type NodeStats struct {
	...
	// Deprecated: Marked as deprecated in samvaad_internal.proto.
...
func (x *NodeStats) Reset() {
	*x = NodeStats{}
	mi := &file_samvaad_internal_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *NodeStatsRate) Reset() {
	*x = NodeStatsRate{}
	mi := &file_samvaad_internal_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type StartSession struct {
	...
	ReconnectReason         ReconnectReason     `protobuf:"varint,17,opt,name=reconnect_reason,json=reconnectReason,proto3,enum=samvaad.ReconnectReason" json:"reconnect_reason,omitempty"`
...
func (x *StartSession) Reset() {
	*x = StartSession{}
	mi := &file_samvaad_internal_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StartSession) Descriptor() ([]byte, []int) {
	return file_samvaad_internal_proto_rawDescGZIP(), []int{3}
}
...
func (x *RoomInternal) Reset() {
	*x = RoomInternal{}
	mi := &file_samvaad_internal_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RoomInternal) Descriptor() ([]byte, []int) {
	return file_samvaad_internal_proto_rawDescGZIP(), []int{4}
}
...
type ICEConfig struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	PreferenceSubscriber ICECandidateType       `protobuf:"varint,1,opt,name=preference_subscriber,json=preferenceSubscriber,proto3,enum=samvaad.ICECandidateType" json:"preference_subscriber,omitempty"`
	PreferencePublisher  ICECandidateType       `protobuf:"varint,2,opt,name=preference_publisher,json=preferencePublisher,proto3,enum=samvaad.ICECandidateType" json:"preference_publisher,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *ICEConfig) Reset() {
	*x = ICEConfig{}
	mi := &file_samvaad_internal_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ICEConfig) Descriptor() ([]byte, []int) {
	return file_samvaad_internal_proto_rawDescGZIP(), []int{5}
}
...
var File_samvaad_internal_proto protoreflect.FileDescriptor

const file_samvaad_internal_proto_rawDesc = "" +
	"\n" +
	"\x16\x6c\x69\x76\x65\x6b\x69\x74_internal.proto\x12\a\x6c\x69\x76\x65\x6b\x69\x74\x1a\x1c\x6c\x69\x76\x65\x6b\x69\x74_agent_dispatch.proto\x1a\x14\x6c\x69\x76\x65\x6b\x69\x74_egress.proto\x1a\x14\x6c\x69\x76\x65\x6b\x69\x74_models.proto\x1a\x12\x6c\x69\x76\x65\x6b\x69\x74_room.proto\x1a\x11\x6c\x69\x76\x65\x6b\x69\x74_rtc.proto\x1a\x14logger/options.proto\"\xd4\x01\n" +
	"\x04Node\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x0e\n" +
	"\x02ip\x18\x02 \x01(\tR\x02ip\x12\x19\n" +
	"\bnum_cpus\x18\x03 \x01(\rR\anumCpus\x12(\n" +
	"\x05stats\x18\x04 \x01(\v2\x12.\x6c\x69\x76\x65\x6b\x69\x74.NodeStatsR\x05stats\x12%\n" +
	"\x04type\x18\x05 \x01(\x0e2\x11.\x6c\x69\x76\x65\x6b\x69\x74.NodeTypeR\x04type\x12(\n" +
	"\x05state\x18\x06 \x01(\x0e2\x12.\x6c\x69\x76\x65\x6b\x69\x74.NodeStateR\x05state\x12\x16\n" +
	...
	"\x05rates\x182 \x03(\v2\x16.\x6c\x69\x76\x65\x6b\x69\x74.NodeStatsRateR\x05rates\"\xee\b\n" +
	...
	"\rconnection_id\x18\x03 \x01(\tB\x0f\xbaP\fconnectionIDR\fconnectionId\x12\x1c\n" +
	...
	"\x06client\x18\v \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.ClientInfoR\x06client\x12\x1e\n" +
	"\brecorder\x18\f \x01(\bB\x02\x18\x01R\brecorder\x12\x12\n" +
	"\x04name\x18\r \x01(\tR\x04name\x12\x1f\n" +
	"\vgrants_json\x18\x0e \x01(\tR\n" +
	"grantsJson\x12'\n" +
	"\x0fadaptive_stream\x18\x0f \x01(\bR\x0eadaptiveStream\x127\n" +
	"\x0eparticipant_id\x18\x10 \x01(\tB\x10\xbaP\rparticipantIDR\rparticipantId\x12C\n" +
	"\x10reconnect_reason\x18\x11 \x01(\x0e2\x18.\x6c\x69\x76\x65\x6b\x69\x74.ReconnectReasonR\x0freconnectReason\x129\n" +
	...
	"\vcreate_room\x18\x14 \x01(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.CreateRoomRequestR\n" +
	"createRoom\x12F\n" +
	"\x12add_track_requests\x18\x15 \x03(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.AddTrackRequestR\x10addTrackRequests\x12D\n" +
	"\x0fpublisher_offer\x18\x16 \x01(\v2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SessionDescriptionR\x0epublisherOffer\x121\n" +
	"\n" +
	"sync_state\x18\x17 \x01(\v2\x12.\x6c\x69\x76\x65\x6b\x69\x74.SyncStateR\tsyncState\x12;\n" +
	...
	"\fRoomInternal\x12;\n" +
	"\ftrack_egress\x18\x01 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.AutoTrackEgressR\vtrackEgress\x12M\n" +
	"\x12participant_egress\x18\x02 \x01(\v2\x1e.\x6c\x69\x76\x65\x6b\x69\x74.AutoParticipantEgressR\x11participantEgress\x12:\n" +
	"\rplayout_delay\x18\x03 \x01(\v2\x15.\x6c\x69\x76\x65\x6b\x69\x74.PlayoutDelayR\fplayoutDelay\x12E\n" +
	"\x10agent_dispatches\x18\x05 \x03(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.RoomAgentDispatchR\x0fagentDispatches\x12!\n" +
	...
	"exportRoom\x123\n" +
	"\x04tags\x18\b \x03(\v2\x1f.\x6c\x69\x76\x65\x6b\x69\x74.RoomInternal.TagsEntryR\x04tags\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xa9\x01\n" +
	"\tICEConfig\x12N\n" +
	"\x15preference_subscriber\x18\x01 \x01(\x0e2\x19.\x6c\x69\x76\x65\x6b\x69\x74.ICECandidateTypeR\x14preferenceSubscriber\x12L\n" +
	"\x14preference_publisher\x18\x02 \x01(\x0e2\x19.\x6c\x69\x76\x65\x6b\x69\x74.ICECandidateTypeR\x13preferencePublisher*v\n" +
	"\bNodeType\x12\n" +
	"\n" +
	...
	"\aICT_TLS\x10\x02BFZ#github.com/\x6c\x69\x76\x65\x6b\x69\x74/protocol/\x6c\x69\x76\x65\x6b\x69\x74\xaa\x02\r\x4c\x69\x76\x65\x4b\x69\x74.Proto\xea\x02\x0e\x4c\x69\x76\x65\x4b\x69\x74::Protob\x06proto3"

var (
	file_samvaad_internal_proto_rawDescOnce sync.Once
	file_samvaad_internal_proto_rawDescData []byte
)

func file_samvaad_internal_proto_rawDescGZIP() []byte {
	file_samvaad_internal_proto_rawDescOnce.Do(func() {
		file_samvaad_internal_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_samvaad_internal_proto_rawDesc), len(file_samvaad_internal_proto_rawDesc)))
	})
	return file_samvaad_internal_proto_rawDescData
}

var file_samvaad_internal_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_samvaad_internal_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_samvaad_internal_proto_goTypes = []any{
	(NodeType)(0),                 // 0: samvaad.NodeType
	(NodeState)(0),                // 1: samvaad.NodeState
	(ICECandidateType)(0),         // 2: samvaad.ICECandidateType
	(*Node)(nil),                  // 3: samvaad.Node
	(*NodeStats)(nil),             // 4: samvaad.NodeStats
	(*NodeStatsRate)(nil),         // 5: samvaad.NodeStatsRate
	(*StartSession)(nil),          // 6: samvaad.StartSession
	(*RoomInternal)(nil),          // 7: samvaad.RoomInternal
	(*ICEConfig)(nil),             // 8: samvaad.ICEConfig
	nil,                           // 9: samvaad.RoomInternal.TagsEntry
	(*ClientInfo)(nil),            // 10: samvaad.ClientInfo
	(ReconnectReason)(0),          // 11: samvaad.ReconnectReason
	(*CreateRoomRequest)(nil),     // 12: samvaad.CreateRoomRequest
	(*AddTrackRequest)(nil),       // 13: samvaad.AddTrackRequest
	(*SessionDescription)(nil),    // 14: samvaad.SessionDescription
	(*SyncState)(nil),             // 15: samvaad.SyncState
	(*AutoTrackEgress)(nil),       // 16: samvaad.AutoTrackEgress
	(*AutoParticipantEgress)(nil), // 17: samvaad.AutoParticipantEgress
	(*PlayoutDelay)(nil),          // 18: samvaad.PlayoutDelay
	(*RoomAgentDispatch)(nil),     // 19: samvaad.RoomAgentDispatch
}
var file_samvaad_internal_proto_depIdxs = []int32{
	4,  // 0: samvaad.Node.stats:type_name -> samvaad.NodeStats
	0,  // 1: samvaad.Node.type:type_name -> samvaad.NodeType
	1,  // 2: samvaad.Node.state:type_name -> samvaad.NodeState
	5,  // 3: samvaad.NodeStats.rates:type_name -> samvaad.NodeStatsRate
	10, // 4: samvaad.StartSession.client:type_name -> samvaad.ClientInfo
	11, // 5: samvaad.StartSession.reconnect_reason:type_name -> samvaad.ReconnectReason
	12, // 6: samvaad.StartSession.create_room:type_name -> samvaad.CreateRoomRequest
	13, // 7: samvaad.StartSession.add_track_requests:type_name -> samvaad.AddTrackRequest
	14, // 8: samvaad.StartSession.publisher_offer:type_name -> samvaad.SessionDescription
	15, // 9: samvaad.StartSession.sync_state:type_name -> samvaad.SyncState
	16, // 10: samvaad.RoomInternal.track_egress:type_name -> samvaad.AutoTrackEgress
	17, // 11: samvaad.RoomInternal.participant_egress:type_name -> samvaad.AutoParticipantEgress
	18, // 12: samvaad.RoomInternal.playout_delay:type_name -> samvaad.PlayoutDelay
	19, // 13: samvaad.RoomInternal.agent_dispatches:type_name -> samvaad.RoomAgentDispatch
	9,  // 14: samvaad.RoomInternal.tags:type_name -> samvaad.RoomInternal.TagsEntry
	2,  // 15: samvaad.ICEConfig.preference_subscriber:type_name -> samvaad.ICECandidateType
	2,  // 16: samvaad.ICEConfig.preference_publisher:type_name -> samvaad.ICECandidateType
...
func init() { file_samvaad_internal_proto_init() }
func file_samvaad_internal_proto_init() {
	if File_samvaad_internal_proto != nil {
		return
	}
	...
	file_samvaad_rtc_proto_init()
	file_samvaad_internal_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_samvaad_internal_proto_rawDesc), len(file_samvaad_internal_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_samvaad_internal_proto_goTypes,
		DependencyIndexes: file_samvaad_internal_proto_depIdxs,
		EnumInfos:         file_samvaad_internal_proto_enumTypes,
		MessageInfos:      file_samvaad_internal_proto_msgTypes,
	}.Build()
	File_samvaad_internal_proto = out.File
	file_samvaad_internal_proto_goTypes = nil
	file_samvaad_internal_proto_depIdxs = nil
}
