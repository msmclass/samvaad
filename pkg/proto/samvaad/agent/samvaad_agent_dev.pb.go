...
// 	protoc        v4.23.4
// source: agent/samvaad_agent_dev.proto
...
func (x *AgentDevMessage) Reset() {
	*x = AgentDevMessage{}
	mi := &file_agent_samvaad_agent_dev_proto_msgTypes[0]
...
func (*AgentDevMessage) Descriptor() ([]byte, []int) {
	return file_agent_samvaad_agent_dev_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetRunningAgentJobsRequest) Reset() {
	*x = GetRunningAgentJobsRequest{}
	mi := &file_agent_samvaad_agent_dev_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetRunningAgentJobsRequest) Descriptor() ([]byte, []int) {
	return file_agent_samvaad_agent_dev_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetRunningAgentJobsResponse) Reset() {
	*x = GetRunningAgentJobsResponse{}
	mi := &file_agent_samvaad_agent_dev_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetRunningAgentJobsResponse) Descriptor() ([]byte, []int) {
	return file_agent_samvaad_agent_dev_proto_rawDescGZIP(), []int{2}
}
...
func (x *RunningAgentJobInfo) Reset() {
	*x = RunningAgentJobInfo{}
	mi := &file_agent_samvaad_agent_dev_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RunningAgentJobInfo) Descriptor() ([]byte, []int) {
	return file_agent_samvaad_agent_dev_proto_rawDescGZIP(), []int{3}
}
...
var File_agent_samvaad_agent_dev_proto protoreflect.FileDescriptor

const file_agent_samvaad_agent_dev_proto_rawDesc = "" +
	"\n" +
	"\x1dagent/\x6c\x69\x76\x65\x6b\x69\x74_agent_dev.proto\x12\r\x6c\x69\x76\x65\x6b\x69\x74.agent\"\xeb\x01\n" +
	"\x0fAgentDevMessage\x12d\n" +
	"\x18get_running_jobs_request\x18\x01 \x01(\v2).\x6c\x69\x76\x65\x6b\x69\x74.agent.GetRunningAgentJobsRequestH\x00R\x15getRunningJobsRequest\x12g\n" +
	"\x19get_running_jobs_response\x18\x02 \x01(\v2*.\x6c\x69\x76\x65\x6b\x69\x74.agent.GetRunningAgentJobsResponseH\x00R\x16getRunningJobsResponseB\t\n" +
	"\amessage\"\x1c\n" +
	"\x1aGetRunningAgentJobsRequest\"U\n" +
	"\x1bGetRunningAgentJobsResponse\x126\n" +
	"\x04jobs\x18\x01 \x03(\v2\".\x6c\x69\x76\x65\x6b\x69\x74.agent.RunningAgentJobInfoR\x04jobs\"\xfa\x01\n" +
	...
	"\bmock_job\x18\b \x01(\bR\amockJobB+Z)github.com/\x6c\x69\x76\x65\x6b\x69\x74/protocol/\x6c\x69\x76\x65\x6b\x69\x74/agentb\x06proto3"

var (
	file_agent_samvaad_agent_dev_proto_rawDescOnce sync.Once
	file_agent_samvaad_agent_dev_proto_rawDescData []byte
)

func file_agent_samvaad_agent_dev_proto_rawDescGZIP() []byte {
	file_agent_samvaad_agent_dev_proto_rawDescOnce.Do(func() {
		file_agent_samvaad_agent_dev_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_agent_samvaad_agent_dev_proto_rawDesc), len(file_agent_samvaad_agent_dev_proto_rawDesc)))
	})
	return file_agent_samvaad_agent_dev_proto_rawDescData
}

var file_agent_samvaad_agent_dev_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_agent_samvaad_agent_dev_proto_goTypes = []any{
	(*AgentDevMessage)(nil),             // 0: samvaad.agent.AgentDevMessage
	(*GetRunningAgentJobsRequest)(nil),  // 1: samvaad.agent.GetRunningAgentJobsRequest
	(*GetRunningAgentJobsResponse)(nil), // 2: samvaad.agent.GetRunningAgentJobsResponse
	(*RunningAgentJobInfo)(nil),         // 3: samvaad.agent.RunningAgentJobInfo
}
var file_agent_samvaad_agent_dev_proto_depIdxs = []int32{
	1, // 0: samvaad.agent.AgentDevMessage.get_running_jobs_request:type_name -> samvaad.agent.GetRunningAgentJobsRequest
	2, // 1: samvaad.agent.AgentDevMessage.get_running_jobs_response:type_name -> samvaad.agent.GetRunningAgentJobsResponse
	3, // 2: samvaad.agent.GetRunningAgentJobsResponse.jobs:type_name -> samvaad.agent.RunningAgentJobInfo
...
func init() { file_agent_samvaad_agent_dev_proto_init() }
func file_agent_samvaad_agent_dev_proto_init() {
	if File_agent_samvaad_agent_dev_proto != nil {
		return
	}
	file_agent_samvaad_agent_dev_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_agent_samvaad_agent_dev_proto_rawDesc), len(file_agent_samvaad_agent_dev_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_agent_samvaad_agent_dev_proto_goTypes,
		DependencyIndexes: file_agent_samvaad_agent_dev_proto_depIdxs,
		MessageInfos:      file_agent_samvaad_agent_dev_proto_msgTypes,
	}.Build()
	File_agent_samvaad_agent_dev_proto = out.File
	file_agent_samvaad_agent_dev_proto_goTypes = nil
	file_agent_samvaad_agent_dev_proto_depIdxs = nil
}
