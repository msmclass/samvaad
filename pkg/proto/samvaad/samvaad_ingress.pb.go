...
func (IngressInput) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_ingress_proto_enumTypes[0].Descriptor()
}

func (IngressInput) Type() protoreflect.EnumType {
	return &file_samvaad_ingress_proto_enumTypes[0]
}
...
func (IngressInput) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_ingress_proto_rawDescGZIP(), []int{0}
}
...
func (IngressAudioEncodingPreset) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_ingress_proto_enumTypes[1].Descriptor()
}

func (IngressAudioEncodingPreset) Type() protoreflect.EnumType {
	return &file_samvaad_ingress_proto_enumTypes[1]
}
...
func (IngressAudioEncodingPreset) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_ingress_proto_rawDescGZIP(), []int{1}
}
...
func (IngressVideoEncodingPreset) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_ingress_proto_enumTypes[2].Descriptor()
}

func (IngressVideoEncodingPreset) Type() protoreflect.EnumType {
	return &file_samvaad_ingress_proto_enumTypes[2]
}
...
func (IngressVideoEncodingPreset) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_ingress_proto_rawDescGZIP(), []int{2}
}
...
func (IngressState_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_ingress_proto_enumTypes[3].Descriptor()
}

func (IngressState_Status) Type() protoreflect.EnumType {
	return &file_samvaad_ingress_proto_enumTypes[3]
}
...
func (IngressState_Status) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_ingress_proto_rawDescGZIP(), []int{6, 0}
}

type CreateIngressRequest struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	InputType IngressInput           `protobuf:"varint,1,opt,name=input_type,json=inputType,proto3,enum=samvaad.IngressInput" json:"input_type,omitempty"`
	...
	//
	// Deprecated: Marked as deprecated in samvaad_ingress.proto.
...
func (x *CreateIngressRequest) Reset() {
	*x = CreateIngressRequest{}
	mi := &file_samvaad_ingress_proto_msgTypes[0]
...
type IngressAudioOptions struct {
	...
	Source TrackSource            `protobuf:"varint,2,opt,name=source,proto3,enum=samvaad.TrackSource" json:"source,omitempty"`
...
func (x *IngressAudioOptions) Reset() {
	*x = IngressAudioOptions{}
	mi := &file_samvaad_ingress_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type IngressAudioOptions_Preset struct {
	Preset IngressAudioEncodingPreset `protobuf:"varint,3,opt,name=preset,proto3,enum=samvaad.IngressAudioEncodingPreset,oneof"`
}
...
func (x *IngressVideoOptions) Reset() {
	*x = IngressVideoOptions{}
	mi := &file_samvaad_ingress_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type IngressVideoOptions_Preset struct {
	Preset IngressVideoEncodingPreset `protobuf:"varint,3,opt,name=preset,proto3,enum=samvaad.IngressVideoEncodingPreset,oneof"`
}
...
type IngressAudioEncodingOptions struct {
	...
	AudioCodec    AudioCodec `protobuf:"varint,1,opt,name=audio_codec,json=audioCodec,proto3,enum=samvaad.AudioCodec" json:"audio_codec,omitempty"`
...
func (x *IngressAudioEncodingOptions) Reset() {
	*x = IngressAudioEncodingOptions{}
	mi := &file_samvaad_ingress_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IngressAudioEncodingOptions) Descriptor() ([]byte, []int) {
	return file_samvaad_ingress_proto_rawDescGZIP(), []int{3}
}
...
type IngressVideoEncodingOptions struct {
	...
	VideoCodec VideoCodec `protobuf:"varint,1,opt,name=video_codec,json=videoCodec,proto3,enum=samvaad.VideoCodec" json:"video_codec,omitempty"`
...
func (x *IngressVideoEncodingOptions) Reset() {
	*x = IngressVideoEncodingOptions{}
	mi := &file_samvaad_ingress_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IngressVideoEncodingOptions) Descriptor() ([]byte, []int) {
	return file_samvaad_ingress_proto_rawDescGZIP(), []int{4}
}
...
type IngressInfo struct {
	...
	InputType IngressInput `protobuf:"varint,5,opt,name=input_type,json=inputType,proto3,enum=samvaad.IngressInput" json:"input_type,omitempty"`
	// Deprecated: Marked as deprecated in samvaad_ingress.proto.
...
func (x *IngressInfo) Reset() {
	*x = IngressInfo{}
	mi := &file_samvaad_ingress_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IngressInfo) Descriptor() ([]byte, []int) {
	return file_samvaad_ingress_proto_rawDescGZIP(), []int{5}
}
...
type IngressState struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Status        IngressState_Status    `protobuf:"varint,1,opt,name=status,proto3,enum=samvaad.IngressState_Status" json:"status,omitempty"`
...
func (x *IngressState) Reset() {
	*x = IngressState{}
	mi := &file_samvaad_ingress_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IngressState) Descriptor() ([]byte, []int) {
	return file_samvaad_ingress_proto_rawDescGZIP(), []int{6}
}
...
func (x *InputVideoState) Reset() {
	*x = InputVideoState{}
	mi := &file_samvaad_ingress_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InputVideoState) Descriptor() ([]byte, []int) {
	return file_samvaad_ingress_proto_rawDescGZIP(), []int{7}
}
...
func (x *InputAudioState) Reset() {
	*x = InputAudioState{}
	mi := &file_samvaad_ingress_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InputAudioState) Descriptor() ([]byte, []int) {
	return file_samvaad_ingress_proto_rawDescGZIP(), []int{8}
}
...
func (x *UpdateIngressRequest) Reset() {
	*x = UpdateIngressRequest{}
	mi := &file_samvaad_ingress_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateIngressRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_ingress_proto_rawDescGZIP(), []int{9}
}
...
func (x *ListIngressRequest) Reset() {
	*x = ListIngressRequest{}
	mi := &file_samvaad_ingress_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListIngressRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_ingress_proto_rawDescGZIP(), []int{10}
}
...
func (x *ListIngressResponse) Reset() {
	*x = ListIngressResponse{}
	mi := &file_samvaad_ingress_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListIngressResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_ingress_proto_rawDescGZIP(), []int{11}
}
...
func (x *DeleteIngressRequest) Reset() {
	*x = DeleteIngressRequest{}
	mi := &file_samvaad_ingress_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteIngressRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_ingress_proto_rawDescGZIP(), []int{12}
}
...
var File_samvaad_ingress_proto protoreflect.FileDescriptor

const file_samvaad_ingress_proto_rawDesc = "" +
	"\n" +
	"\x15\x6c\x69\x76\x65\x6b\x69\x74_ingress.proto\x12\a\x6c\x69\x76\x65\x6b\x69\x74\x1a\x14\x6c\x69\x76\x65\x6b\x69\x74_models.proto\x1a\x14logger/options.proto\"\xdc\x04\n" +
	"\x14CreateIngressRequest\x124\n" +
	"\n" +
	"input_type\x18\x01 \x01(\x0e2\x15.\x6c\x69\x76\x65\x6b\x69\x74.IngressInputR\tinputType\x12\x10\n" +
	...
	"\x05audio\x18\x06 \x01(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.IngressAudioOptionsR\x05audio\x122\n" +
	"\x05video\x18\a \x01(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.IngressVideoOptionsR\x05video\x12\x1d\n" +
	...
	"\x06source\x18\x02 \x01(\x0e2\x14.\x6c\x69\x76\x65\x6b\x69\x74.TrackSourceR\x06source\x12=\n" +
	"\x06preset\x18\x03 \x01(\x0e2#.\x6c\x69\x76\x65\x6b\x69\x74.IngressAudioEncodingPresetH\x00R\x06preset\x12@\n" +
	"\aoptions\x18\x04 \x01(\v2$.\x6c\x69\x76\x65\x6b\x69\x74.IngressAudioEncodingOptionsH\x00R\aoptionsB\x12\n" +
	"\x10encoding_options\"\xec\x01\n" +
	"\x13IngressVideoOptions\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12,\n" +
	"\x06source\x18\x02 \x01(\x0e2\x14.\x6c\x69\x76\x65\x6b\x69\x74.TrackSourceR\x06source\x12=\n" +
	"\x06preset\x18\x03 \x01(\x0e2#.\x6c\x69\x76\x65\x6b\x69\x74.IngressVideoEncodingPresetH\x00R\x06preset\x12@\n" +
	"\aoptions\x18\x04 \x01(\v2$.\x6c\x69\x76\x65\x6b\x69\x74.IngressVideoEncodingOptionsH\x00R\aoptionsB\x12\n" +
	"\x10encoding_options\"\xaa\x01\n" +
	"\x1bIngressAudioEncodingOptions\x124\n" +
	"\vaudio_codec\x18\x01 \x01(\x0e2\x13.\x6c\x69\x76\x65\x6b\x69\x74.AudioCodecR\n" +
	"audioCodec\x12\x18\n" +
	...
	"\vvideo_codec\x18\x01 \x01(\x0e2\x13.\x6c\x69\x76\x65\x6b\x69\x74.VideoCodecR\n" +
	"videoCodec\x12\x1d\n" +
	"\n" +
	"frame_rate\x18\x02 \x01(\x01R\tframeRate\x12+\n" +
	"\x06layers\x18\x03 \x03(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.VideoLayerR\x06layers\"\xe8\x05\n" +
	"\vIngressInfo\x12+\n" +
	"\n" +
	...
	"\n" +
	"input_type\x18\x05 \x01(\x0e2\x15.\x6c\x69\x76\x65\x6b\x69\x74.IngressInputR\tinputType\x121\n" +
	...
	"\x05audio\x18\x06 \x01(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.IngressAudioOptionsR\x05audio\x122\n" +
	"\x05video\x18\a \x01(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.IngressVideoOptionsR\x05video\x12\x1b\n" +
	...
	"\x05state\x18\f \x01(\v2\x15.\x6c\x69\x76\x65\x6b\x69\x74.IngressStateR\x05state\x12\x1d\n" +
	"\aenabled\x18\x10 \x01(\bH\x01R\aenabled\x88\x01\x01B\x15\n" +
	"\x13_enable_transcodingB\n" +
	"\n" +
	"\b_enabled\"\x90\x04\n" +
	"\fIngressState\x124\n" +
	"\x06status\x18\x01 \x01(\x0e2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.IngressState.StatusR\x06status\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error\x12.\n" +
	"\x05video\x18\x03 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.InputVideoStateR\x05video\x12.\n" +
	"\x05audio\x18\x04 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.InputAudioStateR\x05audio\x12\"\n" +
	"\aroom_id\x18\x05 \x01(\tB\t\xbaP\x06roomIDR\x06roomId\x12\x1d\n" +
	"\n" +
	...
	"\vresource_id\x18\t \x01(\tB\r\xbaP\n" +
	"resourceIDR\n" +
	"resourceId\x12*\n" +
	"\x06tracks\x18\x06 \x03(\v2\x12.\x6c\x69\x76\x65\x6b\x69\x74.TrackInfoR\x06tracks\"{\n" +
	"\x06Status\x12\x15\n" +
	...
	"\n" +
	"page_token\x18\x03 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.TokenPaginationR\tpageToken\x12\x1b\n" +
	"\troom_name\x18\x01 \x01(\tR\broomName\x12+\n" +
	"\n" +
	"ingress_id\x18\x02 \x01(\tB\f\xbaP\tingressIDR\tingressId\"\x83\x01\n" +
	"\x13ListIngressResponse\x12@\n" +
	"\x0fnext_page_token\x18\x02 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.TokenPaginationR\rnextPageToken\x12*\n" +
	"\x05items\x18\x01 \x03(\v2\x14.\x6c\x69\x76\x65\x6b\x69\x74.IngressInfoR\x05items\"C\n" +
	"\x14DeleteIngressRequest\x12+\n" +
	"\n" +
	"ingress_id\x18\x01 \x01(\tB\f\xbaP\tingressIDR\tingressId*=\n" +
	...
	"\aIngress\x12D\n" +
	"\rCreateIngress\x12\x1d.\x6c\x69\x76\x65\x6b\x69\x74.CreateIngressRequest\x1a\x14.\x6c\x69\x76\x65\x6b\x69\x74.IngressInfo\x12D\n" +
	"\rUpdateIngress\x12\x1d.\x6c\x69\x76\x65\x6b\x69\x74.UpdateIngressRequest\x1a\x14.\x6c\x69\x76\x65\x6b\x69\x74.IngressInfo\x12H\n" +
	"\vListIngress\x12\x1b.\x6c\x69\x76\x65\x6b\x69\x74.ListIngressRequest\x1a\x1c.\x6c\x69\x76\x65\x6b\x69\x74.ListIngressResponse\x12D\n" +
	"\rDeleteIngress\x12\x1d.\x6c\x69\x76\x65\x6b\x69\x74.DeleteIngressRequest\x1a\x14.\x6c\x69\x76\x65\x6b\x69\x74.IngressInfoBFZ#github.com/\x6c\x69\x76\x65\x6b\x69\x74/protocol/\x6c\x69\x76\x65\x6b\x69\x74\xaa\x02\r\x4c\x69\x76\x65\x4b\x69\x74.Proto\xea\x02\x0e\x4c\x69\x76\x65\x4b\x69\x74::Protob\x06proto3"

var (
	file_samvaad_ingress_proto_rawDescOnce sync.Once
	file_samvaad_ingress_proto_rawDescData []byte
)

func file_samvaad_ingress_proto_rawDescGZIP() []byte {
	file_samvaad_ingress_proto_rawDescOnce.Do(func() {
		file_samvaad_ingress_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_samvaad_ingress_proto_rawDesc), len(file_samvaad_ingress_proto_rawDesc)))
	})
	return file_samvaad_ingress_proto_rawDescData
}

var file_samvaad_ingress_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_samvaad_ingress_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_samvaad_ingress_proto_goTypes = []any{
	(IngressInput)(0),                   // 0: samvaad.IngressInput
	(IngressAudioEncodingPreset)(0),     // 1: samvaad.IngressAudioEncodingPreset
	(IngressVideoEncodingPreset)(0),     // 2: samvaad.IngressVideoEncodingPreset
	(IngressState_Status)(0),            // 3: samvaad.IngressState.Status
	(*CreateIngressRequest)(nil),        // 4: samvaad.CreateIngressRequest
	(*IngressAudioOptions)(nil),         // 5: samvaad.IngressAudioOptions
	(*IngressVideoOptions)(nil),         // 6: samvaad.IngressVideoOptions
	(*IngressAudioEncodingOptions)(nil), // 7: samvaad.IngressAudioEncodingOptions
	(*IngressVideoEncodingOptions)(nil), // 8: samvaad.IngressVideoEncodingOptions
	(*IngressInfo)(nil),                 // 9: samvaad.IngressInfo
	(*IngressState)(nil),                // 10: samvaad.IngressState
	(*InputVideoState)(nil),             // 11: samvaad.InputVideoState
	(*InputAudioState)(nil),             // 12: samvaad.InputAudioState
	(*UpdateIngressRequest)(nil),        // 13: samvaad.UpdateIngressRequest
	(*ListIngressRequest)(nil),          // 14: samvaad.ListIngressRequest
	(*ListIngressResponse)(nil),         // 15: samvaad.ListIngressResponse
	(*DeleteIngressRequest)(nil),        // 16: samvaad.DeleteIngressRequest
	(TrackSource)(0),                    // 17: samvaad.TrackSource
	(AudioCodec)(0),                     // 18: samvaad.AudioCodec
	(VideoCodec)(0),                     // 19: samvaad.VideoCodec
	(*VideoLayer)(nil),                  // 20: samvaad.VideoLayer
	(*TrackInfo)(nil),                   // 21: samvaad.TrackInfo
	(*TokenPagination)(nil),             // 22: samvaad.TokenPagination
}
var file_samvaad_ingress_proto_depIdxs = []int32{
	0,  // 0: samvaad.CreateIngressRequest.input_type:type_name -> samvaad.IngressInput
	5,  // 1: samvaad.CreateIngressRequest.audio:type_name -> samvaad.IngressAudioOptions
	6,  // 2: samvaad.CreateIngressRequest.video:type_name -> samvaad.IngressVideoOptions
	17, // 3: samvaad.IngressAudioOptions.source:type_name -> samvaad.TrackSource
	1,  // 4: samvaad.IngressAudioOptions.preset:type_name -> samvaad.IngressAudioEncodingPreset
	7,  // 5: samvaad.IngressAudioOptions.options:type_name -> samvaad.IngressAudioEncodingOptions
	17, // 6: samvaad.IngressVideoOptions.source:type_name -> samvaad.TrackSource
	2,  // 7: samvaad.IngressVideoOptions.preset:type_name -> samvaad.IngressVideoEncodingPreset
	8,  // 8: samvaad.IngressVideoOptions.options:type_name -> samvaad.IngressVideoEncodingOptions
	18, // 9: samvaad.IngressAudioEncodingOptions.audio_codec:type_name -> samvaad.AudioCodec
	19, // 10: samvaad.IngressVideoEncodingOptions.video_codec:type_name -> samvaad.VideoCodec
	20, // 11: samvaad.IngressVideoEncodingOptions.layers:type_name -> samvaad.VideoLayer
	0,  // 12: samvaad.IngressInfo.input_type:type_name -> samvaad.IngressInput
	5,  // 13: samvaad.IngressInfo.audio:type_name -> samvaad.IngressAudioOptions
	6,  // 14: samvaad.IngressInfo.video:type_name -> samvaad.IngressVideoOptions
	10, // 15: samvaad.IngressInfo.state:type_name -> samvaad.IngressState
	3,  // 16: samvaad.IngressState.status:type_name -> samvaad.IngressState.Status
	11, // 17: samvaad.IngressState.video:type_name -> samvaad.InputVideoState
	12, // 18: samvaad.IngressState.audio:type_name -> samvaad.InputAudioState
	21, // 19: samvaad.IngressState.tracks:type_name -> samvaad.TrackInfo
	5,  // 20: samvaad.UpdateIngressRequest.audio:type_name -> samvaad.IngressAudioOptions
	6,  // 21: samvaad.UpdateIngressRequest.video:type_name -> samvaad.IngressVideoOptions
	22, // 22: samvaad.ListIngressRequest.page_token:type_name -> samvaad.TokenPagination
	22, // 23: samvaad.ListIngressResponse.next_page_token:type_name -> samvaad.TokenPagination
	9,  // 24: samvaad.ListIngressResponse.items:type_name -> samvaad.IngressInfo
	4,  // 25: samvaad.Ingress.CreateIngress:input_type -> samvaad.CreateIngressRequest
	13, // 26: samvaad.Ingress.UpdateIngress:input_type -> samvaad.UpdateIngressRequest
	14, // 27: samvaad.Ingress.ListIngress:input_type -> samvaad.ListIngressRequest
	16, // 28: samvaad.Ingress.DeleteIngress:input_type -> samvaad.DeleteIngressRequest
	9,  // 29: samvaad.Ingress.CreateIngress:output_type -> samvaad.IngressInfo
	9,  // 30: samvaad.Ingress.UpdateIngress:output_type -> samvaad.IngressInfo
	15, // 31: samvaad.Ingress.ListIngress:output_type -> samvaad.ListIngressResponse
	9,  // 32: samvaad.Ingress.DeleteIngress:output_type -> samvaad.IngressInfo
...
func init() { file_samvaad_ingress_proto_init() }
func file_samvaad_ingress_proto_init() {
	if File_samvaad_ingress_proto != nil {
		return
	}
	file_samvaad_models_proto_init()
	file_samvaad_ingress_proto_msgTypes[0].OneofWrappers = []any{}
	file_samvaad_ingress_proto_msgTypes[1].OneofWrappers = []any{
		(*IngressAudioOptions_Preset)(nil),
		(*IngressAudioOptions_Options)(nil),
	}
	file_samvaad_ingress_proto_msgTypes[2].OneofWrappers = []any{
		(*IngressVideoOptions_Preset)(nil),
		(*IngressVideoOptions_Options)(nil),
	}
	file_samvaad_ingress_proto_msgTypes[5].OneofWrappers = []any{}
	file_samvaad_ingress_proto_msgTypes[9].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_samvaad_ingress_proto_rawDesc), len(file_samvaad_ingress_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_samvaad_ingress_proto_goTypes,
		DependencyIndexes: file_samvaad_ingress_proto_depIdxs,
		EnumInfos:         file_samvaad_ingress_proto_enumTypes,
		MessageInfos:      file_samvaad_ingress_proto_msgTypes,
	}.Build()
	File_samvaad_ingress_proto = out.File
	file_samvaad_ingress_proto_goTypes = nil
	file_samvaad_ingress_proto_depIdxs = nil
}
