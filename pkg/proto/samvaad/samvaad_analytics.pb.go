...
// 	protoc        v4.23.4
// source: samvaad_analytics.proto
...
func (StreamType) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_analytics_proto_enumTypes[0].Descriptor()
}

func (StreamType) Type() protoreflect.EnumType {
	return &file_samvaad_analytics_proto_enumTypes[0]
}
...
func (StreamType) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{0}
}
...
func (AnalyticsEventType) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_analytics_proto_enumTypes[1].Descriptor()
}

func (AnalyticsEventType) Type() protoreflect.EnumType {
	return &file_samvaad_analytics_proto_enumTypes[1]
}
...
func (AnalyticsEventType) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{1}
}
...
func (FeatureUsageInfo_Feature) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_analytics_proto_enumTypes[2].Descriptor()
}

func (FeatureUsageInfo_Feature) Type() protoreflect.EnumType {
	return &file_samvaad_analytics_proto_enumTypes[2]
}
...
func (FeatureUsageInfo_Feature) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{12, 0}
}
...
func (x *AnalyticsVideoLayer) Reset() {
	*x = AnalyticsVideoLayer{}
	mi := &file_samvaad_analytics_proto_msgTypes[0]
...
func (x *AnalyticsStream) Reset() {
	*x = AnalyticsStream{}
	mi := &file_samvaad_analytics_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AnalyticsStat struct {
	...
	Kind          StreamType             `protobuf:"varint,2,opt,name=kind,proto3,enum=samvaad.StreamType" json:"kind,omitempty"`
...
func (x *AnalyticsStat) Reset() {
	*x = AnalyticsStat{}
	mi := &file_samvaad_analytics_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnalyticsStat) Descriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{2}
}
...
func (x *AnalyticsStats) Reset() {
	*x = AnalyticsStats{}
	mi := &file_samvaad_analytics_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnalyticsStats) Descriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{3}
}
...
type AnalyticsClientMeta struct {
	...
	ReconnectReason ReconnectReason `protobuf:"varint,6,opt,name=reconnect_reason,json=reconnectReason,proto3,enum=samvaad.ReconnectReason" json:"reconnect_reason,omitempty"`
...
func (x *AnalyticsClientMeta) Reset() {
	*x = AnalyticsClientMeta{}
	mi := &file_samvaad_analytics_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnalyticsClientMeta) Descriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{4}
}
...
type AnalyticsEvent struct {
	...
	Type                      AnalyticsEventType     `protobuf:"varint,1,opt,name=type,proto3,enum=samvaad.AnalyticsEventType" json:"type,omitempty"`
	...
	MaxSubscribedVideoQuality VideoQuality           `protobuf:"varint,14,opt,name=max_subscribed_video_quality,json=maxSubscribedVideoQuality,proto3,enum=samvaad.VideoQuality" json:"max_subscribed_video_quality,omitempty"`
...
func (x *AnalyticsEvent) Reset() {
	*x = AnalyticsEvent{}
	mi := &file_samvaad_analytics_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnalyticsEvent) Descriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{5}
}
...
func (x *AnalyticsEvents) Reset() {
	*x = AnalyticsEvents{}
	mi := &file_samvaad_analytics_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnalyticsEvents) Descriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{6}
}
...
type AnalyticsRoomParticipant struct {
	...
	State         ParticipantInfo_State  `protobuf:"varint,4,opt,name=state,proto3,enum=samvaad.ParticipantInfo_State" json:"state,omitempty"`
...
func (x *AnalyticsRoomParticipant) Reset() {
	*x = AnalyticsRoomParticipant{}
	mi := &file_samvaad_analytics_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnalyticsRoomParticipant) Descriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{7}
}
...
func (x *AnalyticsRoom) Reset() {
	*x = AnalyticsRoom{}
	mi := &file_samvaad_analytics_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnalyticsRoom) Descriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{8}
}
...
func (x *AnalyticsNodeRooms) Reset() {
	*x = AnalyticsNodeRooms{}
	mi := &file_samvaad_analytics_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AnalyticsNodeRooms) Descriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{9}
}
...
func (x *ReportInfo) Reset() {
	*x = ReportInfo{}
	mi := &file_samvaad_analytics_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReportInfo) Descriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{10}
}
...
func (x *TimeRange) Reset() {
	*x = TimeRange{}
	mi := &file_samvaad_analytics_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TimeRange) Descriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{11}
}
...
type FeatureUsageInfo struct {
	state               protoimpl.MessageState   `protogen:"open.v1"`
	Feature             FeatureUsageInfo_Feature `protobuf:"varint,1,opt,name=feature,proto3,enum=samvaad.FeatureUsageInfo_Feature" json:"feature,omitempty"`
...
func (x *FeatureUsageInfo) Reset() {
	*x = FeatureUsageInfo{}
	mi := &file_samvaad_analytics_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FeatureUsageInfo) Descriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{12}
}
...
func (x *APICallRequest) Reset() {
	*x = APICallRequest{}
	mi := &file_samvaad_analytics_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*APICallRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{13}
}
...
func (x *APICallInfo) Reset() {
	*x = APICallInfo{}
	mi := &file_samvaad_analytics_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*APICallInfo) Descriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{14}
}
...
func (x *WebhookInfo) Reset() {
	*x = WebhookInfo{}
	mi := &file_samvaad_analytics_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WebhookInfo) Descriptor() ([]byte, []int) {
	return file_samvaad_analytics_proto_rawDescGZIP(), []int{15}
}
...
var File_samvaad_analytics_proto protoreflect.FileDescriptor

const file_samvaad_analytics_proto_rawDesc = "" +
	"\n" +
	"\x17\x6c\x69\x76\x65\x6b\x69\x74_analytics.proto\x12\a\x6c\x69\x76\x65\x6b\x69\x74\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x14\x6c\x69\x76\x65\x6b\x69\x74_models.proto\x1a\x14\x6c\x69\x76\x65\x6b\x69\x74_egress.proto\x1a\x15\x6c\x69\x76\x65\x6b\x69\x74_ingress.proto\x1a\x11\x6c\x69\x76\x65\x6b\x69\x74_sip.proto\x1a\x12\x6c\x69\x76\x65\x6b\x69\x74_room.proto\x1a\x14logger/options.proto\"s\n" +
	...
	"\fvideo_layers\x18\x0f \x03(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.AnalyticsVideoLayerR\vvideoLayers\x129\n" +
	"\n" +
	...
	"\x04kind\x18\x02 \x01(\x0e2\x13.\x6c\x69\x76\x65\x6b\x69\x74.StreamTypeR\x04kind\x129\n" +
	"\n" +
	...
	"\astreams\x18\n" +
	" \x03(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.AnalyticsStreamR\astreams\x12\x12\n" +
	...
	"\x05stats\x18\x01 \x03(\v2\x16.\x6c\x69\x76\x65\x6b\x69\x74.AnalyticsStatR\x05stats\"\x82\x03\n" +
	...
	"\x10reconnect_reason\x18\x06 \x01(\x0e2\x18.\x6c\x69\x76\x65\x6b\x69\x74.ReconnectReasonR\x0freconnectReason\x12\x1e\n" +
	...
	"\x04type\x18\x01 \x01(\x0e2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.AnalyticsEventTypeR\x04type\x128\n" +
	"\ttimestamp\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12\"\n" +
	"\aroom_id\x18\x03 \x01(\tB\t\xbaP\x06roomIDR\x06roomId\x12!\n" +
	"\x04room\x18\x04 \x01(\v2\r.\x6c\x69\x76\x65\x6b\x69\x74.RoomR\x04room\x127\n" +
	"\x0eparticipant_id\x18\x05 \x01(\tB\x10\xbaP\rparticipantIDR\rparticipantId\x12:\n" +
	"\vparticipant\x18\x06 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.ParticipantInfoR\vparticipant\x12%\n" +
	"\btrack_id\x18\a \x01(\tB\n" +
	"\xbaP\atrackIDR\atrackId\x12(\n" +
	"\x05track\x18\b \x01(\v2\x12.\x6c\x69\x76\x65\x6b\x69\x74.TrackInfoR\x05track\x12#\n" +
	"\ranalytics_key\x18\n" +
	" \x01(\tR\fanalyticsKey\x124\n" +
	"\vclient_info\x18\v \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.ClientInfoR\n" +
	"clientInfo\x12=\n" +
	"\vclient_meta\x18\f \x01(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.AnalyticsClientMetaR\n" +
	"clientMeta\x12(\n" +
	"\tegress_id\x18\r \x01(\tB\v\xbaP\begressIDR\begressId\x12+\n" +
	"\n" +
	"ingress_id\x18\x13 \x01(\tB\f\xbaP\tingressIDR\tingressId\x12V\n" +
	"\x1cmax_subscribed_video_quality\x18\x0e \x01(\x0e2\x15.\x6c\x69\x76\x65\x6b\x69\x74.VideoQualityR\x19maxSubscribedVideoQuality\x126\n" +
	"\tpublisher\x18\x0f \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.ParticipantInfoR\tpublisher\x12\x12\n" +
	"\x04mime\x18\x10 \x01(\tR\x04mime\x12+\n" +
	"\x06egress\x18\x11 \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.EgressInfoR\x06egress\x12.\n" +
	"\aingress\x18\x12 \x01(\v2\x14.\x6c\x69\x76\x65\x6b\x69\x74.IngressInfoR\aingress\x12\x14\n" +
	"\x05error\x18\x14 \x01(\tR\x05error\x12.\n" +
	"\trtp_stats\x18\x15 \x01(\v2\x11.\x6c\x69\x76\x65\x6b\x69\x74.RTPStatsR\brtpStats\x12\x1f\n" +
	...
	"\bsip_call\x18\x1b \x01(\v2\x14.\x6c\x69\x76\x65\x6b\x69\x74.SIPCallInfoR\asipCall\x12/\n" +
	"\fsip_trunk_id\x18\x1c \x01(\tB\r\xbaP\n" +
	"sipTrunkIDR\n" +
	"sipTrunkId\x12H\n" +
	"\x11sip_inbound_trunk\x18\x1d \x01(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.SIPInboundTrunkInfoR\x0fsipInboundTrunk\x12K\n" +
	"\x12sip_outbound_trunk\x18\x1e \x01(\v2\x1d.\x6c\x69\x76\x65\x6b\x69\x74.SIPOutboundTrunkInfoR\x10sipOutboundTrunk\x12E\n" +
	"\x14sip_dispatch_rule_id\x18\x1f \x01(\tB\x14\xbaP\x11sipDispatchRuleIDR\x11sipDispatchRuleId\x12H\n" +
	"\x11sip_dispatch_rule\x18  \x01(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.SIPDispatchRuleInfoR\x0fsipDispatchRule\x12;\n" +
	"\fsip_transfer\x18$ \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.SIPTransferInfoR\vsipTransfer\x12+\n" +
	"\x06report\x18! \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.ReportInfoR\x06report\x12/\n" +
	"\bapi_call\x18\" \x01(\v2\x14.\x6c\x69\x76\x65\x6b\x69\x74.APICallInfoR\aapiCall\x12.\n" +
	"\awebhook\x18# \x01(\v2\x14.\x6c\x69\x76\x65\x6b\x69\x74.WebhookInfoR\awebhook\"B\n" +
	"\x0fAnalyticsEvents\x12/\n" +
	"\x06events\x18\x01 \x03(\v2\x17.\x6c\x69\x76\x65\x6b\x69\x74.AnalyticsEventR\x06events\"\xc9\x01\n" +
	"\x18AnalyticsRoomParticipant\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1a\n" +
	"\bidentity\x18\x02 \x01(\tR\bidentity\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x124\n" +
	"\x05state\x18\x04 \x01(\x0e2\x1e.\x6c\x69\x76\x65\x6b\x69\x74.ParticipantInfo.StateR\x05state\x127\n" +
	...
	"\fparticipants\x18\x04 \x03(\v2!.\x6c\x69\x76\x65\x6b\x69\x74.AnalyticsRoomParticipantR\fparticipants\"\xc9\x01\n" +
	...
	"\x05rooms\x18\x04 \x03(\v2\x16.\x6c\x69\x76\x65\x6b\x69\x74.AnalyticsRoomR\x05rooms\"Y\n" +
	"\n" +
	"ReportInfo\x12@\n" +
	"\rfeature_usage\x18\x01 \x01(\v2\x19.\x6c\x69\x76\x65\x6b\x69\x74.FeatureUsageInfoH\x00R\ffeatureUsageB\t\n" +
	"\amessage\"}\n" +
	"\tTimeRange\x129\n" +
	"\n" +
	...
	"\afeature\x18\x01 \x01(\x0e2!.\x6c\x69\x76\x65\x6b\x69\x74.FeatureUsageInfo.FeatureR\afeature\x12+\n" +
	"\n" +
	...
	"\vtime_ranges\x18\b \x03(\v2\x12.\x6c\x69\x76\x65\x6b\x69\x74.TimeRangeR\n" +
	"timeRanges\x12M\n" +
	"\ffeature_info\x18\t \x03(\v2*.\x6c\x69\x76\x65\x6b\x69\x74.FeatureUsageInfo.FeatureInfoEntryR\vfeatureInfo\x1a>\n" +
	...
	"\x13create_room_request\x18\x01 \x01(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.CreateRoomRequestH\x00R\x11createRoomRequest\x12I\n" +
	"\x12list_rooms_request\x18\x02 \x01(\v2\x19.\x6c\x69\x76\x65\x6b\x69\x74.ListRoomsRequestH\x00R\x10listRoomsRequest\x12L\n" +
	"\x13delete_room_request\x18\x03 \x01(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.DeleteRoomRequestH\x00R\x11deleteRoomRequest\x12^\n" +
	"\x19list_participants_request\x18\x04 \x01(\v2 .\x6c\x69\x76\x65\x6b\x69\x74.ListParticipantsRequestH\x00R\x17listParticipantsRequest\x12^\n" +
	"\x19room_participant_identity\x18\x05 \x01(\v2 .\x6c\x69\x76\x65\x6b\x69\x74.RoomParticipantIdentityH\x00R\x17roomParticipantIdentity\x12V\n" +
	"\x17mute_room_track_request\x18\x06 \x01(\v2\x1d.\x6c\x69\x76\x65\x6b\x69\x74.MuteRoomTrackRequestH\x00R\x14muteRoomTrackRequest\x12a\n" +
	"\x1aupdate_participant_request\x18\a \x01(\v2!.\x6c\x69\x76\x65\x6b\x69\x74.UpdateParticipantRequestH\x00R\x18updateParticipantRequest\x12g\n" +
	"\x1cupdate_subscriptions_request\x18\b \x01(\v2#.\x6c\x69\x76\x65\x6b\x69\x74.UpdateSubscriptionsRequestH\x00R\x1aupdateSubscriptionsRequest\x12F\n" +
	"\x11send_data_request\x18\t \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.SendDataRequestH\x00R\x0fsendDataRequest\x12e\n" +
	"\x1cupdate_room_metadata_request\x18\n" +
	" \x01(\v2\".\x6c\x69\x76\x65\x6b\x69\x74.UpdateRoomMetadataRequestH\x00R\x19updateRoomMetadataRequestB\t\n" +
	"\amessage\"\xe5\x04\n" +
	"\vAPICallInfo\x12+\n" +
	"\n" +
	"project_id\x18\x01 \x01(\tB\f\xbaP\tprojectIDR\tprojectId\x121\n" +
	"\arequest\x18\x02 \x01(\v2\x17.\x6c\x69\x76\x65\x6b\x69\x74.APICallRequestR\arequest\x12\x18\n" +
	...
	"\x06REPORT\x10(\x12\f\n" +
	"\bAPI_CALL\x10)\x12\v\n" +
	"\aWEBHOOK\x10*BFZ#github.com/\x6c\x69\x76\x65\x6b\x69\x74/protocol/\x6c\x69\x76\x65\x6b\x69\x74\xaa\x02\r\x4c\x69\x76\x65\x4b\x69\x74.Proto\xea\x02\x0e\x4c\x69\x76\x65\x4b\x69\x74::Protob\x06proto3"

var (
	file_samvaad_analytics_proto_rawDescOnce sync.Once
	file_samvaad_analytics_proto_rawDescData []byte
)

func file_samvaad_analytics_proto_rawDescGZIP() []byte {
	file_samvaad_analytics_proto_rawDescOnce.Do(func() {
		file_samvaad_analytics_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_samvaad_analytics_proto_rawDesc), len(file_samvaad_analytics_proto_rawDesc)))
	})
	return file_samvaad_analytics_proto_rawDescData
}

var file_samvaad_analytics_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_samvaad_analytics_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_samvaad_analytics_proto_goTypes = []any{
	(StreamType)(0),                    // 0: samvaad.StreamType
	(AnalyticsEventType)(0),            // 1: samvaad.AnalyticsEventType
	(FeatureUsageInfo_Feature)(0),      // 2: samvaad.FeatureUsageInfo.Feature
	(*AnalyticsVideoLayer)(nil),        // 3: samvaad.AnalyticsVideoLayer
	(*AnalyticsStream)(nil),            // 4: samvaad.AnalyticsStream
	(*AnalyticsStat)(nil),              // 5: samvaad.AnalyticsStat
	(*AnalyticsStats)(nil),             // 6: samvaad.AnalyticsStats
	(*AnalyticsClientMeta)(nil),        // 7: samvaad.AnalyticsClientMeta
	(*AnalyticsEvent)(nil),             // 8: samvaad.AnalyticsEvent
	(*AnalyticsEvents)(nil),            // 9: samvaad.AnalyticsEvents
	(*AnalyticsRoomParticipant)(nil),   // 10: samvaad.AnalyticsRoomParticipant
	(*AnalyticsRoom)(nil),              // 11: samvaad.AnalyticsRoom
	(*AnalyticsNodeRooms)(nil),         // 12: samvaad.AnalyticsNodeRooms
	(*ReportInfo)(nil),                 // 13: samvaad.ReportInfo
	(*TimeRange)(nil),                  // 14: samvaad.TimeRange
	(*FeatureUsageInfo)(nil),           // 15: samvaad.FeatureUsageInfo
	(*APICallRequest)(nil),             // 16: samvaad.APICallRequest
	(*APICallInfo)(nil),                // 17: samvaad.APICallInfo
	(*WebhookInfo)(nil),                // 18: samvaad.WebhookInfo
	nil,                                // 19: samvaad.FeatureUsageInfo.FeatureInfoEntry
	(*timestamppb.Timestamp)(nil),      // 20: google.protobuf.Timestamp
	(ReconnectReason)(0),               // 21: samvaad.ReconnectReason
	(*Room)(nil),                       // 22: samvaad.Room
	(*ParticipantInfo)(nil),            // 23: samvaad.ParticipantInfo
	(*TrackInfo)(nil),                  // 24: samvaad.TrackInfo
	(*ClientInfo)(nil),                 // 25: samvaad.ClientInfo
	(VideoQuality)(0),                  // 26: samvaad.VideoQuality
	(*EgressInfo)(nil),                 // 27: samvaad.EgressInfo
	(*IngressInfo)(nil),                // 28: samvaad.IngressInfo
	(*RTPStats)(nil),                   // 29: samvaad.RTPStats
	(*SIPCallInfo)(nil),                // 30: samvaad.SIPCallInfo
	(*SIPInboundTrunkInfo)(nil),        // 31: samvaad.SIPInboundTrunkInfo
	(*SIPOutboundTrunkInfo)(nil),       // 32: samvaad.SIPOutboundTrunkInfo
	(*SIPDispatchRuleInfo)(nil),        // 33: samvaad.SIPDispatchRuleInfo
	(*SIPTransferInfo)(nil),            // 34: samvaad.SIPTransferInfo
	(ParticipantInfo_State)(0),         // 35: samvaad.ParticipantInfo.State
	(*CreateRoomRequest)(nil),          // 36: samvaad.CreateRoomRequest
	(*ListRoomsRequest)(nil),           // 37: samvaad.ListRoomsRequest
	(*DeleteRoomRequest)(nil),          // 38: samvaad.DeleteRoomRequest
	(*ListParticipantsRequest)(nil),    // 39: samvaad.ListParticipantsRequest
	(*RoomParticipantIdentity)(nil),    // 40: samvaad.RoomParticipantIdentity
	(*MuteRoomTrackRequest)(nil),       // 41: samvaad.MuteRoomTrackRequest
	(*UpdateParticipantRequest)(nil),   // 42: samvaad.UpdateParticipantRequest
	(*UpdateSubscriptionsRequest)(nil), // 43: samvaad.UpdateSubscriptionsRequest
	(*SendDataRequest)(nil),            // 44: samvaad.SendDataRequest
	(*UpdateRoomMetadataRequest)(nil),  // 45: samvaad.UpdateRoomMetadataRequest
}
var file_samvaad_analytics_proto_depIdxs = []int32{
	3,  // 0: samvaad.AnalyticsStream.video_layers:type_name -> samvaad.AnalyticsVideoLayer
	20, // 1: samvaad.AnalyticsStream.start_time:type_name -> google.protobuf.Timestamp
	20, // 2: samvaad.AnalyticsStream.end_time:type_name -> google.protobuf.Timestamp
	0,  // 3: samvaad.AnalyticsStat.kind:type_name -> samvaad.StreamType
	20, // 4: samvaad.AnalyticsStat.time_stamp:type_name -> google.protobuf.Timestamp
	4,  // 5: samvaad.AnalyticsStat.streams:type_name -> samvaad.AnalyticsStream
	5,  // 6: samvaad.AnalyticsStats.stats:type_name -> samvaad.AnalyticsStat
	21, // 7: samvaad.AnalyticsClientMeta.reconnect_reason:type_name -> samvaad.ReconnectReason
	1,  // 8: samvaad.AnalyticsEvent.type:type_name -> samvaad.AnalyticsEventType
	20, // 9: samvaad.AnalyticsEvent.timestamp:type_name -> google.protobuf.Timestamp
	22, // 10: samvaad.AnalyticsEvent.room:type_name -> samvaad.Room
	23, // 11: samvaad.AnalyticsEvent.participant:type_name -> samvaad.ParticipantInfo
	24, // 12: samvaad.AnalyticsEvent.track:type_name -> samvaad.TrackInfo
	25, // 13: samvaad.AnalyticsEvent.client_info:type_name -> samvaad.ClientInfo
	7,  // 14: samvaad.AnalyticsEvent.client_meta:type_name -> samvaad.AnalyticsClientMeta
	26, // 15: samvaad.AnalyticsEvent.max_subscribed_video_quality:type_name -> samvaad.VideoQuality
	23, // 16: samvaad.AnalyticsEvent.publisher:type_name -> samvaad.ParticipantInfo
	27, // 17: samvaad.AnalyticsEvent.egress:type_name -> samvaad.EgressInfo
	28, // 18: samvaad.AnalyticsEvent.ingress:type_name -> samvaad.IngressInfo
	29, // 19: samvaad.AnalyticsEvent.rtp_stats:type_name -> samvaad.RTPStats
	30, // 20: samvaad.AnalyticsEvent.sip_call:type_name -> samvaad.SIPCallInfo
	31, // 21: samvaad.AnalyticsEvent.sip_inbound_trunk:type_name -> samvaad.SIPInboundTrunkInfo
	32, // 22: samvaad.AnalyticsEvent.sip_outbound_trunk:type_name -> samvaad.SIPOutboundTrunkInfo
	33, // 23: samvaad.AnalyticsEvent.sip_dispatch_rule:type_name -> samvaad.SIPDispatchRuleInfo
	34, // 24: samvaad.AnalyticsEvent.sip_transfer:type_name -> samvaad.SIPTransferInfo
	13, // 25: samvaad.AnalyticsEvent.report:type_name -> samvaad.ReportInfo
	17, // 26: samvaad.AnalyticsEvent.api_call:type_name -> samvaad.APICallInfo
	18, // 27: samvaad.AnalyticsEvent.webhook:type_name -> samvaad.WebhookInfo
	8,  // 28: samvaad.AnalyticsEvents.events:type_name -> samvaad.AnalyticsEvent
	35, // 29: samvaad.AnalyticsRoomParticipant.state:type_name -> samvaad.ParticipantInfo.State
	20, // 30: samvaad.AnalyticsRoomParticipant.joined_at:type_name -> google.protobuf.Timestamp
	20, // 31: samvaad.AnalyticsRoom.created_at:type_name -> google.protobuf.Timestamp
	10, // 32: samvaad.AnalyticsRoom.participants:type_name -> samvaad.AnalyticsRoomParticipant
	20, // 33: samvaad.AnalyticsNodeRooms.timestamp:type_name -> google.protobuf.Timestamp
	11, // 34: samvaad.AnalyticsNodeRooms.rooms:type_name -> samvaad.AnalyticsRoom
	15, // 35: samvaad.ReportInfo.feature_usage:type_name -> samvaad.FeatureUsageInfo
	20, // 36: samvaad.TimeRange.started_at:type_name -> google.protobuf.Timestamp
	20, // 37: samvaad.TimeRange.ended_at:type_name -> google.protobuf.Timestamp
	2,  // 38: samvaad.FeatureUsageInfo.feature:type_name -> samvaad.FeatureUsageInfo.Feature
	14, // 39: samvaad.FeatureUsageInfo.time_ranges:type_name -> samvaad.TimeRange
	19, // 40: samvaad.FeatureUsageInfo.feature_info:type_name -> samvaad.FeatureUsageInfo.FeatureInfoEntry
	36, // 41: samvaad.APICallRequest.create_room_request:type_name -> samvaad.CreateRoomRequest
	37, // 42: samvaad.APICallRequest.list_rooms_request:type_name -> samvaad.ListRoomsRequest
	38, // 43: samvaad.APICallRequest.delete_room_request:type_name -> samvaad.DeleteRoomRequest
	39, // 44: samvaad.APICallRequest.list_participants_request:type_name -> samvaad.ListParticipantsRequest
	40, // 45: samvaad.APICallRequest.room_participant_identity:type_name -> samvaad.RoomParticipantIdentity
	41, // 46: samvaad.APICallRequest.mute_room_track_request:type_name -> samvaad.MuteRoomTrackRequest
	42, // 47: samvaad.APICallRequest.update_participant_request:type_name -> samvaad.UpdateParticipantRequest
	43, // 48: samvaad.APICallRequest.update_subscriptions_request:type_name -> samvaad.UpdateSubscriptionsRequest
	44, // 49: samvaad.APICallRequest.send_data_request:type_name -> samvaad.SendDataRequest
	45, // 50: samvaad.APICallRequest.update_room_metadata_request:type_name -> samvaad.UpdateRoomMetadataRequest
	16, // 51: samvaad.APICallInfo.request:type_name -> samvaad.APICallRequest
	20, // 52: samvaad.APICallInfo.started_at:type_name -> google.protobuf.Timestamp
	20, // 53: samvaad.WebhookInfo.created_at:type_name -> google.protobuf.Timestamp
	20, // 54: samvaad.WebhookInfo.queued_at:type_name -> google.protobuf.Timestamp
	20, // 55: samvaad.WebhookInfo.sent_at:type_name -> google.protobuf.Timestamp
...
func init() { file_samvaad_analytics_proto_init() }
func file_samvaad_analytics_proto_init() {
	if File_samvaad_analytics_proto != nil {
		return
	}
	file_samvaad_models_proto_init()
	file_samvaad_egress_proto_init()
	file_samvaad_ingress_proto_init()
	file_samvaad_sip_proto_init()
	file_samvaad_room_proto_init()
	file_samvaad_analytics_proto_msgTypes[4].OneofWrappers = []any{}
	file_samvaad_analytics_proto_msgTypes[10].OneofWrappers = []any{
		(*ReportInfo_FeatureUsage)(nil),
	}
	file_samvaad_analytics_proto_msgTypes[13].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_samvaad_analytics_proto_rawDesc), len(file_samvaad_analytics_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_samvaad_analytics_proto_goTypes,
		DependencyIndexes: file_samvaad_analytics_proto_depIdxs,
		EnumInfos:         file_samvaad_analytics_proto_enumTypes,
		MessageInfos:      file_samvaad_analytics_proto_msgTypes,
	}.Build()
	File_samvaad_analytics_proto = out.File
	file_samvaad_analytics_proto_goTypes = nil
	file_samvaad_analytics_proto_depIdxs = nil
}
