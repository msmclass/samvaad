...
func NewSIPProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) SIP {
	...
	serviceURL += baseServicePath(pathPrefix, "samvaad", "SIP")
	urls := [16]string{
...
const SIPPathPrefix = "/twirp/samvaad.SIP/"
...
func (s *sIPServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "samvaad", "SIP")
}
