...
// 	protoc        v4.23.4
// source: samvaad_phone_number.proto
...
func (PhoneNumberStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_phone_number_proto_enumTypes[0].Descriptor()
}

func (PhoneNumberStatus) Type() protoreflect.EnumType {
	return &file_samvaad_phone_number_proto_enumTypes[0]
}
...
func (PhoneNumberStatus) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_phone_number_proto_rawDescGZIP(), []int{0}
}
...
func (PhoneNumberType) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_phone_number_proto_enumTypes[1].Descriptor()
}

func (PhoneNumberType) Type() protoreflect.EnumType {
	return &file_samvaad_phone_number_proto_enumTypes[1]
}
...
func (PhoneNumberType) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_phone_number_proto_rawDescGZIP(), []int{1}
}
...
func (x *SearchPhoneNumbersRequest) Reset() {
	*x = SearchPhoneNumbersRequest{}
	mi := &file_samvaad_phone_number_proto_msgTypes[0]
...
func (x *SearchPhoneNumbersResponse) Reset() {
	*x = SearchPhoneNumbersResponse{}
	mi := &file_samvaad_phone_number_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *PurchasePhoneNumberRequest) Reset() {
	*x = PurchasePhoneNumberRequest{}
	mi := &file_samvaad_phone_number_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PurchasePhoneNumberRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_phone_number_proto_rawDescGZIP(), []int{2}
}
...
func (x *PurchasePhoneNumberResponse) Reset() {
	*x = PurchasePhoneNumberResponse{}
	mi := &file_samvaad_phone_number_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PurchasePhoneNumberResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_phone_number_proto_rawDescGZIP(), []int{3}
}
...
type ListPhoneNumbersRequest struct {
	...
	Statuses          []PhoneNumberStatus    `protobuf:"varint,2,rep,packed,name=statuses,proto3,enum=samvaad.PhoneNumberStatus" json:"statuses,omitempty"`               // Filter by statuses (active, pending, released)
...
func (x *ListPhoneNumbersRequest) Reset() {
	*x = ListPhoneNumbersRequest{}
	mi := &file_samvaad_phone_number_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListPhoneNumbersRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_phone_number_proto_rawDescGZIP(), []int{4}
}
...
func (x *ListPhoneNumbersResponse) Reset() {
	*x = ListPhoneNumbersResponse{}
	mi := &file_samvaad_phone_number_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListPhoneNumbersResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_phone_number_proto_rawDescGZIP(), []int{5}
}
...
func (x *GetPhoneNumberRequest) Reset() {
	*x = GetPhoneNumberRequest{}
	mi := &file_samvaad_phone_number_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetPhoneNumberRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_phone_number_proto_rawDescGZIP(), []int{6}
}
...
func (x *GetPhoneNumberResponse) Reset() {
	*x = GetPhoneNumberResponse{}
	mi := &file_samvaad_phone_number_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetPhoneNumberResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_phone_number_proto_rawDescGZIP(), []int{7}
}
...
func (x *UpdatePhoneNumberRequest) Reset() {
	*x = UpdatePhoneNumberRequest{}
	mi := &file_samvaad_phone_number_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdatePhoneNumberRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_phone_number_proto_rawDescGZIP(), []int{8}
}
...
func (x *UpdatePhoneNumberResponse) Reset() {
	*x = UpdatePhoneNumberResponse{}
	mi := &file_samvaad_phone_number_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdatePhoneNumberResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_phone_number_proto_rawDescGZIP(), []int{9}
}
...
func (x *ReleasePhoneNumbersRequest) Reset() {
	*x = ReleasePhoneNumbersRequest{}
	mi := &file_samvaad_phone_number_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReleasePhoneNumbersRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_phone_number_proto_rawDescGZIP(), []int{10}
}
...
func (x *ReleasePhoneNumbersResponse) Reset() {
	*x = ReleasePhoneNumbersResponse{}
	mi := &file_samvaad_phone_number_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReleasePhoneNumbersResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_phone_number_proto_rawDescGZIP(), []int{11}
}
...
type PhoneNumber struct {
	...
	NumberType   PhoneNumberType        `protobuf:"varint,5,opt,name=number_type,json=numberType,proto3,enum=samvaad.PhoneNumberType" json:"number_type,omitempty"` // Number type (mobile, local, toll-free, unknown)
	...
	Status       PhoneNumberStatus      `protobuf:"varint,12,opt,name=status,proto3,enum=samvaad.PhoneNumberStatus" json:"status,omitempty"`                        // Current status
	...
	// Deprecated: Marked as deprecated in samvaad_phone_number.proto.
...
func (x *PhoneNumber) Reset() {
	*x = PhoneNumber{}
	mi := &file_samvaad_phone_number_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PhoneNumber) Descriptor() ([]byte, []int) {
	return file_samvaad_phone_number_proto_rawDescGZIP(), []int{12}
}
...
var File_samvaad_phone_number_proto protoreflect.FileDescriptor

const file_samvaad_phone_number_proto_rawDesc = "" +
	"\n" +
	"\x1a\x6c\x69\x76\x65\x6b\x69\x74_phone_number.proto\x12\a\x6c\x69\x76\x65\x6b\x69\x74\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x14\x6c\x69\x76\x65\x6b\x69\x74_models.proto\x1a\x14logger/options.proto\"\xe0\x01\n" +
	...
	"\n" +
	"page_token\x18\x04 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.TokenPaginationH\x02R\tpageToken\x88\x01\x01B\f\n" +
	"\n" +
	"_area_codeB\b\n" +
	"\x06_limitB\r\n" +
	"\v_page_token\"\x8a\x01\n" +
	"\x1aSearchPhoneNumbersResponse\x12*\n" +
	"\x05items\x18\x01 \x03(\v2\x14.\x6c\x69\x76\x65\x6b\x69\x74.PhoneNumberR\x05items\x12@\n" +
	"\x0fnext_page_token\x18\x02 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.TokenPaginationR\rnextPageToken\"\xa6\x01\n" +
	"\x1aPurchasePhoneNumberRequest\x12#\n" +
	"\rphone_numbers\x18\x01 \x03(\tR\fphoneNumbers\x12J\n" +
	"\x14sip_dispatch_rule_id\x18\x02 \x01(\tB\x14\xbaP\x11sipDispatchRuleIDH\x00R\x11sipDispatchRuleId\x88\x01\x01B\x17\n" +
	"\x15_sip_dispatch_rule_id\"X\n" +
	"\x1bPurchasePhoneNumberResponse\x129\n" +
	"\rphone_numbers\x18\x01 \x03(\v2\x14.\x6c\x69\x76\x65\x6b\x69\x74.PhoneNumberR\fphoneNumbers\"\xa8\x02\n" +
	"\x17ListPhoneNumbersRequest\x12\x19\n" +
	"\x05limit\x18\x01 \x01(\x05H\x00R\x05limit\x88\x01\x01\x126\n" +
	"\bstatuses\x18\x02 \x03(\x0e2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.PhoneNumberStatusR\bstatuses\x12<\n" +
	"\n" +
	"page_token\x18\x03 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.TokenPaginationH\x01R\tpageToken\x88\x01\x01\x12J\n" +
	"\x14sip_dispatch_rule_id\x18\x04 \x01(\tB\x14\xbaP\x11sipDispatchRuleIDH\x02R\x11sipDispatchRuleId\x88\x01\x01B\b\n" +
	"\x06_limitB\r\n" +
	"\v_page_tokenB\x17\n" +
	"\x15_sip_dispatch_rule_id\"\xce\x01\n" +
	"\x18ListPhoneNumbersResponse\x12*\n" +
	"\x05items\x18\x01 \x03(\v2\x14.\x6c\x69\x76\x65\x6b\x69\x74.PhoneNumberR\x05items\x12@\n" +
	"\x0fnext_page_token\x18\x02 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.TokenPaginationR\rnextPageToken\x12\x1f\n" +
	...
	"\fphone_number\x18\x01 \x01(\v2\x14.\x6c\x69\x76\x65\x6b\x69\x74.PhoneNumberR\vphoneNumber\"\xd4\x01\n" +
	...
	"\fphone_number\x18\x01 \x01(\v2\x14.\x6c\x69\x76\x65\x6b\x69\x74.PhoneNumberR\vphoneNumber\"S\n" +
	...
	"\vnumber_type\x18\x05 \x01(\x0e2\x18.\x6c\x69\x76\x65\x6b\x69\x74.PhoneNumberTypeR\n" +
	"numberType\x12\x1a\n" +
	...
	"\x06status\x18\f \x01(\x0e2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.PhoneNumberStatusR\x06status\x12;\n" +
	...
	"\x12SearchPhoneNumbers\x12\".\x6c\x69\x76\x65\x6b\x69\x74.SearchPhoneNumbersRequest\x1a#.\x6c\x69\x76\x65\x6b\x69\x74.SearchPhoneNumbersResponse\"\x00\x12b\n" +
	"\x13PurchasePhoneNumber\x12#.\x6c\x69\x76\x65\x6b\x69\x74.PurchasePhoneNumberRequest\x1a$.\x6c\x69\x76\x65\x6b\x69\x74.PurchasePhoneNumberResponse\"\x00\x12Y\n" +
	"\x10ListPhoneNumbers\x12 .\x6c\x69\x76\x65\x6b\x69\x74.ListPhoneNumbersRequest\x1a!.\x6c\x69\x76\x65\x6b\x69\x74.ListPhoneNumbersResponse\"\x00\x12S\n" +
	"\x0eGetPhoneNumber\x12\x1e.\x6c\x69\x76\x65\x6b\x69\x74.GetPhoneNumberRequest\x1a\x1f.\x6c\x69\x76\x65\x6b\x69\x74.GetPhoneNumberResponse\"\x00\x12\\\n" +
	"\x11UpdatePhoneNumber\x12!.\x6c\x69\x76\x65\x6b\x69\x74.UpdatePhoneNumberRequest\x1a\".\x6c\x69\x76\x65\x6b\x69\x74.UpdatePhoneNumberResponse\"\x00\x12b\n" +
	"\x13ReleasePhoneNumbers\x12#.\x6c\x69\x76\x65\x6b\x69\x74.ReleasePhoneNumbersRequest\x1a$.\x6c\x69\x76\x65\x6b\x69\x74.ReleasePhoneNumbersResponse\"\x00BFZ#github.com/\x6c\x69\x76\x65\x6b\x69\x74/protocol/\x6c\x69\x76\x65\x6b\x69\x74\xaa\x02\r\x4c\x69\x76\x65\x4b\x69\x74.Proto\xea\x02\x0e\x4c\x69\x76\x65\x4b\x69\x74::Protob\x06proto3"

var (
	file_samvaad_phone_number_proto_rawDescOnce sync.Once
	file_samvaad_phone_number_proto_rawDescData []byte
)

func file_samvaad_phone_number_proto_rawDescGZIP() []byte {
	file_samvaad_phone_number_proto_rawDescOnce.Do(func() {
		file_samvaad_phone_number_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_samvaad_phone_number_proto_rawDesc), len(file_samvaad_phone_number_proto_rawDesc)))
	})
	return file_samvaad_phone_number_proto_rawDescData
}

var file_samvaad_phone_number_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_samvaad_phone_number_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_samvaad_phone_number_proto_goTypes = []any{
	(PhoneNumberStatus)(0),              // 0: samvaad.PhoneNumberStatus
	(PhoneNumberType)(0),                // 1: samvaad.PhoneNumberType
	(*SearchPhoneNumbersRequest)(nil),   // 2: samvaad.SearchPhoneNumbersRequest
	(*SearchPhoneNumbersResponse)(nil),  // 3: samvaad.SearchPhoneNumbersResponse
	(*PurchasePhoneNumberRequest)(nil),  // 4: samvaad.PurchasePhoneNumberRequest
	(*PurchasePhoneNumberResponse)(nil), // 5: samvaad.PurchasePhoneNumberResponse
	(*ListPhoneNumbersRequest)(nil),     // 6: samvaad.ListPhoneNumbersRequest
	(*ListPhoneNumbersResponse)(nil),    // 7: samvaad.ListPhoneNumbersResponse
	(*GetPhoneNumberRequest)(nil),       // 8: samvaad.GetPhoneNumberRequest
	(*GetPhoneNumberResponse)(nil),      // 9: samvaad.GetPhoneNumberResponse
	(*UpdatePhoneNumberRequest)(nil),    // 10: samvaad.UpdatePhoneNumberRequest
	(*UpdatePhoneNumberResponse)(nil),   // 11: samvaad.UpdatePhoneNumberResponse
	(*ReleasePhoneNumbersRequest)(nil),  // 12: samvaad.ReleasePhoneNumbersRequest
	(*ReleasePhoneNumbersResponse)(nil), // 13: samvaad.ReleasePhoneNumbersResponse
	(*PhoneNumber)(nil),                 // 14: samvaad.PhoneNumber
	(*TokenPagination)(nil),             // 15: samvaad.TokenPagination
	(*timestamppb.Timestamp)(nil),       // 16: google.protobuf.Timestamp
}
var file_samvaad_phone_number_proto_depIdxs = []int32{
	15, // 0: samvaad.SearchPhoneNumbersRequest.page_token:type_name -> samvaad.TokenPagination
	14, // 1: samvaad.SearchPhoneNumbersResponse.items:type_name -> samvaad.PhoneNumber
	15, // 2: samvaad.SearchPhoneNumbersResponse.next_page_token:type_name -> samvaad.TokenPagination
	14, // 3: samvaad.PurchasePhoneNumberResponse.phone_numbers:type_name -> samvaad.PhoneNumber
	0,  // 4: samvaad.ListPhoneNumbersRequest.statuses:type_name -> samvaad.PhoneNumberStatus
	15, // 5: samvaad.ListPhoneNumbersRequest.page_token:type_name -> samvaad.TokenPagination
	14, // 6: samvaad.ListPhoneNumbersResponse.items:type_name -> samvaad.PhoneNumber
	15, // 7: samvaad.ListPhoneNumbersResponse.next_page_token:type_name -> samvaad.TokenPagination
	14, // 8: samvaad.GetPhoneNumberResponse.phone_number:type_name -> samvaad.PhoneNumber
	14, // 9: samvaad.UpdatePhoneNumberResponse.phone_number:type_name -> samvaad.PhoneNumber
	1,  // 10: samvaad.PhoneNumber.number_type:type_name -> samvaad.PhoneNumberType
	16, // 11: samvaad.PhoneNumber.created_at:type_name -> google.protobuf.Timestamp
	16, // 12: samvaad.PhoneNumber.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 13: samvaad.PhoneNumber.status:type_name -> samvaad.PhoneNumberStatus
	16, // 14: samvaad.PhoneNumber.assigned_at:type_name -> google.protobuf.Timestamp
	16, // 15: samvaad.PhoneNumber.released_at:type_name -> google.protobuf.Timestamp
	2,  // 16: samvaad.PhoneNumberService.SearchPhoneNumbers:input_type -> samvaad.SearchPhoneNumbersRequest
	4,  // 17: samvaad.PhoneNumberService.PurchasePhoneNumber:input_type -> samvaad.PurchasePhoneNumberRequest
	6,  // 18: samvaad.PhoneNumberService.ListPhoneNumbers:input_type -> samvaad.ListPhoneNumbersRequest
	8,  // 19: samvaad.PhoneNumberService.GetPhoneNumber:input_type -> samvaad.GetPhoneNumberRequest
	10, // 20: samvaad.PhoneNumberService.UpdatePhoneNumber:input_type -> samvaad.UpdatePhoneNumberRequest
	12, // 21: samvaad.PhoneNumberService.ReleasePhoneNumbers:input_type -> samvaad.ReleasePhoneNumbersRequest
	3,  // 22: samvaad.PhoneNumberService.SearchPhoneNumbers:output_type -> samvaad.SearchPhoneNumbersResponse
	5,  // 23: samvaad.PhoneNumberService.PurchasePhoneNumber:output_type -> samvaad.PurchasePhoneNumberResponse
	7,  // 24: samvaad.PhoneNumberService.ListPhoneNumbers:output_type -> samvaad.ListPhoneNumbersResponse
	9,  // 25: samvaad.PhoneNumberService.GetPhoneNumber:output_type -> samvaad.GetPhoneNumberResponse
	11, // 26: samvaad.PhoneNumberService.UpdatePhoneNumber:output_type -> samvaad.UpdatePhoneNumberResponse
	13, // 27: samvaad.PhoneNumberService.ReleasePhoneNumbers:output_type -> samvaad.ReleasePhoneNumbersResponse
...
func init() { file_samvaad_phone_number_proto_init() }
func file_samvaad_phone_number_proto_init() {
	if File_samvaad_phone_number_proto != nil {
		return
	}
	file_samvaad_models_proto_init()
	file_samvaad_phone_number_proto_msgTypes[0].OneofWrappers = []any{}
	file_samvaad_phone_number_proto_msgTypes[2].OneofWrappers = []any{}
	file_samvaad_phone_number_proto_msgTypes[4].OneofWrappers = []any{}
	file_samvaad_phone_number_proto_msgTypes[6].OneofWrappers = []any{}
	file_samvaad_phone_number_proto_msgTypes[8].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_samvaad_phone_number_proto_rawDesc), len(file_samvaad_phone_number_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_samvaad_phone_number_proto_goTypes,
		DependencyIndexes: file_samvaad_phone_number_proto_depIdxs,
		EnumInfos:         file_samvaad_phone_number_proto_enumTypes,
		MessageInfos:      file_samvaad_phone_number_proto_msgTypes,
	}.Build()
	File_samvaad_phone_number_proto = out.File
	file_samvaad_phone_number_proto_goTypes = nil
	file_samvaad_phone_number_proto_depIdxs = nil
}
