...
func (SignalTarget) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_rtc_proto_enumTypes[0].Descriptor()
}

func (SignalTarget) Type() protoreflect.EnumType {
	return &file_samvaad_rtc_proto_enumTypes[0]
}
...
func (SignalTarget) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{0}
}
...
func (StreamState) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_rtc_proto_enumTypes[1].Descriptor()
}

func (StreamState) Type() protoreflect.EnumType {
	return &file_samvaad_rtc_proto_enumTypes[1]
}
...
func (StreamState) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{1}
}
...
func (CandidateProtocol) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_rtc_proto_enumTypes[2].Descriptor()
}

func (CandidateProtocol) Type() protoreflect.EnumType {
	return &file_samvaad_rtc_proto_enumTypes[2]
}
...
func (CandidateProtocol) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{2}
}
...
func (LeaveRequest_Action) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_rtc_proto_enumTypes[3].Descriptor()
}

func (LeaveRequest_Action) Type() protoreflect.EnumType {
	return &file_samvaad_rtc_proto_enumTypes[3]
}
...
func (LeaveRequest_Action) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{22, 0}
}
...
func (RequestResponse_Reason) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_rtc_proto_enumTypes[4].Descriptor()
}

func (RequestResponse_Reason) Type() protoreflect.EnumType {
	return &file_samvaad_rtc_proto_enumTypes[4]
}
...
func (RequestResponse_Reason) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{49, 0}
}
...
func (WrappedJoinRequest_Compression) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_rtc_proto_enumTypes[5].Descriptor()
}

func (WrappedJoinRequest_Compression) Type() protoreflect.EnumType {
	return &file_samvaad_rtc_proto_enumTypes[5]
}
...
func (WrappedJoinRequest_Compression) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{53, 0}
}
...
func (x *SignalRequest) Reset() {
	*x = SignalRequest{}
	mi := &file_samvaad_rtc_proto_msgTypes[0]
...
// Deprecated: Marked as deprecated in samvaad_rtc.proto.
...
func (x *SignalResponse) Reset() {
	*x = SignalResponse{}
	mi := &file_samvaad_rtc_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type SimulcastCodec struct {
	...
	VideoLayerMode VideoLayer_Mode        `protobuf:"varint,5,opt,name=video_layer_mode,json=videoLayerMode,proto3,enum=samvaad.VideoLayer_Mode" json:"video_layer_mode,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *SimulcastCodec) Reset() {
	*x = SimulcastCodec{}
	mi := &file_samvaad_rtc_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AddTrackRequest struct {
	...
	Type   TrackType `protobuf:"varint,3,opt,name=type,proto3,enum=samvaad.TrackType" json:"type,omitempty"`
	...
	Source          TrackSource       `protobuf:"varint,8,opt,name=source,proto3,enum=samvaad.TrackSource" json:"source,omitempty"`
	...
	Encryption Encryption_Type `protobuf:"varint,14,opt,name=encryption,proto3,enum=samvaad.Encryption_Type" json:"encryption,omitempty"`
	// which stream the track belongs to, used to group tracks together.
	// if not specified, server will infer it from track source to bundle camera/microphone, screenshare/audio together
	Stream                string                 `protobuf:"bytes,15,opt,name=stream,proto3" json:"stream,omitempty"`
	BackupCodecPolicy     BackupCodecPolicy      `protobuf:"varint,16,opt,name=backup_codec_policy,json=backupCodecPolicy,proto3,enum=samvaad.BackupCodecPolicy" json:"backup_codec_policy,omitempty"`
	AudioFeatures         []AudioTrackFeature    `protobuf:"varint,17,rep,packed,name=audio_features,json=audioFeatures,proto3,enum=samvaad.AudioTrackFeature" json:"audio_features,omitempty"`
	PacketTrailerFeatures []PacketTrailerFeature `protobuf:"varint,18,rep,packed,name=packet_trailer_features,json=packetTrailerFeatures,proto3,enum=samvaad.PacketTrailerFeature" json:"packet_trailer_features,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *AddTrackRequest) Reset() {
	*x = AddTrackRequest{}
	mi := &file_samvaad_rtc_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AddTrackRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{3}
}
...
type PublishDataTrackRequest struct {
	...
	Encryption    Encryption_Type `protobuf:"varint,3,opt,name=encryption,proto3,enum=samvaad.Encryption_Type" json:"encryption,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PublishDataTrackRequest) Reset() {
	*x = PublishDataTrackRequest{}
	mi := &file_samvaad_rtc_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PublishDataTrackRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{4}
}
...
func (x *PublishDataTrackResponse) Reset() {
	*x = PublishDataTrackResponse{}
	mi := &file_samvaad_rtc_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PublishDataTrackResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{5}
}
...
func (x *UnpublishDataTrackRequest) Reset() {
	*x = UnpublishDataTrackRequest{}
	mi := &file_samvaad_rtc_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnpublishDataTrackRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{6}
}
...
func (x *UnpublishDataTrackResponse) Reset() {
	*x = UnpublishDataTrackResponse{}
	mi := &file_samvaad_rtc_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UnpublishDataTrackResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{7}
}
...
func (x *DataTrackSubscriberHandles) Reset() {
	*x = DataTrackSubscriberHandles{}
	mi := &file_samvaad_rtc_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DataTrackSubscriberHandles) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{8}
}
...
type TrickleRequest struct {
	...
	Target        SignalTarget           `protobuf:"varint,2,opt,name=target,proto3,enum=samvaad.SignalTarget" json:"target,omitempty"`
...
func (x *TrickleRequest) Reset() {
	*x = TrickleRequest{}
	mi := &file_samvaad_rtc_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TrickleRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{9}
}
...
func (x *MuteTrackRequest) Reset() {
	*x = MuteTrackRequest{}
	mi := &file_samvaad_rtc_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MuteTrackRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{10}
}
...
func (x *JoinResponse) Reset() {
	*x = JoinResponse{}
	mi := &file_samvaad_rtc_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*JoinResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{11}
}
...
func (x *ReconnectResponse) Reset() {
	*x = ReconnectResponse{}
	mi := &file_samvaad_rtc_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReconnectResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{12}
}
...
func (x *TrackPublishedResponse) Reset() {
	*x = TrackPublishedResponse{}
	mi := &file_samvaad_rtc_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TrackPublishedResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{13}
}
...
func (x *TrackUnpublishedResponse) Reset() {
	*x = TrackUnpublishedResponse{}
	mi := &file_samvaad_rtc_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TrackUnpublishedResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{14}
}
...
func (x *SessionDescription) Reset() {
	*x = SessionDescription{}
	mi := &file_samvaad_rtc_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SessionDescription) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{15}
}
...
func (x *ParticipantUpdate) Reset() {
	*x = ParticipantUpdate{}
	mi := &file_samvaad_rtc_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ParticipantUpdate) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{16}
}
...
func (x *UpdateSubscription) Reset() {
	*x = UpdateSubscription{}
	mi := &file_samvaad_rtc_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateSubscription) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{17}
}
...
func (x *UpdateDataSubscription) Reset() {
	*x = UpdateDataSubscription{}
	mi := &file_samvaad_rtc_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateDataSubscription) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{18}
}
...
type UpdateTrackSettings struct {
	...
	Quality VideoQuality `protobuf:"varint,4,opt,name=quality,proto3,enum=samvaad.VideoQuality" json:"quality,omitempty"`
...
func (x *UpdateTrackSettings) Reset() {
	*x = UpdateTrackSettings{}
	mi := &file_samvaad_rtc_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateTrackSettings) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{19}
}
...
type UpdateLocalAudioTrack struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TrackSid      string                 `protobuf:"bytes,1,opt,name=track_sid,json=trackSid,proto3" json:"track_sid,omitempty"`
	Features      []AudioTrackFeature    `protobuf:"varint,2,rep,packed,name=features,proto3,enum=samvaad.AudioTrackFeature" json:"features,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateLocalAudioTrack) Reset() {
	*x = UpdateLocalAudioTrack{}
	mi := &file_samvaad_rtc_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateLocalAudioTrack) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{20}
}
...
func (x *UpdateLocalVideoTrack) Reset() {
	*x = UpdateLocalVideoTrack{}
	mi := &file_samvaad_rtc_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateLocalVideoTrack) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{21}
}
...
type LeaveRequest struct {
	...
	Reason        DisconnectReason    `protobuf:"varint,2,opt,name=reason,proto3,enum=samvaad.DisconnectReason" json:"reason,omitempty"`
	Action        LeaveRequest_Action `protobuf:"varint,3,opt,name=action,proto3,enum=samvaad.LeaveRequest_Action" json:"action,omitempty"`
...
func (x *LeaveRequest) Reset() {
	*x = LeaveRequest{}
	mi := &file_samvaad_rtc_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LeaveRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{22}
}
...
func (x *UpdateVideoLayers) Reset() {
	*x = UpdateVideoLayers{}
	mi := &file_samvaad_rtc_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateVideoLayers) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{23}
}
...
func (x *UpdateParticipantMetadata) Reset() {
	*x = UpdateParticipantMetadata{}
	mi := &file_samvaad_rtc_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateParticipantMetadata) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{24}
}
...
func (x *ICEServer) Reset() {
	*x = ICEServer{}
	mi := &file_samvaad_rtc_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ICEServer) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{25}
}
...
func (x *SpeakersChanged) Reset() {
	*x = SpeakersChanged{}
	mi := &file_samvaad_rtc_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SpeakersChanged) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{26}
}
...
func (x *RoomUpdate) Reset() {
	*x = RoomUpdate{}
	mi := &file_samvaad_rtc_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RoomUpdate) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{27}
}
...
type ConnectionQualityInfo struct {
	...
	Quality        ConnectionQuality      `protobuf:"varint,2,opt,name=quality,proto3,enum=samvaad.ConnectionQuality" json:"quality,omitempty"`
...
func (x *ConnectionQualityInfo) Reset() {
	*x = ConnectionQualityInfo{}
	mi := &file_samvaad_rtc_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConnectionQualityInfo) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{28}
}
...
func (x *ConnectionQualityUpdate) Reset() {
	*x = ConnectionQualityUpdate{}
	mi := &file_samvaad_rtc_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConnectionQualityUpdate) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{29}
}
...
type StreamStateInfo struct {
	...
	State          StreamState            `protobuf:"varint,3,opt,name=state,proto3,enum=samvaad.StreamState" json:"state,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *StreamStateInfo) Reset() {
	*x = StreamStateInfo{}
	mi := &file_samvaad_rtc_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StreamStateInfo) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{30}
}
...
func (x *StreamStateUpdate) Reset() {
	*x = StreamStateUpdate{}
	mi := &file_samvaad_rtc_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StreamStateUpdate) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{31}
}
...
type SubscribedQuality struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Quality       VideoQuality           `protobuf:"varint,1,opt,name=quality,proto3,enum=samvaad.VideoQuality" json:"quality,omitempty"`
...
func (x *SubscribedQuality) Reset() {
	*x = SubscribedQuality{}
	mi := &file_samvaad_rtc_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SubscribedQuality) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{32}
}
...
func (x *SubscribedCodec) Reset() {
	*x = SubscribedCodec{}
	mi := &file_samvaad_rtc_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SubscribedCodec) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{33}
}
...
func (x *SubscribedQualityUpdate) Reset() {
	*x = SubscribedQualityUpdate{}
	mi := &file_samvaad_rtc_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SubscribedQualityUpdate) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{34}
}
...
func (x *SubscribedAudioCodecUpdate) Reset() {
	*x = SubscribedAudioCodecUpdate{}
	mi := &file_samvaad_rtc_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SubscribedAudioCodecUpdate) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{35}
}
...
func (x *TrackPermission) Reset() {
	*x = TrackPermission{}
	mi := &file_samvaad_rtc_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TrackPermission) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{36}
}
...
func (x *SubscriptionPermission) Reset() {
	*x = SubscriptionPermission{}
	mi := &file_samvaad_rtc_proto_msgTypes[37]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SubscriptionPermission) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{37}
}
...
func (x *SubscriptionPermissionUpdate) Reset() {
	*x = SubscriptionPermissionUpdate{}
	mi := &file_samvaad_rtc_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SubscriptionPermissionUpdate) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{38}
}
...
func (x *RoomMovedResponse) Reset() {
	*x = RoomMovedResponse{}
	mi := &file_samvaad_rtc_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RoomMovedResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{39}
}
...
func (x *SyncState) Reset() {
	*x = SyncState{}
	mi := &file_samvaad_rtc_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SyncState) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{40}
}
...
func (x *DataChannelReceiveState) Reset() {
	*x = DataChannelReceiveState{}
	mi := &file_samvaad_rtc_proto_msgTypes[41]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DataChannelReceiveState) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{41}
}
...
type DataChannelInfo struct {
	...
	Target        SignalTarget           `protobuf:"varint,3,opt,name=target,proto3,enum=samvaad.SignalTarget" json:"target,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DataChannelInfo) Reset() {
	*x = DataChannelInfo{}
	mi := &file_samvaad_rtc_proto_msgTypes[42]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DataChannelInfo) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{42}
}
...
func (x *SimulateScenario) Reset() {
	*x = SimulateScenario{}
	mi := &file_samvaad_rtc_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SimulateScenario) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{43}
}
...
type SimulateScenario_SwitchCandidateProtocol struct {
	...
	SwitchCandidateProtocol CandidateProtocol `protobuf:"varint,5,opt,name=switch_candidate_protocol,json=switchCandidateProtocol,proto3,enum=samvaad.CandidateProtocol,oneof"`
}
...
func (x *Ping) Reset() {
	*x = Ping{}
	mi := &file_samvaad_rtc_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Ping) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{44}
}
...
func (x *Pong) Reset() {
	*x = Pong{}
	mi := &file_samvaad_rtc_proto_msgTypes[45]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Pong) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{45}
}
...
func (x *RegionSettings) Reset() {
	*x = RegionSettings{}
	mi := &file_samvaad_rtc_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegionSettings) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{46}
}
...
func (x *RegionInfo) Reset() {
	*x = RegionInfo{}
	mi := &file_samvaad_rtc_proto_msgTypes[47]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegionInfo) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{47}
}
...
type SubscriptionResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TrackSid      string                 `protobuf:"bytes,1,opt,name=track_sid,json=trackSid,proto3" json:"track_sid,omitempty"`
	Err           SubscriptionError      `protobuf:"varint,2,opt,name=err,proto3,enum=samvaad.SubscriptionError" json:"err,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SubscriptionResponse) Reset() {
	*x = SubscriptionResponse{}
	mi := &file_samvaad_rtc_proto_msgTypes[48]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SubscriptionResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{48}
}
...
type RequestResponse struct {
	...
	Reason    RequestResponse_Reason `protobuf:"varint,2,opt,name=reason,proto3,enum=samvaad.RequestResponse_Reason" json:"reason,omitempty"`
...
func (x *RequestResponse) Reset() {
	*x = RequestResponse{}
	mi := &file_samvaad_rtc_proto_msgTypes[49]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RequestResponse) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{49}
}
...
func (x *TrackSubscribed) Reset() {
	*x = TrackSubscribed{}
	mi := &file_samvaad_rtc_proto_msgTypes[50]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TrackSubscribed) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{50}
}
...
func (x *ConnectionSettings) Reset() {
	*x = ConnectionSettings{}
	mi := &file_samvaad_rtc_proto_msgTypes[51]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConnectionSettings) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{51}
}
...
type JoinRequest struct {
	...
	ReconnectReason       ReconnectReason     `protobuf:"varint,8,opt,name=reconnect_reason,json=reconnectReason,proto3,enum=samvaad.ReconnectReason" json:"reconnect_reason,omitempty"`
...
func (x *JoinRequest) Reset() {
	*x = JoinRequest{}
	mi := &file_samvaad_rtc_proto_msgTypes[52]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*JoinRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{52}
}
...
type WrappedJoinRequest struct {
	state         protoimpl.MessageState         `protogen:"open.v1"`
	Compression   WrappedJoinRequest_Compression `protobuf:"varint,1,opt,name=compression,proto3,enum=samvaad.WrappedJoinRequest_Compression" json:"compression,omitempty"`
...
func (x *WrappedJoinRequest) Reset() {
	*x = WrappedJoinRequest{}
	mi := &file_samvaad_rtc_proto_msgTypes[53]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WrappedJoinRequest) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{53}
}
...
func (x *MediaSectionsRequirement) Reset() {
	*x = MediaSectionsRequirement{}
	mi := &file_samvaad_rtc_proto_msgTypes[54]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MediaSectionsRequirement) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{54}
}
...
func (x *DataTrackSubscriberHandles_PublishedDataTrack) Reset() {
	*x = DataTrackSubscriberHandles_PublishedDataTrack{}
	mi := &file_samvaad_rtc_proto_msgTypes[55]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DataTrackSubscriberHandles_PublishedDataTrack) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{8, 0}
}
...
func (x *UpdateDataSubscription_Update) Reset() {
	*x = UpdateDataSubscription_Update{}
	mi := &file_samvaad_rtc_proto_msgTypes[58]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateDataSubscription_Update) Descriptor() ([]byte, []int) {
	return file_samvaad_rtc_proto_rawDescGZIP(), []int{18, 0}
}
...
var File_samvaad_rtc_proto protoreflect.FileDescriptor

const file_samvaad_rtc_proto_rawDesc = "" +
	"\n" +
	"\x11\x6c\x69\x76\x65\x6b\x69\x74_rtc.proto\x12\a\x6c\x69\x76\x65\x6b\x69\x74\x1a\x14\x6c\x69\x76\x65\x6b\x69\x74_models.proto\x1a\x14logger/options.proto\"\xc3\n" +
	"\n" +
	"\rSignalRequest\x123\n" +
	"\x05offer\x18\x01 \x01(\v2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SessionDescriptionH\x00R\x05offer\x125\n" +
	"\x06answer\x18\x02 \x01(\v2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SessionDescriptionH\x00R\x06answer\x123\n" +
	"\atrickle\x18\x03 \x01(\v2\x17.\x6c\x69\x76\x65\x6b\x69\x74.TrickleRequestH\x00R\atrickle\x127\n" +
	"\tadd_track\x18\x04 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.AddTrackRequestH\x00R\baddTrack\x12/\n" +
	"\x04mute\x18\x05 \x01(\v2\x19.\x6c\x69\x76\x65\x6b\x69\x74.MuteTrackRequestH\x00R\x04mute\x12A\n" +
	"\fsubscription\x18\x06 \x01(\v2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.UpdateSubscriptionH\x00R\fsubscription\x12C\n" +
	"\rtrack_setting\x18\a \x01(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.UpdateTrackSettingsH\x00R\ftrackSetting\x12-\n" +
	"\x05leave\x18\b \x01(\v2\x15.\x6c\x69\x76\x65\x6b\x69\x74.LeaveRequestH\x00R\x05leave\x12E\n" +
	"\rupdate_layers\x18\n" +
	" \x01(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.UpdateVideoLayersB\x02\x18\x01H\x00R\fupdateLayers\x12Z\n" +
	"\x17subscription_permission\x18\v \x01(\v2\x1f.\x6c\x69\x76\x65\x6b\x69\x74.SubscriptionPermissionH\x00R\x16subscriptionPermission\x123\n" +
	"\n" +
	"sync_state\x18\f \x01(\v2\x12.\x6c\x69\x76\x65\x6b\x69\x74.SyncStateH\x00R\tsyncState\x127\n" +
	"\bsimulate\x18\r \x01(\v2\x19.\x6c\x69\x76\x65\x6b\x69\x74.SimulateScenarioH\x00R\bsimulate\x12\x14\n" +
	"\x04ping\x18\x0e \x01(\x03H\x00R\x04ping\x12M\n" +
	"\x0fupdate_metadata\x18\x0f \x01(\v2\".\x6c\x69\x76\x65\x6b\x69\x74.UpdateParticipantMetadataH\x00R\x0eupdateMetadata\x12*\n" +
	"\bping_req\x18\x10 \x01(\v2\r.\x6c\x69\x76\x65\x6b\x69\x74.PingH\x00R\apingReq\x12N\n" +
	"\x12update_audio_track\x18\x11 \x01(\v2\x1e.\x6c\x69\x76\x65\x6b\x69\x74.UpdateLocalAudioTrackH\x00R\x10updateAudioTrack\x12N\n" +
	"\x12update_video_track\x18\x12 \x01(\v2\x1e.\x6c\x69\x76\x65\x6b\x69\x74.UpdateLocalVideoTrackH\x00R\x10updateVideoTrack\x12_\n" +
	"\x1apublish_data_track_request\x18\x13 \x01(\v2 .\x6c\x69\x76\x65\x6b\x69\x74.PublishDataTrackRequestH\x00R\x17publishDataTrackRequest\x12e\n" +
	"\x1cunpublish_data_track_request\x18\x14 \x01(\v2\".\x6c\x69\x76\x65\x6b\x69\x74.UnpublishDataTrackRequestH\x00R\x19unpublishDataTrackRequest\x12[\n" +
	"\x18update_data_subscription\x18\x15 \x01(\v2\x1f.\x6c\x69\x76\x65\x6b\x69\x74.UpdateDataSubscriptionH\x00R\x16updateDataSubscriptionB\t\n" +
	"\amessage\"\xd9\x0f\n" +
	"\x0eSignalResponse\x12+\n" +
	"\x04join\x18\x01 \x01(\v2\x15.\x6c\x69\x76\x65\x6b\x69\x74.JoinResponseH\x00R\x04join\x125\n" +
	"\x06answer\x18\x02 \x01(\v2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SessionDescriptionH\x00R\x06answer\x123\n" +
	"\x05offer\x18\x03 \x01(\v2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SessionDescriptionH\x00R\x05offer\x123\n" +
	"\atrickle\x18\x04 \x01(\v2\x17.\x6c\x69\x76\x65\x6b\x69\x74.TrickleRequestH\x00R\atrickle\x124\n" +
	"\x06update\x18\x05 \x01(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.ParticipantUpdateH\x00R\x06update\x12J\n" +
	"\x0ftrack_published\x18\x06 \x01(\v2\x1f.\x6c\x69\x76\x65\x6b\x69\x74.TrackPublishedResponseH\x00R\x0etrackPublished\x12-\n" +
	"\x05leave\x18\b \x01(\v2\x15.\x6c\x69\x76\x65\x6b\x69\x74.LeaveRequestH\x00R\x05leave\x12/\n" +
	"\x04mute\x18\t \x01(\v2\x19.\x6c\x69\x76\x65\x6b\x69\x74.MuteTrackRequestH\x00R\x04mute\x12E\n" +
	"\x10speakers_changed\x18\n" +
	" \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.SpeakersChangedH\x00R\x0fspeakersChanged\x126\n" +
	"\vroom_update\x18\v \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.RoomUpdateH\x00R\n" +
	"roomUpdate\x12Q\n" +
	"\x12connection_quality\x18\f \x01(\v2 .\x6c\x69\x76\x65\x6b\x69\x74.ConnectionQualityUpdateH\x00R\x11connectionQuality\x12L\n" +
	"\x13stream_state_update\x18\r \x01(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.StreamStateUpdateH\x00R\x11streamStateUpdate\x12^\n" +
	"\x19subscribed_quality_update\x18\x0e \x01(\v2 .\x6c\x69\x76\x65\x6b\x69\x74.SubscribedQualityUpdateH\x00R\x17subscribedQualityUpdate\x12m\n" +
	"\x1esubscription_permission_update\x18\x0f \x01(\v2%.\x6c\x69\x76\x65\x6b\x69\x74.SubscriptionPermissionUpdateH\x00R\x1csubscriptionPermissionUpdate\x12%\n" +
	"\rrefresh_token\x18\x10 \x01(\tH\x00R\frefreshToken\x12P\n" +
	"\x11track_unpublished\x18\x11 \x01(\v2!.\x6c\x69\x76\x65\x6b\x69\x74.TrackUnpublishedResponseH\x00R\x10trackUnpublished\x12\x14\n" +
	"\x04pong\x18\x12 \x01(\x03H\x00R\x04pong\x12:\n" +
	"\treconnect\x18\x13 \x01(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.ReconnectResponseH\x00R\treconnect\x12,\n" +
	"\tpong_resp\x18\x14 \x01(\v2\r.\x6c\x69\x76\x65\x6b\x69\x74.PongH\x00R\bpongResp\x12T\n" +
	"\x15subscription_response\x18\x15 \x01(\v2\x1d.\x6c\x69\x76\x65\x6b\x69\x74.SubscriptionResponseH\x00R\x14subscriptionResponse\x12E\n" +
	"\x10request_response\x18\x16 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.RequestResponseH\x00R\x0frequestResponse\x12E\n" +
	"\x10track_subscribed\x18\x17 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.TrackSubscribedH\x00R\x0ftrackSubscribed\x12;\n" +
	"\n" +
	"room_moved\x18\x18 \x01(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.RoomMovedResponseH\x00R\troomMoved\x12a\n" +
	"\x1amedia_sections_requirement\x18\x19 \x01(\v2!.\x6c\x69\x76\x65\x6b\x69\x74.MediaSectionsRequirementH\x00R\x18mediaSectionsRequirement\x12h\n" +
	"\x1dsubscribed_audio_codec_update\x18\x1a \x01(\v2#.\x6c\x69\x76\x65\x6b\x69\x74.SubscribedAudioCodecUpdateH\x00R\x1asubscribedAudioCodecUpdate\x12b\n" +
	"\x1bpublish_data_track_response\x18\x1b \x01(\v2!.\x6c\x69\x76\x65\x6b\x69\x74.PublishDataTrackResponseH\x00R\x18publishDataTrackResponse\x12h\n" +
	"\x1dunpublish_data_track_response\x18\x1c \x01(\v2#.\x6c\x69\x76\x65\x6b\x69\x74.UnpublishDataTrackResponseH\x00R\x1aunpublishDataTrackResponse\x12h\n" +
	"\x1ddata_track_subscriber_handles\x18\x1d \x01(\v2#.\x6c\x69\x76\x65\x6b\x69\x74.DataTrackSubscriberHandlesH\x00R\x1adataTrackSubscriberHandlesB\t\n" +
	"\amessage\"\xa9\x01\n" +
	"\x0eSimulcastCodec\x12\x14\n" +
	"\x05codec\x18\x01 \x01(\tR\x05codec\x12\x10\n" +
	"\x03cid\x18\x02 \x01(\tR\x03cid\x12+\n" +
	"\x06layers\x18\x04 \x03(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.VideoLayerR\x06layers\x12B\n" +
	"\x10video_layer_mode\x18\x05 \x01(\x0e2\x18.\x6c\x69\x76\x65\x6b\x69\x74.VideoLayer.ModeR\x0evideoLayerMode\"\xee\x05\n" +
	"\x0fAddTrackRequest\x12\x10\n" +
	"\x03cid\x18\x01 \x01(\tR\x03cid\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12&\n" +
	"\x04type\x18\x03 \x01(\x0e2\x12.\x6c\x69\x76\x65\x6b\x69\x74.TrackTypeR\x04type\x12\x14\n" +
	...
	"disableDtx\x12,\n" +
	"\x06source\x18\b \x01(\x0e2\x14.\x6c\x69\x76\x65\x6b\x69\x74.TrackSourceR\x06source\x12+\n" +
	"\x06layers\x18\t \x03(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.VideoLayerR\x06layers\x12B\n" +
	"\x10simulcast_codecs\x18\n" +
	" \x03(\v2\x17.\x6c\x69\x76\x65\x6b\x69\x74.SimulcastCodecR\x0fsimulcastCodecs\x12\x10\n" +
	"\x03sid\x18\v \x01(\tR\x03sid\x12\x1a\n" +
	"\x06stereo\x18\f \x01(\bB\x02\x18\x01R\x06stereo\x12\x1f\n" +
	"\vdisable_red\x18\r \x01(\bR\n" +
	"disableRed\x128\n" +
	"\n" +
	"encryption\x18\x0e \x01(\x0e2\x18.\x6c\x69\x76\x65\x6b\x69\x74.Encryption.TypeR\n" +
	"encryption\x12\x16\n" +
	"\x06stream\x18\x0f \x01(\tR\x06stream\x12J\n" +
	"\x13backup_codec_policy\x18\x10 \x01(\x0e2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.BackupCodecPolicyR\x11backupCodecPolicy\x12A\n" +
	"\x0eaudio_features\x18\x11 \x03(\x0e2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.AudioTrackFeatureR\raudioFeatures\x12U\n" +
	"\x17packet_trailer_features\x18\x12 \x03(\x0e2\x1d.\x6c\x69\x76\x65\x6b\x69\x74.PacketTrailerFeatureR\x15packetTrailerFeatures\"\x86\x01\n" +
	"\x17PublishDataTrackRequest\x12\x1d\n" +
	"\n" +
	"pub_handle\x18\x01 \x01(\rR\tpubHandle\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x128\n" +
	"\n" +
	"encryption\x18\x03 \x01(\x0e2\x18.\x6c\x69\x76\x65\x6b\x69\x74.Encryption.TypeR\n" +
	"encryption\"F\n" +
	"\x18PublishDataTrackResponse\x12*\n" +
	"\x04info\x18\x01 \x01(\v2\x16.\x6c\x69\x76\x65\x6b\x69\x74.DataTrackInfoR\x04info\":\n" +
	"\x19UnpublishDataTrackRequest\x12\x1d\n" +
	"\n" +
	"pub_handle\x18\x01 \x01(\rR\tpubHandle\"H\n" +
	"\x1aUnpublishDataTrackResponse\x12*\n" +
	"\x04info\x18\x01 \x01(\v2\x16.\x6c\x69\x76\x65\x6b\x69\x74.DataTrackInfoR\x04info\"\xf1\x02\n" +
	"\x1aDataTrackSubscriberHandles\x12T\n" +
	"\vsub_handles\x18\x01 \x03(\v23.\x6c\x69\x76\x65\x6b\x69\x74.DataTrackSubscriberHandles.SubHandlesEntryR\n" +
	...
	"\x05value\x18\x02 \x01(\v26.\x6c\x69\x76\x65\x6b\x69\x74.DataTrackSubscriberHandles.PublishedDataTrackR\x05value:\x028\x01\"{\n" +
	"\x0eTrickleRequest\x12$\n" +
	"\rcandidateInit\x18\x01 \x01(\tR\rcandidateInit\x12-\n" +
	"\x06target\x18\x02 \x01(\x0e2\x15.\x6c\x69\x76\x65\x6b\x69\x74.SignalTargetR\x06target\x12\x14\n" +
	...
	"\fJoinResponse\x12!\n" +
	"\x04room\x18\x01 \x01(\v2\r.\x6c\x69\x76\x65\x6b\x69\x74.RoomR\x04room\x12:\n" +
	"\vparticipant\x18\x02 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.ParticipantInfoR\vparticipant\x12G\n" +
	"\x12other_participants\x18\x03 \x03(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.ParticipantInfoR\x11otherParticipants\x12%\n" +
	"\x0eserver_version\x18\x04 \x01(\tR\rserverVersion\x123\n" +
	"\vice_servers\x18\x05 \x03(\v2\x12.\x6c\x69\x76\x65\x6b\x69\x74.ICEServerR\n" +
	"iceServers\x12-\n" +
	"\x12subscriber_primary\x18\x06 \x01(\bR\x11subscriberPrimary\x12'\n" +
	"\x0falternative_url\x18\a \x01(\tR\x0ealternativeUrl\x12O\n" +
	"\x14client_configuration\x18\b \x01(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.ClientConfigurationR\x13clientConfiguration\x12#\n" +
	"\rserver_region\x18\t \x01(\tR\fserverRegion\x12!\n" +
	"\fping_timeout\x18\n" +
	" \x01(\x05R\vpingTimeout\x12#\n" +
	"\rping_interval\x18\v \x01(\x05R\fpingInterval\x124\n" +
	"\vserver_info\x18\f \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.ServerInfoR\n" +
	"serverInfo\x12\x1f\n" +
	"\vsif_trailer\x18\r \x01(\fR\n" +
	"sifTrailer\x12D\n" +
	"\x16enabled_publish_codecs\x18\x0e \x03(\v2\x0e.\x6c\x69\x76\x65\x6b\x69\x74.CodecR\x14enabledPublishCodecs\x12!\n" +
	"\ffast_publish\x18\x0f \x01(\bR\vfastPublish\"\xf9\x01\n" +
	"\x11ReconnectResponse\x123\n" +
	"\vice_servers\x18\x01 \x03(\v2\x12.\x6c\x69\x76\x65\x6b\x69\x74.ICEServerR\n" +
	"iceServers\x12O\n" +
	"\x14client_configuration\x18\x02 \x01(\v2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.ClientConfigurationR\x13clientConfiguration\x124\n" +
	"\vserver_info\x18\x03 \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.ServerInfoR\n" +
	"serverInfo\x12(\n" +
	"\x10last_message_seq\x18\x04 \x01(\rR\x0elastMessageSeq\"T\n" +
	"\x16TrackPublishedResponse\x12\x10\n" +
	"\x03cid\x18\x01 \x01(\tR\x03cid\x12(\n" +
	"\x05track\x18\x02 \x01(\v2\x12.\x6c\x69\x76\x65\x6b\x69\x74.TrackInfoR\x05track\"7\n" +
	"\x18TrackUnpublishedResponse\x12\x1b\n" +
	"\ttrack_sid\x18\x01 \x01(\tR\btrackSid\"\xf2\x01\n" +
	"\x12SessionDescription\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x10\n" +
	"\x03sdp\x18\x02 \x01(\tR\x03sdp\x12\x0e\n" +
	"\x02id\x18\x03 \x01(\rR\x02id\x12e\n" +
	"\x0fmid_to_track_id\x18\x04 \x03(\v2-.\x6c\x69\x76\x65\x6b\x69\x74.SessionDescription.MidToTrackIdEntryB\x0f\xbaP\fmidToTrackIDR\fmidToTrackId\x1a?\n" +
	"\x11MidToTrackIdEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"Q\n" +
	"\x11ParticipantUpdate\x12<\n" +
	"\fparticipants\x18\x01 \x03(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.ParticipantInfoR\fparticipants\"\x9c\x01\n" +
	"\x12UpdateSubscription\x12\x1d\n" +
	"\n" +
	"track_sids\x18\x01 \x03(\tR\ttrackSids\x12\x1c\n" +
	"\tsubscribe\x18\x02 \x01(\bR\tsubscribe\x12I\n" +
	"\x12participant_tracks\x18\x03 \x03(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.ParticipantTracksR\x11participantTracks\"\xe1\x01\n" +
	"\x16UpdateDataSubscription\x12@\n" +
	"\aupdates\x18\x01 \x03(\v2&.\x6c\x69\x76\x65\x6b\x69\x74.UpdateDataSubscription.UpdateR\aupdates\x1a\x84\x01\n" +
	"\x06Update\x12\x1b\n" +
	"\ttrack_sid\x18\x01 \x01(\tR\btrackSid\x12\x1c\n" +
	"\tsubscribe\x18\x02 \x01(\bR\tsubscribe\x12?\n" +
	"\aoptions\x18\x03 \x01(\v2%.\x6c\x69\x76\x65\x6b\x69\x74.DataTrackSubscriptionOptionsR\aoptions\"\xdd\x01\n" +
	"\x13UpdateTrackSettings\x12\x1d\n" +
	"\n" +
	"track_sids\x18\x01 \x03(\tR\ttrackSids\x12\x1a\n" +
	"\bdisabled\x18\x03 \x01(\bR\bdisabled\x12/\n" +
	"\aquality\x18\x04 \x01(\x0e2\x15.\x6c\x69\x76\x65\x6b\x69\x74.VideoQualityR\aquality\x12\x14\n" +
	...
	"\bfeatures\x18\x02 \x03(\x0e2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.AudioTrackFeatureR\bfeatures\"b\n" +
	...
	"\x06reason\x18\x02 \x01(\x0e2\x19.\x6c\x69\x76\x65\x6b\x69\x74.DisconnectReasonR\x06reason\x124\n" +
	"\x06action\x18\x03 \x01(\x0e2\x1c.\x6c\x69\x76\x65\x6b\x69\x74.LeaveRequest.ActionR\x06action\x121\n" +
	"\aregions\x18\x04 \x01(\v2\x17.\x6c\x69\x76\x65\x6b\x69\x74.RegionSettingsR\aregions\"3\n" +
	"\x06Action\x12\x0e\n" +
	"\n" +
	...
	"\x06layers\x18\x02 \x03(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.VideoLayerR\x06layers:\x02\x18\x01\"\xfd\x02\n" +
	"\x19UpdateParticipantMetadata\x12@\n" +
	"\bmetadata\x18\x01 \x01(\tB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\bmetadata\x128\n" +
	"\x04name\x18\x02 \x01(\tB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\x04name\x12x\n" +
	"\n" +
	"attributes\x18\x03 \x03(\v22.\x6c\x69\x76\x65\x6b\x69\x74.UpdateParticipantMetadata.AttributesEntryB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\n" +
	"attributes\x12+\n" +
	"\n" +
	"request_id\x18\x04 \x01(\rB\f\xbaP\trequestIDR\trequestId\x1a=\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"e\n" +
	"\tICEServer\x12\x12\n" +
	"\x04urls\x18\x01 \x03(\tR\x04urls\x12\x1f\n" +
	"\busername\x18\x02 \x01(\tB\x03\xa8P\x01R\busername\x12#\n" +
	"\n" +
	"credential\x18\x03 \x01(\tB\x03\xa8P\x01R\n" +
	"credential\"C\n" +
	"\x0fSpeakersChanged\x120\n" +
	"\bspeakers\x18\x01 \x03(\v2\x14.\x6c\x69\x76\x65\x6b\x69\x74.SpeakerInfoR\bspeakers\"/\n" +
	"\n" +
	"RoomUpdate\x12!\n" +
	"\x04room\x18\x01 \x01(\v2\r.\x6c\x69\x76\x65\x6b\x69\x74.RoomR\x04room\"\x8c\x01\n" +
	"\x15ConnectionQualityInfo\x12'\n" +
	"\x0fparticipant_sid\x18\x01 \x01(\tR\x0eparticipantSid\x124\n" +
	"\aquality\x18\x02 \x01(\x0e2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.ConnectionQualityR\aquality\x12\x14\n" +
	"\x05score\x18\x03 \x01(\x02R\x05score\"S\n" +
	"\x17ConnectionQualityUpdate\x128\n" +
	"\aupdates\x18\x01 \x03(\v2\x1e.\x6c\x69\x76\x65\x6b\x69\x74.ConnectionQualityInfoR\aupdates\"\x83\x01\n" +
	"\x0fStreamStateInfo\x12'\n" +
	"\x0fparticipant_sid\x18\x01 \x01(\tR\x0eparticipantSid\x12\x1b\n" +
	"\ttrack_sid\x18\x02 \x01(\tR\btrackSid\x12*\n" +
	"\x05state\x18\x03 \x01(\x0e2\x14.\x6c\x69\x76\x65\x6b\x69\x74.StreamStateR\x05state\"R\n" +
	"\x11StreamStateUpdate\x12=\n" +
	"\rstream_states\x18\x01 \x03(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.StreamStateInfoR\fstreamStates\"^\n" +
	"\x11SubscribedQuality\x12/\n" +
	"\aquality\x18\x01 \x01(\x0e2\x15.\x6c\x69\x76\x65\x6b\x69\x74.VideoQualityR\aquality\x12\x18\n" +
	"\aenabled\x18\x02 \x01(\bR\aenabled\"a\n" +
	"\x0fSubscribedCodec\x12\x14\n" +
	"\x05codec\x18\x01 \x01(\tR\x05codec\x128\n" +
	"\tqualities\x18\x02 \x03(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.SubscribedQualityR\tqualities\"\xd0\x01\n" +
	"\x17SubscribedQualityUpdate\x12\x1b\n" +
	"\ttrack_sid\x18\x01 \x01(\tR\btrackSid\x12Q\n" +
	"\x14subscribed_qualities\x18\x02 \x03(\v2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.SubscribedQualityB\x02\x18\x01R\x13subscribedQualities\x12E\n" +
	"\x11subscribed_codecs\x18\x03 \x03(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.SubscribedCodecR\x10subscribedCodecs\"\x90\x01\n" +
	"\x1aSubscribedAudioCodecUpdate\x12\x1b\n" +
	"\ttrack_sid\x18\x01 \x01(\tR\btrackSid\x12U\n" +
	"\x17subscribed_audio_codecs\x18\x02 \x03(\v2\x1d.\x6c\x69\x76\x65\x6b\x69\x74.SubscribedAudioCodecR\x15subscribedAudioCodecs\"\xab\x01\n" +
	...
	"\x11track_permissions\x18\x02 \x03(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.TrackPermissionR\x10trackPermissions\"~\n" +
	...
	"\x04room\x18\x01 \x01(\v2\r.\x6c\x69\x76\x65\x6b\x69\x74.RoomR\x04room\x12\x14\n" +
	"\x05token\x18\x02 \x01(\tR\x05token\x12:\n" +
	"\vparticipant\x18\x03 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.ParticipantInfoR\vparticipant\x12G\n" +
	"\x12other_participants\x18\x04 \x03(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.ParticipantInfoR\x11otherParticipants\"\x9e\x04\n" +
	"\tSyncState\x123\n" +
	"\x06answer\x18\x01 \x01(\v2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SessionDescriptionR\x06answer\x12?\n" +
	"\fsubscription\x18\x02 \x01(\v2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.UpdateSubscriptionR\fsubscription\x12F\n" +
	"\x0epublish_tracks\x18\x03 \x03(\v2\x1f.\x6c\x69\x76\x65\x6b\x69\x74.TrackPublishedResponseR\rpublishTracks\x12=\n" +
	"\rdata_channels\x18\x04 \x03(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.DataChannelInfoR\fdataChannels\x121\n" +
	"\x05offer\x18\x05 \x01(\v2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SessionDescriptionR\x05offer\x12.\n" +
	"\x13track_sids_disabled\x18\x06 \x03(\tR\x11trackSidsDisabled\x12^\n" +
	"\x1adatachannel_receive_states\x18\a \x03(\v2 .\x6c\x69\x76\x65\x6b\x69\x74.DataChannelReceiveStateR\x18datachannelReceiveStates\x12Q\n" +
	"\x13publish_data_tracks\x18\b \x03(\v2!.\x6c\x69\x76\x65\x6b\x69\x74.PublishDataTrackResponseR\x11publishDataTracks\"Y\n" +
	...
	"\x06target\x18\x03 \x01(\x0e2\x15.\x6c\x69\x76\x65\x6b\x69\x74.SignalTargetR\x06target\"\x9b\x04\n" +
	...
	"\x19switch_candidate_protocol\x18\x05 \x01(\x0e2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.CandidateProtocolH\x00R\x17switchCandidateProtocol\x123\n" +
	...
	"\aregions\x18\x01 \x03(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.RegionInfoR\aregions\"R\n" +
	"\n" +
	"RegionInfo\x12\x16\n" +
	...
	"\ttrack_sid\x18\x01 \x01(\tR\btrackSid\x12,\n" +
	"\x03err\x18\x02 \x01(\x0e2\x1a.\x6c\x69\x76\x65\x6b\x69\x74.SubscriptionErrorR\x03err\"\xa5\a\n" +
	"\x0fRequestResponse\x12+\n" +
	"\n" +
	"request_id\x18\x01 \x01(\rB\f\xbaP\trequestIDR\trequestId\x127\n" +
	"\x06reason\x18\x02 \x01(\x0e2\x1f.\x6c\x69\x76\x65\x6b\x69\x74.RequestResponse.ReasonR\x06reason\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\x123\n" +
	"\atrickle\x18\x04 \x01(\v2\x17.\x6c\x69\x76\x65\x6b\x69\x74.TrickleRequestH\x00R\atrickle\x127\n" +
	"\tadd_track\x18\x05 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.AddTrackRequestH\x00R\baddTrack\x12/\n" +
	"\x04mute\x18\x06 \x01(\v2\x19.\x6c\x69\x76\x65\x6b\x69\x74.MuteTrackRequestH\x00R\x04mute\x12M\n" +
	"\x0fupdate_metadata\x18\a \x01(\v2\".\x6c\x69\x76\x65\x6b\x69\x74.UpdateParticipantMetadataH\x00R\x0eupdateMetadata\x12N\n" +
	"\x12update_audio_track\x18\b \x01(\v2\x1e.\x6c\x69\x76\x65\x6b\x69\x74.UpdateLocalAudioTrackH\x00R\x10updateAudioTrack\x12N\n" +
	"\x12update_video_track\x18\t \x01(\v2\x1e.\x6c\x69\x76\x65\x6b\x69\x74.UpdateLocalVideoTrackH\x00R\x10updateVideoTrack\x12P\n" +
	"\x12publish_data_track\x18\n" +
	" \x01(\v2 .\x6c\x69\x76\x65\x6b\x69\x74.PublishDataTrackRequestH\x00R\x10publishDataTrack\x12V\n" +
	"\x14unpublish_data_track\x18\v \x01(\v2\".\x6c\x69\x76\x65\x6b\x69\x74.UnpublishDataTrackRequestH\x00R\x12unpublishDataTrack\"\xce\x01\n" +
	"\x06Reason\x12\x06\n" +
	"\x02OK\x10\x00\x12\r\n" +
	...
	"\x1a_auto_subscribe_data_track\"\xf9\x05\n" +
	"\vJoinRequest\x124\n" +
	"\vclient_info\x18\x01 \x01(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.ClientInfoR\n" +
	"clientInfo\x12L\n" +
	"\x13connection_settings\x18\x02 \x01(\v2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.ConnectionSettingsR\x12connectionSettings\x12@\n" +
	"\bmetadata\x18\x03 \x01(\tB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\bmetadata\x12\x8c\x01\n" +
	"\x16participant_attributes\x18\x04 \x03(\v2/.\x6c\x69\x76\x65\x6b\x69\x74.JoinRequest.ParticipantAttributesEntryB$\xa8P\x01\xb2P\x1e<redacted ({{ .Size }} bytes)>R\x15participantAttributes\x12F\n" +
	"\x12add_track_requests\x18\x05 \x03(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.AddTrackRequestR\x10addTrackRequests\x12D\n" +
	"\x0fpublisher_offer\x18\x06 \x01(\v2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SessionDescriptionR\x0epublisherOffer\x12\x1c\n" +
	"\treconnect\x18\a \x01(\bR\treconnect\x12C\n" +
	"\x10reconnect_reason\x18\b \x01(\x0e2\x18.\x6c\x69\x76\x65\x6b\x69\x74.ReconnectReasonR\x0freconnectReason\x12'\n" +
	"\x0fparticipant_sid\x18\t \x01(\tR\x0eparticipantSid\x121\n" +
	"\n" +
	"sync_state\x18\n" +
	" \x01(\v2\x12.\x6c\x69\x76\x65\x6b\x69\x74.SyncStateR\tsyncState\x1aH\n" +
	"\x1aParticipantAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xa5\x01\n" +
	"\x12WrappedJoinRequest\x12I\n" +
	"\vcompression\x18\x01 \x01(\x0e2'.\x6c\x69\x76\x65\x6b\x69\x74.WrappedJoinRequest.CompressionR\vcompression\x12!\n" +
	...
	"\x03TLS\x10\x02BFZ#github.com/\x6c\x69\x76\x65\x6b\x69\x74/protocol/\x6c\x69\x76\x65\x6b\x69\x74\xaa\x02\r\x4c\x69\x76\x65\x4b\x69\x74.Proto\xea\x02\x0e\x4c\x69\x76\x65\x4b\x69\x74::Protob\x06proto3"

var (
	file_samvaad_rtc_proto_rawDescOnce sync.Once
	file_samvaad_rtc_proto_rawDescData []byte
)

func file_samvaad_rtc_proto_rawDescGZIP() []byte {
	file_samvaad_rtc_proto_rawDescOnce.Do(func() {
		file_samvaad_rtc_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_samvaad_rtc_proto_rawDesc), len(file_samvaad_rtc_proto_rawDesc)))
	})
	return file_samvaad_rtc_proto_rawDescData
}

var file_samvaad_rtc_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_samvaad_rtc_proto_msgTypes = make([]protoimpl.MessageInfo, 61)
var file_samvaad_rtc_proto_goTypes = []any{
	(SignalTarget)(0),                                     // 0: samvaad.SignalTarget
	(StreamState)(0),                                      // 1: samvaad.StreamState
	(CandidateProtocol)(0),                                // 2: samvaad.CandidateProtocol
	(LeaveRequest_Action)(0),                              // 3: samvaad.LeaveRequest.Action
	(RequestResponse_Reason)(0),                           // 4: samvaad.RequestResponse.Reason
	(WrappedJoinRequest_Compression)(0),                   // 5: samvaad.WrappedJoinRequest.Compression
	(*SignalRequest)(nil),                                 // 6: samvaad.SignalRequest
	(*SignalResponse)(nil),                                // 7: samvaad.SignalResponse
	(*SimulcastCodec)(nil),                                // 8: samvaad.SimulcastCodec
	(*AddTrackRequest)(nil),                               // 9: samvaad.AddTrackRequest
	(*PublishDataTrackRequest)(nil),                       // 10: samvaad.PublishDataTrackRequest
	(*PublishDataTrackResponse)(nil),                      // 11: samvaad.PublishDataTrackResponse
	(*UnpublishDataTrackRequest)(nil),                     // 12: samvaad.UnpublishDataTrackRequest
	(*UnpublishDataTrackResponse)(nil),                    // 13: samvaad.UnpublishDataTrackResponse
	(*DataTrackSubscriberHandles)(nil),                    // 14: samvaad.DataTrackSubscriberHandles
	(*TrickleRequest)(nil),                                // 15: samvaad.TrickleRequest
	(*MuteTrackRequest)(nil),                              // 16: samvaad.MuteTrackRequest
	(*JoinResponse)(nil),                                  // 17: samvaad.JoinResponse
	(*ReconnectResponse)(nil),                             // 18: samvaad.ReconnectResponse
	(*TrackPublishedResponse)(nil),                        // 19: samvaad.TrackPublishedResponse
	(*TrackUnpublishedResponse)(nil),                      // 20: samvaad.TrackUnpublishedResponse
	(*SessionDescription)(nil),                            // 21: samvaad.SessionDescription
	(*ParticipantUpdate)(nil),                             // 22: samvaad.ParticipantUpdate
	(*UpdateSubscription)(nil),                            // 23: samvaad.UpdateSubscription
	(*UpdateDataSubscription)(nil),                        // 24: samvaad.UpdateDataSubscription
	(*UpdateTrackSettings)(nil),                           // 25: samvaad.UpdateTrackSettings
	(*UpdateLocalAudioTrack)(nil),                         // 26: samvaad.UpdateLocalAudioTrack
	(*UpdateLocalVideoTrack)(nil),                         // 27: samvaad.UpdateLocalVideoTrack
	(*LeaveRequest)(nil),                                  // 28: samvaad.LeaveRequest
	(*UpdateVideoLayers)(nil),                             // 29: samvaad.UpdateVideoLayers
	(*UpdateParticipantMetadata)(nil),                     // 30: samvaad.UpdateParticipantMetadata
	(*ICEServer)(nil),                                     // 31: samvaad.ICEServer
	(*SpeakersChanged)(nil),                               // 32: samvaad.SpeakersChanged
	(*RoomUpdate)(nil),                                    // 33: samvaad.RoomUpdate
	(*ConnectionQualityInfo)(nil),                         // 34: samvaad.ConnectionQualityInfo
	(*ConnectionQualityUpdate)(nil),                       // 35: samvaad.ConnectionQualityUpdate
	(*StreamStateInfo)(nil),                               // 36: samvaad.StreamStateInfo
	(*StreamStateUpdate)(nil),                             // 37: samvaad.StreamStateUpdate
	(*SubscribedQuality)(nil),                             // 38: samvaad.SubscribedQuality
	(*SubscribedCodec)(nil),                               // 39: samvaad.SubscribedCodec
	(*SubscribedQualityUpdate)(nil),                       // 40: samvaad.SubscribedQualityUpdate
	(*SubscribedAudioCodecUpdate)(nil),                    // 41: samvaad.SubscribedAudioCodecUpdate
	(*TrackPermission)(nil),                               // 42: samvaad.TrackPermission
	(*SubscriptionPermission)(nil),                        // 43: samvaad.SubscriptionPermission
	(*SubscriptionPermissionUpdate)(nil),                  // 44: samvaad.SubscriptionPermissionUpdate
	(*RoomMovedResponse)(nil),                             // 45: samvaad.RoomMovedResponse
	(*SyncState)(nil),                                     // 46: samvaad.SyncState
	(*DataChannelReceiveState)(nil),                       // 47: samvaad.DataChannelReceiveState
	(*DataChannelInfo)(nil),                               // 48: samvaad.DataChannelInfo
	(*SimulateScenario)(nil),                              // 49: samvaad.SimulateScenario
	(*Ping)(nil),                                          // 50: samvaad.Ping
	(*Pong)(nil),                                          // 51: samvaad.Pong
	(*RegionSettings)(nil),                                // 52: samvaad.RegionSettings
	(*RegionInfo)(nil),                                    // 53: samvaad.RegionInfo
	(*SubscriptionResponse)(nil),                          // 54: samvaad.SubscriptionResponse
	(*RequestResponse)(nil),                               // 55: samvaad.RequestResponse
	(*TrackSubscribed)(nil),                               // 56: samvaad.TrackSubscribed
	(*ConnectionSettings)(nil),                            // 57: samvaad.ConnectionSettings
	(*JoinRequest)(nil),                                   // 58: samvaad.JoinRequest
	(*WrappedJoinRequest)(nil),                            // 59: samvaad.WrappedJoinRequest
	(*MediaSectionsRequirement)(nil),                      // 60: samvaad.MediaSectionsRequirement
	(*DataTrackSubscriberHandles_PublishedDataTrack)(nil), // 61: samvaad.DataTrackSubscriberHandles.PublishedDataTrack
	nil,                                   // 62: samvaad.DataTrackSubscriberHandles.SubHandlesEntry
	nil,                                   // 63: samvaad.SessionDescription.MidToTrackIdEntry
	(*UpdateDataSubscription_Update)(nil), // 64: samvaad.UpdateDataSubscription.Update
	nil,                                   // 65: samvaad.UpdateParticipantMetadata.AttributesEntry
	nil,                                   // 66: samvaad.JoinRequest.ParticipantAttributesEntry
	(*VideoLayer)(nil),                    // 67: samvaad.VideoLayer
	(VideoLayer_Mode)(0),                  // 68: samvaad.VideoLayer.Mode
	(TrackType)(0),                        // 69: samvaad.TrackType
	(TrackSource)(0),                      // 70: samvaad.TrackSource
	(Encryption_Type)(0),                  // 71: samvaad.Encryption.Type
	(BackupCodecPolicy)(0),                // 72: samvaad.BackupCodecPolicy
	(AudioTrackFeature)(0),                // 73: samvaad.AudioTrackFeature
	(PacketTrailerFeature)(0),             // 74: samvaad.PacketTrailerFeature
	(*DataTrackInfo)(nil),                 // 75: samvaad.DataTrackInfo
	(*Room)(nil),                          // 76: samvaad.Room
	(*ParticipantInfo)(nil),               // 77: samvaad.ParticipantInfo
	(*ClientConfiguration)(nil),           // 78: samvaad.ClientConfiguration
	(*ServerInfo)(nil),                    // 79: samvaad.ServerInfo
	(*Codec)(nil),                         // 80: samvaad.Codec
	(*TrackInfo)(nil),                     // 81: samvaad.TrackInfo
	(*ParticipantTracks)(nil),             // 82: samvaad.ParticipantTracks
	(VideoQuality)(0),                     // 83: samvaad.VideoQuality
	(DisconnectReason)(0),                 // 84: samvaad.DisconnectReason
	(*SpeakerInfo)(nil),                   // 85: samvaad.SpeakerInfo
	(ConnectionQuality)(0),                // 86: samvaad.ConnectionQuality
	(*SubscribedAudioCodec)(nil),          // 87: samvaad.SubscribedAudioCodec
	(SubscriptionError)(0),                // 88: samvaad.SubscriptionError
	(*ClientInfo)(nil),                    // 89: samvaad.ClientInfo
	(ReconnectReason)(0),                  // 90: samvaad.ReconnectReason
	(*DataTrackSubscriptionOptions)(nil),  // 91: samvaad.DataTrackSubscriptionOptions
}
var file_samvaad_rtc_proto_depIdxs = []int32{
	21,  // 0: samvaad.SignalRequest.offer:type_name -> samvaad.SessionDescription
	21,  // 1: samvaad.SignalRequest.answer:type_name -> samvaad.SessionDescription
	15,  // 2: samvaad.SignalRequest.trickle:type_name -> samvaad.TrickleRequest
	9,   // 3: samvaad.SignalRequest.add_track:type_name -> samvaad.AddTrackRequest
	16,  // 4: samvaad.SignalRequest.mute:type_name -> samvaad.MuteTrackRequest
	23,  // 5: samvaad.SignalRequest.subscription:type_name -> samvaad.UpdateSubscription
	25,  // 6: samvaad.SignalRequest.track_setting:type_name -> samvaad.UpdateTrackSettings
	28,  // 7: samvaad.SignalRequest.leave:type_name -> samvaad.LeaveRequest
	29,  // 8: samvaad.SignalRequest.update_layers:type_name -> samvaad.UpdateVideoLayers
	43,  // 9: samvaad.SignalRequest.subscription_permission:type_name -> samvaad.SubscriptionPermission
	46,  // 10: samvaad.SignalRequest.sync_state:type_name -> samvaad.SyncState
	49,  // 11: samvaad.SignalRequest.simulate:type_name -> samvaad.SimulateScenario
	30,  // 12: samvaad.SignalRequest.update_metadata:type_name -> samvaad.UpdateParticipantMetadata
	50,  // 13: samvaad.SignalRequest.ping_req:type_name -> samvaad.Ping
	26,  // 14: samvaad.SignalRequest.update_audio_track:type_name -> samvaad.UpdateLocalAudioTrack
	27,  // 15: samvaad.SignalRequest.update_video_track:type_name -> samvaad.UpdateLocalVideoTrack
	10,  // 16: samvaad.SignalRequest.publish_data_track_request:type_name -> samvaad.PublishDataTrackRequest
	12,  // 17: samvaad.SignalRequest.unpublish_data_track_request:type_name -> samvaad.UnpublishDataTrackRequest
	24,  // 18: samvaad.SignalRequest.update_data_subscription:type_name -> samvaad.UpdateDataSubscription
	17,  // 19: samvaad.SignalResponse.join:type_name -> samvaad.JoinResponse
	21,  // 20: samvaad.SignalResponse.answer:type_name -> samvaad.SessionDescription
	21,  // 21: samvaad.SignalResponse.offer:type_name -> samvaad.SessionDescription
	15,  // 22: samvaad.SignalResponse.trickle:type_name -> samvaad.TrickleRequest
	22,  // 23: samvaad.SignalResponse.update:type_name -> samvaad.ParticipantUpdate
	19,  // 24: samvaad.SignalResponse.track_published:type_name -> samvaad.TrackPublishedResponse
	28,  // 25: samvaad.SignalResponse.leave:type_name -> samvaad.LeaveRequest
	16,  // 26: samvaad.SignalResponse.mute:type_name -> samvaad.MuteTrackRequest
	32,  // 27: samvaad.SignalResponse.speakers_changed:type_name -> samvaad.SpeakersChanged
	33,  // 28: samvaad.SignalResponse.room_update:type_name -> samvaad.RoomUpdate
	35,  // 29: samvaad.SignalResponse.connection_quality:type_name -> samvaad.ConnectionQualityUpdate
	37,  // 30: samvaad.SignalResponse.stream_state_update:type_name -> samvaad.StreamStateUpdate
	40,  // 31: samvaad.SignalResponse.subscribed_quality_update:type_name -> samvaad.SubscribedQualityUpdate
	44,  // 32: samvaad.SignalResponse.subscription_permission_update:type_name -> samvaad.SubscriptionPermissionUpdate
	20,  // 33: samvaad.SignalResponse.track_unpublished:type_name -> samvaad.TrackUnpublishedResponse
	18,  // 34: samvaad.SignalResponse.reconnect:type_name -> samvaad.ReconnectResponse
	51,  // 35: samvaad.SignalResponse.pong_resp:type_name -> samvaad.Pong
	54,  // 36: samvaad.SignalResponse.subscription_response:type_name -> samvaad.SubscriptionResponse
	55,  // 37: samvaad.SignalResponse.request_response:type_name -> samvaad.RequestResponse
	56,  // 38: samvaad.SignalResponse.track_subscribed:type_name -> samvaad.TrackSubscribed
	45,  // 39: samvaad.SignalResponse.room_moved:type_name -> samvaad.RoomMovedResponse
	60,  // 40: samvaad.SignalResponse.media_sections_requirement:type_name -> samvaad.MediaSectionsRequirement
	41,  // 41: samvaad.SignalResponse.subscribed_audio_codec_update:type_name -> samvaad.SubscribedAudioCodecUpdate
	11,  // 42: samvaad.SignalResponse.publish_data_track_response:type_name -> samvaad.PublishDataTrackResponse
	13,  // 43: samvaad.SignalResponse.unpublish_data_track_response:type_name -> samvaad.UnpublishDataTrackResponse
	14,  // 44: samvaad.SignalResponse.data_track_subscriber_handles:type_name -> samvaad.DataTrackSubscriberHandles
	67,  // 45: samvaad.SimulcastCodec.layers:type_name -> samvaad.VideoLayer
	68,  // 46: samvaad.SimulcastCodec.video_layer_mode:type_name -> samvaad.VideoLayer.Mode
	69,  // 47: samvaad.AddTrackRequest.type:type_name -> samvaad.TrackType
	70,  // 48: samvaad.AddTrackRequest.source:type_name -> samvaad.TrackSource
	67,  // 49: samvaad.AddTrackRequest.layers:type_name -> samvaad.VideoLayer
	8,   // 50: samvaad.AddTrackRequest.simulcast_codecs:type_name -> samvaad.SimulcastCodec
	71,  // 51: samvaad.AddTrackRequest.encryption:type_name -> samvaad.Encryption.Type
	72,  // 52: samvaad.AddTrackRequest.backup_codec_policy:type_name -> samvaad.BackupCodecPolicy
	73,  // 53: samvaad.AddTrackRequest.audio_features:type_name -> samvaad.AudioTrackFeature
	74,  // 54: samvaad.AddTrackRequest.packet_trailer_features:type_name -> samvaad.PacketTrailerFeature
	71,  // 55: samvaad.PublishDataTrackRequest.encryption:type_name -> samvaad.Encryption.Type
	75,  // 56: samvaad.PublishDataTrackResponse.info:type_name -> samvaad.DataTrackInfo
	75,  // 57: samvaad.UnpublishDataTrackResponse.info:type_name -> samvaad.DataTrackInfo
	62,  // 58: samvaad.DataTrackSubscriberHandles.sub_handles:type_name -> samvaad.DataTrackSubscriberHandles.SubHandlesEntry
	0,   // 59: samvaad.TrickleRequest.target:type_name -> samvaad.SignalTarget
	76,  // 60: samvaad.JoinResponse.room:type_name -> samvaad.Room
	77,  // 61: samvaad.JoinResponse.participant:type_name -> samvaad.ParticipantInfo
	77,  // 62: samvaad.JoinResponse.other_participants:type_name -> samvaad.ParticipantInfo
	31,  // 63: samvaad.JoinResponse.ice_servers:type_name -> samvaad.ICEServer
	78,  // 64: samvaad.JoinResponse.client_configuration:type_name -> samvaad.ClientConfiguration
	79,  // 65: samvaad.JoinResponse.server_info:type_name -> samvaad.ServerInfo
	80,  // 66: samvaad.JoinResponse.enabled_publish_codecs:type_name -> samvaad.Codec
	31,  // 67: samvaad.ReconnectResponse.ice_servers:type_name -> samvaad.ICEServer
	78,  // 68: samvaad.ReconnectResponse.client_configuration:type_name -> samvaad.ClientConfiguration
	79,  // 69: samvaad.ReconnectResponse.server_info:type_name -> samvaad.ServerInfo
	81,  // 70: samvaad.TrackPublishedResponse.track:type_name -> samvaad.TrackInfo
	63,  // 71: samvaad.SessionDescription.mid_to_track_id:type_name -> samvaad.SessionDescription.MidToTrackIdEntry
	77,  // 72: samvaad.ParticipantUpdate.participants:type_name -> samvaad.ParticipantInfo
	82,  // 73: samvaad.UpdateSubscription.participant_tracks:type_name -> samvaad.ParticipantTracks
	64,  // 74: samvaad.UpdateDataSubscription.updates:type_name -> samvaad.UpdateDataSubscription.Update
	83,  // 75: samvaad.UpdateTrackSettings.quality:type_name -> samvaad.VideoQuality
	73,  // 76: samvaad.UpdateLocalAudioTrack.features:type_name -> samvaad.AudioTrackFeature
	84,  // 77: samvaad.LeaveRequest.reason:type_name -> samvaad.DisconnectReason
	3,   // 78: samvaad.LeaveRequest.action:type_name -> samvaad.LeaveRequest.Action
	52,  // 79: samvaad.LeaveRequest.regions:type_name -> samvaad.RegionSettings
	67,  // 80: samvaad.UpdateVideoLayers.layers:type_name -> samvaad.VideoLayer
	65,  // 81: samvaad.UpdateParticipantMetadata.attributes:type_name -> samvaad.UpdateParticipantMetadata.AttributesEntry
	85,  // 82: samvaad.SpeakersChanged.speakers:type_name -> samvaad.SpeakerInfo
	76,  // 83: samvaad.RoomUpdate.room:type_name -> samvaad.Room
	86,  // 84: samvaad.ConnectionQualityInfo.quality:type_name -> samvaad.ConnectionQuality
	34,  // 85: samvaad.ConnectionQualityUpdate.updates:type_name -> samvaad.ConnectionQualityInfo
	1,   // 86: samvaad.StreamStateInfo.state:type_name -> samvaad.StreamState
	36,  // 87: samvaad.StreamStateUpdate.stream_states:type_name -> samvaad.StreamStateInfo
	83,  // 88: samvaad.SubscribedQuality.quality:type_name -> samvaad.VideoQuality
	38,  // 89: samvaad.SubscribedCodec.qualities:type_name -> samvaad.SubscribedQuality
	38,  // 90: samvaad.SubscribedQualityUpdate.subscribed_qualities:type_name -> samvaad.SubscribedQuality
	39,  // 91: samvaad.SubscribedQualityUpdate.subscribed_codecs:type_name -> samvaad.SubscribedCodec
	87,  // 92: samvaad.SubscribedAudioCodecUpdate.subscribed_audio_codecs:type_name -> samvaad.SubscribedAudioCodec
	42,  // 93: samvaad.SubscriptionPermission.track_permissions:type_name -> samvaad.TrackPermission
	76,  // 94: samvaad.RoomMovedResponse.room:type_name -> samvaad.Room
	77,  // 95: samvaad.RoomMovedResponse.participant:type_name -> samvaad.ParticipantInfo
	77,  // 96: samvaad.RoomMovedResponse.other_participants:type_name -> samvaad.ParticipantInfo
	21,  // 97: samvaad.SyncState.answer:type_name -> samvaad.SessionDescription
	23,  // 98: samvaad.SyncState.subscription:type_name -> samvaad.UpdateSubscription
	19,  // 99: samvaad.SyncState.publish_tracks:type_name -> samvaad.TrackPublishedResponse
	48,  // 100: samvaad.SyncState.data_channels:type_name -> samvaad.DataChannelInfo
	21,  // 101: samvaad.SyncState.offer:type_name -> samvaad.SessionDescription
	47,  // 102: samvaad.SyncState.datachannel_receive_states:type_name -> samvaad.DataChannelReceiveState
	11,  // 103: samvaad.SyncState.publish_data_tracks:type_name -> samvaad.PublishDataTrackResponse
	0,   // 104: samvaad.DataChannelInfo.target:type_name -> samvaad.SignalTarget
	2,   // 105: samvaad.SimulateScenario.switch_candidate_protocol:type_name -> samvaad.CandidateProtocol
	53,  // 106: samvaad.RegionSettings.regions:type_name -> samvaad.RegionInfo
	88,  // 107: samvaad.SubscriptionResponse.err:type_name -> samvaad.SubscriptionError
	4,   // 108: samvaad.RequestResponse.reason:type_name -> samvaad.RequestResponse.Reason
	15,  // 109: samvaad.RequestResponse.trickle:type_name -> samvaad.TrickleRequest
	9,   // 110: samvaad.RequestResponse.add_track:type_name -> samvaad.AddTrackRequest
	16,  // 111: samvaad.RequestResponse.mute:type_name -> samvaad.MuteTrackRequest
	30,  // 112: samvaad.RequestResponse.update_metadata:type_name -> samvaad.UpdateParticipantMetadata
	26,  // 113: samvaad.RequestResponse.update_audio_track:type_name -> samvaad.UpdateLocalAudioTrack
	27,  // 114: samvaad.RequestResponse.update_video_track:type_name -> samvaad.UpdateLocalVideoTrack
	10,  // 115: samvaad.RequestResponse.publish_data_track:type_name -> samvaad.PublishDataTrackRequest
	12,  // 116: samvaad.RequestResponse.unpublish_data_track:type_name -> samvaad.UnpublishDataTrackRequest
	89,  // 117: samvaad.JoinRequest.client_info:type_name -> samvaad.ClientInfo
	57,  // 118: samvaad.JoinRequest.connection_settings:type_name -> samvaad.ConnectionSettings
	66,  // 119: samvaad.JoinRequest.participant_attributes:type_name -> samvaad.JoinRequest.ParticipantAttributesEntry
	9,   // 120: samvaad.JoinRequest.add_track_requests:type_name -> samvaad.AddTrackRequest
	21,  // 121: samvaad.JoinRequest.publisher_offer:type_name -> samvaad.SessionDescription
	90,  // 122: samvaad.JoinRequest.reconnect_reason:type_name -> samvaad.ReconnectReason
	46,  // 123: samvaad.JoinRequest.sync_state:type_name -> samvaad.SyncState
	5,   // 124: samvaad.WrappedJoinRequest.compression:type_name -> samvaad.WrappedJoinRequest.Compression
	61,  // 125: samvaad.DataTrackSubscriberHandles.SubHandlesEntry.value:type_name -> samvaad.DataTrackSubscriberHandles.PublishedDataTrack
	91,  // 126: samvaad.UpdateDataSubscription.Update.options:type_name -> samvaad.DataTrackSubscriptionOptions
...
func init() { file_samvaad_rtc_proto_init() }
func file_samvaad_rtc_proto_init() {
	if File_samvaad_rtc_proto != nil {
		return
	}
	file_samvaad_models_proto_init()
	file_samvaad_rtc_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_samvaad_rtc_proto_msgTypes[1].OneofWrappers = []any{
	...
	file_samvaad_rtc_proto_msgTypes[43].OneofWrappers = []any{
	...
	file_samvaad_rtc_proto_msgTypes[49].OneofWrappers = []any{
	...
	file_samvaad_rtc_proto_msgTypes[51].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_samvaad_rtc_proto_rawDesc), len(file_samvaad_rtc_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   61,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_samvaad_rtc_proto_goTypes,
		DependencyIndexes: file_samvaad_rtc_proto_depIdxs,
		EnumInfos:         file_samvaad_rtc_proto_enumTypes,
		MessageInfos:      file_samvaad_rtc_proto_msgTypes,
	}.Build()
	File_samvaad_rtc_proto = out.File
	file_samvaad_rtc_proto_goTypes = nil
	file_samvaad_rtc_proto_depIdxs = nil
}
