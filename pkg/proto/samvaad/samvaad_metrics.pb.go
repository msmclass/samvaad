...
func (MetricLabel) Descriptor() protoreflect.EnumDescriptor {
	return file_samvaad_metrics_proto_enumTypes[0].Descriptor()
}

func (MetricLabel) Type() protoreflect.EnumType {
	return &file_samvaad_metrics_proto_enumTypes[0]
}
...
func (MetricLabel) EnumDescriptor() ([]byte, []int) {
	return file_samvaad_metrics_proto_rawDescGZIP(), []int{0}
}
...
func (x *MetricsBatch) Reset() {
	*x = MetricsBatch{}
	mi := &file_samvaad_metrics_proto_msgTypes[0]
...
func (x *TimeSeriesMetric) Reset() {
	*x = TimeSeriesMetric{}
	mi := &file_samvaad_metrics_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TimeSeriesMetric) Descriptor() ([]byte, []int) {
	return file_samvaad_metrics_proto_rawDescGZIP(), []int{1}
}
...
func (x *MetricSample) Reset() {
	*x = MetricSample{}
	mi := &file_samvaad_metrics_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MetricSample) Descriptor() ([]byte, []int) {
	return file_samvaad_metrics_proto_rawDescGZIP(), []int{2}
}
...
func (x *EventMetric) Reset() {
	*x = EventMetric{}
	mi := &file_samvaad_metrics_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EventMetric) Descriptor() ([]byte, []int) {
	return file_samvaad_metrics_proto_rawDescGZIP(), []int{3}
}
...
func (x *MetricsRecordingHeader) Reset() {
	*x = MetricsRecordingHeader{}
	mi := &file_samvaad_metrics_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MetricsRecordingHeader) Descriptor() ([]byte, []int) {
	return file_samvaad_metrics_proto_rawDescGZIP(), []int{4}
}
...
var File_samvaad_metrics_proto protoreflect.FileDescriptor

const file_samvaad_metrics_proto_rawDesc = "" +
	"\n" +
	"\x15\x6c\x69\x76\x65\x6b\x69\x74_metrics.proto\x12\a\x6c\x69\x76\x65\x6b\x69\x74\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x14logger/options.proto\"\x85\x02\n" +
	"\fMetricsBatch\x12!\n" +
	...
	"\vtime_series\x18\x04 \x03(\v2\x19.\x6c\x69\x76\x65\x6b\x69\x74.TimeSeriesMetricR\n" +
	"timeSeries\x12,\n" +
	"\x06events\x18\x05 \x03(\v2\x14.\x6c\x69\x76\x65\x6b\x69\x74.EventMetricR\x06events\"\xbb\x01\n" +
	...
	"\asamples\x18\x04 \x03(\v2\x15.\x6c\x69\x76\x65\x6b\x69\x74.MetricSampleR\asamples\x12\x10\n" +
	...
	"\troom_tags\x18\x05 \x03(\v2-.\x6c\x69\x76\x65\x6b\x69\x74.MetricsRecordingHeader.RoomTagsEntryR\broomTags\x12\x1b\n" +
	...
	"!METRIC_LABEL_PREDEFINED_MAX_VALUE\x10\x80 BFZ#github.com/\x6c\x69\x76\x65\x6b\x69\x74/protocol/\x6c\x69\x76\x65\x6b\x69\x74\xaa\x02\r\x4c\x69\x76\x65\x4b\x69\x74.Proto\xea\x02\x0e\x4c\x69\x76\x65\x4b\x69\x74::Protob\x06proto3"

var (
	file_samvaad_metrics_proto_rawDescOnce sync.Once
	file_samvaad_metrics_proto_rawDescData []byte
)

func file_samvaad_metrics_proto_rawDescGZIP() []byte {
	file_samvaad_metrics_proto_rawDescOnce.Do(func() {
		file_samvaad_metrics_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_samvaad_metrics_proto_rawDesc), len(file_samvaad_metrics_proto_rawDesc)))
	})
	return file_samvaad_metrics_proto_rawDescData
}

var file_samvaad_metrics_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_samvaad_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_samvaad_metrics_proto_goTypes = []any{
	(MetricLabel)(0),               // 0: samvaad.MetricLabel
	(*MetricsBatch)(nil),           // 1: samvaad.MetricsBatch
	(*TimeSeriesMetric)(nil),       // 2: samvaad.TimeSeriesMetric
	(*MetricSample)(nil),           // 3: samvaad.MetricSample
	(*EventMetric)(nil),            // 4: samvaad.EventMetric
	(*MetricsRecordingHeader)(nil), // 5: samvaad.MetricsRecordingHeader
	nil,                            // 6: samvaad.MetricsRecordingHeader.RoomTagsEntry
	(*timestamppb.Timestamp)(nil),  // 7: google.protobuf.Timestamp
}
var file_samvaad_metrics_proto_depIdxs = []int32{
	7,  // 0: samvaad.MetricsBatch.normalized_timestamp:type_name -> google.protobuf.Timestamp
	2,  // 1: samvaad.MetricsBatch.time_series:type_name -> samvaad.TimeSeriesMetric
	4,  // 2: samvaad.MetricsBatch.events:type_name -> samvaad.EventMetric
	3,  // 3: samvaad.TimeSeriesMetric.samples:type_name -> samvaad.MetricSample
	7,  // 4: samvaad.MetricSample.normalized_timestamp:type_name -> google.protobuf.Timestamp
	7,  // 5: samvaad.EventMetric.normalized_start_timestamp:type_name -> google.protobuf.Timestamp
	7,  // 6: samvaad.EventMetric.normalized_end_timestamp:type_name -> google.protobuf.Timestamp
	7,  // 7: samvaad.MetricsRecordingHeader.start_time:type_name -> google.protobuf.Timestamp
	6,  // 8: samvaad.MetricsRecordingHeader.room_tags:type_name -> samvaad.MetricsRecordingHeader.RoomTagsEntry
	7,  // 9: samvaad.MetricsRecordingHeader.room_start_time:type_name -> google.protobuf.Timestamp
...
func init() { file_samvaad_metrics_proto_init() }
func file_samvaad_metrics_proto_init() {
	if File_samvaad_metrics_proto != nil {
		return
	}
	file_samvaad_metrics_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_samvaad_metrics_proto_rawDesc), len(file_samvaad_metrics_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_samvaad_metrics_proto_goTypes,
		DependencyIndexes: file_samvaad_metrics_proto_depIdxs,
		EnumInfos:         file_samvaad_metrics_proto_enumTypes,
		MessageInfos:      file_samvaad_metrics_proto_msgTypes,
	}.Build()
	File_samvaad_metrics_proto = out.File
	file_samvaad_metrics_proto_goTypes = nil
	file_samvaad_metrics_proto_depIdxs = nil
}
