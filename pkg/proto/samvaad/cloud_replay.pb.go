...
const file_cloud_replay_proto_rawDesc = "" +
	"\n" +
	"\x12cloud_replay.proto\x12\a\x6c\x69\x76\x65\x6b\x69\x74\x1a\x1bgoogle/protobuf/empty.proto\x1a\x14\x6c\x69\x76\x65\x6b\x69\x74_egress.proto\x1a\x14\x6c\x69\x76\x65\x6b\x69\x74_models.proto\x1a\x14logger/options.proto\"j\n" +
	"\x12ListReplaysRequest\x12\x1b\n" +
	"\troom_name\x18\x01 \x01(\tR\broomName\x127\n" +
	"\n" +
	"page_token\x18\x02 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.TokenPaginationR\tpageToken\"\x86\x01\n" +
	"\x13ListReplaysResponse\x12-\n" +
	"\areplays\x18\x01 \x03(\v2\x13.\x6c\x69\x76\x65\x6b\x69\x74.ReplayInfoR\areplays\x12@\n" +
	"\x0fnext_page_token\x18\x02 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.TokenPaginationR\rnextPageToken\"\x93\x01\n" +
	"\n" +
	"ReplayInfo\x12(\n" +
	...
	"\x06Replay\x12H\n" +
	"\vListReplays\x12\x1b.\x6c\x69\x76\x65\x6b\x69\x74.ListReplaysRequest\x1a\x1c.\x6c\x69\x76\x65\x6b\x69\x74.ListReplaysResponse\x12?\n" +
	"\bPlayback\x12\x18.\x6c\x69\x76\x65\x6b\x69\x74.PlaybackRequest\x1a\x19.\x6c\x69\x76\x65\x6b\x69\x74.PlaybackResponse\x124\n" +
	"\x04Seek\x12\x14.\x6c\x69\x76\x65\x6b\x69\x74.SeekRequest\x1a\x16.google.protobuf.Empty\x12>\n" +
	"\x05Close\x12\x1d.\x6c\x69\x76\x65\x6b\x69\x74.ClosePlaybackRequest\x1a\x16.google.protobuf.Empty\x12;\n" +
	"\x06Export\x12\x1c.\x6c\x69\x76\x65\x6b\x69\x74.ExportReplayRequest\x1a\x13.\x6c\x69\x76\x65\x6b\x69\x74.EgressInfo\x12D\n" +
	"\fDeleteReplay\x12\x1c.\x6c\x69\x76\x65\x6b\x69\x74.DeleteReplayRequest\x1a\x16.google.protobuf.EmptyBFZ#github.com/\x6c\x69\x76\x65\x6b\x69\x74/protocol/\x6c\x69\x76\x65\x6b\x69\x74\xaa\x02\r\x4c\x69\x76\x65\x4b\x69\x74.Proto\xea\x02\x0e\x4c\x69\x76\x65\x4b\x69\x74::Protob\x06proto3"
...
var file_cloud_replay_proto_goTypes = []any{
	(*ListReplaysRequest)(nil),   // 0: samvaad.ListReplaysRequest
	(*ListReplaysResponse)(nil),  // 1: samvaad.ListReplaysResponse
	(*ReplayInfo)(nil),           // 2: samvaad.ReplayInfo
	(*PlaybackRequest)(nil),      // 3: samvaad.PlaybackRequest
	(*PlaybackResponse)(nil),     // 4: samvaad.PlaybackResponse
	(*SeekRequest)(nil),          // 5: samvaad.SeekRequest
	(*ClosePlaybackRequest)(nil), // 6: samvaad.ClosePlaybackRequest
	(*DeleteReplayRequest)(nil),  // 7: samvaad.DeleteReplayRequest
	(*TokenPagination)(nil),      // 8: samvaad.TokenPagination
	(*ExportReplayRequest)(nil),  // 9: samvaad.ExportReplayRequest
	(*emptypb.Empty)(nil),        // 10: google.protobuf.Empty
	(*EgressInfo)(nil),           // 11: samvaad.EgressInfo
}
var file_cloud_replay_proto_depIdxs = []int32{
	8,  // 0: samvaad.ListReplaysRequest.page_token:type_name -> samvaad.TokenPagination
	2,  // 1: samvaad.ListReplaysResponse.replays:type_name -> samvaad.ReplayInfo
	8,  // 2: samvaad.ListReplaysResponse.next_page_token:type_name -> samvaad.TokenPagination
	0,  // 3: samvaad.Replay.ListReplays:input_type -> samvaad.ListReplaysRequest
	3,  // 4: samvaad.Replay.Playback:input_type -> samvaad.PlaybackRequest
	5,  // 5: samvaad.Replay.Seek:input_type -> samvaad.SeekRequest
	6,  // 6: samvaad.Replay.Close:input_type -> samvaad.ClosePlaybackRequest
	9,  // 7: samvaad.Replay.Export:input_type -> samvaad.ExportReplayRequest
	7,  // 8: samvaad.Replay.DeleteReplay:input_type -> samvaad.DeleteReplayRequest
	1,  // 9: samvaad.Replay.ListReplays:output_type -> samvaad.ListReplaysResponse
	4,  // 10: samvaad.Replay.Playback:output_type -> samvaad.PlaybackResponse
	10, // 11: samvaad.Replay.Seek:output_type -> google.protobuf.Empty
	10, // 12: samvaad.Replay.Close:output_type -> google.protobuf.Empty
	11, // 13: samvaad.Replay.Export:output_type -> samvaad.EgressInfo
	10, // 14: samvaad.Replay.DeleteReplay:output_type -> google.protobuf.Empty
