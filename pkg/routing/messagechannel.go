...
func NewDefaultMessageChannel(connectionID samvaad.ConnectionID) *MessageChannel {
	return NewMessageChannel(connectionID, DefaultMessageChannelSize)
}

func NewMessageChannel(connectionID samvaad.ConnectionID, size int) *MessageChannel {
...
func (m *MessageChannel) ConnectionID() samvaad.ConnectionID {
