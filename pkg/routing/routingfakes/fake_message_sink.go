...
func (fake *FakeMessageSink) ConnectionID() samvaad.ConnectionID {
...
func (fake *FakeMessageSink) ConnectionIDCalls(stub func() samvaad.ConnectionID) {
	fake.connectionIDMutex.Lock()
	defer fake.connectionIDMutex.Unlock()
	fake.ConnectionIDStub = stub
}

func (fake *FakeMessageSink) ConnectionIDReturns(result1 samvaad.ConnectionID) {
	fake.connectionIDMutex.Lock()
	defer fake.connectionIDMutex.Unlock()
...
func (fake *FakeMessageSink) ConnectionIDReturnsOnCall(i int, result1 samvaad.ConnectionID) {
	fake.connectionIDMutex.Lock()
	defer fake.connectionIDMutex.Unlock()
	fake.ConnectionIDStub = nil
