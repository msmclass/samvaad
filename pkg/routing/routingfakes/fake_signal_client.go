...
type FakeSignalClient struct {
	...
	StartParticipantSignalStub        func(context.Context, samvaad.RoomName, routing.ParticipantInit, samvaad.NodeID) (samvaad.ConnectionID, routing.MessageSink, routing.MessageSource, error)
...
func (fake *FakeSignalClient) StartParticipantSignal(arg1 context.Context, arg2 samvaad.RoomName, arg3 routing.ParticipantInit, arg4 samvaad.NodeID) (samvaad.ConnectionID, routing.MessageSink, routing.MessageSource, error) {
...
func (fake *FakeSignalClient) StartParticipantSignalCalls(stub func(context.Context, samvaad.RoomName, routing.ParticipantInit, samvaad.NodeID) (samvaad.ConnectionID, routing.MessageSink, routing.MessageSource, error)) {
	fake.startParticipantSignalMutex.Lock()
	defer fake.startParticipantSignalMutex.Unlock()
	fake.StartParticipantSignalStub = stub
}

func (fake *FakeSignalClient) StartParticipantSignalArgsForCall(i int) (context.Context, samvaad.RoomName, routing.ParticipantInit, samvaad.NodeID) {
	fake.startParticipantSignalMutex.RLock()
	defer fake.startParticipantSignalMutex.RUnlock()
...
func (fake *FakeSignalClient) StartParticipantSignalReturns(result1 samvaad.ConnectionID, result2 routing.MessageSink, result3 routing.MessageSource, result4 error) {
	fake.startParticipantSignalMutex.Lock()
	defer fake.startParticipantSignalMutex.Unlock()
...
func (fake *FakeSignalClient) StartParticipantSignalReturnsOnCall(i int, result1 samvaad.ConnectionID, result2 routing.MessageSink, result3 routing.MessageSource, result4 error) {
	fake.startParticipantSignalMutex.Lock()
	defer fake.startParticipantSignalMutex.Unlock()
	fake.StartParticipantSignalStub = nil
