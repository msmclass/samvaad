...
type FakeMessageSource struct {
	...
	ConnectionIDStub        func() samvaad.ConnectionID
...
func (fake *FakeMessageSource) ConnectionID() samvaad.ConnectionID {
...
func (fake *FakeMessageSource) ConnectionIDCalls(stub func() samvaad.ConnectionID) {
	fake.connectionIDMutex.Lock()
	defer fake.connectionIDMutex.Unlock()
	fake.ConnectionIDStub = stub
}

func (fake *FakeMessageSource) ConnectionIDReturns(result1 samvaad.ConnectionID) {
	fake.connectionIDMutex.Lock()
	defer fake.connectionIDMutex.Unlock()
...
func (fake *FakeMessageSource) ConnectionIDReturnsOnCall(i int, result1 samvaad.ConnectionID) {
	fake.connectionIDMutex.Lock()
	defer fake.connectionIDMutex.Unlock()
	fake.ConnectionIDStub = nil
