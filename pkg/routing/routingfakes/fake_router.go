...
type FakeRouter struct {
	ClearRoomStateStub        func(context.Context, samvaad.RoomName) error
	...
	CreateRoomStub        func(context.Context, *samvaad.CreateRoomRequest) (*samvaad.Room, error)
	createRoomMutex       sync.RWMutex
	createRoomArgsForCall []struct {
		arg1 context.Context
		arg2 *samvaad.CreateRoomRequest
	}
	...
	GetNodeForRoomStub        func(context.Context, samvaad.RoomName) (*samvaad.Node, error)
	...
	ListNodesStub        func() ([]*samvaad.Node, error)
	...
	SetNodeForRoomStub        func(context.Context, samvaad.RoomName, samvaad.NodeID) error
	...
	StartParticipantSignalStub        func(context.Context, samvaad.RoomName, routing.ParticipantInit) (routing.StartParticipantSignalResults, error)
...
func (fake *FakeRouter) ClearRoomState(arg1 context.Context, arg2 samvaad.RoomName) error {
...
func (fake *FakeRouter) ClearRoomStateCalls(stub func(context.Context, samvaad.RoomName) error) {
	fake.clearRoomStateMutex.Lock()
	defer fake.clearRoomStateMutex.Unlock()
	fake.ClearRoomStateStub = stub
}

func (fake *FakeRouter) ClearRoomStateArgsForCall(i int) (context.Context, samvaad.RoomName) {
	fake.clearRoomStateMutex.RLock()
	defer fake.clearRoomStateMutex.RUnlock()
...
func (fake *FakeRouter) CreateRoom(arg1 context.Context, arg2 *samvaad.CreateRoomRequest) (*samvaad.Room, error) {
...
func (fake *FakeRouter) CreateRoomCalls(stub func(context.Context, *samvaad.CreateRoomRequest) (*samvaad.Room, error)) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
	fake.CreateRoomStub = stub
}

func (fake *FakeRouter) CreateRoomArgsForCall(i int) (context.Context, *samvaad.CreateRoomRequest) {
	fake.createRoomMutex.RLock()
	defer fake.createRoomMutex.RUnlock()
...
func (fake *FakeRouter) CreateRoomReturns(result1 *samvaad.Room, result2 error) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
...
func (fake *FakeRouter) CreateRoomReturnsOnCall(i int, result1 *samvaad.Room, result2 error) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
	fake.CreateRoomStub = nil
...
func (fake *FakeRouter) GetNodeForRoom(arg1 context.Context, arg2 samvaad.RoomName) (*samvaad.Node, error) {
...
func (fake *FakeRouter) GetNodeForRoomCalls(stub func(context.Context, samvaad.RoomName) (*samvaad.Node, error)) {
	fake.getNodeForRoomMutex.Lock()
	defer fake.getNodeForRoomMutex.Unlock()
	fake.GetNodeForRoomStub = stub
}

func (fake *FakeRouter) GetNodeForRoomArgsForCall(i int) (context.Context, samvaad.RoomName) {
	fake.getNodeForRoomMutex.RLock()
	defer fake.getNodeForRoomMutex.RUnlock()
...
func (fake *FakeRouter) GetNodeForRoomReturns(result1 *samvaad.Node, result2 error) {
	fake.getNodeForRoomMutex.Lock()
	defer fake.getNodeForRoomMutex.Unlock()
...
func (fake *FakeRouter) GetNodeForRoomReturnsOnCall(i int, result1 *samvaad.Node, result2 error) {
	fake.getNodeForRoomMutex.Lock()
	defer fake.getNodeForRoomMutex.Unlock()
	fake.GetNodeForRoomStub = nil
...
func (fake *FakeRouter) ListNodes() ([]*samvaad.Node, error) {
...
func (fake *FakeRouter) ListNodesCalls(stub func() ([]*samvaad.Node, error)) {
	fake.listNodesMutex.Lock()
	defer fake.listNodesMutex.Unlock()
	fake.ListNodesStub = stub
}

func (fake *FakeRouter) ListNodesReturns(result1 []*samvaad.Node, result2 error) {
	fake.listNodesMutex.Lock()
	defer fake.listNodesMutex.Unlock()
...
func (fake *FakeRouter) ListNodesReturnsOnCall(i int, result1 []*samvaad.Node, result2 error) {
	fake.listNodesMutex.Lock()
	defer fake.listNodesMutex.Unlock()
	fake.ListNodesStub = nil
...
func (fake *FakeRouter) SetNodeForRoom(arg1 context.Context, arg2 samvaad.RoomName, arg3 samvaad.NodeID) error {
...
func (fake *FakeRouter) SetNodeForRoomCalls(stub func(context.Context, samvaad.RoomName, samvaad.NodeID) error) {
	fake.setNodeForRoomMutex.Lock()
	defer fake.setNodeForRoomMutex.Unlock()
	fake.SetNodeForRoomStub = stub
}

func (fake *FakeRouter) SetNodeForRoomArgsForCall(i int) (context.Context, samvaad.RoomName, samvaad.NodeID) {
	fake.setNodeForRoomMutex.RLock()
	defer fake.setNodeForRoomMutex.RUnlock()
...
func (fake *FakeRouter) StartParticipantSignal(arg1 context.Context, arg2 samvaad.RoomName, arg3 routing.ParticipantInit) (routing.StartParticipantSignalResults, error) {
...
func (fake *FakeRouter) StartParticipantSignalCalls(stub func(context.Context, samvaad.RoomName, routing.ParticipantInit) (routing.StartParticipantSignalResults, error)) {
	fake.startParticipantSignalMutex.Lock()
	defer fake.startParticipantSignalMutex.Unlock()
	fake.StartParticipantSignalStub = stub
}

func (fake *FakeRouter) StartParticipantSignalArgsForCall(i int) (context.Context, samvaad.RoomName, routing.ParticipantInit) {
	fake.startParticipantSignalMutex.RLock()
	defer fake.startParticipantSignalMutex.RUnlock()
