...
type FakeRoomManagerClient struct {
	...
	CreateRoomStub        func(context.Context, samvaad.NodeID, *samvaad.CreateRoomRequest, ...psrpc.RequestOption) (*samvaad.Room, error)
	createRoomMutex       sync.RWMutex
	createRoomArgsForCall []struct {
		arg1 context.Context
		arg2 samvaad.NodeID
		arg3 *samvaad.CreateRoomRequest
...
func (fake *FakeRoomManagerClient) CreateRoom(arg1 context.Context, arg2 samvaad.NodeID, arg3 *samvaad.CreateRoomRequest, arg4 ...psrpc.RequestOption) (*samvaad.Room, error) {
...
func (fake *FakeRoomManagerClient) CreateRoomCalls(stub func(context.Context, samvaad.NodeID, *samvaad.CreateRoomRequest, ...psrpc.RequestOption) (*samvaad.Room, error)) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
	fake.CreateRoomStub = stub
}

func (fake *FakeRoomManagerClient) CreateRoomArgsForCall(i int) (context.Context, samvaad.NodeID, *samvaad.CreateRoomRequest, []psrpc.RequestOption) {
	fake.createRoomMutex.RLock()
	defer fake.createRoomMutex.RUnlock()
...
func (fake *FakeRoomManagerClient) CreateRoomReturns(result1 *samvaad.Room, result2 error) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
...
func (fake *FakeRoomManagerClient) CreateRoomReturnsOnCall(i int, result1 *samvaad.Room, result2 error) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
	fake.CreateRoomStub = nil
