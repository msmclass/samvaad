...
func (c *roomManagerClient) CreateRoom(ctx context.Context, nodeID samvaad.NodeID, req *samvaad.CreateRoomRequest, opts ...psrpc.RequestOption) (*samvaad.Room, error) {
