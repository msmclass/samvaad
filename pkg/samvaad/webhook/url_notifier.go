...
func (n *URLNotifier) RegisterProcessedHook(hook func(ctx context.Context, whi *samvaad.WebhookInfo)) {
	n.mu.Lock()
	defer n.mu.Unlock()
	n.processedHook = hook
}

func (n *URLNotifier) getProcessedHook() func(ctx context.Context, whi *samvaad.WebhookInfo) {
	n.mu.RLock()
	defer n.mu.RUnlock()
	return n.processedHook
}

func (n *URLNotifier) QueueNotify(ctx context.Context, event *samvaad.WebhookEvent, opts ...NotifyOption) error {
...
func (n *URLNotifier) send(event *samvaad.WebhookEvent, params *URLNotifierParams) error {
	// set dropped count
