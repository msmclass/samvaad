...
type ResourceURLNotifierParams struct {
	...
	APIKey     string
	APISecret  string
	FieldsHook func(whi *samvaad.WebhookInfo)
	EventKey   func(event *samvaad.WebhookEvent) string
	FilterParams
}
...
type ResourceURLNotifier struct {
	...
	processedHook func(ctx context.Context, whi *samvaad.WebhookInfo)
...
func (r *ResourceURLNotifier) RegisterProcessedHook(hook func(ctx context.Context, whi *samvaad.WebhookInfo)) {
	r.mu.Lock()
	defer r.mu.Unlock()
	r.processedHook = hook
}

func (r *ResourceURLNotifier) getProcessedHook() func(ctx context.Context, whi *samvaad.WebhookInfo) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	return r.processedHook
}

func (r *ResourceURLNotifier) QueueNotify(ctx context.Context, event *samvaad.WebhookEvent, opts ...NotifyOption) error {
...
func (r *ResourceURLNotifier) send(event *samvaad.WebhookEvent, params *ResourceURLNotifierParams) error {
