...
import (
	...
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/internal"
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/internal/bus"
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/internal/interceptors"
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/pkg/info"
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/pkg/metadata"
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/pkg/rand"
)
...
func selectServer(
	...
	for {
		...
		case res := <-resChan:
			...
			if res.Error != "" {
				resErr = psrpc.NewErrorf(psrpc.ErrorCode(res.Code), "%s", res.Error)
			}
		}
	}
}
