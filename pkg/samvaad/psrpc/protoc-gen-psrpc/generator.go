...
import (
	...
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/protoc-gen-psrpc/internal/gen"
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/protoc-gen-psrpc/internal/gen/stringutils"
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/protoc-gen-psrpc/internal/gen/typemap"
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/protoc-gen-psrpc/options"
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/version"
)
...
func (t *psrpc) generateImports(file *descriptor.FileDescriptorProto) {
	...
	// dependency imports
	t.P(`  "github.com/msmclass/samvaad/pkg/samvaad/psrpc"`)
	t.P(`  "github.com/msmclass/samvaad/pkg/samvaad/psrpc/pkg/client"`)
	t.P(`  "github.com/msmclass/samvaad/pkg/samvaad/psrpc/pkg/info"`)
	t.P(`  "github.com/msmclass/samvaad/pkg/samvaad/psrpc/pkg/rand"`)
	t.P(`  "github.com/msmclass/samvaad/pkg/samvaad/psrpc/pkg/server"`)
	t.P(`  "github.com/msmclass/samvaad/pkg/samvaad/psrpc/version"`)
	t.P(`)`)
