...
// # Usage
//
// The CPU request is read from the SAMVAAD_CPU_REQUEST environment variable,
// which should be populated e.g via the Kubernetes Downward API:
//
//	env:
//	  - name: SAMVAAD_CPU_REQUEST
//	    valueFrom:
//	      resourceFieldRef:
//	        containerName: <name>
...
//
//	import _ "github.com/msmclass/samvaad/pkg/samvaad/utils/hwstats/maxprocs"
package maxprocs
...
// Install caps GOMAXPROCS to ceil(SAMVAAD_CPU_REQUEST) when that environment
