...
func TestMetricsBatchBuilder(t *testing.T) {
	...
	t.Run("time series metric", func(t *testing.T) {
		...
		expected := &samvaad.MetricsBatch{
			...
			TimeSeries: []*samvaad.TimeSeriesMetric{
				{
					Label:               uint32(samvaad.MetricLabel_PUBLISHER_RTT),
					ParticipantIdentity: uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE),
					TrackSid:            uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE) + 1,
					Samples: []*samvaad.MetricSample{
						{
							TimestampMs:         at.UnixMilli(),
							NormalizedTimestamp: timestamppb.New(normalizedAt),
							Value:               42.4,
					...
					Rid: uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE) + 2,
				},
				{
					Label:               uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE) + 3,
					ParticipantIdentity: uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE),
					TrackSid:            uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE) + 4,
					Samples: []*samvaad.MetricSample{
						{
							TimestampMs:         at.UnixMilli(),
							NormalizedTimestamp: timestamppb.New(normalizedAt),
					...
					Rid: uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE) + 5,
				},
				{
					Label:               uint32(samvaad.MetricLabel_SUBSCRIBER_RTT),
					ParticipantIdentity: uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE) + 6,
					Samples: []*samvaad.MetricSample{
						{
							TimestampMs:         at.UnixMilli(),
							NormalizedTimestamp: timestamppb.New(normalizedAt),
				...
				{
					Label:               uint32(samvaad.MetricLabel_CLIENT_VIDEO_SUBSCRIBER_FREEZE_COUNT),
					ParticipantIdentity: uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE),
					Samples: []*samvaad.MetricSample{
						{
							TimestampMs:         at.UnixMilli(),
		...
		_, err = mbb.AddTimeSeriesMetric(TimeSeriesMetric{
			MetricLabel:         samvaad.MetricLabel_SUBSCRIBER_RTT,
		...
		_, err = mbb.AddTimeSeriesMetric(TimeSeriesMetric{
			MetricLabel:         samvaad.MetricLabel_CLIENT_VIDEO_SUBSCRIBER_FREEZE_COUNT,
			ParticipantIdentity: "PA_1",
			Samples: []MetricSample{
				{
					At:           at,
		...
		_, err = mbb.AddTimeSeriesMetric(TimeSeriesMetric{
			MetricLabel:         samvaad.MetricLabel_CLIENT_VIDEO_PUBLISHER_QUALITY_LIMITATION_DURATION_OTHER,
			ParticipantIdentity: "PA_2",
			Samples: []MetricSample{
				{
					At:           at,
	...
	t.Run("event metric", func(t *testing.T) {
		...
		expected := &samvaad.MetricsBatch{
			...
			Events: []*samvaad.EventMetric{
				...
				{
					Label:                    uint32(samvaad.MetricLabel_CLIENT_VIDEO_PUBLISHER_QUALITY_LIMITATION_DURATION_OTHER),
					ParticipantIdentity:      uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE),
					TrackSid:                 uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE) + 1,
					StartTimestampMs:         at.UnixMilli(),
					EndTimestampMs:           &atMilli,
			...
			TimeSeries: []*samvaad.TimeSeriesMetric{
				{
					Label:               uint32(samvaad.MetricLabel_SUBSCRIBER_RTT),
					ParticipantIdentity: uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE) + 5,
					Samples: []*samvaad.MetricSample{
						{
							TimestampMs:         at.UnixMilli(),
							NormalizedTimestamp: timestamppb.New(normalizedAt),
	...
	t.Run("merge", func(t *testing.T) {
		...
		expected := &samvaad.MetricsBatch{
			...
			Events: []*samvaad.EventMetric{
				...
				{
					Label:                    uint32(samvaad.MetricLabel_CLIENT_VIDEO_PUBLISHER_QUALITY_LIMITATION_DURATION_BANDWIDTH),
					ParticipantIdentity:      uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE),
					TrackSid:                 uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE) + 4,
					StartTimestampMs:         at.UnixMilli(),
					NormalizedStartTimestamp: timestamppb.New(normalizedAt),
		...
		toMerge := &samvaad.MetricsBatch{
			...
			Events: []*samvaad.EventMetric{
				{
					Label:                    uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE),
					ParticipantIdentity:      uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE) + 1,
					TrackSid:                 uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE) + 2,
					StartTimestampMs:         at.UnixMilli(),
					NormalizedStartTimestamp: timestamppb.New(normalizedAt),
					Metadata:                 "md2",
					Rid:                      uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE) + 3,
				},
				{
					Label:                    uint32(samvaad.MetricLabel_CLIENT_VIDEO_PUBLISHER_QUALITY_LIMITATION_DURATION_BANDWIDTH),
					ParticipantIdentity:      uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE) + 1,
			...
			TimeSeries: []*samvaad.TimeSeriesMetric{
				{
					Label:               uint32(samvaad.MetricLabel_SUBSCRIBER_RTT),
					ParticipantIdentity: uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE) + 4,
					Samples: []*samvaad.MetricSample{
						{
							TimestampMs:         at.UnixMilli(),
							NormalizedTimestamp: timestamppb.New(normalizedAt),
				...
				{
					// should be filtered
					Label:               uint32(samvaad.MetricLabel_CLIENT_VIDEO_PUBLISHER_QUALITY_LIMITATION_DURATION_CPU),
					ParticipantIdentity: uint32(samvaad.MetricLabel_METRIC_LABEL_PREDEFINED_MAX_VALUE) + 4,
					Samples: []*samvaad.MetricSample{
						{
							TimestampMs:         at.UnixMilli(),
