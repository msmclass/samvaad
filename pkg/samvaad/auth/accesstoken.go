...
func (t *AccessToken) SetKind(kind samvaad.ParticipantInfo_Kind) *AccessToken {
	t.grant.SetParticipantKind(kind)
	return t
}

func (t *AccessToken) SetKindDetail(details ...samvaad.ParticipantInfo_KindDetail) *AccessToken {
...
func (t *AccessToken) SetRoomConfig(config *samvaad.RoomConfiguration) *AccessToken {
	if config == nil {
...
func (t *AccessToken) SetAgents(agents ...*samvaad.RoomAgentDispatch) *AccessToken {
