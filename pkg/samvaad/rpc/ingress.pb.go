...
type WHIPRTCConnectionNotifyRequest struct {
	...
	Video         *samvaad.InputVideoState `protobuf:"bytes,3,opt,name=video,proto3" json:"video,omitempty"`
	Audio         *samvaad.InputAudioState `protobuf:"bytes,4,opt,name=audio,proto3" json:"audio,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WHIPRTCConnectionNotifyRequest) GetVideo() *samvaad.InputVideoState {
	if x != nil {
		return x.Video
	}
	return nil
...
func (x *WHIPRTCConnectionNotifyRequest) GetAudio() *samvaad.InputAudioState {
	if x != nil {
		return x.Audio
	}
	return nil
...
func (x *StartIngressRequest) GetInfo() *samvaad.IngressInfo {
	if x != nil {
		return x.Info
	}
	return nil
...
const file_rpc_ingress_proto_rawDesc = "" +
	"\n" +
	"\x11rpc/ingress.proto\x12\x03rpc\x1a\roptions.proto\x1a\x15\x6c\x69\x76\x65\x6b\x69\x74_ingress.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x14logger/options.proto\"\x1a\n" +
	...
	"\x05audio\x18\x04 \x01(\v2\x18.\x6c\x69\x76\x65\x6b\x69\x74.InputAudioStateR\x05audio\"\x94\x03\n" +
	...
	"\fStartIngress\x12\x18.rpc.StartIngressRequest\x1a\x14.\x6c\x69\x76\x65\x6b\x69\x74.IngressInfo\"\x06\xb2\x89\x01\x020\x01\x12\\\n" +
	...
	"\rUpdateIngress\x12\x1d.\x6c\x69\x76\x65\x6b\x69\x74.UpdateIngressRequest\x1a\x15.\x6c\x69\x76\x65\x6b\x69\x74.IngressState\"\x06\xb2\x89\x01\x02\x10\x01\x12M\n" +
	"\rDeleteIngress\x12\x1d.\x6c\x69\x76\x65\x6b\x69\x74.DeleteIngressRequest\x1a\x15.\x6c\x69\x76\x65\x6b\x69\x74.IngressState\"\x06\xb2\x89\x01\x02\x10\x01\x12T\n" +
...
var file_rpc_ingress_proto_goTypes = []any{
	...
	(*samvaad.InputVideoState)(nil),        // 11: samvaad.InputVideoState
	(*samvaad.InputAudioState)(nil),        // 12: samvaad.InputAudioState
	(*samvaad.IngressInfo)(nil),            // 13: samvaad.IngressInfo
	(*samvaad.UpdateIngressRequest)(nil),   // 14: samvaad.UpdateIngressRequest
	(*samvaad.DeleteIngressRequest)(nil),   // 15: samvaad.DeleteIngressRequest
	(*samvaad.IngressState)(nil),           // 16: samvaad.IngressState
...
var file_rpc_ingress_proto_depIdxs = []int32{
	...
	11, // 1: rpc.WHIPRTCConnectionNotifyRequest.video:type_name -> samvaad.InputVideoState
	12, // 2: rpc.WHIPRTCConnectionNotifyRequest.audio:type_name -> samvaad.InputAudioState
	13, // 3: rpc.StartIngressRequest.info:type_name -> samvaad.IngressInfo
	...
	14, // 9: rpc.IngressHandler.UpdateIngress:input_type -> samvaad.UpdateIngressRequest
	15, // 10: rpc.IngressHandler.DeleteIngress:input_type -> samvaad.DeleteIngressRequest
	...
	13, // 14: rpc.IngressInternal.StartIngress:output_type -> samvaad.IngressInfo
	1,  // 15: rpc.IngressInternal.ListActiveIngress:output_type -> rpc.ListActiveIngressResponse
	16, // 16: rpc.IngressHandler.UpdateIngress:output_type -> samvaad.IngressState
	16, // 17: rpc.IngressHandler.DeleteIngress:output_type -> samvaad.IngressState
