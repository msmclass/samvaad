...
type RoomManagerClient[NodeIdTopicType ~string] interface {
	CreateRoom(ctx context.Context, nodeId NodeIdTopicType, req *samvaad6.CreateRoomRequest, opts ...psrpc.RequestOption) (*samvaad1.Room, error)
...
type RoomManagerServerImpl interface {
	CreateRoom(context.Context, *samvaad6.CreateRoomRequest) (*samvaad1.Room, error)
}
...
func (c *roomManagerClient[NodeIdTopicType]) CreateRoom(ctx context.Context, nodeId NodeIdTopicType, req *samvaad6.CreateRoomRequest, opts ...psrpc.RequestOption) (*samvaad1.Room, error) {
	return client.RequestSingle[*samvaad1.Room](ctx, c.client, "CreateRoom", []string{string(nodeId)}, req, opts...)
}
...
func (UnimplementedRoomManagerServer) CreateRoom(context.Context, *samvaad6.CreateRoomRequest) (*samvaad1.Room, error) {
