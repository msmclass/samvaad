...
type FakeKeepalivePubSub struct {
	...
	PublishPingStub        func(context.Context, samvaad.NodeID, *rpc.KeepalivePing) error
	...
	SubscribePingStub        func(context.Context, samvaad.NodeID) (psrpc.Subscription[*rpc.KeepalivePing], error)
...
func (fake *FakeKeepalivePubSub) PublishPing(arg1 context.Context, arg2 samvaad.NodeID, arg3 *rpc.KeepalivePing) error {
...
func (fake *FakeKeepalivePubSub) PublishPingCalls(stub func(context.Context, samvaad.NodeID, *rpc.KeepalivePing) error) {
	fake.publishPingMutex.Lock()
	defer fake.publishPingMutex.Unlock()
	fake.PublishPingStub = stub
}

func (fake *FakeKeepalivePubSub) PublishPingArgsForCall(i int) (context.Context, samvaad.NodeID, *rpc.KeepalivePing) {
	fake.publishPingMutex.RLock()
	defer fake.publishPingMutex.RUnlock()
...
func (fake *FakeKeepalivePubSub) SubscribePing(arg1 context.Context, arg2 samvaad.NodeID) (psrpc.Subscription[*rpc.KeepalivePing], error) {
...
func (fake *FakeKeepalivePubSub) SubscribePingCalls(stub func(context.Context, samvaad.NodeID) (psrpc.Subscription[*rpc.KeepalivePing], error)) {
	fake.subscribePingMutex.Lock()
	defer fake.subscribePingMutex.Unlock()
	fake.SubscribePingStub = stub
}

func (fake *FakeKeepalivePubSub) SubscribePingArgsForCall(i int) (context.Context, samvaad.NodeID) {
	fake.subscribePingMutex.RLock()
	defer fake.subscribePingMutex.RUnlock()
