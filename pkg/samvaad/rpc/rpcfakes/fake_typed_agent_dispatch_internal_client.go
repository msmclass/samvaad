...
type FakeTypedAgentDispatchInternalClient struct {
	...
	CreateDispatchStub        func(context.Context, rpc.RoomTopic, *samvaad.AgentDispatch, ...psrpc.RequestOption) (*samvaad.AgentDispatch, error)
	createDispatchMutex       sync.RWMutex
	createDispatchArgsForCall []struct {
		arg1 context.Context
		arg2 rpc.RoomTopic
		arg3 *samvaad.AgentDispatch
		arg4 []psrpc.RequestOption
	}
	createDispatchReturns struct {
		result1 *samvaad.AgentDispatch
		result2 error
	}
	...
	DeleteDispatchStub        func(context.Context, rpc.RoomTopic, *samvaad.DeleteAgentDispatchRequest, ...psrpc.RequestOption) (*samvaad.AgentDispatch, error)
	deleteDispatchMutex       sync.RWMutex
	deleteDispatchArgsForCall []struct {
		arg1 context.Context
		arg2 rpc.RoomTopic
		arg3 *samvaad.DeleteAgentDispatchRequest
		arg4 []psrpc.RequestOption
	}
	...
	ListDispatchStub        func(context.Context, rpc.RoomTopic, *samvaad.ListAgentDispatchRequest, ...psrpc.RequestOption) (*samvaad.ListAgentDispatchResponse, error)
	listDispatchMutex       sync.RWMutex
	listDispatchArgsForCall []struct {
		arg1 context.Context
		arg2 rpc.RoomTopic
		arg3 *samvaad.ListAgentDispatchRequest
		arg4 []psrpc.RequestOption
	}
	listDispatchReturns struct {
		result1 *samvaad.ListAgentDispatchResponse
		result2 error
	}
...
func (fake *FakeTypedAgentDispatchInternalClient) CreateDispatch(arg1 context.Context, arg2 rpc.RoomTopic, arg3 *samvaad.AgentDispatch, arg4 ...psrpc.RequestOption) (*samvaad.AgentDispatch, error) {
...
func (fake *FakeTypedAgentDispatchInternalClient) CreateDispatchCalls(stub func(context.Context, rpc.RoomTopic, *samvaad.AgentDispatch, ...psrpc.RequestOption) (*samvaad.AgentDispatch, error)) {
	fake.createDispatchMutex.Lock()
	defer fake.createDispatchMutex.Unlock()
	fake.CreateDispatchStub = stub
}

func (fake *FakeTypedAgentDispatchInternalClient) CreateDispatchArgsForCall(i int) (context.Context, rpc.RoomTopic, *samvaad.AgentDispatch, []psrpc.RequestOption) {
	fake.createDispatchMutex.RLock()
	defer fake.createDispatchMutex.RUnlock()
...
func (fake *FakeTypedAgentDispatchInternalClient) CreateDispatchReturns(result1 *samvaad.AgentDispatch, result2 error) {
	fake.createDispatchMutex.Lock()
	defer fake.createDispatchMutex.Unlock()
...
func (fake *FakeTypedAgentDispatchInternalClient) CreateDispatchReturnsOnCall(i int, result1 *samvaad.AgentDispatch, result2 error) {
	fake.createDispatchMutex.Lock()
	defer fake.createDispatchMutex.Unlock()
	fake.CreateDispatchStub = nil
...
func (fake *FakeTypedAgentDispatchInternalClient) DeleteDispatch(arg1 context.Context, arg2 rpc.RoomTopic, arg3 *samvaad.DeleteAgentDispatchRequest, arg4 ...psrpc.RequestOption) (*samvaad.AgentDispatch, error) {
...
func (fake *FakeTypedAgentDispatchInternalClient) DeleteDispatchCalls(stub func(context.Context, rpc.RoomTopic, *samvaad.DeleteAgentDispatchRequest, ...psrpc.RequestOption) (*samvaad.AgentDispatch, error)) {
	fake.deleteDispatchMutex.Lock()
	defer fake.deleteDispatchMutex.Unlock()
	fake.DeleteDispatchStub = stub
}

func (fake *FakeTypedAgentDispatchInternalClient) DeleteDispatchArgsForCall(i int) (context.Context, rpc.RoomTopic, *samvaad.DeleteAgentDispatchRequest, []psrpc.RequestOption) {
	fake.deleteDispatchMutex.RLock()
	defer fake.deleteDispatchMutex.RUnlock()
...
func (fake *FakeTypedAgentDispatchInternalClient) DeleteDispatchReturns(result1 *samvaad.AgentDispatch, result2 error) {
	fake.deleteDispatchMutex.Lock()
	defer fake.deleteDispatchMutex.Unlock()
...
func (fake *FakeTypedAgentDispatchInternalClient) DeleteDispatchReturnsOnCall(i int, result1 *samvaad.AgentDispatch, result2 error) {
	fake.deleteDispatchMutex.Lock()
	defer fake.deleteDispatchMutex.Unlock()
	fake.DeleteDispatchStub = nil
...
func (fake *FakeTypedAgentDispatchInternalClient) ListDispatch(arg1 context.Context, arg2 rpc.RoomTopic, arg3 *samvaad.ListAgentDispatchRequest, arg4 ...psrpc.RequestOption) (*samvaad.ListAgentDispatchResponse, error) {
...
func (fake *FakeTypedAgentDispatchInternalClient) ListDispatchCalls(stub func(context.Context, rpc.RoomTopic, *samvaad.ListAgentDispatchRequest, ...psrpc.RequestOption) (*samvaad.ListAgentDispatchResponse, error)) {
	fake.listDispatchMutex.Lock()
	defer fake.listDispatchMutex.Unlock()
	fake.ListDispatchStub = stub
}

func (fake *FakeTypedAgentDispatchInternalClient) ListDispatchArgsForCall(i int) (context.Context, rpc.RoomTopic, *samvaad.ListAgentDispatchRequest, []psrpc.RequestOption) {
	fake.listDispatchMutex.RLock()
	defer fake.listDispatchMutex.RUnlock()
...
func (fake *FakeTypedAgentDispatchInternalClient) ListDispatchReturns(result1 *samvaad.ListAgentDispatchResponse, result2 error) {
	fake.listDispatchMutex.Lock()
	defer fake.listDispatchMutex.Unlock()
...
func (fake *FakeTypedAgentDispatchInternalClient) ListDispatchReturnsOnCall(i int, result1 *samvaad.ListAgentDispatchResponse, result2 error) {
	fake.listDispatchMutex.Lock()
	defer fake.listDispatchMutex.Unlock()
	fake.ListDispatchStub = nil
