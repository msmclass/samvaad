...
import samvaad2 "github.com/msmclass/samvaad/pkg/proto/samvaad"
...
type AgentInternalClient interface {
	...
	JobRequest(ctx context.Context, namespace string, jobType string, req *samvaad2.Job, opts ...psrpc.RequestOption) (*JobRequestResponse, error)
...
type AgentInternalServerImpl interface {
	...
	JobRequest(context.Context, *samvaad2.Job) (*JobRequestResponse, error)
	JobRequestAffinity(context.Context, *samvaad2.Job) float32
...
func (c *agentInternalClient) JobRequest(ctx context.Context, namespace string, jobType string, req *samvaad2.Job, opts ...psrpc.RequestOption) (*JobRequestResponse, error) {
...
func (UnimplementedAgentInternalServer) JobRequest(context.Context, *samvaad2.Job) (*JobRequestResponse, error) {
	return nil, psrpc.ErrUnimplemented
}
func (UnimplementedAgentInternalServer) JobRequestAffinity(context.Context, *samvaad2.Job) float32 {
	return -1
}
