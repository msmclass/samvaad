...
type JobRequestResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	State         *samvaad.JobState      `protobuf:"bytes,1,opt,name=state,proto3" json:"state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *JobRequestResponse) GetState() *samvaad.JobState {
	if x != nil {
		return x.State
	}
	return nil
...
func (x *JobTerminateResponse) GetState() *samvaad.JobState {
	if x != nil {
		return x.State
	}
	return nil
...
const file_rpc_agent_proto_rawDesc = "" +
	"\n" +
	"\x0frpc/agent.proto\x12\x03rpc\x1a\x1bgoogle/protobuf/empty.proto\x1a\roptions.proto\x1a\x13\x6c\x69\x76\x65\x6b\x69\x74_agent.proto\x1a\x14logger/options.proto\"\x15\n" +
	...
	"\x05state\x18\x01 \x01(\v2\x11.\x6c\x69\x76\x65\x6b\x69\x74.JobStateR\x05state\"g\n" +
	...
	"\x05state\x18\x01 \x01(\v2\x11.\x6c\x69\x76\x65\x6b\x69\x74.JobStateR\x05state*D\n" +
	...
	"\n" +
	"JobRequest\x12\f.\x6c\x69\x76\x65\x6b\x69\x74.Job\x1a\x17.rpc.JobRequestResponse\"\x1f\xb2\x89\x01\x1b\x10\x01\x1a\x15\x12\tnamespace\x12\bjob_type0\x01\x12U\n" +
	...
	"\x10WorkerRegistered\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\"\x1f\xb2\x89\x01\x1b\b\x01\x10\x01\x1a\x13\x12\x11handler_namespace(\x01B!Z\x1fgithub.com/\x6c\x69\x76\x65\x6b\x69\x74/protocol/rpcb\x06proto3"
...
var file_rpc_agent_proto_goTypes = []any{
	...
	(*samvaad.JobState)(nil),     // 6: samvaad.JobState
	(*samvaad.Job)(nil),          // 7: samvaad.Job
	(*emptypb.Empty)(nil),        // 8: google.protobuf.Empty
}
var file_rpc_agent_proto_depIdxs = []int32{
	6, // 0: rpc.JobRequestResponse.state:type_name -> samvaad.JobState
	0, // 1: rpc.JobTerminateRequest.reason:type_name -> rpc.JobTerminateReason
	6, // 2: rpc.JobTerminateResponse.state:type_name -> samvaad.JobState
	1, // 3: rpc.AgentInternal.CheckEnabled:input_type -> rpc.CheckEnabledRequest
	7, // 4: rpc.AgentInternal.JobRequest:input_type -> samvaad.Job
