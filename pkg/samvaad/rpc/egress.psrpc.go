...
type EgressInternalClient interface {
	StartEgress(ctx context.Context, topic string, req *StartEgressRequest, opts ...psrpc.RequestOption) (*samvaad4.EgressInfo, error)
...
type EgressInternalServerImpl interface {
	StartEgress(context.Context, *StartEgressRequest) (*samvaad4.EgressInfo, error)
...
func (c *egressInternalClient) StartEgress(ctx context.Context, topic string, req *StartEgressRequest, opts ...psrpc.RequestOption) (*samvaad4.EgressInfo, error) {
	return client.RequestSingle[*samvaad4.EgressInfo](ctx, c.client, "StartEgress", []string{topic}, req, opts...)
}
...
func (UnimplementedEgressInternalServer) StartEgress(context.Context, *StartEgressRequest) (*samvaad4.EgressInfo, error) {
...
type EgressHandlerClient interface {
	UpdateEgress(ctx context.Context, topic string, req *samvaad4.UpdateEgressRequest, opts ...psrpc.RequestOption) (*samvaad4.EgressInfo, error)

	StopEgress(ctx context.Context, topic string, req *samvaad4.StopEgressRequest, opts ...psrpc.RequestOption) (*samvaad4.EgressInfo, error)

	// --- Deprecated ---
	UpdateStream(ctx context.Context, topic string, req *samvaad4.UpdateStreamRequest, opts ...psrpc.RequestOption) (*samvaad4.EgressInfo, error)
...
type EgressHandlerServerImpl interface {
	UpdateEgress(context.Context, *samvaad4.UpdateEgressRequest) (*samvaad4.EgressInfo, error)

	StopEgress(context.Context, *samvaad4.StopEgressRequest) (*samvaad4.EgressInfo, error)

	// --- Deprecated ---
	UpdateStream(context.Context, *samvaad4.UpdateStreamRequest) (*samvaad4.EgressInfo, error)
}
...
func (c *egressHandlerClient) UpdateEgress(ctx context.Context, topic string, req *samvaad4.UpdateEgressRequest, opts ...psrpc.RequestOption) (*samvaad4.EgressInfo, error) {
	return client.RequestSingle[*samvaad4.EgressInfo](ctx, c.client, "UpdateEgress", []string{topic}, req, opts...)
}

func (c *egressHandlerClient) StopEgress(ctx context.Context, topic string, req *samvaad4.StopEgressRequest, opts ...psrpc.RequestOption) (*samvaad4.EgressInfo, error) {
	return client.RequestSingle[*samvaad4.EgressInfo](ctx, c.client, "StopEgress", []string{topic}, req, opts...)
}

func (c *egressHandlerClient) UpdateStream(ctx context.Context, topic string, req *samvaad4.UpdateStreamRequest, opts ...psrpc.RequestOption) (*samvaad4.EgressInfo, error) {
	return client.RequestSingle[*samvaad4.EgressInfo](ctx, c.client, "UpdateStream", []string{topic}, req, opts...)
}
...
func (UnimplementedEgressHandlerServer) UpdateEgress(context.Context, *samvaad4.UpdateEgressRequest) (*samvaad4.EgressInfo, error) {
	return nil, psrpc.ErrUnimplemented
}

func (UnimplementedEgressHandlerServer) StopEgress(context.Context, *samvaad4.StopEgressRequest) (*samvaad4.EgressInfo, error) {
	return nil, psrpc.ErrUnimplemented
}

func (UnimplementedEgressHandlerServer) UpdateStream(context.Context, *samvaad4.UpdateStreamRequest) (*samvaad4.EgressInfo, error) {
	return nil, psrpc.ErrUnimplemented
}
