...
import samvaad3 "github.com/msmclass/samvaad/pkg/proto/samvaad"
...
type AgentDispatchInternalClient[RoomTopicType ~string] interface {
	CreateDispatch(ctx context.Context, room RoomTopicType, req *samvaad3.AgentDispatch, opts ...psrpc.RequestOption) (*samvaad3.AgentDispatch, error)

	DeleteDispatch(ctx context.Context, room RoomTopicType, req *samvaad3.DeleteAgentDispatchRequest, opts ...psrpc.RequestOption) (*samvaad3.AgentDispatch, error)

	ListDispatch(ctx context.Context, room RoomTopicType, req *samvaad3.ListAgentDispatchRequest, opts ...psrpc.RequestOption) (*samvaad3.ListAgentDispatchResponse, error)
...
type AgentDispatchInternalServerImpl interface {
	CreateDispatch(context.Context, *samvaad3.AgentDispatch) (*samvaad3.AgentDispatch, error)

	DeleteDispatch(context.Context, *samvaad3.DeleteAgentDispatchRequest) (*samvaad3.AgentDispatch, error)

	ListDispatch(context.Context, *samvaad3.ListAgentDispatchRequest) (*samvaad3.ListAgentDispatchResponse, error)
}
...
func (c *agentDispatchInternalClient[RoomTopicType]) CreateDispatch(ctx context.Context, room RoomTopicType, req *samvaad3.AgentDispatch, opts ...psrpc.RequestOption) (*samvaad3.AgentDispatch, error) {
	return client.RequestSingle[*samvaad3.AgentDispatch](ctx, c.client, "CreateDispatch", []string{string(room)}, req, opts...)
}

func (c *agentDispatchInternalClient[RoomTopicType]) DeleteDispatch(ctx context.Context, room RoomTopicType, req *samvaad3.DeleteAgentDispatchRequest, opts ...psrpc.RequestOption) (*samvaad3.AgentDispatch, error) {
	return client.RequestSingle[*samvaad3.AgentDispatch](ctx, c.client, "DeleteDispatch", []string{string(room)}, req, opts...)
}

func (c *agentDispatchInternalClient[RoomTopicType]) ListDispatch(ctx context.Context, room RoomTopicType, req *samvaad3.ListAgentDispatchRequest, opts ...psrpc.RequestOption) (*samvaad3.ListAgentDispatchResponse, error) {
	return client.RequestSingle[*samvaad3.ListAgentDispatchResponse](ctx, c.client, "ListDispatch", []string{string(room)}, req, opts...)
}
...
func (UnimplementedAgentDispatchInternalServer) CreateDispatch(context.Context, *samvaad3.AgentDispatch) (*samvaad3.AgentDispatch, error) {
	return nil, psrpc.ErrUnimplemented
}

func (UnimplementedAgentDispatchInternalServer) DeleteDispatch(context.Context, *samvaad3.DeleteAgentDispatchRequest) (*samvaad3.AgentDispatch, error) {
	return nil, psrpc.ErrUnimplemented
}

func (UnimplementedAgentDispatchInternalServer) ListDispatch(context.Context, *samvaad3.ListAgentDispatchRequest) (*samvaad3.ListAgentDispatchResponse, error) {
	return nil, psrpc.ErrUnimplemented
}
