...
type RoomClient[RoomTopicType ~string] interface {
	DeleteRoom(ctx context.Context, room RoomTopicType, req *samvaad6.DeleteRoomRequest, opts ...psrpc.RequestOption) (*samvaad6.DeleteRoomResponse, error)

	SendData(ctx context.Context, room RoomTopicType, req *samvaad6.SendDataRequest, opts ...psrpc.RequestOption) (*samvaad6.SendDataResponse, error)

	UpdateRoomMetadata(ctx context.Context, room RoomTopicType, req *samvaad6.UpdateRoomMetadataRequest, opts ...psrpc.RequestOption) (*samvaad1.Room, error)

	ListParticipants(ctx context.Context, room RoomTopicType, req *samvaad6.ListParticipantsRequest, opts ...psrpc.RequestOption) (*samvaad6.ListParticipantsResponse, error)

	GetParticipant(ctx context.Context, room RoomTopicType, req *samvaad6.RoomParticipantIdentity, opts ...psrpc.RequestOption) (*samvaad1.ParticipantInfo, error)
...
type RoomServerImpl interface {
	DeleteRoom(context.Context, *samvaad6.DeleteRoomRequest) (*samvaad6.DeleteRoomResponse, error)

	SendData(context.Context, *samvaad6.SendDataRequest) (*samvaad6.SendDataResponse, error)

	UpdateRoomMetadata(context.Context, *samvaad6.UpdateRoomMetadataRequest) (*samvaad1.Room, error)

	ListParticipants(context.Context, *samvaad6.ListParticipantsRequest) (*samvaad6.ListParticipantsResponse, error)

	GetParticipant(context.Context, *samvaad6.RoomParticipantIdentity) (*samvaad1.ParticipantInfo, error)
}
...
func (c *roomClient[RoomTopicType]) DeleteRoom(ctx context.Context, room RoomTopicType, req *samvaad6.DeleteRoomRequest, opts ...psrpc.RequestOption) (*samvaad6.DeleteRoomResponse, error) {
	return client.RequestSingle[*samvaad6.DeleteRoomResponse](ctx, c.client, "DeleteRoom", []string{string(room)}, req, opts...)
}

func (c *roomClient[RoomTopicType]) SendData(ctx context.Context, room RoomTopicType, req *samvaad6.SendDataRequest, opts ...psrpc.RequestOption) (*samvaad6.SendDataResponse, error) {
	return client.RequestSingle[*samvaad6.SendDataResponse](ctx, c.client, "SendData", []string{string(room)}, req, opts...)
}

func (c *roomClient[RoomTopicType]) UpdateRoomMetadata(ctx context.Context, room RoomTopicType, req *samvaad6.UpdateRoomMetadataRequest, opts ...psrpc.RequestOption) (*samvaad1.Room, error) {
	return client.RequestSingle[*samvaad1.Room](ctx, c.client, "UpdateRoomMetadata", []string{string(room)}, req, opts...)
}

func (c *roomClient[RoomTopicType]) ListParticipants(ctx context.Context, room RoomTopicType, req *samvaad6.ListParticipantsRequest, opts ...psrpc.RequestOption) (*samvaad6.ListParticipantsResponse, error) {
	return client.RequestSingle[*samvaad6.ListParticipantsResponse](ctx, c.client, "ListParticipants", []string{string(room)}, req, opts...)
}

func (c *roomClient[RoomTopicType]) GetParticipant(ctx context.Context, room RoomTopicType, req *samvaad6.RoomParticipantIdentity, opts ...psrpc.RequestOption) (*samvaad1.ParticipantInfo, error) {
	return client.RequestSingle[*samvaad1.ParticipantInfo](ctx, c.client, "GetParticipant", []string{string(room)}, req, opts...)
}
...
func (UnimplementedRoomServer) DeleteRoom(context.Context, *samvaad6.DeleteRoomRequest) (*samvaad6.DeleteRoomResponse, error) {
	return nil, psrpc.ErrUnimplemented
}

func (UnimplementedRoomServer) SendData(context.Context, *samvaad6.SendDataRequest) (*samvaad6.SendDataResponse, error) {
	return nil, psrpc.ErrUnimplemented
}

func (UnimplementedRoomServer) UpdateRoomMetadata(context.Context, *samvaad6.UpdateRoomMetadataRequest) (*samvaad1.Room, error) {
	return nil, psrpc.ErrUnimplemented
}

func (UnimplementedRoomServer) ListParticipants(context.Context, *samvaad6.ListParticipantsRequest) (*samvaad6.ListParticipantsResponse, error) {
	return nil, psrpc.ErrUnimplemented
}

func (UnimplementedRoomServer) GetParticipant(context.Context, *samvaad6.RoomParticipantIdentity) (*samvaad1.ParticipantInfo, error) {
	return nil, psrpc.ErrUnimplemented
}
