...
type RelaySignalRequest struct {
	...
	Requests      []*samvaad.SignalRequest `protobuf:"bytes,3,rep,name=requests,proto3" json:"requests,omitempty"`
...
func (x *RelaySignalRequest) GetStartSession() *samvaad.StartSession {
	if x != nil {
...
func (x *RelaySignalRequest) GetRequests() []*samvaad.SignalRequest {
	if x != nil {
		return x.Requests
	}
	return nil
...
type RelaySignalResponse struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	Responses     []*samvaad.SignalResponse `protobuf:"bytes,2,rep,name=responses,proto3" json:"responses,omitempty"`
...
func (x *RelaySignalResponse) GetResponses() []*samvaad.SignalResponse {
	if x != nil {
		return x.Responses
	}
	return nil
...
const file_rpc_signal_proto_rawDesc = "" +
	"\n" +
	"\x10rpc/signal.proto\x12\x03rpc\x1a\roptions.proto\x1a\x16\x6c\x69\x76\x65\x6b\x69\x74_internal.proto\x1a\x11\x6c\x69\x76\x65\x6b\x69\x74_rtc.proto\"\xac\x01\n" +
	"\x12RelaySignalRequest\x12:\n" +
	"\rstart_session\x18\x01 \x01(\v2\x15.\x6c\x69\x76\x65\x6b\x69\x74.StartSessionR\fstartSession\x122\n" +
	"\brequests\x18\x03 \x03(\v2\x16.\x6c\x69\x76\x65\x6b\x69\x74.SignalRequestR\brequests\x12\x10\n" +
	"\x03seq\x18\x04 \x01(\x04R\x03seq\x12\x14\n" +
	"\x05close\x18\x05 \x01(\bR\x05close\"t\n" +
	"\x13RelaySignalResponse\x125\n" +
	"\tresponses\x18\x02 \x03(\v2\x17.\x6c\x69\x76\x65\x6b\x69\x74.SignalResponseR\tresponses\x12\x10\n" +
	...
	"\x04node\x12\anode_id\x18\x01 \x01 \x01B!Z\x1fgithub.com/\x6c\x69\x76\x65\x6b\x69\x74/protocol/rpcb\x06proto3"
...
var file_rpc_signal_proto_goTypes = []any{
	...
	(*samvaad.StartSession)(nil),   // 2: samvaad.StartSession
	(*samvaad.SignalRequest)(nil),  // 3: samvaad.SignalRequest
	(*samvaad.SignalResponse)(nil), // 4: samvaad.SignalResponse
}
var file_rpc_signal_proto_depIdxs = []int32{
	2, // 0: rpc.RelaySignalRequest.start_session:type_name -> samvaad.StartSession
	3, // 1: rpc.RelaySignalRequest.requests:type_name -> samvaad.SignalRequest
	4, // 2: rpc.RelaySignalResponse.responses:type_name -> samvaad.SignalResponse
