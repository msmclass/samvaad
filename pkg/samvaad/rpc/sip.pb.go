...
type InternalCreateSIPParticipantRequest struct {
	...
	Transport          samvaad.SIPTransport `protobuf:"varint,16,opt,name=transport,proto3,enum=samvaad.SIPTransport" json:"transport,omitempty"`
	...
	IncludeHeaders  samvaad.SIPHeaderOptions `protobuf:"varint,27,opt,name=include_headers,json=includeHeaders,proto3,enum=samvaad.SIPHeaderOptions" json:"include_headers,omitempty"`
	EnabledFeatures []samvaad.SIPFeature     `protobuf:"varint,25,rep,packed,name=enabled_features,json=enabledFeatures,proto3,enum=samvaad.SIPFeature" json:"enabled_features,omitempty"`
	...
	MediaEncryption samvaad.SIPMediaEncryption `protobuf:"varint,28,opt,name=media_encryption,json=mediaEncryption,proto3,enum=samvaad.SIPMediaEncryption" json:"media_encryption,omitempty"`
	Media           *samvaad.SIPMediaConfig    `protobuf:"bytes,34,opt,name=media,proto3" json:"media,omitempty"`
	...
	Destination *samvaad.Destination `protobuf:"bytes,32,opt,name=destination,proto3" json:"destination,omitempty"`
...
func (x *InternalCreateSIPParticipantRequest) GetTransport() samvaad.SIPTransport {
	if x != nil {
		return x.Transport
	}
	return samvaad.SIPTransport(0)
}
...
func (x *InternalCreateSIPParticipantRequest) GetIncludeHeaders() samvaad.SIPHeaderOptions {
	if x != nil {
...
func (x *InternalCreateSIPParticipantRequest) GetEnabledFeatures() []samvaad.SIPFeature {
	if x != nil {
...
// Deprecated: Marked as deprecated in rpc/sip.proto.
func (x *InternalCreateSIPParticipantRequest) GetMediaEncryption() samvaad.SIPMediaEncryption {
	if x != nil {
...
func (x *InternalCreateSIPParticipantRequest) GetMedia() *samvaad.SIPMediaConfig {
	if x != nil {
		return x.Media
	}
	return nil
...
func (x *InternalCreateSIPParticipantRequest) GetDestination() *samvaad.Destination {
	if x != nil {
...
const file_rpc_sip_proto_rawDesc = "" +
	"\n" +
	"\rrpc/sip.proto\x12\x03rpc\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\roptions.proto\x1a\x11\x6c\x69\x76\x65\x6b\x69\x74_sip.proto\x1a\x14logger/options.proto\"\x99\x13\n" +
	...
	"\ttransport\x18\x10 \x01(\x0e2\x15.\x6c\x69\x76\x65\x6b\x69\x74.SIPTransportR\ttransport\x12\x16\n" +
	...
	"\x0finclude_headers\x18\x1b \x01(\x0e2\x19.\x6c\x69\x76\x65\x6b\x69\x74.SIPHeaderOptionsR\x0eincludeHeaders\x12>\n" +
	"\x10enabled_features\x18\x19 \x03(\x0e2\x13.\x6c\x69\x76\x65\x6b\x69\x74.SIPFeatureR\x0fenabledFeatures\x12B\n" +
	...
	"\x10media_encryption\x18\x1c \x01(\x0e2\x1b.\x6c\x69\x76\x65\x6b\x69\x74.SIPMediaEncryptionB\x02\x18\x01R\x0fmediaEncryption\x12-\n" +
	"\x05media\x18\" \x01(\v2\x17.\x6c\x69\x76\x65\x6b\x69\x74.SIPMediaConfigR\x05media\x12.\n" +
	...
	"\vdestination\x18  \x01(\v2\x14.\x6c\x69\x76\x65\x6b\x69\x74.DestinationR\vdestination\x12_\n" +
	...
	"\x16TransferSIPParticipant\x12*.rpc.InternalTransferSIPParticipantRequest\x1a\x16.google.protobuf.Empty\"\x15\xb2\x89\x01\x11\x10\x01\x1a\r\x12\vsip_call_idB!Z\x1fgithub.com/\x6c\x69\x76\x65\x6b\x69\x74/protocol/rpcb\x06proto3"
...
var file_rpc_sip_proto_goTypes = []any{
	...
	(samvaad.SIPTransport)(0),       // 10: samvaad.SIPTransport
	(samvaad.SIPHeaderOptions)(0),   // 11: samvaad.SIPHeaderOptions
	(samvaad.SIPFeature)(0),         // 12: samvaad.SIPFeature
	(*durationpb.Duration)(nil),     // 13: google.protobuf.Duration
	(samvaad.SIPMediaEncryption)(0), // 14: samvaad.SIPMediaEncryption
	(*samvaad.SIPMediaConfig)(nil),  // 15: samvaad.SIPMediaConfig
	(*samvaad.Destination)(nil),     // 16: samvaad.Destination
	(*emptypb.Empty)(nil),           // 17: google.protobuf.Empty
}
var file_rpc_sip_proto_depIdxs = []int32{
	10, // 0: rpc.InternalCreateSIPParticipantRequest.transport:type_name -> samvaad.SIPTransport
	...
	11, // 5: rpc.InternalCreateSIPParticipantRequest.include_headers:type_name -> samvaad.SIPHeaderOptions
	12, // 6: rpc.InternalCreateSIPParticipantRequest.enabled_features:type_name -> samvaad.SIPFeature
	...
	14, // 9: rpc.InternalCreateSIPParticipantRequest.media_encryption:type_name -> samvaad.SIPMediaEncryption
	15, // 10: rpc.InternalCreateSIPParticipantRequest.media:type_name -> samvaad.SIPMediaConfig
	16, // 11: rpc.InternalCreateSIPParticipantRequest.destination:type_name -> samvaad.Destination
