...
type IngressInternalClient interface {
	StartIngress(ctx context.Context, req *StartIngressRequest, opts ...psrpc.RequestOption) (*samvaad5.IngressInfo, error)
...
type IngressInternalServerImpl interface {
	StartIngress(context.Context, *StartIngressRequest) (*samvaad5.IngressInfo, error)
...
func (c *ingressInternalClient) StartIngress(ctx context.Context, req *StartIngressRequest, opts ...psrpc.RequestOption) (*samvaad5.IngressInfo, error) {
	return client.RequestSingle[*samvaad5.IngressInfo](ctx, c.client, "StartIngress", nil, req, opts...)
}
...
func (UnimplementedIngressInternalServer) StartIngress(context.Context, *StartIngressRequest) (*samvaad5.IngressInfo, error) {
...
type IngressHandlerClient interface {
	UpdateIngress(ctx context.Context, topic string, req *samvaad5.UpdateIngressRequest, opts ...psrpc.RequestOption) (*samvaad5.IngressState, error)

	DeleteIngress(ctx context.Context, topic string, req *samvaad5.DeleteIngressRequest, opts ...psrpc.RequestOption) (*samvaad5.IngressState, error)
...
type IngressHandlerServerImpl interface {
	UpdateIngress(context.Context, *samvaad5.UpdateIngressRequest) (*samvaad5.IngressState, error)

	DeleteIngress(context.Context, *samvaad5.DeleteIngressRequest) (*samvaad5.IngressState, error)
...
func (c *ingressHandlerClient) UpdateIngress(ctx context.Context, topic string, req *samvaad5.UpdateIngressRequest, opts ...psrpc.RequestOption) (*samvaad5.IngressState, error) {
	return client.RequestSingle[*samvaad5.IngressState](ctx, c.client, "UpdateIngress", []string{topic}, req, opts...)
}

func (c *ingressHandlerClient) DeleteIngress(ctx context.Context, topic string, req *samvaad5.DeleteIngressRequest, opts ...psrpc.RequestOption) (*samvaad5.IngressState, error) {
	return client.RequestSingle[*samvaad5.IngressState](ctx, c.client, "DeleteIngress", []string{topic}, req, opts...)
}
...
func (UnimplementedIngressHandlerServer) UpdateIngress(context.Context, *samvaad5.UpdateIngressRequest) (*samvaad5.IngressState, error) {
	return nil, psrpc.ErrUnimplemented
}

func (UnimplementedIngressHandlerServer) DeleteIngress(context.Context, *samvaad5.DeleteIngressRequest) (*samvaad5.IngressState, error) {
	return nil, psrpc.ErrUnimplemented
}
