...
import (
	...
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/pkg/client"
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/pkg/info"
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/pkg/rand"
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/pkg/server"
	"github.com/msmclass/samvaad/pkg/samvaad/psrpc/version"
)
import samvaad1 "github.com/msmclass/samvaad/pkg/proto/samvaad"
import samvaad6 "github.com/msmclass/samvaad/pkg/proto/samvaad"
...
type ParticipantClient[ParticipantTopicType ~string] interface {
	RemoveParticipant(ctx context.Context, participant ParticipantTopicType, req *samvaad6.RoomParticipantIdentity, opts ...psrpc.RequestOption) (*samvaad6.RemoveParticipantResponse, error)

	MutePublishedTrack(ctx context.Context, participant ParticipantTopicType, req *samvaad6.MuteRoomTrackRequest, opts ...psrpc.RequestOption) (*samvaad6.MuteRoomTrackResponse, error)

	UpdateParticipant(ctx context.Context, participant ParticipantTopicType, req *samvaad6.UpdateParticipantRequest, opts ...psrpc.RequestOption) (*samvaad1.ParticipantInfo, error)

	UpdateSubscriptions(ctx context.Context, participant ParticipantTopicType, req *samvaad6.UpdateSubscriptionsRequest, opts ...psrpc.RequestOption) (*samvaad6.UpdateSubscriptionsResponse, error)

	ForwardParticipant(ctx context.Context, participant ParticipantTopicType, req *samvaad6.ForwardParticipantRequest, opts ...psrpc.RequestOption) (*samvaad6.ForwardParticipantResponse, error)

	MoveParticipant(ctx context.Context, participant ParticipantTopicType, req *samvaad6.MoveParticipantRequest, opts ...psrpc.RequestOption) (*samvaad6.MoveParticipantResponse, error)

	PerformRpc(ctx context.Context, participant ParticipantTopicType, req *samvaad6.PerformRpcRequest, opts ...psrpc.RequestOption) (*samvaad6.PerformRpcResponse, error)
...
type ParticipantServerImpl interface {
	RemoveParticipant(context.Context, *samvaad6.RoomParticipantIdentity) (*samvaad6.RemoveParticipantResponse, error)

	MutePublishedTrack(context.Context, *samvaad6.MuteRoomTrackRequest) (*samvaad6.MuteRoomTrackResponse, error)

	UpdateParticipant(context.Context, *samvaad6.UpdateParticipantRequest) (*samvaad1.ParticipantInfo, error)

	UpdateSubscriptions(context.Context, *samvaad6.UpdateSubscriptionsRequest) (*samvaad6.UpdateSubscriptionsResponse, error)

	ForwardParticipant(context.Context, *samvaad6.ForwardParticipantRequest) (*samvaad6.ForwardParticipantResponse, error)

	MoveParticipant(context.Context, *samvaad6.MoveParticipantRequest) (*samvaad6.MoveParticipantResponse, error)

	PerformRpc(context.Context, *samvaad6.PerformRpcRequest) (*samvaad6.PerformRpcResponse, error)
}
...
func (c *participantClient[ParticipantTopicType]) RemoveParticipant(ctx context.Context, participant ParticipantTopicType, req *samvaad6.RoomParticipantIdentity, opts ...psrpc.RequestOption) (*samvaad6.RemoveParticipantResponse, error) {
	return client.RequestSingle[*samvaad6.RemoveParticipantResponse](ctx, c.client, "RemoveParticipant", []string{string(participant)}, req, opts...)
}

func (c *participantClient[ParticipantTopicType]) MutePublishedTrack(ctx context.Context, participant ParticipantTopicType, req *samvaad6.MuteRoomTrackRequest, opts ...psrpc.RequestOption) (*samvaad6.MuteRoomTrackResponse, error) {
	return client.RequestSingle[*samvaad6.MuteRoomTrackResponse](ctx, c.client, "MutePublishedTrack", []string{string(participant)}, req, opts...)
}

func (c *participantClient[ParticipantTopicType]) UpdateParticipant(ctx context.Context, participant ParticipantTopicType, req *samvaad6.UpdateParticipantRequest, opts ...psrpc.RequestOption) (*samvaad1.ParticipantInfo, error) {
	return client.RequestSingle[*samvaad1.ParticipantInfo](ctx, c.client, "UpdateParticipant", []string{string(participant)}, req, opts...)
}

func (c *participantClient[ParticipantTopicType]) UpdateSubscriptions(ctx context.Context, participant ParticipantTopicType, req *samvaad6.UpdateSubscriptionsRequest, opts ...psrpc.RequestOption) (*samvaad6.UpdateSubscriptionsResponse, error) {
	return client.RequestSingle[*samvaad6.UpdateSubscriptionsResponse](ctx, c.client, "UpdateSubscriptions", []string{string(participant)}, req, opts...)
}

func (c *participantClient[ParticipantTopicType]) ForwardParticipant(ctx context.Context, participant ParticipantTopicType, req *samvaad6.ForwardParticipantRequest, opts ...psrpc.RequestOption) (*samvaad6.ForwardParticipantResponse, error) {
	return client.RequestSingle[*samvaad6.ForwardParticipantResponse](ctx, c.client, "ForwardParticipant", []string{string(participant)}, req, opts...)
}

func (c *participantClient[ParticipantTopicType]) MoveParticipant(ctx context.Context, participant ParticipantTopicType, req *samvaad6.MoveParticipantRequest, opts ...psrpc.RequestOption) (*samvaad6.MoveParticipantResponse, error) {
	return client.RequestSingle[*samvaad6.MoveParticipantResponse](ctx, c.client, "MoveParticipant", []string{string(participant)}, req, opts...)
}

func (c *participantClient[ParticipantTopicType]) PerformRpc(ctx context.Context, participant ParticipantTopicType, req *samvaad6.PerformRpcRequest, opts ...psrpc.RequestOption) (*samvaad6.PerformRpcResponse, error) {
	return client.RequestSingle[*samvaad6.PerformRpcResponse](ctx, c.client, "PerformRpc", []string{string(participant)}, req, opts...)
}
...
func (UnimplementedParticipantServer) RemoveParticipant(context.Context, *samvaad6.RoomParticipantIdentity) (*samvaad6.RemoveParticipantResponse, error) {
	return nil, psrpc.ErrUnimplemented
}

func (UnimplementedParticipantServer) MutePublishedTrack(context.Context, *samvaad6.MuteRoomTrackRequest) (*samvaad6.MuteRoomTrackResponse, error) {
	return nil, psrpc.ErrUnimplemented
}

func (UnimplementedParticipantServer) UpdateParticipant(context.Context, *samvaad6.UpdateParticipantRequest) (*samvaad1.ParticipantInfo, error) {
	return nil, psrpc.ErrUnimplemented
}

func (UnimplementedParticipantServer) UpdateSubscriptions(context.Context, *samvaad6.UpdateSubscriptionsRequest) (*samvaad6.UpdateSubscriptionsResponse, error) {
	return nil, psrpc.ErrUnimplemented
}

func (UnimplementedParticipantServer) ForwardParticipant(context.Context, *samvaad6.ForwardParticipantRequest) (*samvaad6.ForwardParticipantResponse, error) {
	return nil, psrpc.ErrUnimplemented
}

func (UnimplementedParticipantServer) MoveParticipant(context.Context, *samvaad6.MoveParticipantRequest) (*samvaad6.MoveParticipantResponse, error) {
	return nil, psrpc.ErrUnimplemented
}

func (UnimplementedParticipantServer) PerformRpc(context.Context, *samvaad6.PerformRpcRequest) (*samvaad6.PerformRpcResponse, error) {
	return nil, psrpc.ErrUnimplemented
}
