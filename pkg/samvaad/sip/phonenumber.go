...
func DetermineNumberType(phoneNumber string) samvaad.PhoneNumberType {
	// Parse the phone number without defaulting to any country
	num, err := phonenumbers.Parse(phoneNumber, "")
	if err != nil {
		// If parsing fails, fall back to unknown
		return samvaad.PhoneNumberType_PHONE_NUMBER_TYPE_UNKNOWN
	}
	...
	case phonenumbers.MOBILE:
		return samvaad.PhoneNumberType_PHONE_NUMBER_TYPE_MOBILE
	case phonenumbers.FIXED_LINE:
		return samvaad.PhoneNumberType_PHONE_NUMBER_TYPE_LOCAL
	case phonenumbers.FIXED_LINE_OR_MOBILE:
		return samvaad.PhoneNumberType_PHONE_NUMBER_TYPE_LOCAL
	case phonenumbers.TOLL_FREE:
		return samvaad.PhoneNumberType_PHONE_NUMBER_TYPE_TOLL_FREE
	default:
		return samvaad.PhoneNumberType_PHONE_NUMBER_TYPE_UNKNOWN
	}
}
