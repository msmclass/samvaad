...
type ParticipantReporterResolver interface {
	Resolve(roomName samvaad.RoomName, roomID samvaad.RoomID, participant samvaad.ParticipantIdentity, pID samvaad.ParticipantID)
	Reset()
}
...
func (r deferredParticipantResolver) Resolve(roomName samvaad.RoomName, roomID samvaad.RoomID, participant samvaad.ParticipantIdentity, pID samvaad.ParticipantID) {
