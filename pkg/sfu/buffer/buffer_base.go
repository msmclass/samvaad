...
import (
	...
	"github.com/msmclass/samvaad/pkg/samvaad/transport/pkg/nack"
...
type BufferProvider interface {
	...
	SetSenderReportData(srData *samvaad.RTCPSenderReportState)
	GetSenderReportData() *samvaad.RTCPSenderReportState
	...
	CloseWithReason(reason string) (*samvaad.RTPStats, error)
}
...
func (b *BufferBase) CloseWithReason(reason string) (stats *samvaad.RTPStats, err error) {
	b.closeOnce.Do(func() {
...
func (b *BufferBase) stopRTPStats(reason string) (stats *samvaad.RTPStats, statsLite *samvaad.RTPStats) {
	if b.rtpStats != nil {
		b.rtpStats.Stop()
...
func (b *BufferBase) stopRTPStatsLite(reason string) (statsLite *samvaad.RTPStats) {
	if b.rtpStatsLite != nil {
		b.rtpStatsLite.Stop()
...
func (b *BufferBase) SetSenderReportData(srData *samvaad.RTCPSenderReportState) {
	b.RLock()
	didSet := false
	if b.rtpStats != nil {
...
func (b *BufferBase) GetSenderReportData() *samvaad.RTCPSenderReportState {
	b.RLock()
	defer b.RUnlock()
...
func (b *BufferBase) GetStats() *samvaad.RTPStats {
	b.RLock()
	defer b.RUnlock()
