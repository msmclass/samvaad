...
import (
	...
	"github.com/msmclass/samvaad/pkg/samvaad/utils/rtputil"
)
...
func RTCPSenderReportPropagationDelay(rsrs *samvaad.RTCPSenderReportState, passThrough bool) time.Duration {
	if passThrough {
		return 0
	}
...
type rtpStatsBase struct {
	*rtpStatsBaseLite
	...
	srFirst  *samvaad.RTCPSenderReportState
	srNewest *samvaad.RTCPSenderReportState
...
func (r *rtpStatsBase) maybeAdjustFirstPacketTime(
	srData *samvaad.RTCPSenderReportState,
	tsOffset uint64,
	extStartTS uint64,
...
func (r *rtpStatsBase) firstPacketTimeAdjustLogFields(now, firstTime int64, adjustment int64, extNowTS, extStartTS uint64, srData *samvaad.RTCPSenderReportState, tsOffset uint64, timeSinceReceive, timeSinceFirst, samplesDuration time.Duration, samplesDiff int64) []any {
	return []any{
...
func (r *rtpStatsBase) getDrift(extStartTS, extHighestTS uint64) (
	packetDrift *samvaad.RTPDrift,
	ntpReportDrift *samvaad.RTPDrift,
	receivedReportDrift *samvaad.RTPDrift,
	rebasedReportDrift *samvaad.RTPDrift,
) {
	if r.firstTime != 0 {
...
func AggregateRTPStats(statsList []*samvaad.RTPStats) *samvaad.RTPStats {
...
func ReconcileRTPStatsWithRTX(primaryStats *samvaad.RTPStats, rtxStats *samvaad.RTPStats) *samvaad.RTPStats {
