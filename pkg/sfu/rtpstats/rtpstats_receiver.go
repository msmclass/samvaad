...
import (
	...
	"github.com/msmclass/samvaad/pkg/samvaad/transport/pkg/latency"
	"github.com/msmclass/samvaad/pkg/samvaad/transport/pkg/utils"
...
func (r *RTPStatsReceiver) getExtendedSenderReport(srData *samvaad.RTCPSenderReportState) *samvaad.RTCPSenderReportState {
	tsCycles := uint64(0)
	if r.srNewest != nil {
...
func (r *RTPStatsReceiver) checkOutOfOrderSenderReport(srData *samvaad.RTCPSenderReportState) bool {
...
func (r *RTPStatsReceiver) checkRTPClockSkewForSenderReport(srData *samvaad.RTCPSenderReportState) {
	if r.srNewest == nil {
		return
	}
...
func (r *RTPStatsReceiver) checkRTPClockSkewAgainstMediaPathForSenderReport(srData *samvaad.RTCPSenderReportState) {
	if r.highestTime == 0 {
		return
	}
...
func (r *RTPStatsReceiver) updatePropagationDelayAndRecordSenderReport(srData *samvaad.RTCPSenderReportState) {
	srTime := mediatransportutil.NtpTime(srData.NtpTimestamp).Time()
...
func (r *RTPStatsReceiver) SetRtcpSenderReportData(srData *samvaad.RTCPSenderReportState) bool {
	r.lock.Lock()
	defer r.lock.Unlock()
...
func (r *RTPStatsReceiver) GetRtcpSenderReportData() *samvaad.RTCPSenderReportState {
	r.lock.RLock()
...
func (r *RTPStatsReceiver) ToProto() *samvaad.RTPStats {
	if r == nil {
		return nil
	}
