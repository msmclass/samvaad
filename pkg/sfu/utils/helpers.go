...
func IsSimulcastMode(m samvaad.VideoLayer_Mode) bool {
	return m == samvaad.VideoLayer_ONE_SPATIAL_LAYER_PER_STREAM || m == samvaad.VideoLayer_ONE_SPATIAL_LAYER_PER_STREAM_INCOMPLETE_RTCP_SR
}
