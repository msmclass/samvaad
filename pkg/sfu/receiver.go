...
type WebRTCReceiver struct {
	*ReceiverBase
	...
	onStatsUpdate   func(w *WebRTCReceiver, stat *samvaad.AnalyticsStat)
}
...
func NewWebRTCReceiver(
	...
	w.connectionStats.OnStatsUpdate(func(_cs *connectionquality.ConnectionStats, stat *samvaad.AnalyticsStat) {
...
func (w *WebRTCReceiver) OnStatsUpdate(fn func(w *WebRTCReceiver, stat *samvaad.AnalyticsStat)) {
	w.onStatsUpdate = fn
}

func (w *WebRTCReceiver) GetConnectionScoreAndQuality() (float32, samvaad.ConnectionQuality) {
...
func (w *WebRTCReceiver) AddUpTrack(track TrackRemote, buff *buffer.Buffer) error {
	...
	layer := int32(0)
	if w.Kind() == webrtc.RTPCodecTypeVideo && w.videoLayerMode != samvaad.VideoLayer_MULTIPLE_SPATIAL_LAYERS_PER_STREAM {
...
func (w *WebRTCReceiver) UpdateTrackInfo(ti *samvaad.TrackInfo) {
...
func (w *WebRTCReceiver) notifyMaxExpectedLayer(layer int32) {
	...
	if w.Kind() == webrtc.RTPCodecTypeAudio || ti.Source == samvaad.TrackSource_SCREEN_SHARE {
