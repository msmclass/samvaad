...
func TestConnectionQuality(t *testing.T) {
	...
	t.Run("quality scorer operation", func(t *testing.T) {
		...
		require.Equal(t, samvaad.ConnectionQuality_EXCELLENT, quality)
		...
		require.Equal(t, samvaad.ConnectionQuality_POOR, quality)
		...
		require.Equal(t, samvaad.ConnectionQuality_GOOD, quality)
		...
		require.Equal(t, samvaad.ConnectionQuality_LOST, quality)
	...
	t.Run("codecs - packet", func(t *testing.T) {
		type expectedQuality struct {
			...
			expectedMOS          float32
			expectedQuality      samvaad.ConnectionQuality
		}
		testCases := []struct {
			name              string
				...
				expectedQualities: []expectedQuality{
					{
						...
						expectedMOS:          4.6,
						expectedQuality:      samvaad.ConnectionQuality_EXCELLENT,
					},
					{
						packetLossPercentage: 4.0,
						expectedMOS:          4.1,
						expectedQuality:      samvaad.ConnectionQuality_GOOD,
					},
					{
						packetLossPercentage: 9.2,
						expectedMOS:          2.1,
						expectedQuality:      samvaad.ConnectionQuality_POOR,
					},
				},
			},
