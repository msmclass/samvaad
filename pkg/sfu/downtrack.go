...
import (
	...
	"github.com/msmclass/samvaad/pkg/sfu/bwe"
	"github.com/msmclass/samvaad/pkg/sfu/ccutils"
	"github.com/msmclass/samvaad/pkg/sfu/connectionquality"
	"github.com/msmclass/samvaad/pkg/sfu/pacer"
	"github.com/msmclass/samvaad/pkg/sfu/packettrailer"
	act "github.com/msmclass/samvaad/pkg/sfu/rtpextension/abscapturetime"
	dd "github.com/msmclass/samvaad/pkg/sfu/rtpextension/dependencydescriptor"
	pd "github.com/msmclass/samvaad/pkg/sfu/rtpextension/playoutdelay"
	"github.com/msmclass/samvaad/pkg/sfu/rtpstats"
	"github.com/msmclass/samvaad/pkg/sfu/utils"
)
...
type TrackSender interface {
	...
	HandleRTCPSenderReportData(
		...
		layer int32,
		publisherSRData *samvaad.RTCPSenderReportState,
	) error
	Resync()
...
type DownTrackState struct {
	...
	ForwarderState                *samvaad.RTPForwarderState
...
type DownTrackListener interface {
	OnBindAndConnected()
	OnStatsUpdate(stat *samvaad.AnalyticsStat)
...
type DownTrackParams struct {
	...
	SubID                          samvaad.ParticipantID
	StreamID                       string
	MaxTrack                       int
	PlayoutDelayLimit              *samvaad.PlayoutDelay
	Pacer                          pacer.Pacer
...
type DownTrack struct {
	...
	onStatsUpdate   atomic.Value // func(d *DownTrack, stat *samvaad.AnalyticsStat)
...
func NewDownTrack(params DownTrackParams) (*DownTrack, error) {
	...
	d.connectionStats.OnStatsUpdate(func(_cs *connectionquality.ConnectionStats, stat *samvaad.AnalyticsStat) {
		d.params.Listener.OnStatsUpdate(stat)
		if fn, ok := d.onStatsUpdate.Load().(func(*DownTrack, *samvaad.AnalyticsStat)); ok && fn != nil {
			fn(d, stat)
		}
	})
...
func (d *DownTrack) SubscriberID() samvaad.ParticipantID {
	// add `createdAt` to ensure repeated subscriptions from same subscriber to same publisher does not collide
	return samvaad.ParticipantID(fmt.Sprintf("%s:%d", d.params.SubID, d.createdAt))
}
		...
		case *rtcp.ReceiverReport:
			...
			for _, r := range p.Reports {
				...
				if d.playoutDelay != nil {
					...
					if d.params.Source != samvaad.TrackSource_SCREEN_SHARE {
...
func (d *DownTrack) GetConnectionScoreAndQuality() (float32, samvaad.ConnectionQuality) {
...
func (d *DownTrack) OnStatsUpdate(fn func(d *DownTrack, stat *samvaad.AnalyticsStat)) {
	d.onStatsUpdate.Store(fn)
}

func (d *DownTrack) GetTrackStats() *samvaad.RTPStats {
...
func (d *DownTrack) handleRTCPSenderReportData(publisherSRData *samvaad.RTCPSenderReportState, tsOffset uint64) {
