...
func NewStreamTrackerManager(
	...
	if trackInfo.Type == samvaad.TrackType_VIDEO {
...
func (s *StreamTrackerManager) UpdateTrackInfo(ti *samvaad.TrackInfo) {
	s.lock.Lock()
...
func (s *StreamTrackerManager) getLayeredBitrateLocked() ([]int32, Bitrates) {
	...
	if s.videoLayerMode == samvaad.VideoLayer_MULTIPLE_SPATIAL_LAYERS_PER_STREAM && s.ddTracker == nil {
