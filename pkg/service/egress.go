...
func (s *EgressService) StartRoomCompositeEgress(ctx context.Context, req *samvaad.RoomCompositeEgressRequest) (*samvaad.EgressInfo, error) {
	fields := []any{
		"room", req.RoomName,
...
func (s *EgressService) StartWebEgress(ctx context.Context, req *samvaad.WebEgressRequest) (*samvaad.EgressInfo, error) {
	fields := []any{
		"url", req.Url,
		"outputType", egress.GetOutputType(req),
	}
...
func (s *EgressService) StartParticipantEgress(ctx context.Context, req *samvaad.ParticipantEgressRequest) (*samvaad.EgressInfo, error) {
	fields := []any{
		"room", req.RoomName,
...
func (s *EgressService) StartTrackCompositeEgress(ctx context.Context, req *samvaad.TrackCompositeEgressRequest) (*samvaad.EgressInfo, error) {
	fields := []any{
		"room", req.RoomName,
...
func (s *EgressService) StartTrackEgress(ctx context.Context, req *samvaad.TrackEgressRequest) (*samvaad.EgressInfo, error) {
...
func (s *EgressService) startEgress(ctx context.Context, req *rpc.StartEgressRequest) (*samvaad.EgressInfo, error) {
...
func (s *egressLauncher) StartEgress(ctx context.Context, req *rpc.StartEgressRequest) (*samvaad.EgressInfo, error) {
	if s.client == nil {
		return nil, ErrEgressNotConnected
	}
	...
	if req.RoomId == "" {
		...
		if roomName != "" {
			room, _, err := s.store.LoadRoom(ctx, samvaad.RoomName(roomName), false)
			if err != nil {
				return nil, err
			}
			req.RoomId = room.Sid
...
func (s *egressLauncher) StopEgress(ctx context.Context, req *samvaad.StopEgressRequest) (*samvaad.EgressInfo, error) {
	if s.client == nil {
		return nil, ErrEgressNotConnected
	}
...
func (s *EgressService) UpdateLayout(ctx context.Context, req *samvaad.UpdateLayoutRequest) (*samvaad.EgressInfo, error) {
	...
	_, err = s.roomService.UpdateParticipant(ctx, &samvaad.UpdateParticipantRequest{
		Room:     info.RoomName,
...
func (s *EgressService) UpdateStream(ctx context.Context, req *samvaad.UpdateStreamRequest) (*samvaad.EgressInfo, error) {
	...
	if err != nil {
		...
		case samvaad.EgressStatus_EGRESS_STARTING,
			samvaad.EgressStatus_EGRESS_ACTIVE:
			return nil, err
		default:
...
func (s *EgressService) ListEgress(ctx context.Context, req *samvaad.ListEgressRequest) (*samvaad.ListEgressResponse, error) {
	if req.RoomName != "" {
...
func (s *EgressService) StopEgress(ctx context.Context, req *samvaad.StopEgressRequest) (info *samvaad.EgressInfo, err error) {
	defer func() {
