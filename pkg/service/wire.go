...
func InitializeServer(conf *config.Config, currentNode routing.LocalNode) (*SamvaadServer, error) {
	wire.Build(
		getNodeID,
		createRedisClient,
		createStore,
		...
		wire.Bind(new(samvaad.RoomService), new(*RoomService)),
...
func getNodeID(currentNode routing.LocalNode) samvaad.NodeID {
...
func createRedisClient(conf *config.Config) (redis.UniversalClient, error) {
	...
	return redisSamvaad.GetRedisClient(&conf.Redis)
}
