...
import (
	...
	redis2 "github.com/msmclass/samvaad/pkg/samvaad/redis"
...
func InitializeServer(conf *config.Config, currentNode routing.LocalNode) (*SamvaadServer, error) {
	...
	SamvaadServer, err := NewSamvaadServer(conf, roomService, agentDispatchService, egressService, ingressService, sipService, ioInfoService, rtcService, serviceWHIPService, agentService, keyProvider, router, roomManager, signalServer, server, currentNode)
	if err != nil {
		return nil, err
	}
