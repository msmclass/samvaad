...
func (c *WSSignalConnection) ReadRequest() (*samvaad.SignalRequest, int, error) {
...
func (c *WSSignalConnection) ReadWorkerMessage() (*samvaad.WorkerMessage, int, error) {
	// handle special messages and pass on the rest
	messageType, payload, err := c.conn.ReadMessage()
	if err != nil {
		return nil, 0, err
...
func (c *WSSignalConnection) WriteResponse(msg *samvaad.SignalResponse) (int, error) {
	var msgType int
	var payload []byte
	var err error
...
func (c *WSSignalConnection) WriteServerMessage(msg *samvaad.ServerMessage) (int, error) {
	var msgType int
	var payload []byte
	var err error
