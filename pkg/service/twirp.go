...
func RecordRequest(ctx context.Context, request proto.Message) {
	...
	a, ok := ctx.Value(twirpTelemetryKey{}).(*samvaad.APICallInfo)
	if !ok || a == nil {
		return
	}
	...
	case *samvaad.CreateRoomRequest:
		a.Request = &samvaad.APICallRequest{
			Message: &samvaad.APICallRequest_CreateRoomRequest{
				CreateRoomRequest: msg,
			},
		}
		a.RoomName = msg.GetName()

	case *samvaad.ListRoomsRequest:
		a.Request = &samvaad.APICallRequest{
			Message: &samvaad.APICallRequest_ListRoomsRequest{
				ListRoomsRequest: msg,
			},
		}

	case *samvaad.DeleteRoomRequest:
		a.Request = &samvaad.APICallRequest{
			Message: &samvaad.APICallRequest_DeleteRoomRequest{
				DeleteRoomRequest: msg,
			},
		}
		a.RoomName = msg.GetRoom()

	case *samvaad.ListParticipantsRequest:
		a.Request = &samvaad.APICallRequest{
			Message: &samvaad.APICallRequest_ListParticipantsRequest{
				ListParticipantsRequest: msg,
			},
		}
		a.RoomName = msg.GetRoom()

	case *samvaad.RoomParticipantIdentity:
		a.Request = &samvaad.APICallRequest{
			Message: &samvaad.APICallRequest_RoomParticipantIdentity{
	...
	case *samvaad.MuteRoomTrackRequest:
		a.Request = &samvaad.APICallRequest{
			Message: &samvaad.APICallRequest_MuteRoomTrackRequest{
	...
	case *samvaad.UpdateParticipantRequest:
		a.Request = &samvaad.APICallRequest{
			Message: &samvaad.APICallRequest_UpdateParticipantRequest{
	...
	case *samvaad.UpdateSubscriptionsRequest:
		a.Request = &samvaad.APICallRequest{
			Message: &samvaad.APICallRequest_UpdateSubscriptionsRequest{
	...
	case *samvaad.SendDataRequest:
		a.Request = &samvaad.APICallRequest{
			Message: &samvaad.APICallRequest_SendDataRequest{
				SendDataRequest: msg,
			},
		}
		a.RoomName = msg.GetRoom()

	case *samvaad.UpdateRoomMetadataRequest:
		a.Request = &samvaad.APICallRequest{
			Message: &samvaad.APICallRequest_UpdateRoomMetadataRequest{
