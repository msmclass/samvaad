...
type FakeObjectStore struct {
	DeleteParticipantStub        func(context.Context, samvaad.RoomName, samvaad.ParticipantIdentity) error
	...
	DeleteRoomStub        func(context.Context, samvaad.RoomName) error
	...
	HasParticipantStub        func(context.Context, samvaad.RoomName, samvaad.ParticipantIdentity) (bool, error)
	...
	ListParticipantsStub        func(context.Context, samvaad.RoomName) ([]*samvaad.ParticipantInfo, error)
	...
	ListRoomsStub        func(context.Context, []samvaad.RoomName) ([]*samvaad.Room, error)
	...
	LoadParticipantStub        func(context.Context, samvaad.RoomName, samvaad.ParticipantIdentity) (*samvaad.ParticipantInfo, error)
	...
	LoadRoomStub        func(context.Context, samvaad.RoomName, bool) (*samvaad.Room, *samvaad.RoomInternal, error)
	...
	LockRoomStub        func(context.Context, samvaad.RoomName, time.Duration) (string, error)
	...
	RoomExistsStub        func(context.Context, samvaad.RoomName) (bool, error)
	...
	StoreParticipantStub        func(context.Context, samvaad.RoomName, *samvaad.ParticipantInfo) error
	...
	StoreRoomStub        func(context.Context, *samvaad.Room, *samvaad.RoomInternal) error
	storeRoomMutex       sync.RWMutex
	storeRoomArgsForCall []struct {
		arg1 context.Context
		arg2 *samvaad.Room
		arg3 *samvaad.RoomInternal
	}
	...
	UnlockRoomStub        func(context.Context, samvaad.RoomName, string) error
...
func (fake *FakeObjectStore) DeleteParticipant(arg1 context.Context, arg2 samvaad.RoomName, arg3 samvaad.ParticipantIdentity) error {
...
func (fake *FakeObjectStore) DeleteParticipantCalls(stub func(context.Context, samvaad.RoomName, samvaad.ParticipantIdentity) error) {
	fake.deleteParticipantMutex.Lock()
	defer fake.deleteParticipantMutex.Unlock()
	fake.DeleteParticipantStub = stub
}

func (fake *FakeObjectStore) DeleteParticipantArgsForCall(i int) (context.Context, samvaad.RoomName, samvaad.ParticipantIdentity) {
	fake.deleteParticipantMutex.RLock()
	defer fake.deleteParticipantMutex.RUnlock()
...
func (fake *FakeObjectStore) DeleteRoom(arg1 context.Context, arg2 samvaad.RoomName) error {
...
func (fake *FakeObjectStore) DeleteRoomCalls(stub func(context.Context, samvaad.RoomName) error) {
	fake.deleteRoomMutex.Lock()
	defer fake.deleteRoomMutex.Unlock()
	fake.DeleteRoomStub = stub
}

func (fake *FakeObjectStore) DeleteRoomArgsForCall(i int) (context.Context, samvaad.RoomName) {
	fake.deleteRoomMutex.RLock()
	defer fake.deleteRoomMutex.RUnlock()
...
func (fake *FakeObjectStore) HasParticipant(arg1 context.Context, arg2 samvaad.RoomName, arg3 samvaad.ParticipantIdentity) (bool, error) {
...
func (fake *FakeObjectStore) HasParticipantCalls(stub func(context.Context, samvaad.RoomName, samvaad.ParticipantIdentity) (bool, error)) {
	fake.hasParticipantMutex.Lock()
	defer fake.hasParticipantMutex.Unlock()
	fake.HasParticipantStub = stub
}

func (fake *FakeObjectStore) HasParticipantArgsForCall(i int) (context.Context, samvaad.RoomName, samvaad.ParticipantIdentity) {
	fake.hasParticipantMutex.RLock()
	defer fake.hasParticipantMutex.RUnlock()
...
func (fake *FakeObjectStore) ListParticipants(arg1 context.Context, arg2 samvaad.RoomName) ([]*samvaad.ParticipantInfo, error) {
...
func (fake *FakeObjectStore) ListParticipantsCalls(stub func(context.Context, samvaad.RoomName) ([]*samvaad.ParticipantInfo, error)) {
	fake.listParticipantsMutex.Lock()
	defer fake.listParticipantsMutex.Unlock()
	fake.ListParticipantsStub = stub
}

func (fake *FakeObjectStore) ListParticipantsArgsForCall(i int) (context.Context, samvaad.RoomName) {
	fake.listParticipantsMutex.RLock()
	defer fake.listParticipantsMutex.RUnlock()
...
func (fake *FakeObjectStore) ListParticipantsReturns(result1 []*samvaad.ParticipantInfo, result2 error) {
	fake.listParticipantsMutex.Lock()
	defer fake.listParticipantsMutex.Unlock()
...
func (fake *FakeObjectStore) ListParticipantsReturnsOnCall(i int, result1 []*samvaad.ParticipantInfo, result2 error) {
	fake.listParticipantsMutex.Lock()
	defer fake.listParticipantsMutex.Unlock()
	fake.ListParticipantsStub = nil
...
func (fake *FakeObjectStore) ListRooms(arg1 context.Context, arg2 []samvaad.RoomName) ([]*samvaad.Room, error) {
	var arg2Copy []samvaad.RoomName
	if arg2 != nil {
		arg2Copy = make([]samvaad.RoomName, len(arg2))
		copy(arg2Copy, arg2)
	}
...
func (fake *FakeObjectStore) ListRoomsCalls(stub func(context.Context, []samvaad.RoomName) ([]*samvaad.Room, error)) {
	fake.listRoomsMutex.Lock()
	defer fake.listRoomsMutex.Unlock()
	fake.ListRoomsStub = stub
}

func (fake *FakeObjectStore) ListRoomsArgsForCall(i int) (context.Context, []samvaad.RoomName) {
	fake.listRoomsMutex.RLock()
	defer fake.listRoomsMutex.RUnlock()
...
func (fake *FakeObjectStore) ListRoomsReturns(result1 []*samvaad.Room, result2 error) {
	fake.listRoomsMutex.Lock()
	defer fake.listRoomsMutex.Unlock()
...
func (fake *FakeObjectStore) ListRoomsReturnsOnCall(i int, result1 []*samvaad.Room, result2 error) {
	fake.listRoomsMutex.Lock()
	defer fake.listRoomsMutex.Unlock()
	fake.ListRoomsStub = nil
...
func (fake *FakeObjectStore) LoadParticipant(arg1 context.Context, arg2 samvaad.RoomName, arg3 samvaad.ParticipantIdentity) (*samvaad.ParticipantInfo, error) {
...
func (fake *FakeObjectStore) LoadParticipantCalls(stub func(context.Context, samvaad.RoomName, samvaad.ParticipantIdentity) (*samvaad.ParticipantInfo, error)) {
	fake.loadParticipantMutex.Lock()
	defer fake.loadParticipantMutex.Unlock()
	fake.LoadParticipantStub = stub
}

func (fake *FakeObjectStore) LoadParticipantArgsForCall(i int) (context.Context, samvaad.RoomName, samvaad.ParticipantIdentity) {
	fake.loadParticipantMutex.RLock()
	defer fake.loadParticipantMutex.RUnlock()
...
func (fake *FakeObjectStore) LoadParticipantReturns(result1 *samvaad.ParticipantInfo, result2 error) {
	fake.loadParticipantMutex.Lock()
	defer fake.loadParticipantMutex.Unlock()
...
func (fake *FakeObjectStore) LoadParticipantReturnsOnCall(i int, result1 *samvaad.ParticipantInfo, result2 error) {
	fake.loadParticipantMutex.Lock()
	defer fake.loadParticipantMutex.Unlock()
	fake.LoadParticipantStub = nil
...
func (fake *FakeObjectStore) LoadRoom(arg1 context.Context, arg2 samvaad.RoomName, arg3 bool) (*samvaad.Room, *samvaad.RoomInternal, error) {
...
func (fake *FakeObjectStore) LoadRoomCalls(stub func(context.Context, samvaad.RoomName, bool) (*samvaad.Room, *samvaad.RoomInternal, error)) {
	fake.loadRoomMutex.Lock()
	defer fake.loadRoomMutex.Unlock()
	fake.LoadRoomStub = stub
}

func (fake *FakeObjectStore) LoadRoomArgsForCall(i int) (context.Context, samvaad.RoomName, bool) {
	fake.loadRoomMutex.RLock()
	defer fake.loadRoomMutex.RUnlock()
...
func (fake *FakeObjectStore) LoadRoomReturns(result1 *samvaad.Room, result2 *samvaad.RoomInternal, result3 error) {
	fake.loadRoomMutex.Lock()
	defer fake.loadRoomMutex.Unlock()
...
func (fake *FakeObjectStore) LoadRoomReturnsOnCall(i int, result1 *samvaad.Room, result2 *samvaad.RoomInternal, result3 error) {
	fake.loadRoomMutex.Lock()
	defer fake.loadRoomMutex.Unlock()
	fake.LoadRoomStub = nil
...
func (fake *FakeObjectStore) LockRoom(arg1 context.Context, arg2 samvaad.RoomName, arg3 time.Duration) (string, error) {
...
func (fake *FakeObjectStore) LockRoomCalls(stub func(context.Context, samvaad.RoomName, time.Duration) (string, error)) {
	fake.lockRoomMutex.Lock()
	defer fake.lockRoomMutex.Unlock()
	fake.LockRoomStub = stub
}

func (fake *FakeObjectStore) LockRoomArgsForCall(i int) (context.Context, samvaad.RoomName, time.Duration) {
	fake.lockRoomMutex.RLock()
	defer fake.lockRoomMutex.RUnlock()
...
func (fake *FakeObjectStore) RoomExists(arg1 context.Context, arg2 samvaad.RoomName) (bool, error) {
...
func (fake *FakeObjectStore) RoomExistsCalls(stub func(context.Context, samvaad.RoomName) (bool, error)) {
	fake.roomExistsMutex.Lock()
	defer fake.roomExistsMutex.Unlock()
	fake.RoomExistsStub = stub
}

func (fake *FakeObjectStore) RoomExistsArgsForCall(i int) (context.Context, samvaad.RoomName) {
	fake.roomExistsMutex.RLock()
	defer fake.roomExistsMutex.RUnlock()
...
func (fake *FakeObjectStore) StoreParticipant(arg1 context.Context, arg2 samvaad.RoomName, arg3 *samvaad.ParticipantInfo) error {
...
func (fake *FakeObjectStore) StoreParticipantCalls(stub func(context.Context, samvaad.RoomName, *samvaad.ParticipantInfo) error) {
	fake.storeParticipantMutex.Lock()
	defer fake.storeParticipantMutex.Unlock()
	fake.StoreParticipantStub = stub
}

func (fake *FakeObjectStore) StoreParticipantArgsForCall(i int) (context.Context, samvaad.RoomName, *samvaad.ParticipantInfo) {
	fake.storeParticipantMutex.RLock()
	defer fake.storeParticipantMutex.RUnlock()
...
func (fake *FakeObjectStore) StoreRoom(arg1 context.Context, arg2 *samvaad.Room, arg3 *samvaad.RoomInternal) error {
...
func (fake *FakeObjectStore) StoreRoomCalls(stub func(context.Context, *samvaad.Room, *samvaad.RoomInternal) error) {
	fake.storeRoomMutex.Lock()
	defer fake.storeRoomMutex.Unlock()
	fake.StoreRoomStub = stub
}

func (fake *FakeObjectStore) StoreRoomArgsForCall(i int) (context.Context, *samvaad.Room, *samvaad.RoomInternal) {
	fake.storeRoomMutex.RLock()
	defer fake.storeRoomMutex.RUnlock()
...
func (fake *FakeObjectStore) UnlockRoom(arg1 context.Context, arg2 samvaad.RoomName, arg3 string) error {
...
func (fake *FakeObjectStore) UnlockRoomCalls(stub func(context.Context, samvaad.RoomName, string) error) {
	fake.unlockRoomMutex.Lock()
	defer fake.unlockRoomMutex.Unlock()
	fake.UnlockRoomStub = stub
}

func (fake *FakeObjectStore) UnlockRoomArgsForCall(i int) (context.Context, samvaad.RoomName, string) {
	fake.unlockRoomMutex.RLock()
	defer fake.unlockRoomMutex.RUnlock()
