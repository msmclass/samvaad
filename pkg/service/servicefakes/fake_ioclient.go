...
type FakeIOClient struct {
	CreateEgressStub        func(context.Context, *samvaad.EgressInfo) (*emptypb.Empty, error)
	...
	CreateIngressStub        func(context.Context, *samvaad.IngressInfo) (*emptypb.Empty, error)
	...
	GetEgressStub        func(context.Context, *rpc.GetEgressRequest) (*samvaad.EgressInfo, error)
	...
	ListEgressStub        func(context.Context, *samvaad.ListEgressRequest) (*samvaad.ListEgressResponse, error)
	listEgressMutex       sync.RWMutex
	listEgressArgsForCall []struct {
		arg1 context.Context
		arg2 *samvaad.ListEgressRequest
	}
	listEgressReturns struct {
		result1 *samvaad.ListEgressResponse
		result2 error
	}
...
func (fake *FakeIOClient) CreateEgress(arg1 context.Context, arg2 *samvaad.EgressInfo) (*emptypb.Empty, error) {
...
func (fake *FakeIOClient) CreateEgressCalls(stub func(context.Context, *samvaad.EgressInfo) (*emptypb.Empty, error)) {
	fake.createEgressMutex.Lock()
	defer fake.createEgressMutex.Unlock()
	fake.CreateEgressStub = stub
}

func (fake *FakeIOClient) CreateEgressArgsForCall(i int) (context.Context, *samvaad.EgressInfo) {
	fake.createEgressMutex.RLock()
	defer fake.createEgressMutex.RUnlock()
...
func (fake *FakeIOClient) CreateIngress(arg1 context.Context, arg2 *samvaad.IngressInfo) (*emptypb.Empty, error) {
...
func (fake *FakeIOClient) CreateIngressCalls(stub func(context.Context, *samvaad.IngressInfo) (*emptypb.Empty, error)) {
	fake.createIngressMutex.Lock()
	defer fake.createIngressMutex.Unlock()
	fake.CreateIngressStub = stub
}

func (fake *FakeIOClient) CreateIngressArgsForCall(i int) (context.Context, *samvaad.IngressInfo) {
	fake.createIngressMutex.RLock()
	defer fake.createIngressMutex.RUnlock()
...
func (fake *FakeIOClient) GetEgress(arg1 context.Context, arg2 *rpc.GetEgressRequest) (*samvaad.EgressInfo, error) {
...
func (fake *FakeIOClient) GetEgressCalls(stub func(context.Context, *rpc.GetEgressRequest) (*samvaad.EgressInfo, error)) {
	fake.getEgressMutex.Lock()
...
func (fake *FakeIOClient) GetEgressReturns(result1 *samvaad.EgressInfo, result2 error) {
	fake.getEgressMutex.Lock()
	defer fake.getEgressMutex.Unlock()
...
func (fake *FakeIOClient) GetEgressReturnsOnCall(i int, result1 *samvaad.EgressInfo, result2 error) {
	fake.getEgressMutex.Lock()
	defer fake.getEgressMutex.Unlock()
	fake.GetEgressStub = nil
...
func (fake *FakeIOClient) ListEgress(arg1 context.Context, arg2 *samvaad.ListEgressRequest) (*samvaad.ListEgressResponse, error) {
...
func (fake *FakeIOClient) ListEgressCalls(stub func(context.Context, *samvaad.ListEgressRequest) (*samvaad.ListEgressResponse, error)) {
	fake.listEgressMutex.Lock()
	defer fake.listEgressMutex.Unlock()
	fake.ListEgressStub = stub
}

func (fake *FakeIOClient) ListEgressArgsForCall(i int) (context.Context, *samvaad.ListEgressRequest) {
	fake.listEgressMutex.RLock()
	defer fake.listEgressMutex.RUnlock()
...
func (fake *FakeIOClient) ListEgressReturns(result1 *samvaad.ListEgressResponse, result2 error) {
	fake.listEgressMutex.Lock()
	defer fake.listEgressMutex.Unlock()
...
func (fake *FakeIOClient) ListEgressReturnsOnCall(i int, result1 *samvaad.ListEgressResponse, result2 error) {
	fake.listEgressMutex.Lock()
	defer fake.listEgressMutex.Unlock()
	fake.ListEgressStub = nil
