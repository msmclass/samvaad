...
type FakeIngressStore struct {
	DeleteIngressStub        func(context.Context, *samvaad.IngressInfo) error
	...
	ListIngressStub        func(context.Context, samvaad.RoomName) ([]*samvaad.IngressInfo, error)
	...
	LoadIngressStub        func(context.Context, string) (*samvaad.IngressInfo, error)
	...
	LoadIngressFromStreamKeyStub        func(context.Context, string) (*samvaad.IngressInfo, error)
	...
	StoreIngressStub        func(context.Context, *samvaad.IngressInfo) error
	...
	UpdateIngressStub        func(context.Context, *samvaad.IngressInfo) error
	...
	UpdateIngressStateStub        func(context.Context, string, *samvaad.IngressState) error
	updateIngressStateMutex       sync.RWMutex
	updateIngressStateArgsForCall []struct {
		arg1 context.Context
		arg2 string
		arg3 *samvaad.IngressState
	}
...
func (fake *FakeIngressStore) DeleteIngress(arg1 context.Context, arg2 *samvaad.IngressInfo) error {
...
func (fake *FakeIngressStore) DeleteIngressCalls(stub func(context.Context, *samvaad.IngressInfo) error) {
	fake.deleteIngressMutex.Lock()
	defer fake.deleteIngressMutex.Unlock()
	fake.DeleteIngressStub = stub
}

func (fake *FakeIngressStore) DeleteIngressArgsForCall(i int) (context.Context, *samvaad.IngressInfo) {
	fake.deleteIngressMutex.RLock()
	defer fake.deleteIngressMutex.RUnlock()
...
func (fake *FakeIngressStore) ListIngress(arg1 context.Context, arg2 samvaad.RoomName) ([]*samvaad.IngressInfo, error) {
...
func (fake *FakeIngressStore) ListIngressCalls(stub func(context.Context, samvaad.RoomName) ([]*samvaad.IngressInfo, error)) {
	fake.listIngressMutex.Lock()
	defer fake.listIngressMutex.Unlock()
	fake.ListIngressStub = stub
}

func (fake *FakeIngressStore) ListIngressArgsForCall(i int) (context.Context, samvaad.RoomName) {
	fake.listIngressMutex.RLock()
	defer fake.listIngressMutex.RUnlock()
...
func (fake *FakeIngressStore) ListIngressReturns(result1 []*samvaad.IngressInfo, result2 error) {
	fake.listIngressMutex.Lock()
	defer fake.listIngressMutex.Unlock()
...
func (fake *FakeIngressStore) ListIngressReturnsOnCall(i int, result1 []*samvaad.IngressInfo, result2 error) {
	fake.listIngressMutex.Lock()
	defer fake.listIngressMutex.Unlock()
	fake.ListIngressStub = nil
...
func (fake *FakeIngressStore) LoadIngress(arg1 context.Context, arg2 string) (*samvaad.IngressInfo, error) {
...
func (fake *FakeIngressStore) LoadIngressCalls(stub func(context.Context, string) (*samvaad.IngressInfo, error)) {
	fake.loadIngressMutex.Lock()
...
func (fake *FakeIngressStore) LoadIngressReturns(result1 *samvaad.IngressInfo, result2 error) {
	fake.loadIngressMutex.Lock()
	defer fake.loadIngressMutex.Unlock()
...
func (fake *FakeIngressStore) LoadIngressReturnsOnCall(i int, result1 *samvaad.IngressInfo, result2 error) {
	fake.loadIngressMutex.Lock()
	defer fake.loadIngressMutex.Unlock()
	fake.LoadIngressStub = nil
...
func (fake *FakeIngressStore) LoadIngressFromStreamKey(arg1 context.Context, arg2 string) (*samvaad.IngressInfo, error) {
...
func (fake *FakeIngressStore) LoadIngressFromStreamKeyCalls(stub func(context.Context, string) (*samvaad.IngressInfo, error)) {
	fake.loadIngressFromStreamKeyMutex.Lock()
...
func (fake *FakeIngressStore) LoadIngressFromStreamKeyReturns(result1 *samvaad.IngressInfo, result2 error) {
	fake.loadIngressFromStreamKeyMutex.Lock()
	defer fake.loadIngressFromStreamKeyMutex.Unlock()
...
func (fake *FakeIngressStore) LoadIngressFromStreamKeyReturnsOnCall(i int, result1 *samvaad.IngressInfo, result2 error) {
	fake.loadIngressFromStreamKeyMutex.Lock()
	defer fake.loadIngressFromStreamKeyMutex.Unlock()
	fake.LoadIngressFromStreamKeyStub = nil
...
func (fake *FakeIngressStore) StoreIngress(arg1 context.Context, arg2 *samvaad.IngressInfo) error {
...
func (fake *FakeIngressStore) StoreIngressCalls(stub func(context.Context, *samvaad.IngressInfo) error) {
	fake.storeIngressMutex.Lock()
	defer fake.storeIngressMutex.Unlock()
	fake.StoreIngressStub = stub
}

func (fake *FakeIngressStore) StoreIngressArgsForCall(i int) (context.Context, *samvaad.IngressInfo) {
	fake.storeIngressMutex.RLock()
	defer fake.storeIngressMutex.RUnlock()
...
func (fake *FakeIngressStore) UpdateIngress(arg1 context.Context, arg2 *samvaad.IngressInfo) error {
...
func (fake *FakeIngressStore) UpdateIngressCalls(stub func(context.Context, *samvaad.IngressInfo) error) {
	fake.updateIngressMutex.Lock()
	defer fake.updateIngressMutex.Unlock()
	fake.UpdateIngressStub = stub
}

func (fake *FakeIngressStore) UpdateIngressArgsForCall(i int) (context.Context, *samvaad.IngressInfo) {
	fake.updateIngressMutex.RLock()
	defer fake.updateIngressMutex.RUnlock()
...
func (fake *FakeIngressStore) UpdateIngressState(arg1 context.Context, arg2 string, arg3 *samvaad.IngressState) error {
...
func (fake *FakeIngressStore) UpdateIngressStateCalls(stub func(context.Context, string, *samvaad.IngressState) error) {
	fake.updateIngressStateMutex.Lock()
	defer fake.updateIngressStateMutex.Unlock()
	fake.UpdateIngressStateStub = stub
}

func (fake *FakeIngressStore) UpdateIngressStateArgsForCall(i int) (context.Context, string, *samvaad.IngressState) {
	fake.updateIngressStateMutex.RLock()
	defer fake.updateIngressStateMutex.RUnlock()
