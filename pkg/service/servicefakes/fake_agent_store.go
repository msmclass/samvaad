...
type FakeAgentStore struct {
	DeleteAgentDispatchStub        func(context.Context, *samvaad.AgentDispatch) error
	deleteAgentDispatchMutex       sync.RWMutex
	deleteAgentDispatchArgsForCall []struct {
		arg1 context.Context
		arg2 *samvaad.AgentDispatch
	}
	...
	DeleteAgentJobStub        func(context.Context, *samvaad.Job) error
	...
	ListAgentDispatchesStub        func(context.Context, samvaad.RoomName) ([]*samvaad.AgentDispatch, error)
	...
	StoreAgentDispatchStub        func(context.Context, *samvaad.AgentDispatch) error
	...
	StoreAgentJobStub        func(context.Context, *samvaad.Job) error
...
func (fake *FakeAgentStore) DeleteAgentDispatch(arg1 context.Context, arg2 *samvaad.AgentDispatch) error {
...
func (fake *FakeAgentStore) DeleteAgentDispatchCalls(stub func(context.Context, *samvaad.AgentDispatch) error) {
	fake.deleteAgentDispatchMutex.Lock()
	defer fake.deleteAgentDispatchMutex.Unlock()
	fake.DeleteAgentDispatchStub = stub
}

func (fake *FakeAgentStore) DeleteAgentDispatchArgsForCall(i int) (context.Context, *samvaad.AgentDispatch) {
	fake.deleteAgentDispatchMutex.RLock()
	defer fake.deleteAgentDispatchMutex.RUnlock()
...
func (fake *FakeAgentStore) DeleteAgentJob(arg1 context.Context, arg2 *samvaad.Job) error {
...
func (fake *FakeAgentStore) DeleteAgentJobCalls(stub func(context.Context, *samvaad.Job) error) {
	fake.deleteAgentJobMutex.Lock()
	defer fake.deleteAgentJobMutex.Unlock()
	fake.DeleteAgentJobStub = stub
}

func (fake *FakeAgentStore) DeleteAgentJobArgsForCall(i int) (context.Context, *samvaad.Job) {
	fake.deleteAgentJobMutex.RLock()
	defer fake.deleteAgentJobMutex.RUnlock()
...
func (fake *FakeAgentStore) ListAgentDispatches(arg1 context.Context, arg2 samvaad.RoomName) ([]*samvaad.AgentDispatch, error) {
...
func (fake *FakeAgentStore) ListAgentDispatchesCalls(stub func(context.Context, samvaad.RoomName) ([]*samvaad.AgentDispatch, error)) {
	fake.listAgentDispatchesMutex.Lock()
	defer fake.listAgentDispatchesMutex.Unlock()
	fake.ListAgentDispatchesStub = stub
}

func (fake *FakeAgentStore) ListAgentDispatchesArgsForCall(i int) (context.Context, samvaad.RoomName) {
	fake.listAgentDispatchesMutex.RLock()
	defer fake.listAgentDispatchesMutex.RUnlock()
...
func (fake *FakeAgentStore) ListAgentDispatchesReturns(result1 []*samvaad.AgentDispatch, result2 error) {
	fake.listAgentDispatchesMutex.Lock()
	defer fake.listAgentDispatchesMutex.Unlock()
...
func (fake *FakeAgentStore) ListAgentDispatchesReturnsOnCall(i int, result1 []*samvaad.AgentDispatch, result2 error) {
	fake.listAgentDispatchesMutex.Lock()
	defer fake.listAgentDispatchesMutex.Unlock()
	fake.ListAgentDispatchesStub = nil
...
func (fake *FakeAgentStore) StoreAgentDispatch(arg1 context.Context, arg2 *samvaad.AgentDispatch) error {
...
func (fake *FakeAgentStore) StoreAgentDispatchCalls(stub func(context.Context, *samvaad.AgentDispatch) error) {
	fake.storeAgentDispatchMutex.Lock()
	defer fake.storeAgentDispatchMutex.Unlock()
	fake.StoreAgentDispatchStub = stub
}

func (fake *FakeAgentStore) StoreAgentDispatchArgsForCall(i int) (context.Context, *samvaad.AgentDispatch) {
	fake.storeAgentDispatchMutex.RLock()
	defer fake.storeAgentDispatchMutex.RUnlock()
...
func (fake *FakeAgentStore) StoreAgentJob(arg1 context.Context, arg2 *samvaad.Job) error {
...
func (fake *FakeAgentStore) StoreAgentJobCalls(stub func(context.Context, *samvaad.Job) error) {
	fake.storeAgentJobMutex.Lock()
	defer fake.storeAgentJobMutex.Unlock()
	fake.StoreAgentJobStub = stub
}

func (fake *FakeAgentStore) StoreAgentJobArgsForCall(i int) (context.Context, *samvaad.Job) {
	fake.storeAgentJobMutex.RLock()
	defer fake.storeAgentJobMutex.RUnlock()
