...
type FakeEgressStore struct {
	ListEgressStub        func(context.Context, samvaad.RoomName, bool) ([]*samvaad.EgressInfo, error)
	...
	LoadEgressStub        func(context.Context, string) (*samvaad.EgressInfo, error)
	...
	StoreEgressStub        func(context.Context, *samvaad.EgressInfo) error
	...
	UpdateEgressStub        func(context.Context, *samvaad.EgressInfo) error
...
func (fake *FakeEgressStore) ListEgress(arg1 context.Context, arg2 samvaad.RoomName, arg3 bool) ([]*samvaad.EgressInfo, error) {
...
func (fake *FakeEgressStore) ListEgressCalls(stub func(context.Context, samvaad.RoomName, bool) ([]*samvaad.EgressInfo, error)) {
	fake.listEgressMutex.Lock()
	defer fake.listEgressMutex.Unlock()
	fake.ListEgressStub = stub
}

func (fake *FakeEgressStore) ListEgressArgsForCall(i int) (context.Context, samvaad.RoomName, bool) {
	fake.listEgressMutex.RLock()
	defer fake.listEgressMutex.RUnlock()
...
func (fake *FakeEgressStore) ListEgressReturns(result1 []*samvaad.EgressInfo, result2 error) {
	fake.listEgressMutex.Lock()
	defer fake.listEgressMutex.Unlock()
...
func (fake *FakeEgressStore) ListEgressReturnsOnCall(i int, result1 []*samvaad.EgressInfo, result2 error) {
	fake.listEgressMutex.Lock()
	defer fake.listEgressMutex.Unlock()
	fake.ListEgressStub = nil
...
func (fake *FakeEgressStore) LoadEgress(arg1 context.Context, arg2 string) (*samvaad.EgressInfo, error) {
...
func (fake *FakeEgressStore) LoadEgressCalls(stub func(context.Context, string) (*samvaad.EgressInfo, error)) {
	fake.loadEgressMutex.Lock()
...
func (fake *FakeEgressStore) LoadEgressReturns(result1 *samvaad.EgressInfo, result2 error) {
	fake.loadEgressMutex.Lock()
	defer fake.loadEgressMutex.Unlock()
...
func (fake *FakeEgressStore) LoadEgressReturnsOnCall(i int, result1 *samvaad.EgressInfo, result2 error) {
	fake.loadEgressMutex.Lock()
	defer fake.loadEgressMutex.Unlock()
	fake.LoadEgressStub = nil
...
func (fake *FakeEgressStore) StoreEgress(arg1 context.Context, arg2 *samvaad.EgressInfo) error {
...
func (fake *FakeEgressStore) StoreEgressCalls(stub func(context.Context, *samvaad.EgressInfo) error) {
	fake.storeEgressMutex.Lock()
	defer fake.storeEgressMutex.Unlock()
	fake.StoreEgressStub = stub
}

func (fake *FakeEgressStore) StoreEgressArgsForCall(i int) (context.Context, *samvaad.EgressInfo) {
	fake.storeEgressMutex.RLock()
	defer fake.storeEgressMutex.RUnlock()
...
func (fake *FakeEgressStore) UpdateEgress(arg1 context.Context, arg2 *samvaad.EgressInfo) error {
...
func (fake *FakeEgressStore) UpdateEgressCalls(stub func(context.Context, *samvaad.EgressInfo) error) {
	fake.updateEgressMutex.Lock()
	defer fake.updateEgressMutex.Unlock()
	fake.UpdateEgressStub = stub
}

func (fake *FakeEgressStore) UpdateEgressArgsForCall(i int) (context.Context, *samvaad.EgressInfo) {
	fake.updateEgressMutex.RLock()
	defer fake.updateEgressMutex.RUnlock()
