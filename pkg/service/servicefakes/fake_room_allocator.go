...
type FakeRoomAllocator struct {
	...
	CreateRoomStub        func(context.Context, *samvaad.CreateRoomRequest, bool) (*samvaad.Room, *samvaad.RoomInternal, bool, error)
	...
	SelectRoomNodeStub        func(context.Context, samvaad.RoomName, samvaad.NodeID) error
	...
	ValidateCreateRoomStub        func(context.Context, samvaad.RoomName) error
...
func (fake *FakeRoomAllocator) CreateRoom(arg1 context.Context, arg2 *samvaad.CreateRoomRequest, arg3 bool) (*samvaad.Room, *samvaad.RoomInternal, bool, error) {
...
func (fake *FakeRoomAllocator) CreateRoomCalls(stub func(context.Context, *samvaad.CreateRoomRequest, bool) (*samvaad.Room, *samvaad.RoomInternal, bool, error)) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
	fake.CreateRoomStub = stub
}

func (fake *FakeRoomAllocator) CreateRoomArgsForCall(i int) (context.Context, *samvaad.CreateRoomRequest, bool) {
	fake.createRoomMutex.RLock()
	defer fake.createRoomMutex.RUnlock()
...
func (fake *FakeRoomAllocator) CreateRoomReturns(result1 *samvaad.Room, result2 *samvaad.RoomInternal, result3 bool, result4 error) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
...
func (fake *FakeRoomAllocator) CreateRoomReturnsOnCall(i int, result1 *samvaad.Room, result2 *samvaad.RoomInternal, result3 bool, result4 error) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
	fake.CreateRoomStub = nil
...
func (fake *FakeRoomAllocator) SelectRoomNode(arg1 context.Context, arg2 samvaad.RoomName, arg3 samvaad.NodeID) error {
...
func (fake *FakeRoomAllocator) SelectRoomNodeCalls(stub func(context.Context, samvaad.RoomName, samvaad.NodeID) error) {
	fake.selectRoomNodeMutex.Lock()
	defer fake.selectRoomNodeMutex.Unlock()
	fake.SelectRoomNodeStub = stub
}

func (fake *FakeRoomAllocator) SelectRoomNodeArgsForCall(i int) (context.Context, samvaad.RoomName, samvaad.NodeID) {
	fake.selectRoomNodeMutex.RLock()
	defer fake.selectRoomNodeMutex.RUnlock()
...
func (fake *FakeRoomAllocator) ValidateCreateRoom(arg1 context.Context, arg2 samvaad.RoomName) error {
...
func (fake *FakeRoomAllocator) ValidateCreateRoomCalls(stub func(context.Context, samvaad.RoomName) error) {
	fake.validateCreateRoomMutex.Lock()
	defer fake.validateCreateRoomMutex.Unlock()
	fake.ValidateCreateRoomStub = stub
}

func (fake *FakeRoomAllocator) ValidateCreateRoomArgsForCall(i int) (context.Context, samvaad.RoomName) {
	fake.validateCreateRoomMutex.RLock()
	defer fake.validateCreateRoomMutex.RUnlock()
