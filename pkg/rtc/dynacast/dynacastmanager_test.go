...
type testDynacastManagerListener struct {
	onSubscribedMaxQualityChange func(subscribedQualties []*samvaad.SubscribedCodec)
	onSubscribedAudioCodecChange func(subscribedCodecs []*samvaad.SubscribedAudioCodec)
}
...
func TestSubscribedMaxQuality(t *testing.T) {
	t.Run("subscribers muted", func(t *testing.T) {
		var lock sync.Mutex
		actualSubscribedQualities := make([]*samvaad.SubscribedCodec, 0)

		dm := NewDynacastManagerVideo(DynacastManagerVideoParams{
			Listener: &testDynacastManagerListener{
				onSubscribedMaxQualityChange: func(subscribedQualities []*samvaad.SubscribedCodec) {
					lock.Lock()
		...
		dm.NotifySubscriberMaxQuality("s1", mime.MimeTypeVP8, samvaad.VideoQuality_HIGH)
		dm.NotifySubscriberMaxQuality("s2", mime.MimeTypeAV1, samvaad.VideoQuality_HIGH)

		// mute all subscribers of vp8
		dm.NotifySubscriberMaxQuality("s1", mime.MimeTypeVP8, samvaad.VideoQuality_OFF)

		expectedSubscribedQualities := []*samvaad.SubscribedCodec{
			{
			...
			},
			{
				...
				Qualities: []*samvaad.SubscribedQuality{
					{Quality: samvaad.VideoQuality_LOW, Enabled: true},
					{Quality: samvaad.VideoQuality_MEDIUM, Enabled: true},
					{Quality: samvaad.VideoQuality_HIGH, Enabled: true},
				},
			},
		}
	...
	t.Run("subscribers max quality", func(t *testing.T) {
		...
		dm.(*dynacastManagerVideo).maxSubscribedQuality = map[mime.MimeType]samvaad.VideoQuality{
			mime.MimeTypeVP8: samvaad.VideoQuality_LOW,
			mime.MimeTypeAV1: samvaad.VideoQuality_LOW,
		}
		dm.NotifySubscriberMaxQuality("s1", mime.MimeTypeVP8, samvaad.VideoQuality_HIGH)
		dm.NotifySubscriberMaxQuality("s2", mime.MimeTypeVP8, samvaad.VideoQuality_MEDIUM)
		dm.NotifySubscriberMaxQuality("s3", mime.MimeTypeAV1, samvaad.VideoQuality_MEDIUM)
		...
		dm.NotifySubscriberMaxQuality("s1", mime.MimeTypeVP8, samvaad.VideoQuality_MEDIUM)
		...
		dm.NotifySubscriberMaxQuality("s1", mime.MimeTypeVP8, samvaad.VideoQuality_LOW)
		dm.NotifySubscriberMaxQuality("s2", mime.MimeTypeVP8, samvaad.VideoQuality_LOW)
		dm.NotifySubscriberMaxQuality("s3", mime.MimeTypeAV1, samvaad.VideoQuality_LOW)
		...
		dm.NotifySubscriberMaxQuality("s2", mime.MimeTypeVP8, samvaad.VideoQuality_OFF)
		...
		dm.NotifySubscriberMaxQuality("s1", mime.MimeTypeVP8, samvaad.VideoQuality_OFF)
		dm.NotifySubscriberMaxQuality("s3", mime.MimeTypeAV1, samvaad.VideoQuality_OFF)
		...
		dm.NotifySubscriberNodeMaxQuality("n1", []types.SubscribedCodecQuality{
			{CodecMime: mime.MimeTypeVP8, Quality: samvaad.VideoQuality_HIGH},
			{CodecMime: mime.MimeTypeAV1, Quality: samvaad.VideoQuality_MEDIUM},
		})
...
func TestCodecRegression(t *testing.T) {
	t.Run("codec regression video", func(t *testing.T) {
		...
		dm.NotifySubscriberMaxQuality("s1", mime.MimeTypeAV1, samvaad.VideoQuality_HIGH)
		...
		dm.NotifySubscriberMaxQuality("s1", mime.MimeTypeAV1, samvaad.VideoQuality_MEDIUM)
		dm.NotifySubscriberNodeMaxQuality("n1", []types.SubscribedCodecQuality{
			{CodecMime: mime.MimeTypeAV1, Quality: samvaad.VideoQuality_HIGH},
		})
		expectedSubscribedQualities = []*samvaad.SubscribedCodec{
			{
				Codec: mime.MimeTypeAV1.String(),
	...
	t.Run("codec regression audio", func(t *testing.T) {
		var lock sync.Mutex
		actualSubscribedCodecs := make([]*samvaad.SubscribedAudioCodec, 0)
		...
		expectedSubscribedCodecs := []*samvaad.SubscribedAudioCodec{
			{
		...
		dm.NotifySubscriptionNode("n1", []*samvaad.SubscribedAudioCodec{
...
func subscribedCodecsAsString(c1 []*samvaad.SubscribedCodec) string {
	slices.SortFunc(c1, func(a, b *samvaad.SubscribedCodec) int {
...
func subscribedAudioCodecsAsString(c1 []*samvaad.SubscribedAudioCodec) string {
	slices.SortFunc(c1, func(a, b *samvaad.SubscribedAudioCodec) int {
		return strings.Compare(a.Codec, b.Codec)
	})
