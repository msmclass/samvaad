...
func handleICEExchange(t *testing.T, a, b *PCTransport, ah, bh *transportfakes.FakeHandler) {
	ah.OnICECandidateCalls(func(candidate *webrtc.ICECandidate, target samvaad.SignalTarget) error {
		if candidate == nil {
			return nil
		}
	...
	bh.OnICECandidateCalls(func(candidate *webrtc.ICECandidate, target samvaad.SignalTarget) error {
		if candidate == nil {
			return nil
		}
...
func TestConfigureAudioTransceiver(t *testing.T) {
	for _, testcase := range []struct {
		...
		t.Run(fmt.Sprintf("nack=%v,stereo=%v", testcase.nack, testcase.stereo), func(t *testing.T) {
			...
			registerCodecs(&me, []*samvaad.Codec{{Mime: mime.MimeTypeOpus.String()}}, RTCPFeedbackConfig{Audio: []webrtc.RTCPFeedback{{Type: webrtc.TypeRTCPFBNACK}}}, false)
...
func TestSinglePCMediaEngineUnionsCodecs(t *testing.T) {
	...
	publishOnly := []*samvaad.Codec{
		{Mime: mime.MimeTypeOpus.String()},
		{Mime: mime.MimeTypeVP8.String()},
	}
	subscribeOnly := []*samvaad.Codec{
		{Mime: mime.MimeTypeOpus.String()},
		{Mime: mime.MimeTypeVP8.String()},
		{Mime: mime.MimeTypeH264.String()},
	}
...
func TestSinglePCAnswerStripsSubscribeOnlyCodecsFromRecvSide(t *testing.T) {
	publishCodecs := []*samvaad.Codec{
		{Mime: mime.MimeTypeOpus.String()},
		{Mime: mime.MimeTypeVP8.String()},
	}
	subscribeCodecs := []*samvaad.Codec{
		{Mime: mime.MimeTypeOpus.String()},
		{Mime: mime.MimeTypeVP8.String()},
		{Mime: mime.MimeTypeH264.String()},
	}
