...
func (c ClientInfo) isGo() bool {
	return c.ClientInfo != nil && c.ClientInfo.Sdk == samvaad.ClientInfo_GO
}
...
func (c ClientInfo) SupportsCodecChange() bool {
	return c.ClientInfo != nil && c.ClientInfo.Sdk != samvaad.ClientInfo_GO && c.ClientInfo.Sdk != samvaad.ClientInfo_UNKNOWN
}

func (c ClientInfo) CanHandleReconnectResponse() bool {
	if c.Sdk == samvaad.ClientInfo_JS {
...
func (c ClientInfo) SupportsICETCP() bool {
	...
	if c.ClientInfo.Sdk == samvaad.ClientInfo_GO {
		// Go does not support active TCP
		return false
	}
	if c.ClientInfo.Sdk == samvaad.ClientInfo_SWIFT {
...
func (c ClientInfo) SupportsTrackSubscribedEvent() bool {
	return c.ClientInfo.GetSdk() != samvaad.ClientInfo_RUST || c.ClientInfo.GetProtocol() >= 10
}
...
func (c ClientInfo) SupportsSctpZeroChecksum() bool {
	return c.ClientInfo.GetSdk() != samvaad.ClientInfo_UNKNOWN &&
...
func (c ClientInfo) HasCapability(cap samvaad.ClientInfo_Capability) bool {
	if c.ClientInfo == nil {
		return false
	}
...
func (c ClientInfo) SupportsPacketTrailer() bool {
	return c.HasCapability(samvaad.ClientInfo_CAP_PACKET_TRAILER)
}
