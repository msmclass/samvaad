...
func registerCodecs(me *webrtc.MediaEngine, codecs []*samvaad.Codec, rtcpFeedback RTCPFeedbackConfig, filterOutH264HighProfile bool) error {
	// audio codecs
...
func createMediaEngine(codecs []*samvaad.Codec, config DirectionConfig, filterOutH264HighProfile bool) (*webrtc.MediaEngine, error) {
...
func IsCodecEnabled(codecs []*samvaad.Codec, cap webrtc.RTPCodecCapability) bool {
...
func selectAlternativeVideoCodec(enabledCodecs []*samvaad.Codec) string {
...
func selectAlternativeAudioCodec(enabledCodecs []*samvaad.Codec) string {
	for _, c := range enabledCodecs {
...
func mergeCodecsByMime(a, b []*samvaad.Codec) []*samvaad.Codec {
	merged := make([]*samvaad.Codec, 0, len(a)+len(b))
