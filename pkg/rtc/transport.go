...
import (
	...
	sfuinterceptor "github.com/msmclass/samvaad/pkg/sfu/interceptor"
	...
	lkinterceptor "github.com/msmclass/samvaad/pkg/samvaad/transport/pkg/interceptor"
	"github.com/msmclass/samvaad/pkg/samvaad/transport/pkg/rtcconfig"
	lktwcc "github.com/msmclass/samvaad/pkg/samvaad/transport/pkg/twcc"
	"github.com/msmclass/samvaad/pkg/samvaad/codecs/mime"
	"github.com/msmclass/samvaad/pkg/proto/samvaad"
	"github.com/msmclass/samvaad/pkg/samvaad/logger"
	"github.com/msmclass/samvaad/pkg/samvaad/logger/pionlogger"
...
type TransportParams struct {
	...
	Transport                     samvaad.SignalTarget
...
func (t *PCTransport) onDataChannel(dc *webrtc.DataChannel) {
	dc.OnOpen(func() {
		...
		var kind samvaad.DataPacket_Kind
		...
		case kind == samvaad.DataPacket_RELIABLE:
			if t.reliableDC != nil {
				t.reliableDC.Close()
			}
		...
		case kind == samvaad.DataPacket_LOSSY:
			if t.lossyDC != nil {
				t.lossyDC.Close()
			}
...
func (t *PCTransport) SendDataMessage(kind samvaad.DataPacket_Kind, data []byte) error {
	...
	if t.params.UseOneShotSignallingMode {
		...
		if kind == samvaad.DataPacket_RELIABLE {
			dc = t.reliableDC
		} else {
			dc = t.lossyDC
		}
...
func (t *PCTransport) SendDataMessageUnlabeled(data []byte, useRaw bool, sender samvaad.ParticipantIdentity) error {
