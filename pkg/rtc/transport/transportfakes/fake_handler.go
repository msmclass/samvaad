...
type FakeHandler struct {
	...
	OnDataMessageStub        func(samvaad.DataPacket_Kind, []byte)
	...
	OnICECandidateStub        func(*webrtc.ICECandidate, samvaad.SignalTarget) error
	onICECandidateMutex       sync.RWMutex
	onICECandidateArgsForCall []struct {
		arg1 *webrtc.ICECandidate
		arg2 samvaad.SignalTarget
	}
...
func (fake *FakeHandler) OnDataMessage(arg1 samvaad.DataPacket_Kind, arg2 []byte) {
	var arg2Copy []byte
	if arg2 != nil {
...
func (fake *FakeHandler) OnDataMessageCalls(stub func(samvaad.DataPacket_Kind, []byte)) {
	fake.onDataMessageMutex.Lock()
	defer fake.onDataMessageMutex.Unlock()
	fake.OnDataMessageStub = stub
}

func (fake *FakeHandler) OnDataMessageArgsForCall(i int) (samvaad.DataPacket_Kind, []byte) {
	fake.onDataMessageMutex.RLock()
	defer fake.onDataMessageMutex.RUnlock()
...
func (fake *FakeHandler) OnICECandidate(arg1 *webrtc.ICECandidate, arg2 samvaad.SignalTarget) error {
...
func (fake *FakeHandler) OnICECandidateCalls(stub func(*webrtc.ICECandidate, samvaad.SignalTarget) error) {
	fake.onICECandidateMutex.Lock()
	defer fake.onICECandidateMutex.Unlock()
	fake.OnICECandidateStub = stub
}

func (fake *FakeHandler) OnICECandidateArgsForCall(i int) (*webrtc.ICECandidate, samvaad.SignalTarget) {
	fake.onICECandidateMutex.RLock()
	defer fake.onICECandidateMutex.RUnlock()
