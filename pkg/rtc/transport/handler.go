...
type Handler interface {
	OnICECandidate(c *webrtc.ICECandidate, target samvaad.SignalTarget) error
	OnInitialConnected()
	OnFullyEstablished()
	...
	OnDataMessage(kind samvaad.DataPacket_Kind, data []byte)
...
func (h UnimplementedHandler) OnICECandidate(c *webrtc.ICECandidate, target samvaad.SignalTarget) error {
...
func (h UnimplementedHandler) OnDataMessage(kind samvaad.DataPacket_Kind, data []byte)            {}
