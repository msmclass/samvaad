...
func (r *WrappedReceiver) TrackID() samvaad.TrackID {
...
func (r *WrappedReceiver) DeleteDownTrack(participantID samvaad.ParticipantID) {
	r.lock.Lock()
...
type DummyReceiver struct {
	...
	downTracks         map[samvaad.ParticipantID]sfu.TrackSender
	onReadyCallbacks   []func()
...
func NewDummyReceiver(trackID samvaad.TrackID, streamId string, codec webrtc.RTPCodecParameters, headerExtensions []webrtc.RTPHeaderExtensionParameter) *DummyReceiver {
	return &DummyReceiver{
		trackID:          trackID,
		streamId:         streamId,
		codec:            codec,
		headerExtensions: headerExtensions,
		downTracks:       make(map[samvaad.ParticipantID]sfu.TrackSender),
	}
}
...
func (d *DummyReceiver) Upgrade(receiver sfu.TrackReceiver) {
	...
	d.downTracks = make(map[samvaad.ParticipantID]sfu.TrackSender)
...
func (d *DummyReceiver) TrackID() samvaad.TrackID {
	return d.trackID
}
...
func (d *DummyReceiver) VideoLayerMode() samvaad.VideoLayer_Mode {
	if receiver := d.getReceiver(); receiver != nil {
...
func (d *DummyReceiver) DeleteDownTrack(subscriberID samvaad.ParticipantID) {
	d.downTrackLock.Lock()
	defer d.downTrackLock.Unlock()
...
func (d *DummyReceiver) TrackInfo() *samvaad.TrackInfo {
	if receiver := d.getReceiver(); receiver != nil {
...
func (d *DummyReceiver) UpdateTrackInfo(ti *samvaad.TrackInfo) {
	if receiver := d.getReceiver(); receiver != nil {
...
func (d *DummyReceiver) GetTrackStats() *samvaad.RTPStats {
	if receiver := d.getReceiver(); receiver != nil {
...
func (d *DummyRedReceiver) DeleteDownTrack(subscriberID samvaad.ParticipantID) {
	d.downTrackLock.Lock()
	defer d.downTrackLock.Unlock()
