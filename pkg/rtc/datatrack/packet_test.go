...
func TestPacket(t *testing.T) {
	...
	t.Run("with extension", func(t *testing.T) {
		...
		ext, err := unmarshaled.GetExtension(uint8(samvaad.DataTrackExtensionID_DTEI_PARTICIPANT_SID))
		require.NoError(t, err)

		var extParticipantSid ExtensionParticipantSid
		require.NoError(t, extParticipantSid.Unmarshal(ext))
		require.Equal(t, samvaad.ParticipantID("test_participant"), extParticipantSid.ParticipantID())
	})
	...
	t.Run("with extension padding", func(t *testing.T) {
		...
		var extParticipantSid ExtensionParticipantSid
		require.NoError(t, extParticipantSid.Unmarshal(ext))
		require.Equal(t, samvaad.ParticipantID("participant"), extParticipantSid.ParticipantID())
	})
	...
	t.Run("bad packet", func(t *testing.T) {
		...
		err = unmarshaled.Unmarshal(badPacket)
		require.NoError(t, err)
		_, err = unmarshaled.GetExtension(uint8(samvaad.DataTrackExtensionID_DTEI_PARTICIPANT_SID))
		require.Error(t, err)
