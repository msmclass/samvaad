...
type FakeDataDownTrack struct {
	...
	UpdateSubscriptionOptionsStub        func(*samvaad.DataTrackSubscriptionOptions)
	updateSubscriptionOptionsMutex       sync.RWMutex
	updateSubscriptionOptionsArgsForCall []struct {
		arg1 *samvaad.DataTrackSubscriptionOptions
	}
...
func (fake *FakeDataDownTrack) UpdateSubscriptionOptions(arg1 *samvaad.DataTrackSubscriptionOptions) {
...
func (fake *FakeDataDownTrack) UpdateSubscriptionOptionsCalls(stub func(*samvaad.DataTrackSubscriptionOptions)) {
	fake.updateSubscriptionOptionsMutex.Lock()
	defer fake.updateSubscriptionOptionsMutex.Unlock()
	fake.UpdateSubscriptionOptionsStub = stub
}

func (fake *FakeDataDownTrack) UpdateSubscriptionOptionsArgsForCall(i int) *samvaad.DataTrackSubscriptionOptions {
	fake.updateSubscriptionOptionsMutex.RLock()
	defer fake.updateSubscriptionOptionsMutex.RUnlock()
