...
type FakeDataTrack struct {
	...
	DeleteDataDownTrackStub        func(samvaad.ParticipantID)
	...
	RemoveSubscriberStub        func(samvaad.ParticipantID)
	removeSubscriberMutex       sync.RWMutex
	removeSubscriberArgsForCall []struct {
		arg1 samvaad.ParticipantID
	}
	ToProtoStub        func() *samvaad.DataTrackInfo
	toProtoMutex       sync.RWMutex
	toProtoArgsForCall []struct {
	}
	toProtoReturns struct {
		result1 *samvaad.DataTrackInfo
	}
...
func (fake *FakeDataTrack) DeleteDataDownTrack(arg1 samvaad.ParticipantID) {
...
func (fake *FakeDataTrack) DeleteDataDownTrackCalls(stub func(samvaad.ParticipantID)) {
	fake.deleteDataDownTrackMutex.Lock()
	defer fake.deleteDataDownTrackMutex.Unlock()
	fake.DeleteDataDownTrackStub = stub
}

func (fake *FakeDataTrack) DeleteDataDownTrackArgsForCall(i int) samvaad.ParticipantID {
	fake.deleteDataDownTrackMutex.RLock()
	defer fake.deleteDataDownTrackMutex.RUnlock()
...
func (fake *FakeDataTrack) ID() samvaad.TrackID {
	fake.iDMutex.Lock()
...
func (fake *FakeDataTrack) IDCalls(stub func() samvaad.TrackID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = stub
}

func (fake *FakeDataTrack) IDReturns(result1 samvaad.TrackID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *FakeDataTrack) IDReturnsOnCall(i int, result1 samvaad.TrackID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *FakeDataTrack) IsSubscriber(arg1 samvaad.ParticipantID) bool {
...
func (fake *FakeDataTrack) IsSubscriberCalls(stub func(samvaad.ParticipantID) bool) {
	fake.isSubscriberMutex.Lock()
	defer fake.isSubscriberMutex.Unlock()
	fake.IsSubscriberStub = stub
}

func (fake *FakeDataTrack) IsSubscriberArgsForCall(i int) samvaad.ParticipantID {
	fake.isSubscriberMutex.RLock()
	defer fake.isSubscriberMutex.RUnlock()
...
func (fake *FakeDataTrack) PublisherID() samvaad.ParticipantID {
...
func (fake *FakeDataTrack) PublisherIDCalls(stub func() samvaad.ParticipantID) {
	fake.publisherIDMutex.Lock()
	defer fake.publisherIDMutex.Unlock()
	fake.PublisherIDStub = stub
}

func (fake *FakeDataTrack) PublisherIDReturns(result1 samvaad.ParticipantID) {
	fake.publisherIDMutex.Lock()
	defer fake.publisherIDMutex.Unlock()
...
func (fake *FakeDataTrack) PublisherIDReturnsOnCall(i int, result1 samvaad.ParticipantID) {
	fake.publisherIDMutex.Lock()
	defer fake.publisherIDMutex.Unlock()
	fake.PublisherIDStub = nil
...
func (fake *FakeDataTrack) PublisherIdentity() samvaad.ParticipantIdentity {
...
func (fake *FakeDataTrack) PublisherIdentityCalls(stub func() samvaad.ParticipantIdentity) {
	fake.publisherIdentityMutex.Lock()
	defer fake.publisherIdentityMutex.Unlock()
	fake.PublisherIdentityStub = stub
}

func (fake *FakeDataTrack) PublisherIdentityReturns(result1 samvaad.ParticipantIdentity) {
	fake.publisherIdentityMutex.Lock()
	defer fake.publisherIdentityMutex.Unlock()
...
func (fake *FakeDataTrack) PublisherIdentityReturnsOnCall(i int, result1 samvaad.ParticipantIdentity) {
	fake.publisherIdentityMutex.Lock()
	defer fake.publisherIdentityMutex.Unlock()
	fake.PublisherIdentityStub = nil
...
func (fake *FakeDataTrack) RemoveSubscriber(arg1 samvaad.ParticipantID) {
...
func (fake *FakeDataTrack) RemoveSubscriberCalls(stub func(samvaad.ParticipantID)) {
	fake.removeSubscriberMutex.Lock()
	defer fake.removeSubscriberMutex.Unlock()
	fake.RemoveSubscriberStub = stub
}

func (fake *FakeDataTrack) RemoveSubscriberArgsForCall(i int) samvaad.ParticipantID {
	fake.removeSubscriberMutex.RLock()
	defer fake.removeSubscriberMutex.RUnlock()
...
func (fake *FakeDataTrack) ToProto() *samvaad.DataTrackInfo {
...
func (fake *FakeDataTrack) ToProtoCalls(stub func() *samvaad.DataTrackInfo) {
	fake.toProtoMutex.Lock()
	defer fake.toProtoMutex.Unlock()
	fake.ToProtoStub = stub
}

func (fake *FakeDataTrack) ToProtoReturns(result1 *samvaad.DataTrackInfo) {
	fake.toProtoMutex.Lock()
	defer fake.toProtoMutex.Unlock()
...
func (fake *FakeDataTrack) ToProtoReturnsOnCall(i int, result1 *samvaad.DataTrackInfo) {
	fake.toProtoMutex.Lock()
	defer fake.toProtoMutex.Unlock()
	fake.ToProtoStub = nil
