...
func (fake *FakeDataTrackSender) SubscriberID() samvaad.ParticipantID {
...
func (fake *FakeDataTrackSender) SubscriberIDCalls(stub func() samvaad.ParticipantID) {
	fake.subscriberIDMutex.Lock()
	defer fake.subscriberIDMutex.Unlock()
	fake.SubscriberIDStub = stub
}

func (fake *FakeDataTrackSender) SubscriberIDReturns(result1 samvaad.ParticipantID) {
	fake.subscriberIDMutex.Lock()
	defer fake.subscriberIDMutex.Unlock()
...
func (fake *FakeDataTrackSender) SubscriberIDReturnsOnCall(i int, result1 samvaad.ParticipantID) {
	fake.subscriberIDMutex.Lock()
	defer fake.subscriberIDMutex.Unlock()
	fake.SubscriberIDStub = nil
