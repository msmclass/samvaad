...
type FakeLocalParticipantListener struct {
	OnDataMessageStub        func(types.LocalParticipant, samvaad.DataPacket_Kind, *samvaad.DataPacket)
	onDataMessageMutex       sync.RWMutex
	onDataMessageArgsForCall []struct {
		arg1 types.LocalParticipant
		arg2 samvaad.DataPacket_Kind
		arg3 *samvaad.DataPacket
	}
	...
	OnMetricsStub        func(types.Participant, *samvaad.DataPacket)
	onMetricsMutex       sync.RWMutex
	onMetricsArgsForCall []struct {
		arg1 types.Participant
		arg2 *samvaad.DataPacket
	}
	...
	OnSimulateScenarioStub        func(types.LocalParticipant, *samvaad.SimulateScenario) error
	onSimulateScenarioMutex       sync.RWMutex
	onSimulateScenarioArgsForCall []struct {
		arg1 types.LocalParticipant
		arg2 *samvaad.SimulateScenario
	}
	...
	OnSubscribeStatusChangedStub        func(types.LocalParticipant, samvaad.ParticipantID, bool)
	onSubscribeStatusChangedMutex       sync.RWMutex
	onSubscribeStatusChangedArgsForCall []struct {
		arg1 types.LocalParticipant
		arg2 samvaad.ParticipantID
		arg3 bool
	}
	...
	OnSyncStateStub        func(types.LocalParticipant, *samvaad.SyncState) error
	onSyncStateMutex       sync.RWMutex
	onSyncStateArgsForCall []struct {
		arg1 types.LocalParticipant
		arg2 *samvaad.SyncState
	}
	...
	OnUpdateDataSubscriptionsStub        func(types.LocalParticipant, *samvaad.UpdateDataSubscription)
	onUpdateDataSubscriptionsMutex       sync.RWMutex
	onUpdateDataSubscriptionsArgsForCall []struct {
		arg1 types.LocalParticipant
		arg2 *samvaad.UpdateDataSubscription
	}
	OnUpdateSubscriptionPermissionStub        func(types.LocalParticipant, *samvaad.SubscriptionPermission) error
	onUpdateSubscriptionPermissionMutex       sync.RWMutex
	onUpdateSubscriptionPermissionArgsForCall []struct {
		arg1 types.LocalParticipant
		arg2 *samvaad.SubscriptionPermission
	}
	...
	OnUpdateSubscriptionsStub        func(types.LocalParticipant, []samvaad.TrackID, []*samvaad.ParticipantTracks, bool)
	onUpdateSubscriptionsMutex       sync.RWMutex
	onUpdateSubscriptionsArgsForCall []struct {
		arg1 types.LocalParticipant
		arg2 []samvaad.TrackID
		arg3 []*samvaad.ParticipantTracks
		arg4 bool
	}
...
func (fake *FakeLocalParticipantListener) OnDataMessage(arg1 types.LocalParticipant, arg2 samvaad.DataPacket_Kind, arg3 *samvaad.DataPacket) {
...
func (fake *FakeLocalParticipantListener) OnDataMessageCalls(stub func(types.LocalParticipant, samvaad.DataPacket_Kind, *samvaad.DataPacket)) {
	fake.onDataMessageMutex.Lock()
	defer fake.onDataMessageMutex.Unlock()
	fake.OnDataMessageStub = stub
}

func (fake *FakeLocalParticipantListener) OnDataMessageArgsForCall(i int) (types.LocalParticipant, samvaad.DataPacket_Kind, *samvaad.DataPacket) {
	fake.onDataMessageMutex.RLock()
	defer fake.onDataMessageMutex.RUnlock()
...
func (fake *FakeLocalParticipantListener) OnMetrics(arg1 types.Participant, arg2 *samvaad.DataPacket) {
...
func (fake *FakeLocalParticipantListener) OnMetricsCalls(stub func(types.Participant, *samvaad.DataPacket)) {
	fake.onMetricsMutex.Lock()
	defer fake.onMetricsMutex.Unlock()
	fake.OnMetricsStub = stub
}

func (fake *FakeLocalParticipantListener) OnMetricsArgsForCall(i int) (types.Participant, *samvaad.DataPacket) {
	fake.onMetricsMutex.RLock()
	defer fake.onMetricsMutex.RUnlock()
...
func (fake *FakeLocalParticipantListener) OnSimulateScenario(arg1 types.LocalParticipant, arg2 *samvaad.SimulateScenario) error {
...
func (fake *FakeLocalParticipantListener) OnSimulateScenarioCalls(stub func(types.LocalParticipant, *samvaad.SimulateScenario) error) {
	fake.onSimulateScenarioMutex.Lock()
	defer fake.onSimulateScenarioMutex.Unlock()
	fake.OnSimulateScenarioStub = stub
}

func (fake *FakeLocalParticipantListener) OnSimulateScenarioArgsForCall(i int) (types.LocalParticipant, *samvaad.SimulateScenario) {
	fake.onSimulateScenarioMutex.RLock()
	defer fake.onSimulateScenarioMutex.RUnlock()
...
func (fake *FakeLocalParticipantListener) OnSubscribeStatusChanged(arg1 types.LocalParticipant, arg2 samvaad.ParticipantID, arg3 bool) {
...
func (fake *FakeLocalParticipantListener) OnSubscribeStatusChangedCalls(stub func(types.LocalParticipant, samvaad.ParticipantID, bool)) {
	fake.onSubscribeStatusChangedMutex.Lock()
	defer fake.onSubscribeStatusChangedMutex.Unlock()
	fake.OnSubscribeStatusChangedStub = stub
}

func (fake *FakeLocalParticipantListener) OnSubscribeStatusChangedArgsForCall(i int) (types.LocalParticipant, samvaad.ParticipantID, bool) {
	fake.onSubscribeStatusChangedMutex.RLock()
	defer fake.onSubscribeStatusChangedMutex.RUnlock()
...
func (fake *FakeLocalParticipantListener) OnSyncState(arg1 types.LocalParticipant, arg2 *samvaad.SyncState) error {
...
func (fake *FakeLocalParticipantListener) OnSyncStateCalls(stub func(types.LocalParticipant, *samvaad.SyncState) error) {
	fake.onSyncStateMutex.Lock()
	defer fake.onSyncStateMutex.Unlock()
	fake.OnSyncStateStub = stub
}

func (fake *FakeLocalParticipantListener) OnSyncStateArgsForCall(i int) (types.LocalParticipant, *samvaad.SyncState) {
	fake.onSyncStateMutex.RLock()
	defer fake.onSyncStateMutex.RUnlock()
...
func (fake *FakeLocalParticipantListener) OnUpdateDataSubscriptions(arg1 types.LocalParticipant, arg2 *samvaad.UpdateDataSubscription) {
...
func (fake *FakeLocalParticipantListener) OnUpdateDataSubscriptionsCalls(stub func(types.LocalParticipant, *samvaad.UpdateDataSubscription)) {
	fake.onUpdateDataSubscriptionsMutex.Lock()
	defer fake.onUpdateDataSubscriptionsMutex.Unlock()
	fake.OnUpdateDataSubscriptionsStub = stub
}

func (fake *FakeLocalParticipantListener) OnUpdateDataSubscriptionsArgsForCall(i int) (types.LocalParticipant, *samvaad.UpdateDataSubscription) {
	fake.onUpdateDataSubscriptionsMutex.RLock()
	defer fake.onUpdateDataSubscriptionsMutex.RUnlock()
...
func (fake *FakeLocalParticipantListener) OnUpdateSubscriptionPermission(arg1 types.LocalParticipant, arg2 *samvaad.SubscriptionPermission) error {
...
func (fake *FakeLocalParticipantListener) OnUpdateSubscriptionPermissionCalls(stub func(types.LocalParticipant, *samvaad.SubscriptionPermission) error) {
	fake.onUpdateSubscriptionPermissionMutex.Lock()
	defer fake.onUpdateSubscriptionPermissionMutex.Unlock()
	fake.OnUpdateSubscriptionPermissionStub = stub
}

func (fake *FakeLocalParticipantListener) OnUpdateSubscriptionPermissionArgsForCall(i int) (types.LocalParticipant, *samvaad.SubscriptionPermission) {
	fake.onUpdateSubscriptionPermissionMutex.RLock()
	defer fake.onUpdateSubscriptionPermissionMutex.RUnlock()
...
func (fake *FakeLocalParticipantListener) OnUpdateSubscriptions(arg1 types.LocalParticipant, arg2 []samvaad.TrackID, arg3 []*samvaad.ParticipantTracks, arg4 bool) {
	var arg2Copy []samvaad.TrackID
	if arg2 != nil {
		arg2Copy = make([]samvaad.TrackID, len(arg2))
		copy(arg2Copy, arg2)
	}
	var arg3Copy []*samvaad.ParticipantTracks
	if arg3 != nil {
		arg3Copy = make([]*samvaad.ParticipantTracks, len(arg3))
		copy(arg3Copy, arg3)
	}
...
func (fake *FakeLocalParticipantListener) OnUpdateSubscriptionsCalls(stub func(types.LocalParticipant, []samvaad.TrackID, []*samvaad.ParticipantTracks, bool)) {
	fake.onUpdateSubscriptionsMutex.Lock()
	defer fake.onUpdateSubscriptionsMutex.Unlock()
	fake.OnUpdateSubscriptionsStub = stub
}

func (fake *FakeLocalParticipantListener) OnUpdateSubscriptionsArgsForCall(i int) (types.LocalParticipant, []samvaad.TrackID, []*samvaad.ParticipantTracks, bool) {
	fake.onUpdateSubscriptionsMutex.RLock()
	defer fake.onUpdateSubscriptionsMutex.RUnlock()
