...
type FakeRoom struct {
	...
	IDStub        func() samvaad.RoomID
	iDMutex       sync.RWMutex
	iDArgsForCall []struct {
	}
	iDReturns struct {
		result1 samvaad.RoomID
	}
	iDReturnsOnCall map[int]struct {
		result1 samvaad.RoomID
	}
	IsDataMessageUserPacketDuplicateStub        func(*samvaad.UserPacket) bool
	isDataMessageUserPacketDuplicateMutex       sync.RWMutex
	isDataMessageUserPacketDuplicateArgsForCall []struct {
		arg1 *samvaad.UserPacket
	}
	...
	NameStub        func() samvaad.RoomName
	nameMutex       sync.RWMutex
	nameArgsForCall []struct {
	}
	nameReturns struct {
		result1 samvaad.RoomName
	}
	nameReturnsOnCall map[int]struct {
		result1 samvaad.RoomName
	}
	RemoveParticipantStub        func(samvaad.ParticipantIdentity, samvaad.ParticipantID, types.ParticipantCloseReason)
	...
	ResolveDataTrackForSubscriberStub        func(types.LocalParticipant, samvaad.TrackID) types.DataResolverResult
	...
	ResolveMediaTrackForSubscriberStub        func(types.LocalParticipant, samvaad.TrackID) types.MediaResolverResult
	...
	UpdateSubscriptionsStub        func(types.LocalParticipant, []samvaad.TrackID, []*samvaad.ParticipantTracks, bool)
...
func (fake *FakeRoom) ID() samvaad.RoomID {
	fake.iDMutex.Lock()
...
func (fake *FakeRoom) IDCalls(stub func() samvaad.RoomID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = stub
}

func (fake *FakeRoom) IDReturns(result1 samvaad.RoomID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *FakeRoom) IDReturnsOnCall(i int, result1 samvaad.RoomID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *FakeRoom) IsDataMessageUserPacketDuplicate(arg1 *samvaad.UserPacket) bool {
...
func (fake *FakeRoom) IsDataMessageUserPacketDuplicateCalls(stub func(*samvaad.UserPacket) bool) {
	fake.isDataMessageUserPacketDuplicateMutex.Lock()
	defer fake.isDataMessageUserPacketDuplicateMutex.Unlock()
	fake.IsDataMessageUserPacketDuplicateStub = stub
}

func (fake *FakeRoom) IsDataMessageUserPacketDuplicateArgsForCall(i int) *samvaad.UserPacket {
	fake.isDataMessageUserPacketDuplicateMutex.RLock()
	defer fake.isDataMessageUserPacketDuplicateMutex.RUnlock()
...
func (fake *FakeRoom) Name() samvaad.RoomName {
	fake.nameMutex.Lock()
...
func (fake *FakeRoom) NameCalls(stub func() samvaad.RoomName) {
	fake.nameMutex.Lock()
	defer fake.nameMutex.Unlock()
	fake.NameStub = stub
}

func (fake *FakeRoom) NameReturns(result1 samvaad.RoomName) {
	fake.nameMutex.Lock()
	defer fake.nameMutex.Unlock()
	fake.NameStub = nil
...
func (fake *FakeRoom) NameReturnsOnCall(i int, result1 samvaad.RoomName) {
	fake.nameMutex.Lock()
	defer fake.nameMutex.Unlock()
	fake.NameStub = nil
...
func (fake *FakeRoom) RemoveParticipant(arg1 samvaad.ParticipantIdentity, arg2 samvaad.ParticipantID, arg3 types.ParticipantCloseReason) {
...
func (fake *FakeRoom) RemoveParticipantCalls(stub func(samvaad.ParticipantIdentity, samvaad.ParticipantID, types.ParticipantCloseReason)) {
	fake.removeParticipantMutex.Lock()
	defer fake.removeParticipantMutex.Unlock()
	fake.RemoveParticipantStub = stub
}

func (fake *FakeRoom) RemoveParticipantArgsForCall(i int) (samvaad.ParticipantIdentity, samvaad.ParticipantID, types.ParticipantCloseReason) {
	fake.removeParticipantMutex.RLock()
	defer fake.removeParticipantMutex.RUnlock()
...
func (fake *FakeRoom) ResolveDataTrackForSubscriber(arg1 types.LocalParticipant, arg2 samvaad.TrackID) types.DataResolverResult {
...
func (fake *FakeRoom) ResolveDataTrackForSubscriberCalls(stub func(types.LocalParticipant, samvaad.TrackID) types.DataResolverResult) {
	fake.resolveDataTrackForSubscriberMutex.Lock()
	defer fake.resolveDataTrackForSubscriberMutex.Unlock()
	fake.ResolveDataTrackForSubscriberStub = stub
}

func (fake *FakeRoom) ResolveDataTrackForSubscriberArgsForCall(i int) (types.LocalParticipant, samvaad.TrackID) {
	fake.resolveDataTrackForSubscriberMutex.RLock()
	defer fake.resolveDataTrackForSubscriberMutex.RUnlock()
...
func (fake *FakeRoom) ResolveMediaTrackForSubscriber(arg1 types.LocalParticipant, arg2 samvaad.TrackID) types.MediaResolverResult {
...
func (fake *FakeRoom) ResolveMediaTrackForSubscriberCalls(stub func(types.LocalParticipant, samvaad.TrackID) types.MediaResolverResult) {
	fake.resolveMediaTrackForSubscriberMutex.Lock()
	defer fake.resolveMediaTrackForSubscriberMutex.Unlock()
	fake.ResolveMediaTrackForSubscriberStub = stub
}

func (fake *FakeRoom) ResolveMediaTrackForSubscriberArgsForCall(i int) (types.LocalParticipant, samvaad.TrackID) {
	fake.resolveMediaTrackForSubscriberMutex.RLock()
	defer fake.resolveMediaTrackForSubscriberMutex.RUnlock()
...
func (fake *FakeRoom) UpdateSubscriptions(arg1 types.LocalParticipant, arg2 []samvaad.TrackID, arg3 []*samvaad.ParticipantTracks, arg4 bool) {
...
func (fake *FakeRoom) UpdateSubscriptionsCalls(stub func(types.LocalParticipant, []samvaad.TrackID, []*samvaad.ParticipantTracks, bool)) {
	fake.updateSubscriptionsMutex.Lock()
	defer fake.updateSubscriptionsMutex.Unlock()
	fake.UpdateSubscriptionsStub = stub
}

func (fake *FakeRoom) UpdateSubscriptionsArgsForCall(i int) (types.LocalParticipant, []samvaad.TrackID, []*samvaad.ParticipantTracks, bool) {
	fake.updateSubscriptionsMutex.RLock()
	defer fake.updateSubscriptionsMutex.RUnlock()
