...
func (fake *FakeParticipantListener) OnMetrics(arg1 types.Participant, arg2 *samvaad.DataPacket) {
...
func (fake *FakeParticipantListener) OnMetricsCalls(stub func(types.Participant, *samvaad.DataPacket)) {
	fake.onMetricsMutex.Lock()
	defer fake.onMetricsMutex.Unlock()
	fake.OnMetricsStub = stub
}

func (fake *FakeParticipantListener) OnMetricsArgsForCall(i int) (types.Participant, *samvaad.DataPacket) {
	fake.onMetricsMutex.RLock()
	defer fake.onMetricsMutex.RUnlock()
