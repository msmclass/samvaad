...
func (t *SubscribedTrack) Bound(err error) {
	...
	if err == nil && t.MediaTrack().Kind() == samvaad.TrackType_VIDEO {
		...
		if t.settings != nil {
			...
			if t.params.AdaptiveStream {
				t.settings = &samvaad.UpdateTrackSettings{Quality: samvaad.VideoQuality_LOW}
			} else {
				t.settings = &samvaad.UpdateTrackSettings{Quality: samvaad.VideoQuality_HIGH}
			}
...
func (t *SubscribedTrack) ID() samvaad.TrackID {
	return samvaad.TrackID(t.downTrack.ID())
}

func (t *SubscribedTrack) PublisherID() samvaad.ParticipantID {
	return t.params.MediaTrack.PublisherID()
}

func (t *SubscribedTrack) PublisherIdentity() samvaad.ParticipantIdentity {
...
func (t *SubscribedTrack) SubscriberID() samvaad.ParticipantID {
	return t.params.Subscriber.ID()
}

func (t *SubscribedTrack) SubscriberIdentity() samvaad.ParticipantIdentity {
...
func (t *SubscribedTrack) UpdateSubscriberSettings(settings *samvaad.UpdateTrackSettings, isImmediate bool) {
	t.settingsLock.Lock()
...
func (t *SubscribedTrack) OnStatsUpdate(stat *samvaad.AnalyticsStat) {
