...
func (fake *FakeAnalyticsService) SendEvent(arg1 context.Context, arg2 *samvaad.AnalyticsEvent) {
...
func (fake *FakeAnalyticsService) SendEventCalls(stub func(context.Context, *samvaad.AnalyticsEvent)) {
	fake.sendEventMutex.Lock()
	defer fake.sendEventMutex.Unlock()
	fake.SendEventStub = stub
}

func (fake *FakeAnalyticsService) SendEventArgsForCall(i int) (context.Context, *samvaad.AnalyticsEvent) {
	fake.sendEventMutex.RLock()
	defer fake.sendEventMutex.RUnlock()
...
func (fake *FakeAnalyticsService) SendNodeRoomStates(arg1 context.Context, arg2 *samvaad.AnalyticsNodeRooms) {
...
func (fake *FakeAnalyticsService) SendNodeRoomStatesCalls(stub func(context.Context, *samvaad.AnalyticsNodeRooms)) {
	fake.sendNodeRoomStatesMutex.Lock()
	defer fake.sendNodeRoomStatesMutex.Unlock()
	fake.SendNodeRoomStatesStub = stub
}

func (fake *FakeAnalyticsService) SendNodeRoomStatesArgsForCall(i int) (context.Context, *samvaad.AnalyticsNodeRooms) {
	fake.sendNodeRoomStatesMutex.RLock()
	defer fake.sendNodeRoomStatesMutex.RUnlock()
...
func (fake *FakeAnalyticsService) SendStats(arg1 context.Context, arg2 []*samvaad.AnalyticsStat) {
...
func (fake *FakeAnalyticsService) SendStatsCalls(stub func(context.Context, []*samvaad.AnalyticsStat)) {
	fake.sendStatsMutex.Lock()
	defer fake.sendStatsMutex.Unlock()
	fake.SendStatsStub = stub
}

func (fake *FakeAnalyticsService) SendStatsArgsForCall(i int) (context.Context, []*samvaad.AnalyticsStat) {
	fake.sendStatsMutex.RLock()
	defer fake.sendStatsMutex.RUnlock()
