...
import (
	...
	"github.com/msmclass/samvaad/pkg/samvaad/utils/hwstats"
	"github.com/msmclass/samvaad/pkg/samvaad/webhook"
)

const (
	SamvaadNamespace string = "samvaad"
)
...
func Init(nodeID string, nodeType samvaad.NodeType) error {
...
func GetNodeStats(nodeStartedAt int64, prevStats []*samvaad.NodeStats, rateIntervals []time.Duration) (*samvaad.NodeStats, error) {
...
func getNodeStatsRate(statsHistory []*samvaad.NodeStats) *samvaad.NodeStatsRate {
