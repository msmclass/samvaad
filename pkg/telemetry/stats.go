...
func (t *telemetryService) TrackStats(roomID samvaad.RoomID, _roomName samvaad.RoomName, key StatsKey, stat *samvaad.AnalyticsStat) {
	t.enqueue(func() {
		direction := prometheus.Incoming
		if key.streamType == samvaad.StreamType_DOWNSTREAM {
