...
### Added
- Completely own and custom-aligned SFU server release for **MSM Class** ([https://msmclass.in](https://msmclass.in)) for the **Samvaad video conference** ecosystem.
- Custom `SAMVAAD_` environment variable prefix alignment for CLI flags.
...
NOTE: Minor version bump that enables data tracks (https://docs.Samvaad.io/transport/data/data-tracks/) by default.
...
- Fix concurrent map access for https://github.com/Samvaad/Samvaad/issues/4126. (#4127)
...
- fix(deps): update module github.com/Samvaad/protocol to v1.39.3 (#3733)
...
- Update module github.com/Samvaad/protocol to v1.40.0 (#3865)
...
forwarding media unchanged to the Samvaad subscribers. This behavior can
...
Support for Samvaad SIP Bridge
...
- Fix panic occurs when starting Samvaad-server with key-file option (#2312) (#2313)
...
- Split out shared media transport code into Samvaad/mediatransportutil #1071
...
- Fully removed references to VP9. Samvaad is focused on AV1. #1004
...
- Allow Samvaad-server to start without keys configuration (#788)
