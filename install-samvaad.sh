...
# Samvaad install script for Linux
...
get_latest_version()
{
  latest_version=$(curl -s https://api.github.com/repos/msmclass/$REPO/releases/latest | grep -oP '"tarball_url": ".*/tarball/v\K([^/]*)(?=")')
...
ARCHIVE_URL="https://github.com/msmclass/$REPO/releases/download/v${VERSION}/${REPO}_${VERSION}_linux_${ARCH}.tar.gz"
...
log "\nsamvaad-server is installed to $INSTALL_PATH\n"
